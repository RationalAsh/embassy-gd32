...
pub type Usbfspsc1_0R = crate::FieldReader;
#[doc = "Field `USBFSPSC_1_0` writer - USBFS clock prescaler selection"]
pub type Usbfspsc1_0W<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type UsbfspscR = crate::BitReader;
#[doc = "Field `USBFSPSC` writer - Bit 2 of USBFSPSC"]
pub type UsbfspscW<'a, REG> = crate::BitWriter<'a, REG>;
impl R {
    ...
    #[inline(always)]
    pub fn usbfspsc_1_0(&self) -> Usbfspsc1_0R {
        Usbfspsc1_0R::new(((self.bits >> 22) & 3) as u8)
    }
    ...
    pub fn usbfspsc(&self) -> UsbfspscR {
        UsbfspscR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - System clock switch"]
    ...
    #[doc = "Bits 14:15 - ADC clock prescaler selection"]
    #[inline(always)]
    pub fn adcpsc_1_0(&mut self) -> Adcpsc1_0W<'_, Cfg0Spec> {
    ...
    #[doc = "Bit 17 - The LSB of PREDV0 division factor"]
    #[inline(always)]
    pub fn predv0_lsb(&mut self) -> Predv0LsbW<'_, Cfg0Spec> {
        Predv0LsbW::new(self, 17)
    }
    #[doc = "Bits 18:21 - The PLL clock multiplication factor"]
    #[inline(always)]
    pub fn pllmf_3_0(&mut self) -> Pllmf3_0W<'_, Cfg0Spec> {
        Pllmf3_0W::new(self, 18)
    }
    #[doc = "Bits 22:23 - USBFS clock prescaler selection"]
    #[inline(always)]
    pub fn usbfspsc_1_0(&mut self) -> Usbfspsc1_0W<'_, Cfg0Spec> {
        Usbfspsc1_0W::new(self, 22)
    }
    #[doc = "Bits 24:27 - CKOUT0 Clock Source Selection"]
    #[inline(always)]
    pub fn ckout0sel(&mut self) -> Ckout0selW<'_, Cfg0Spec> {
        Ckout0selW::new(self, 24)
    }
    #[doc = "Bit 28 - Bit 2 of ADCPSC"]
    #[inline(always)]
    pub fn adcpsc_2(&mut self) -> Adcpsc2W<'_, Cfg0Spec> {
        Adcpsc2W::new(self, 28)
    }
    #[doc = "Bits 29:30 - Bit 5 and Bit 4 of PLLMF"]
    #[inline(always)]
    pub fn pllmf_5_4(&mut self) -> Pllmf5_4W<'_, Cfg0Spec> {
        Pllmf5_4W::new(self, 29)
    }
    #[doc = "Bit 31 - Bit 2 of USBFSPSC"]
    #[inline(always)]
    pub fn usbfspsc(&mut self) -> UsbfspscW<'_, Cfg0Spec> {
        UsbfspscW::new(self, 31)
    }
}
