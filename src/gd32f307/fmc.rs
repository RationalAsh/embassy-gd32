...
pub mod addr0;
#[doc = "OBCTL (r) register accessor: Option byte control register\n\nYou can [`read`](crate::Reg::read) this register and get [`obctl::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@obctl`] module"]
#[doc(alias = "OBCTL")]
