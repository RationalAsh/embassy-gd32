...
impl W {
    #[doc = "Bit 0 - Time stamp enable"]
    #[inline(always)]
    pub fn tmsen(&mut self) -> TmsenW<'_, PtpTsctlSpec> {
        TmsenW::new(self, 0)
    }
    #[doc = "Bit 1 - Time stamp fine or coarse update"]
    #[inline(always)]
    pub fn tmsfcu(&mut self) -> TmsfcuW<'_, PtpTsctlSpec> {
        TmsfcuW::new(self, 1)
    }
    #[doc = "Bit 2 - Time stamp system time initialize"]
    #[inline(always)]
    pub fn tmssti(&mut self) -> TmsstiW<'_, PtpTsctlSpec> {
        TmsstiW::new(self, 2)
    }
    #[doc = "Bit 3 - Time stamp system time update"]
    #[inline(always)]
    pub fn tmsstu(&mut self) -> TmsstuW<'_, PtpTsctlSpec> {
        TmsstuW::new(self, 3)
    }
    #[doc = "Bit 4 - Time stamp interrupt trigger enable"]
    #[inline(always)]
    pub fn tmsiten(&mut self) -> TmsitenW<'_, PtpTsctlSpec> {
        TmsitenW::new(self, 4)
    }
    #[doc = "Bit 5 - Time stamp addend register update"]
    #[inline(always)]
    pub fn tmsaru(&mut self) -> TmsaruW<'_, PtpTsctlSpec> {
        TmsaruW::new(self, 5)
    }
    #[doc = "Bit 8 - All received frames snapshot enable"]
    #[inline(always)]
    pub fn arfsen(&mut self) -> ArfsenW<'_, PtpTsctlSpec> {
        ArfsenW::new(self, 8)
    }
    #[doc = "Bit 9 - Subsecond counter rollover mode"]
    #[inline(always)]
    pub fn scrom(&mut self) -> ScromW<'_, PtpTsctlSpec> {
        ScromW::new(self, 9)
    }
    #[doc = "Bit 10 - PTP frame snooping version"]
    #[inline(always)]
    pub fn pfsv(&mut self) -> PfsvW<'_, PtpTsctlSpec> {
        PfsvW::new(self, 10)
    }
    #[doc = "Bit 11 - Received Ethernet snapshot enable"]
    #[inline(always)]
    pub fn esen(&mut self) -> EsenW<'_, PtpTsctlSpec> {
        EsenW::new(self, 11)
    }
    #[doc = "Bit 12 - Received IPv6 snapshot enable"]
    #[inline(always)]
    pub fn ip6sen(&mut self) -> Ip6senW<'_, PtpTsctlSpec> {
        Ip6senW::new(self, 12)
    }
    #[doc = "Bit 13 - Received IPv4 snapshot enable"]
    #[inline(always)]
    pub fn ip4sen(&mut self) -> Ip4senW<'_, PtpTsctlSpec> {
        Ip4senW::new(self, 13)
    }
    #[doc = "Bit 14 - Received event type message snapshot enable"]
    #[inline(always)]
    pub fn etmsen(&mut self) -> EtmsenW<'_, PtpTsctlSpec> {
        EtmsenW::new(self, 14)
    }
    #[doc = "Bit 15 - Received master node message snapshot enable"]
    #[inline(always)]
    pub fn mnmsen(&mut self) -> MnmsenW<'_, PtpTsctlSpec> {
        MnmsenW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Clock node type for time stamp"]
    #[inline(always)]
    pub fn cknt(&mut self) -> CkntW<'_, PtpTsctlSpec> {
        CkntW::new(self, 16)
    }
    #[doc = "Bit 18 - MAC address filter enable for PTP frame"]
    #[inline(always)]
    pub fn mafen(&mut self) -> MafenW<'_, PtpTsctlSpec> {
        MafenW::new(self, 18)
    }
}
