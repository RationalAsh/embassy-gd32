...
impl W {
    #[doc = "Bit 0 - Transfer completed"]
    #[inline(always)]
    pub fn tf(&mut self) -> TfW<'_, Hch1intfSpec> {
        TfW::new(self, 0)
    }
    #[doc = "Bit 1 - Channel halted"]
    #[inline(always)]
    pub fn ch(&mut self) -> ChW<'_, Hch1intfSpec> {
        ChW::new(self, 1)
    }
    #[doc = "Bit 2 - DMA Error"]
    #[inline(always)]
    pub fn dmaer(&mut self) -> DmaerW<'_, Hch1intfSpec> {
        DmaerW::new(self, 2)
    }
    #[doc = "Bit 3 - STALL response received interrupt"]
    #[inline(always)]
    pub fn stall(&mut self) -> StallW<'_, Hch1intfSpec> {
        StallW::new(self, 3)
    }
    #[doc = "Bit 4 - NAK response received interrupt"]
    #[inline(always)]
    pub fn nak(&mut self) -> NakW<'_, Hch1intfSpec> {
        NakW::new(self, 4)
    }
    #[doc = "Bit 5 - ACK response received/transmitted interrupt"]
    #[inline(always)]
    pub fn ack(&mut self) -> AckW<'_, Hch1intfSpec> {
        AckW::new(self, 5)
    }
    #[doc = "Bit 6 - NYET"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<'_, Hch1intfSpec> {
        NyetW::new(self, 6)
    }
    #[doc = "Bit 7 - USB bus error"]
    #[inline(always)]
    pub fn usber(&mut self) -> UsberW<'_, Hch1intfSpec> {
        UsberW::new(self, 7)
    }
    #[doc = "Bit 8 - Babble error"]
    #[inline(always)]
    pub fn bber(&mut self) -> BberW<'_, Hch1intfSpec> {
        BberW::new(self, 8)
    }
    #[doc = "Bit 9 - Request queue overrun"]
    #[inline(always)]
    pub fn reqovr(&mut self) -> ReqovrW<'_, Hch1intfSpec> {
        ReqovrW::new(self, 9)
    }
    #[doc = "Bit 10 - Data toggle error"]
    #[inline(always)]
    pub fn dter(&mut self) -> DterW<'_, Hch1intfSpec> {
        DterW::new(self, 10)
    }
}
