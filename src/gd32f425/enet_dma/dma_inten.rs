...
impl W {
    #[doc = "Bit 0 - Transmit interrupt enable"]
    #[inline(always)]
    pub fn tien(&mut self) -> TienW<'_, DmaIntenSpec> {
        TienW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit process stopped interrupt enable"]
    #[inline(always)]
    pub fn tpsien(&mut self) -> TpsienW<'_, DmaIntenSpec> {
        TpsienW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit buffer unavailable interrupt enable"]
    #[inline(always)]
    pub fn tbuien(&mut self) -> TbuienW<'_, DmaIntenSpec> {
        TbuienW::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit jabber timeout interrupt enable"]
    #[inline(always)]
    pub fn tjtien(&mut self) -> TjtienW<'_, DmaIntenSpec> {
        TjtienW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive overflow interrupt enable"]
    #[inline(always)]
    pub fn roien(&mut self) -> RoienW<'_, DmaIntenSpec> {
        RoienW::new(self, 4)
    }
    #[doc = "Bit 5 - Transmit underflow interrupt enable"]
    #[inline(always)]
    pub fn tuien(&mut self) -> TuienW<'_, DmaIntenSpec> {
        TuienW::new(self, 5)
    }
    #[doc = "Bit 6 - Receive interrupt enable"]
    #[inline(always)]
    pub fn rien(&mut self) -> RienW<'_, DmaIntenSpec> {
        RienW::new(self, 6)
    }
    #[doc = "Bit 7 - Receive buffer unavailable interrupt enable"]
    #[inline(always)]
    pub fn rbuien(&mut self) -> RbuienW<'_, DmaIntenSpec> {
        RbuienW::new(self, 7)
    }
    #[doc = "Bit 8 - Receive process stopped interrupt enable"]
    #[inline(always)]
    pub fn rpsien(&mut self) -> RpsienW<'_, DmaIntenSpec> {
        RpsienW::new(self, 8)
    }
    #[doc = "Bit 9 - receive watchdog timeout interrupt enable"]
    #[inline(always)]
    pub fn rwtien(&mut self) -> RwtienW<'_, DmaIntenSpec> {
        RwtienW::new(self, 9)
    }
    #[doc = "Bit 10 - Early transmit interrupt enable"]
    #[inline(always)]
    pub fn etien(&mut self) -> EtienW<'_, DmaIntenSpec> {
        EtienW::new(self, 10)
    }
    #[doc = "Bit 13 - Fatal bus error interrupt enable"]
    #[inline(always)]
    pub fn fbeien(&mut self) -> FbeienW<'_, DmaIntenSpec> {
        FbeienW::new(self, 13)
    }
    #[doc = "Bit 14 - Early receive interrupt enable"]
    #[inline(always)]
    pub fn erien(&mut self) -> ErienW<'_, DmaIntenSpec> {
        ErienW::new(self, 14)
    }
    #[doc = "Bit 15 - Abnormal interrupt summary enable"]
    #[inline(always)]
    pub fn aien(&mut self) -> AienW<'_, DmaIntenSpec> {
        AienW::new(self, 15)
    }
    #[doc = "Bit 16 - Normal interrupt summary enable"]
    #[inline(always)]
    pub fn nien(&mut self) -> NienW<'_, DmaIntenSpec> {
        NienW::new(self, 16)
    }
}
