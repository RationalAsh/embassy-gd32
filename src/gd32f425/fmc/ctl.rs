...
impl W {
    ...
    #[doc = "Bit 1 - main flash sector erase command bit"]
    #[inline(always)]
    pub fn ser(&mut self) -> SerW<'_, CtlSpec> {
        SerW::new(self, 1)
    }
    #[doc = "Bit 2 - main flash mass erase for bank0 command bit"]
    #[inline(always)]
    pub fn mer0(&mut self) -> Mer0W<'_, CtlSpec> {
        Mer0W::new(self, 2)
    }
    #[doc = "Bits 3:7 - Select which sector number to be erased."]
    #[inline(always)]
    pub fn sn(&mut self) -> SnW<'_, CtlSpec> {
        SnW::new(self, 3)
    }
    #[doc = "Bits 8:9 - Program size bit"]
    #[inline(always)]
    pub fn psz(&mut self) -> PszW<'_, CtlSpec> {
        PszW::new(self, 8)
    }
    #[doc = "Bit 15 - main flash mass erase for bank1command bit"]
    #[inline(always)]
    pub fn mer1(&mut self) -> Mer1W<'_, CtlSpec> {
        Mer1W::new(self, 15)
    }
    #[doc = "Bit 16 - send erase command to FMC bit"]
    #[inline(always)]
