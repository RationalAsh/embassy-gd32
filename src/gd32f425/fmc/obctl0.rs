...
impl W {
    #[doc = "Bit 0 - FMC_OBCTL0 lock bit"]
    #[inline(always)]
    pub fn ob_lk(&mut self) -> ObLkW<'_, Obctl0Spec> {
        ObLkW::new(self, 0)
    }
    #[doc = "Bit 1 - send option byte change command to FMC bit"]
    #[inline(always)]
    pub fn ob_start(&mut self) -> ObStartW<'_, Obctl0Spec> {
        ObStartW::new(self, 1)
    }
    #[doc = "Bits 2:3 - option byte BOR threshold value"]
    #[inline(always)]
    pub fn bor_th(&mut self) -> BorThW<'_, Obctl0Spec> {
        BorThW::new(self, 2)
    }
    #[doc = "Bit 4 - option byte boot bank value"]
    #[inline(always)]
    pub fn bb(&mut self) -> BbW<'_, Obctl0Spec> {
        BbW::new(self, 4)
    }
    #[doc = "Bit 5 - option byte watchdog value"]
    #[inline(always)]
    pub fn n_wdg_hw(&mut self) -> NWdgHwW<'_, Obctl0Spec> {
        NWdgHwW::new(self, 5)
    }
    #[doc = "Bit 6 - option byte deepsleep reset value"]
    #[inline(always)]
    pub fn n_rst_dpslp(&mut self) -> NRstDpslpW<'_, Obctl0Spec> {
        NRstDpslpW::new(self, 6)
    }
    #[doc = "Bit 7 - option byte standby reset value"]
    #[inline(always)]
    pub fn n_rst_stdby(&mut self) -> NRstStdbyW<'_, Obctl0Spec> {
        NRstStdbyW::new(self, 7)
    }
    #[doc = "Bits 8:15 - option byte Security Protection code"]
    #[inline(always)]
    pub fn spc(&mut self) -> SpcW<'_, Obctl0Spec> {
        SpcW::new(self, 8)
    }
    #[doc = "Bits 16:27 - Erase/program protection of each sector when DRP is 0"]
    #[inline(always)]
    pub fn wp0(&mut self) -> Wp0W<'_, Obctl0Spec> {
        Wp0W::new(self, 16)
    }
    #[doc = "Bit 30 - Double banks or single bank selection when flash size is 1M"]
    #[inline(always)]
    pub fn dbs(&mut self) -> DbsW<'_, Obctl0Spec> {
        DbsW::new(self, 30)
    }
    #[doc = "Bit 31 - D-bus read protection bit"]
    #[inline(always)]
    pub fn drp(&mut self) -> DrpW<'_, Obctl0Spec> {
        DrpW::new(self, 31)
    }
}
