...
impl W {
    #[doc = "Bit 0 - End of operation flag bit"]
    #[inline(always)]
    pub fn end(&mut self) -> EndW<'_, StatSpec> {
        EndW::new(self, 0)
    }
    #[doc = "Bit 1 - Flash operation error flag bit"]
    #[inline(always)]
    pub fn operr(&mut self) -> OperrW<'_, StatSpec> {
        OperrW::new(self, 1)
    }
    #[doc = "Bit 4 - Erase/Program protection error flag bit"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Program size not match error flag bit"]
    #[inline(always)]
    pub fn pgmerr(&mut self) -> PgmerrW<'_, StatSpec> {
        PgmerrW::new(self, 6)
    }
    #[doc = "Bit 7 - Program sequence error flag bit"]
    #[inline(always)]
    pub fn pgserr(&mut self) -> PgserrW<'_, StatSpec> {
        PgserrW::new(self, 7)
    }
    #[doc = "Bit 8 - Read D-bus protection error flag bit"]
    #[inline(always)]
    pub fn rdderr(&mut self) -> RdderrW<'_, StatSpec> {
        RdderrW::new(self, 8)
    }
}
