...
pub enum Outsel {
    #[doc = "0: No effect"]
    Disabled = 0,
    #[doc = "1: If POEN and IOS are 0, output is disabled"]
    Enabled = 1,
}
...
impl OutselR {
    ...
    #[doc = "If POEN and IOS are 0, output is disabled"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - The output value selection"]
    #[inline(always)]
    pub fn outsel(&mut self) -> OutselW<'_, CfgSpec> {
        OutselW::new(self, 0)
    }
    #[doc = "Bit 1 - Write CHxVAL register selection"]
    #[inline(always)]
