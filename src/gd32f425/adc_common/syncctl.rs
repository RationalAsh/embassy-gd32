...
impl W {
    #[doc = "Bits 0:4 - ADC sync mode"]
    #[inline(always)]
    pub fn syncm(&mut self) -> SyncmW<'_, SyncctlSpec> {
        SyncmW::new(self, 0)
    }
    #[doc = "Bits 8:11 - ADC sync delay"]
    #[inline(always)]
    pub fn syncdly(&mut self) -> SyncdlyW<'_, SyncctlSpec> {
        SyncdlyW::new(self, 8)
    }
    #[doc = "Bit 13 - ADC sync DMA disable mode"]
    #[inline(always)]
    pub fn syncddm(&mut self) -> SyncddmW<'_, SyncctlSpec> {
        SyncddmW::new(self, 13)
    }
    #[doc = "Bits 14:15 - ADC sync DMA mode selection"]
    #[inline(always)]
    pub fn syncdma(&mut self) -> SyncdmaW<'_, SyncctlSpec> {
        SyncdmaW::new(self, 14)
    }
    #[doc = "Bits 16:18 - ADC clock"]
    #[inline(always)]
    pub fn adcck(&mut self) -> AdcckW<'_, SyncctlSpec> {
        AdcckW::new(self, 16)
    }
    #[doc = "Bit 22 - Channel 18 (1/4 voltate of external battery) enable of ADC0"]
    #[inline(always)]
    pub fn vbaten(&mut self) -> VbatenW<'_, SyncctlSpec> {
        VbatenW::new(self, 22)
    }
    #[doc = "Bit 23 - Channel 16 (temperature sensor) and 17 (internal reference voltage) enable of ADC0"]
    #[inline(always)]
    pub fn tsvren(&mut self) -> TsvrenW<'_, SyncctlSpec> {
        TsvrenW::new(self, 23)
    }
}
