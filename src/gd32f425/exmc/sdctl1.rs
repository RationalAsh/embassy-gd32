...
impl W {
    #[doc = "Bits 0:1 - Column address bit width"]
    #[inline(always)]
    pub fn caw(&mut self) -> CawW<'_, Sdctl1Spec> {
        CawW::new(self, 0)
    }
    #[doc = "Bits 2:3 - Row address bit width"]
    #[inline(always)]
    pub fn raw(&mut self) -> RawW<'_, Sdctl1Spec> {
        RawW::new(self, 2)
    }
    #[doc = "Bits 4:5 - SDRAM data bus width"]
    #[inline(always)]
    pub fn sdw(&mut self) -> SdwW<'_, Sdctl1Spec> {
        SdwW::new(self, 4)
    }
    #[doc = "Bit 6 - Number of banks"]
    #[inline(always)]
    pub fn nbk(&mut self) -> NbkW<'_, Sdctl1Spec> {
        NbkW::new(self, 6)
    }
    #[doc = "Bits 7:8 - CAS Latency"]
    #[inline(always)]
    pub fn cl(&mut self) -> ClW<'_, Sdctl1Spec> {
        ClW::new(self, 7)
    }
    #[doc = "Bit 9 - Write protection enable"]
    #[inline(always)]
    pub fn wpen(&mut self) -> WpenW<'_, Sdctl1Spec> {
        WpenW::new(self, 9)
    }
    #[doc = "Bits 10:11 - SDRAM clock configuration"]
    #[inline(always)]
    pub fn sdclk(&mut self) -> SdclkW<'_, Sdctl1Spec> {
        SdclkW::new(self, 10)
    }
    #[doc = "Bit 12 - Burst read"]
    #[inline(always)]
    pub fn brstrd(&mut self) -> BrstrdW<'_, Sdctl1Spec> {
        BrstrdW::new(self, 12)
    }
    #[doc = "Bits 13:14 - Pipeline delay"]
    #[inline(always)]
    pub fn piped(&mut self) -> PipedW<'_, Sdctl1Spec> {
        PipedW::new(self, 13)
    }
}
