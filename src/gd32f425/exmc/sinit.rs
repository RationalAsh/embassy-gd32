...
impl W {
    #[doc = "Bits 16:17 - Bit number of SPI PSRAM command phase"]
    #[inline(always)]
    pub fn cmdbit(&mut self) -> CmdbitW<'_, SinitSpec> {
        CmdbitW::new(self, 16)
    }
    #[doc = "Bits 24:28 - Bit number of SPI PSRAM address phase"]
    #[inline(always)]
    pub fn adrbit(&mut self) -> AdrbitW<'_, SinitSpec> {
        AdrbitW::new(self, 24)
    }
    #[doc = "Bits 29:30 - SPI PSRAM ID Length"]
    #[inline(always)]
    pub fn idl(&mut self) -> IdlW<'_, SinitSpec> {
        IdlW::new(self, 29)
    }
    #[doc = "Bit 31 - Read data sample polarity"]
    #[inline(always)]
    pub fn pol(&mut self) -> PolW<'_, SinitSpec> {
        PolW::new(self, 31)
    }
}
