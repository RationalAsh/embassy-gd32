...
impl W {
    #[doc = "Bits 0:3 - Load Mode Register Delay"]
    #[inline(always)]
    pub fn lmrd(&mut self) -> LmrdW<'_, Sdtcfg1Spec> {
        LmrdW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Exit Self-refresh delay"]
    #[inline(always)]
    pub fn xsrd(&mut self) -> XsrdW<'_, Sdtcfg1Spec> {
        XsrdW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Row address select delay"]
    #[inline(always)]
    pub fn rasd(&mut self) -> RasdW<'_, Sdtcfg1Spec> {
        RasdW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Auto refresh delay"]
    #[inline(always)]
    pub fn arfd(&mut self) -> ArfdW<'_, Sdtcfg1Spec> {
        ArfdW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Write recovery delay"]
    #[inline(always)]
    pub fn wrd(&mut self) -> WrdW<'_, Sdtcfg1Spec> {
        WrdW::new(self, 16)
    }
    #[doc = "Bits 20:23 - Row precharge delay"]
    #[inline(always)]
    pub fn rpd(&mut self) -> RpdW<'_, Sdtcfg1Spec> {
        RpdW::new(self, 20)
    }
    #[doc = "Bits 24:27 - Row to column delay"]
    #[inline(always)]
    pub fn rcd(&mut self) -> RcdW<'_, Sdtcfg1Spec> {
        RcdW::new(self, 24)
    }
}
