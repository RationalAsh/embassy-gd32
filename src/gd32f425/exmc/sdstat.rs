...
impl W {
    #[doc = "Bit 0 - Refresh error interrupt flag"]
    #[inline(always)]
    pub fn reif(&mut self) -> ReifW<'_, SdstatSpec> {
        ReifW::new(self, 0)
    }
    #[doc = "Bits 1:2 - Device 0 status"]
    #[inline(always)]
    pub fn sta0(&mut self) -> Sta0W<'_, SdstatSpec> {
        Sta0W::new(self, 1)
    }
    #[doc = "Bits 3:4 - Device1 status"]
    #[inline(always)]
    pub fn sta1(&mut self) -> Sta1W<'_, SdstatSpec> {
        Sta1W::new(self, 3)
    }
    #[doc = "Bit 5 - Not Ready status"]
    #[inline(always)]
    pub fn nrdy(&mut self) -> NrdyW<'_, SdstatSpec> {
        NrdyW::new(self, 5)
    }
}
