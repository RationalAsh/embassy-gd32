...
impl W {
    #[doc = "Bit 0 - NOR bank enable"]
    #[inline(always)]
    pub fn nrbken(&mut self) -> NrbkenW<'_, Snctl2Spec> {
        NrbkenW::new(self, 0)
    }
    #[doc = "Bit 1 - NOR bank memory address/data multiplexing"]
    #[inline(always)]
    pub fn nrmux(&mut self) -> NrmuxW<'_, Snctl2Spec> {
        NrmuxW::new(self, 1)
    }
    #[doc = "Bits 2:3 - NOR bank memory type"]
    #[inline(always)]
    pub fn nrtp(&mut self) -> NrtpW<'_, Snctl2Spec> {
        NrtpW::new(self, 2)
    }
    #[doc = "Bits 4:5 - NOR bank memory data bus width"]
    #[inline(always)]
    pub fn nrw(&mut self) -> NrwW<'_, Snctl2Spec> {
        NrwW::new(self, 4)
    }
    #[doc = "Bit 6 - NOR Flash access enable"]
    #[inline(always)]
    pub fn nren(&mut self) -> NrenW<'_, Snctl2Spec> {
        NrenW::new(self, 6)
    }
    #[doc = "Bit 8 - Synchronous burst enable"]
    #[inline(always)]
    pub fn sbrsten(&mut self) -> SbrstenW<'_, Snctl2Spec> {
        SbrstenW::new(self, 8)
    }
    #[doc = "Bit 9 - NWAIT signal polarity"]
    #[inline(always)]
    pub fn nrwtpol(&mut self) -> NrwtpolW<'_, Snctl2Spec> {
        NrwtpolW::new(self, 9)
    }
    #[doc = "Bit 10 - Wrapped burst mode enable"]
    #[inline(always)]
    pub fn wrapen(&mut self) -> WrapenW<'_, Snctl2Spec> {
        WrapenW::new(self, 10)
    }
    #[doc = "Bit 11 - NWAIT signal configuration, only work in synchronous mode"]
    #[inline(always)]
    pub fn nrwtcfg(&mut self) -> NrwtcfgW<'_, Snctl2Spec> {
        NrwtcfgW::new(self, 11)
    }
    #[doc = "Bit 12 - Write enable"]
    #[inline(always)]
    pub fn wren(&mut self) -> WrenW<'_, Snctl2Spec> {
        WrenW::new(self, 12)
    }
    #[doc = "Bit 13 - NWAIT signal enable"]
    #[inline(always)]
    pub fn nrwten(&mut self) -> NrwtenW<'_, Snctl2Spec> {
        NrwtenW::new(self, 13)
    }
    #[doc = "Bit 14 - Extended mode enable"]
    #[inline(always)]
    pub fn exmoden(&mut self) -> ExmodenW<'_, Snctl2Spec> {
        ExmodenW::new(self, 14)
    }
    #[doc = "Bit 15 - Asynchronous wait"]
    #[inline(always)]
    pub fn asyncwait(&mut self) -> AsyncwaitW<'_, Snctl2Spec> {
        AsyncwaitW::new(self, 15)
    }
    #[doc = "Bits 16:18 - CRAM page size"]
    #[inline(always)]
    pub fn cps(&mut self) -> CpsW<'_, Snctl2Spec> {
        CpsW::new(self, 16)
    }
    #[doc = "Bit 19 - Synchronous write"]
    #[inline(always)]
    pub fn syncwr(&mut self) -> SyncwrW<'_, Snctl2Spec> {
        SyncwrW::new(self, 19)
    }
    #[doc = "Bit 20 - Consecutive Clock"]
    #[inline(always)]
    pub fn cck(&mut self) -> CckW<'_, Snctl2Spec> {
        CckW::new(self, 20)
    }
}
