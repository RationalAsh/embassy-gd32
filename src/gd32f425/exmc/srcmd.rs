...
impl W {
    #[doc = "Bits 0:15 - SPI Read Command for AHB read transfer"]
    #[inline(always)]
    pub fn rcmd(&mut self) -> RcmdW<'_, SrcmdSpec> {
        RcmdW::new(self, 0)
    }
    #[doc = "Bits 16:19 - SPI Read Wait Cycle number after address phase"]
    #[inline(always)]
    pub fn rwaitcycle(&mut self) -> RwaitcycleW<'_, SrcmdSpec> {
        RwaitcycleW::new(self, 16)
    }
    #[doc = "Bits 20:21 - SPI PSRAM Read command mode"]
    #[inline(always)]
    pub fn rmode(&mut self) -> RmodeW<'_, SrcmdSpec> {
        RmodeW::new(self, 20)
    }
    #[doc = "Bit 31 - Send SPI Read ID Command"]
    #[inline(always)]
    pub fn rdid(&mut self) -> RdidW<'_, SrcmdSpec> {
        RdidW::new(self, 31)
    }
}
