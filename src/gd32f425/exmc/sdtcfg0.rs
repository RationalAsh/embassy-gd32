...
impl W {
    #[doc = "Bits 0:3 - Load Mode Register Delay"]
    #[inline(always)]
    pub fn lmrd(&mut self) -> LmrdW<'_, Sdtcfg0Spec> {
        LmrdW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Exit Self-refresh delay"]
    #[inline(always)]
    pub fn xsrd(&mut self) -> XsrdW<'_, Sdtcfg0Spec> {
        XsrdW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Row address select delay"]
    #[inline(always)]
    pub fn rasd(&mut self) -> RasdW<'_, Sdtcfg0Spec> {
        RasdW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Auto refresh delay"]
    #[inline(always)]
    pub fn arfd(&mut self) -> ArfdW<'_, Sdtcfg0Spec> {
        ArfdW::new(self, 12)
    }
    #[doc = "Bits 16:19 - Write recovery delay"]
    #[inline(always)]
    pub fn wrd(&mut self) -> WrdW<'_, Sdtcfg0Spec> {
        WrdW::new(self, 16)
    }
    #[doc = "Bits 20:23 - Row precharge delay"]
    #[inline(always)]
    pub fn rpd(&mut self) -> RpdW<'_, Sdtcfg0Spec> {
        RpdW::new(self, 20)
    }
    #[doc = "Bits 24:27 - Row to column delay"]
    #[inline(always)]
    pub fn rcd(&mut self) -> RcdW<'_, Sdtcfg0Spec> {
        RcdW::new(self, 24)
    }
}
