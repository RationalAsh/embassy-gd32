...
impl W {
    #[doc = "Bit 0 - Capture Enable"]
    #[inline(always)]
    pub fn cap(&mut self) -> CapW<'_, CtlSpec> {
        CapW::new(self, 0)
    }
    #[doc = "Bit 1 - Snapshot mode"]
    #[inline(always)]
    pub fn snap(&mut self) -> SnapW<'_, CtlSpec> {
        SnapW::new(self, 1)
    }
    #[doc = "Bit 2 - Window Enable"]
    #[inline(always)]
    pub fn wden(&mut self) -> WdenW<'_, CtlSpec> {
        WdenW::new(self, 2)
    }
    #[doc = "Bit 3 - JPEG mode"]
    #[inline(always)]
    pub fn jm(&mut self) -> JmW<'_, CtlSpec> {
        JmW::new(self, 3)
    }
    #[doc = "Bit 4 - Embedded Synchronous Mode"]
    #[inline(always)]
    pub fn esm(&mut self) -> EsmW<'_, CtlSpec> {
        EsmW::new(self, 4)
    }
    #[doc = "Bit 5 - Clock Polarity Selection"]
    #[inline(always)]
    pub fn cks(&mut self) -> CksW<'_, CtlSpec> {
        CksW::new(self, 5)
    }
    #[doc = "Bit 6 - Horizontal Polarity Selection"]
    #[inline(always)]
    pub fn hps(&mut self) -> HpsW<'_, CtlSpec> {
        HpsW::new(self, 6)
    }
    #[doc = "Bit 7 - Vertical Polarity Selection"]
    #[inline(always)]
    pub fn vps(&mut self) -> VpsW<'_, CtlSpec> {
        VpsW::new(self, 7)
    }
    #[doc = "Bits 8:9 - Frame rate"]
    #[inline(always)]
    pub fn fr(&mut self) -> FrW<'_, CtlSpec> {
        FrW::new(self, 8)
    }
    #[doc = "Bits 10:11 - Digital camera interface format"]
    #[inline(always)]
    pub fn dcif(&mut self) -> DcifW<'_, CtlSpec> {
        DcifW::new(self, 10)
    }
    #[doc = "Bit 14 - DCI Enable"]
    #[inline(always)]
    pub fn dcien(&mut self) -> DcienW<'_, CtlSpec> {
        DcienW::new(self, 14)
    }
}
