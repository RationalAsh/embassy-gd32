...
impl W {
    #[doc = "Bits 0:3 - Second units in BCD code."]
    #[inline(always)]
    pub fn scu(&mut self) -> ScuW<'_, Alrm1tdSpec> {
        ScuW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Second tens in BCD code."]
    #[inline(always)]
    pub fn sct(&mut self) -> SctW<'_, Alrm1tdSpec> {
        SctW::new(self, 4)
    }
    #[doc = "Bit 7 - Alarm seconds mask bit"]
    #[inline(always)]
    pub fn msks(&mut self) -> MsksW<'_, Alrm1tdSpec> {
        MsksW::new(self, 7)
    }
    #[doc = "Bits 8:11 - Minute units in BCD code."]
    #[inline(always)]
    pub fn mnu(&mut self) -> MnuW<'_, Alrm1tdSpec> {
        MnuW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Minute tens in BCD code."]
    #[inline(always)]
    pub fn mnt(&mut self) -> MntW<'_, Alrm1tdSpec> {
        MntW::new(self, 12)
    }
    #[doc = "Bit 15 - Alarm minutes mask bit"]
    #[inline(always)]
    pub fn mskm(&mut self) -> MskmW<'_, Alrm1tdSpec> {
        MskmW::new(self, 15)
    }
    #[doc = "Bits 16:19 - Hour units in BCD code."]
    #[inline(always)]
    pub fn hru(&mut self) -> HruW<'_, Alrm1tdSpec> {
        HruW::new(self, 16)
    }
    #[doc = "Bits 20:21 - Hour tens in BCD code."]
    #[inline(always)]
    pub fn hrt(&mut self) -> HrtW<'_, Alrm1tdSpec> {
        HrtW::new(self, 20)
    }
    #[doc = "Bit 22 - AM/PM flag"]
    #[inline(always)]
    pub fn pm(&mut self) -> PmW<'_, Alrm1tdSpec> {
        PmW::new(self, 22)
    }
    #[doc = "Bit 23 - Alarm hours mask bit"]
    #[inline(always)]
    pub fn mskh(&mut self) -> MskhW<'_, Alrm1tdSpec> {
        MskhW::new(self, 23)
    }
    #[doc = "Bits 24:27 - Date units or week day in BCD code."]
    #[inline(always)]
    pub fn dayu(&mut self) -> DayuW<'_, Alrm1tdSpec> {
        DayuW::new(self, 24)
    }
    #[doc = "Bits 28:29 - Date tens in BCD code."]
    #[inline(always)]
    pub fn dayt(&mut self) -> DaytW<'_, Alrm1tdSpec> {
        DaytW::new(self, 28)
    }
    #[doc = "Bit 30 - Day of the week selected"]
    #[inline(always)]
    pub fn dows(&mut self) -> DowsW<'_, Alrm1tdSpec> {
        DowsW::new(self, 30)
    }
    #[doc = "Bit 31 - Alarm date mask bit"]
    #[inline(always)]
    pub fn mskd(&mut self) -> MskdW<'_, Alrm1tdSpec> {
        MskdW::new(self, 31)
    }
}
