...
impl W {
    #[doc = "Bits 0:2 - Auto-wakeup timer clock selection"]
    #[inline(always)]
    pub fn wtcs(&mut self) -> WtcsW<'_, CtlSpec> {
        WtcsW::new(self, 0)
    }
    #[doc = "Bit 3 - Valid event edge of time-stamp"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Coarse calibration function enable"]
    #[inline(always)]
    pub fn ccen(&mut self) -> CcenW<'_, CtlSpec> {
        CcenW::new(self, 7)
    }
    #[doc = "Bit 8 - Alarm-0 function enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - Alarm-1 function enable"]
    #[inline(always)]
    pub fn alrm1en(&mut self) -> Alrm1enW<'_, CtlSpec> {
        Alrm1enW::new(self, 9)
    }
    #[doc = "Bit 10 - Auto-wakeup timer function enable"]
    #[inline(always)]
    pub fn wten(&mut self) -> WtenW<'_, CtlSpec> {
        WtenW::new(self, 10)
    }
    #[doc = "Bit 11 - Time-stamp function enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - RTC alarm-1 interrupt enable"]
    #[inline(always)]
    pub fn alrm1ie(&mut self) -> Alrm1ieW<'_, CtlSpec> {
        Alrm1ieW::new(self, 13)
    }
    #[doc = "Bit 14 - Auto-wakeup timer interrupt enable"]
    #[inline(always)]
    pub fn wtie(&mut self) -> WtieW<'_, CtlSpec> {
        WtieW::new(self, 14)
    }
    #[doc = "Bit 15 - Time-stamp interrupt enable"]
    #[inline(always)]
