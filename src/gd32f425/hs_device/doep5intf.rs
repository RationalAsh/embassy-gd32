...
impl W {
    #[doc = "Bit 0 - Transfer finished"]
    #[inline(always)]
    pub fn tf(&mut self) -> TfW<'_, Doep5intfSpec> {
        TfW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled"]
    #[inline(always)]
    pub fn epdis(&mut self) -> EpdisW<'_, Doep5intfSpec> {
        EpdisW::new(self, 1)
    }
    #[doc = "Bit 3 - Setup phase finished"]
    #[inline(always)]
    pub fn stpf(&mut self) -> StpfW<'_, Doep5intfSpec> {
        StpfW::new(self, 3)
    }
    #[doc = "Bit 4 - Endpoint Rx FIFO overrun"]
    #[inline(always)]
    pub fn eprxfovr(&mut self) -> EprxfovrW<'_, Doep5intfSpec> {
        EprxfovrW::new(self, 4)
    }
    #[doc = "Bit 6 - Back-to-back SETUP packets"]
    #[inline(always)]
    pub fn btbstp(&mut self) -> BtbstpW<'_, Doep5intfSpec> {
        BtbstpW::new(self, 6)
    }
    #[doc = "Bit 14 - NYET handshake is sent"]
    #[inline(always)]
    pub fn nyet(&mut self) -> NyetW<'_, Doep5intfSpec> {
        NyetW::new(self, 14)
    }
}
