...
impl W {
    #[doc = "Bit 0 - Transfer completed interrupt enable"]
    #[inline(always)]
    pub fn tfen(&mut self) -> TfenW<'_, DiepintenSpec> {
        TfenW::new(self, 0)
    }
    #[doc = "Bit 1 - Endpoint disabled interrupt enable"]
    #[inline(always)]
    pub fn epdisen(&mut self) -> EpdisenW<'_, DiepintenSpec> {
        EpdisenW::new(self, 1)
    }
    #[doc = "Bit 3 - Control IN timeout condition interrupt enable (Non-isochronous endpoints)"]
    #[inline(always)]
    pub fn citoen(&mut self) -> CitoenW<'_, DiepintenSpec> {
        CitoenW::new(self, 3)
    }
    #[doc = "Bit 4 - Endpoint Tx FIFO underrun interrupt enable bit"]
    #[inline(always)]
    pub fn eptxfuden(&mut self) -> EptxfudenW<'_, DiepintenSpec> {
        EptxfudenW::new(self, 4)
    }
    #[doc = "Bit 6 - IN endpoint NAK effective interrupt enable"]
    #[inline(always)]
    pub fn iepneen(&mut self) -> IepneenW<'_, DiepintenSpec> {
        IepneenW::new(self, 6)
    }
    #[doc = "Bit 7 - Trabsmit FIFO empty interrupt enable"]
    #[inline(always)]
    pub fn txfeen(&mut self) -> TxfeenW<'_, DiepintenSpec> {
        TxfeenW::new(self, 7)
    }
    #[doc = "Bit 13 - NAK handshake sent by USBHS interrupt enable bit"]
    #[inline(always)]
    pub fn naken(&mut self) -> NakenW<'_, DiepintenSpec> {
        NakenW::new(self, 13)
    }
}
