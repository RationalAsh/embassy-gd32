...
impl W {
    #[doc = "Bit 0 - Transfer enable"]
    #[inline(always)]
    pub fn ten(&mut self) -> TenW<'_, IpaCtlSpec> {
        TenW::new(self, 0)
    }
    #[doc = "Bit 1 - Transfer hang up"]
    #[inline(always)]
    pub fn thu(&mut self) -> ThuW<'_, IpaCtlSpec> {
        ThuW::new(self, 1)
    }
    #[doc = "Bit 2 - Transfer stop"]
    #[inline(always)]
    pub fn tst(&mut self) -> TstW<'_, IpaCtlSpec> {
        TstW::new(self, 2)
    }
    #[doc = "Bit 8 - Enable bit for transfer access error interrupt"]
    #[inline(always)]
    pub fn taeie(&mut self) -> TaeieW<'_, IpaCtlSpec> {
        TaeieW::new(self, 8)
    }
    #[doc = "Bit 9 - Enable bit for full transfer finish interrupt"]
    #[inline(always)]
    pub fn ftfie(&mut self) -> FtfieW<'_, IpaCtlSpec> {
        FtfieW::new(self, 9)
    }
    #[doc = "Bit 10 - Enable bit for transfer line mark interrupt"]
    #[inline(always)]
    pub fn tlmie(&mut self) -> TlmieW<'_, IpaCtlSpec> {
        TlmieW::new(self, 10)
    }
    #[doc = "Bit 11 - Enable bit for LUT access conflict interrupt"]
    #[inline(always)]
    pub fn lacie(&mut self) -> LacieW<'_, IpaCtlSpec> {
        LacieW::new(self, 11)
    }
    #[doc = "Bit 12 - Enable bit for LUT loading finish interrupt"]
    #[inline(always)]
    pub fn llfie(&mut self) -> LlfieW<'_, IpaCtlSpec> {
        LlfieW::new(self, 12)
    }
    #[doc = "Bit 13 - Enable bit for wrong configuration interrupt"]
    #[inline(always)]
    pub fn wcfie(&mut self) -> WcfieW<'_, IpaCtlSpec> {
        WcfieW::new(self, 13)
    }
    #[doc = "Bits 16:17 - Pixel format convert mode"]
    #[inline(always)]
    pub fn pfcm(&mut self) -> PfcmW<'_, IpaCtlSpec> {
        PfcmW::new(self, 16)
    }
}
