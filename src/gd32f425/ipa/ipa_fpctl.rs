...
impl W {
    #[doc = "Bits 0:3 - Foreground pixel format"]
    #[inline(always)]
    pub fn fpf(&mut self) -> FpfW<'_, IpaFpctlSpec> {
        FpfW::new(self, 0)
    }
    #[doc = "Bit 4 - Foreground LUT pixel format"]
    #[inline(always)]
    pub fn flpf(&mut self) -> FlpfW<'_, IpaFpctlSpec> {
        FlpfW::new(self, 4)
    }
    #[doc = "Bit 5 - Foreground LUT loading enable"]
    #[inline(always)]
    pub fn fllen(&mut self) -> FllenW<'_, IpaFpctlSpec> {
        FllenW::new(self, 5)
    }
    #[doc = "Bits 8:15 - Foreground LUT number of pixel"]
    #[inline(always)]
    pub fn fcnp(&mut self) -> FcnpW<'_, IpaFpctlSpec> {
        FcnpW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Foreground alpha value calculation algorithm"]
    #[inline(always)]
    pub fn favca(&mut self) -> FavcaW<'_, IpaFpctlSpec> {
        FavcaW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Foreground pre- defined alpha value"]
    #[inline(always)]
    pub fn fpdav(&mut self) -> FpdavW<'_, IpaFpctlSpec> {
        FpdavW::new(self, 24)
    }
}
