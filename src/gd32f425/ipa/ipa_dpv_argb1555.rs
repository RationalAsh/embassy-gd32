...
impl W {
    #[doc = "Bits 0:4 - Destination pre-defined blue value"]
    #[inline(always)]
    pub fn dpdbv(&mut self) -> DpdbvW<'_, IpaDpvArgb1555Spec> {
        DpdbvW::new(self, 0)
    }
    #[doc = "Bits 5:9 - Destination pre-defined green value"]
    #[inline(always)]
    pub fn dpdgv(&mut self) -> DpdgvW<'_, IpaDpvArgb1555Spec> {
        DpdgvW::new(self, 5)
    }
    #[doc = "Bits 10:14 - Destination pre-defined red value"]
    #[inline(always)]
    pub fn dpdrv(&mut self) -> DpdrvW<'_, IpaDpvArgb1555Spec> {
        DpdrvW::new(self, 10)
    }
    #[doc = "Bit 15 - Destination pre-defined alpha value"]
    #[inline(always)]
    pub fn dpdav(&mut self) -> DpdavW<'_, IpaDpvArgb1555Spec> {
        DpdavW::new(self, 15)
    }
}
