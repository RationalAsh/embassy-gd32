...
impl W {
    #[doc = "Bits 0:7 - Destination pre-defined blue value"]
    #[inline(always)]
    pub fn dpdbv(&mut self) -> DpdbvW<'_, IpaDpvArgb8888Spec> {
        DpdbvW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Destination pre-defined green value"]
    #[inline(always)]
    pub fn dpdgv(&mut self) -> DpdgvW<'_, IpaDpvArgb8888Spec> {
        DpdgvW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Destination pre-defined red value"]
    #[inline(always)]
    pub fn dpdrv(&mut self) -> DpdrvW<'_, IpaDpvArgb8888Spec> {
        DpdrvW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Destination pre-defined alpha value"]
    #[inline(always)]
    pub fn dpdav(&mut self) -> DpdavW<'_, IpaDpvArgb8888Spec> {
        DpdavW::new(self, 24)
    }
}
