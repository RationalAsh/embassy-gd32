...
impl W {
    #[doc = "Bits 0:3 - Background pixel format"]
    #[inline(always)]
    pub fn bpf(&mut self) -> BpfW<'_, IpaBpctlSpec> {
        BpfW::new(self, 0)
    }
    #[doc = "Bit 4 - Background LUT pixel format"]
    #[inline(always)]
    pub fn blpf(&mut self) -> BlpfW<'_, IpaBpctlSpec> {
        BlpfW::new(self, 4)
    }
    #[doc = "Bit 5 - Background LUT loading enable"]
    #[inline(always)]
    pub fn bllen(&mut self) -> BllenW<'_, IpaBpctlSpec> {
        BllenW::new(self, 5)
    }
    #[doc = "Bits 8:15 - Background LUT number of pixel"]
    #[inline(always)]
    pub fn bcnp(&mut self) -> BcnpW<'_, IpaBpctlSpec> {
        BcnpW::new(self, 8)
    }
    #[doc = "Bits 16:17 - Background alpha value calculation algorithm"]
    #[inline(always)]
    pub fn bavca(&mut self) -> BavcaW<'_, IpaBpctlSpec> {
        BavcaW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Background pre- defined alpha value"]
    #[inline(always)]
    pub fn bpdav(&mut self) -> BpdavW<'_, IpaBpctlSpec> {
        BpdavW::new(self, 24)
    }
}
