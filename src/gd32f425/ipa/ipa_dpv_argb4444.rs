...
impl W {
    #[doc = "Bits 0:3 - Destination pre-defined blue value"]
    #[inline(always)]
    pub fn dpdbv(&mut self) -> DpdbvW<'_, IpaDpvArgb4444Spec> {
        DpdbvW::new(self, 0)
    }
    #[doc = "Bits 4:7 - Destination pre-defined green value"]
    #[inline(always)]
    pub fn dpdgv(&mut self) -> DpdgvW<'_, IpaDpvArgb4444Spec> {
        DpdgvW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Destination pre-defined red value"]
    #[inline(always)]
    pub fn dpdrv(&mut self) -> DpdrvW<'_, IpaDpvArgb4444Spec> {
        DpdrvW::new(self, 8)
    }
    #[doc = "Bits 12:15 - Destination pre-defined alpha value"]
    #[inline(always)]
    pub fn dpdav(&mut self) -> DpdavW<'_, IpaDpvArgb4444Spec> {
        DpdavW::new(self, 12)
    }
}
