...
impl W {
    #[doc = "Bit 0 - TLI enable bit"]
    #[inline(always)]
    pub fn tlien(&mut self) -> TlienW<'_, CtlSpec> {
        TlienW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Blue channel Dither Bits Number"]
    #[inline(always)]
    pub fn bdb(&mut self) -> BdbW<'_, CtlSpec> {
        BdbW::new(self, 4)
    }
    #[doc = "Bits 8:10 - Green channel Dither Bits Number"]
    #[inline(always)]
    pub fn gdb(&mut self) -> GdbW<'_, CtlSpec> {
        GdbW::new(self, 8)
    }
    #[doc = "Bits 12:14 - Red channel Dither Bits Number"]
    #[inline(always)]
    pub fn rdb(&mut self) -> RdbW<'_, CtlSpec> {
        RdbW::new(self, 12)
    }
    #[doc = "Bit 16 - Dither Function Enable"]
    #[inline(always)]
    pub fn dfen(&mut self) -> DfenW<'_, CtlSpec> {
        DfenW::new(self, 16)
    }
    #[doc = "Bit 28 - Pixel Clock Polarity Selection"]
    #[inline(always)]
    pub fn clkps(&mut self) -> ClkpsW<'_, CtlSpec> {
        ClkpsW::new(self, 28)
    }
    #[doc = "Bit 29 - Data Enable Polarity Selection"]
    #[inline(always)]
    pub fn deps(&mut self) -> DepsW<'_, CtlSpec> {
        DepsW::new(self, 29)
    }
    #[doc = "Bit 30 - Vertical Pulse Polarity Selection"]
    #[inline(always)]
    pub fn vpps(&mut self) -> VppsW<'_, CtlSpec> {
        VppsW::new(self, 30)
    }
    #[doc = "Bit 31 - Horizontal Pulse Polarity Selection"]
    #[inline(always)]
    pub fn hpps(&mut self) -> HppsW<'_, CtlSpec> {
        HppsW::new(self, 31)
    }
}
