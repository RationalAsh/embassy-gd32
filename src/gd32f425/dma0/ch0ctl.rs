...
impl W {
    #[doc = "Bit 0 - Channel enable"]
    #[inline(always)]
    pub fn chen(&mut self) -> ChenW<'_, Ch0ctlSpec> {
        ChenW::new(self, 0)
    }
    #[doc = "Bit 1 - Enable bit for single data mode exception interrupt"]
    #[inline(always)]
    pub fn sdeie(&mut self) -> SdeieW<'_, Ch0ctlSpec> {
        SdeieW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable bit for tranfer access error interrupt"]
    #[inline(always)]
    pub fn taeie(&mut self) -> TaeieW<'_, Ch0ctlSpec> {
        TaeieW::new(self, 2)
    }
    #[doc = "Bit 3 - Enable bit for half transfer finish interrupt"]
    #[inline(always)]
    pub fn htfie(&mut self) -> HtfieW<'_, Ch0ctlSpec> {
        HtfieW::new(self, 3)
    }
    #[doc = "Bit 4 - Enable bit for full transfer finish interrupt"]
    #[inline(always)]
    pub fn ftfie(&mut self) -> FtfieW<'_, Ch0ctlSpec> {
        FtfieW::new(self, 4)
    }
    #[doc = "Bit 5 - Transfer flow controller select"]
    #[inline(always)]
    pub fn tfcs(&mut self) -> TfcsW<'_, Ch0ctlSpec> {
        TfcsW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Transfer mode"]
    #[inline(always)]
    pub fn tm(&mut self) -> TmW<'_, Ch0ctlSpec> {
        TmW::new(self, 6)
    }
    #[doc = "Bit 8 - Circulation mode enable"]
    #[inline(always)]
    pub fn cmen(&mut self) -> CmenW<'_, Ch0ctlSpec> {
        CmenW::new(self, 8)
    }
    #[doc = "Bit 9 - Next address generation algorithm of peripheral"]
    #[inline(always)]
    pub fn pnaga(&mut self) -> PnagaW<'_, Ch0ctlSpec> {
        PnagaW::new(self, 9)
    }
    #[doc = "Bit 10 - Next address generation algorithm of memory"]
    #[inline(always)]
    pub fn mnaga(&mut self) -> MnagaW<'_, Ch0ctlSpec> {
        MnagaW::new(self, 10)
    }
    #[doc = "Bits 11:12 - Transfer width of peripheral"]
    #[inline(always)]
    pub fn pwidth(&mut self) -> PwidthW<'_, Ch0ctlSpec> {
        PwidthW::new(self, 11)
    }
    #[doc = "Bits 13:14 - Transfer width of memory"]
    #[inline(always)]
    pub fn mwidth(&mut self) -> MwidthW<'_, Ch0ctlSpec> {
        MwidthW::new(self, 13)
    }
    #[doc = "Bit 15 - Peripheral address increment fixed"]
    #[inline(always)]
    pub fn paif(&mut self) -> PaifW<'_, Ch0ctlSpec> {
        PaifW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Priority level"]
    #[inline(always)]
    pub fn prio(&mut self) -> PrioW<'_, Ch0ctlSpec> {
        PrioW::new(self, 16)
    }
    #[doc = "Bit 18 - Switch-buffer mode enable"]
    #[inline(always)]
    pub fn sbmen(&mut self) -> SbmenW<'_, Ch0ctlSpec> {
        SbmenW::new(self, 18)
    }
    #[doc = "Bit 19 - Memory buffer select"]
    #[inline(always)]
    pub fn mbs(&mut self) -> MbsW<'_, Ch0ctlSpec> {
        MbsW::new(self, 19)
    }
    #[doc = "Bits 21:22 - Transfer burst type of peripheral"]
    #[inline(always)]
    pub fn pburst(&mut self) -> PburstW<'_, Ch0ctlSpec> {
        PburstW::new(self, 21)
    }
    #[doc = "Bits 23:24 - Transfer burst type of memory"]
    #[inline(always)]
    pub fn mburst(&mut self) -> MburstW<'_, Ch0ctlSpec> {
        MburstW::new(self, 23)
    }
    #[doc = "Bits 25:27 - Peripheral enable"]
    #[inline(always)]
    pub fn perien(&mut self) -> PerienW<'_, Ch0ctlSpec> {
        PerienW::new(self, 25)
    }
}
