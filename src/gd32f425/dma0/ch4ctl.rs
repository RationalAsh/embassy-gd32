...
impl W {
    ...
    #[doc = "Bit 1 - Enable bit for single data mode exception interrupt"]
    #[inline(always)]
    pub fn sdeie(&mut self) -> SdeieW<'_, Ch4ctlSpec> {
        SdeieW::new(self, 1)
    }
    #[doc = "Bit 2 - Enable bit for tranfer access error interrupt"]
    #[inline(always)]
    pub fn taeie(&mut self) -> TaeieW<'_, Ch4ctlSpec> {
        TaeieW::new(self, 2)
    }
    #[doc = "Bit 3 - Enable bit for half transfer finish interrupt"]
    #[inline(always)]
    ...
    #[doc = "Bit 5 - Transfer flow controller select"]
    #[inline(always)]
    pub fn tfcs(&mut self) -> TfcsW<'_, Ch4ctlSpec> {
        TfcsW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Transfer mode"]
    #[inline(always)]
    pub fn tm(&mut self) -> TmW<'_, Ch4ctlSpec> {
        TmW::new(self, 6)
    }
    #[doc = "Bit 8 - Circulation mode enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - Peripheral address increment fixed"]
    #[inline(always)]
    pub fn paif(&mut self) -> PaifW<'_, Ch4ctlSpec> {
        PaifW::new(self, 15)
    }
    #[doc = "Bits 16:17 - Priority level"]
    #[inline(always)]
    ...
    #[doc = "Bit 18 - Switch-buffer mode enable"]
    #[inline(always)]
    pub fn sbmen(&mut self) -> SbmenW<'_, Ch4ctlSpec> {
        SbmenW::new(self, 18)
    }
    #[doc = "Bit 19 - Memory buffer select"]
    #[inline(always)]
    pub fn mbs(&mut self) -> MbsW<'_, Ch4ctlSpec> {
        MbsW::new(self, 19)
    }
    #[doc = "Bits 21:22 - Transfer burst type of peripheral"]
    #[inline(always)]
    pub fn pburst(&mut self) -> PburstW<'_, Ch4ctlSpec> {
        PburstW::new(self, 21)
    }
    #[doc = "Bits 23:24 - Transfer burst type of memory"]
    #[inline(always)]
    pub fn mburst(&mut self) -> MburstW<'_, Ch4ctlSpec> {
        MburstW::new(self, 23)
    }
    #[doc = "Bits 25:27 - Peripheral enable"]
    #[inline(always)]
    pub fn perien(&mut self) -> PerienW<'_, Ch4ctlSpec> {
        PerienW::new(self, 25)
    }
}
