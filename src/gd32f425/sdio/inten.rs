...
impl W {
    #[doc = "Bit 0 - Command response CRC fail interrupt enable"]
    #[inline(always)]
    pub fn ccrcerrie(&mut self) -> CcrcerrieW<'_, IntenSpec> {
        CcrcerrieW::new(self, 0)
    }
    #[doc = "Bit 1 - Data CRC fail interrupt enable"]
    #[inline(always)]
    pub fn dtcrcerrie(&mut self) -> DtcrcerrieW<'_, IntenSpec> {
        DtcrcerrieW::new(self, 1)
    }
    #[doc = "Bit 2 - Command response timeout interrupt enable"]
    #[inline(always)]
    pub fn cmdtmoutie(&mut self) -> CmdtmoutieW<'_, IntenSpec> {
        CmdtmoutieW::new(self, 2)
    }
    #[doc = "Bit 3 - Data timeout interrupt enable"]
    #[inline(always)]
    pub fn dttmoutie(&mut self) -> DttmoutieW<'_, IntenSpec> {
        DttmoutieW::new(self, 3)
    }
    #[doc = "Bit 4 - Transmit FIFO underrun error interrupt enable"]
    #[inline(always)]
    pub fn txureie(&mut self) -> TxureieW<'_, IntenSpec> {
        TxureieW::new(self, 4)
    }
    #[doc = "Bit 5 - Received FIFO overrun error interrupt enable"]
    #[inline(always)]
    pub fn rxoreie(&mut self) -> RxoreieW<'_, IntenSpec> {
        RxoreieW::new(self, 5)
    }
    #[doc = "Bit 6 - Command response received interrupt enable"]
    #[inline(always)]
    pub fn cmdrecvie(&mut self) -> CmdrecvieW<'_, IntenSpec> {
        CmdrecvieW::new(self, 6)
    }
    #[doc = "Bit 7 - Command sent interrupt enable"]
    #[inline(always)]
    pub fn cmdsendie(&mut self) -> CmdsendieW<'_, IntenSpec> {
        CmdsendieW::new(self, 7)
    }
    #[doc = "Bit 8 - Data end interrupt enable"]
    #[inline(always)]
    pub fn dtendie(&mut self) -> DtendieW<'_, IntenSpec> {
        DtendieW::new(self, 8)
    }
    #[doc = "Bit 9 - Start bit error interrupt enable"]
    #[inline(always)]
    pub fn stbiteie(&mut self) -> StbiteieW<'_, IntenSpec> {
        StbiteieW::new(self, 9)
    }
    #[doc = "Bit 10 - Data block end interrupt enable"]
    #[inline(always)]
    pub fn dtblkendie(&mut self) -> DtblkendieW<'_, IntenSpec> {
        DtblkendieW::new(self, 10)
    }
    #[doc = "Bit 11 - Command transmission interrupt enable"]
    #[inline(always)]
    pub fn cmdrunie(&mut self) -> CmdrunieW<'_, IntenSpec> {
        CmdrunieW::new(self, 11)
    }
    #[doc = "Bit 12 - Data transmission interrupt enable"]
    #[inline(always)]
    pub fn txrunie(&mut self) -> TxrunieW<'_, IntenSpec> {
        TxrunieW::new(self, 12)
    }
    #[doc = "Bit 13 - Data reception interrupt enable"]
    #[inline(always)]
    pub fn rxrunie(&mut self) -> RxrunieW<'_, IntenSpec> {
        RxrunieW::new(self, 13)
    }
    #[doc = "Bit 14 - Transmit FIFO half empty interrupt enable"]
    #[inline(always)]
    pub fn tfhie(&mut self) -> TfhieW<'_, IntenSpec> {
        TfhieW::new(self, 14)
    }
    #[doc = "Bit 15 - Receive FIFO half full interrupt enable"]
    #[inline(always)]
    pub fn rfhie(&mut self) -> RfhieW<'_, IntenSpec> {
        RfhieW::new(self, 15)
    }
    #[doc = "Bit 16 - Transmit FIFO full interrupt enable"]
    #[inline(always)]
    pub fn tffie(&mut self) -> TffieW<'_, IntenSpec> {
        TffieW::new(self, 16)
    }
    #[doc = "Bit 17 - Receive FIFO full interrupt enable"]
    #[inline(always)]
    pub fn rffie(&mut self) -> RffieW<'_, IntenSpec> {
        RffieW::new(self, 17)
    }
    #[doc = "Bit 18 - Transmit FIFO empty interrupt enable"]
    #[inline(always)]
    pub fn tfeie(&mut self) -> TfeieW<'_, IntenSpec> {
        TfeieW::new(self, 18)
    }
    #[doc = "Bit 19 - Receive FIFO empty interrupt enable"]
    #[inline(always)]
    pub fn rfeie(&mut self) -> RfeieW<'_, IntenSpec> {
        RfeieW::new(self, 19)
    }
    #[doc = "Bit 20 - Data valid in transmit FIFO interrupt enable"]
    #[inline(always)]
    pub fn txdtvalie(&mut self) -> TxdtvalieW<'_, IntenSpec> {
        TxdtvalieW::new(self, 20)
    }
    #[doc = "Bit 21 - Data valid in receive FIFO interrupt enable"]
    #[inline(always)]
    pub fn rxdtvalie(&mut self) -> RxdtvalieW<'_, IntenSpec> {
        RxdtvalieW::new(self, 21)
    }
    #[doc = "Bit 22 - SD I/O interrupt received interrupt enable"]
    #[inline(always)]
    pub fn sdiointie(&mut self) -> SdiointieW<'_, IntenSpec> {
        SdiointieW::new(self, 22)
    }
    #[doc = "Bit 23 - CE-ATA command completion signal received interrupt enable"]
    #[inline(always)]
    pub fn ataendie(&mut self) -> AtaendieW<'_, IntenSpec> {
