...
impl W {
    #[doc = "Bit 0 - Port 0 output max speed bits"]
    #[inline(always)]
    pub fn spd0(&mut self) -> Spd0W<'_, SpdSpec> {
        Spd0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port 1 output max speed bits"]
    #[inline(always)]
    pub fn spd1(&mut self) -> Spd1W<'_, SpdSpec> {
        Spd1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port 2 output max speed bits"]
    #[inline(always)]
    pub fn spd2(&mut self) -> Spd2W<'_, SpdSpec> {
        Spd2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port 3 output max speed bits"]
    #[inline(always)]
    pub fn spd3(&mut self) -> Spd3W<'_, SpdSpec> {
        Spd3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port 4 output max speed bits"]
    #[inline(always)]
    pub fn spd4(&mut self) -> Spd4W<'_, SpdSpec> {
        Spd4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port 5 output max speed bits"]
    #[inline(always)]
    pub fn spd5(&mut self) -> Spd5W<'_, SpdSpec> {
        Spd5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port 6 output max speed bits"]
    #[inline(always)]
    pub fn spd6(&mut self) -> Spd6W<'_, SpdSpec> {
        Spd6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port 7 output max speed bits"]
    #[inline(always)]
    pub fn spd7(&mut self) -> Spd7W<'_, SpdSpec> {
        Spd7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port 8 output max speed bits"]
    #[inline(always)]
    pub fn spd8(&mut self) -> Spd8W<'_, SpdSpec> {
        Spd8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port 9 output max speed bits"]
    #[inline(always)]
    pub fn spd9(&mut self) -> Spd9W<'_, SpdSpec> {
        Spd9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port 10 output max speed bits"]
    #[inline(always)]
    pub fn spd10(&mut self) -> Spd10W<'_, SpdSpec> {
        Spd10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port 11 output max speed bits"]
    #[inline(always)]
    pub fn spd11(&mut self) -> Spd11W<'_, SpdSpec> {
        Spd11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port 12 output max speed bits"]
    #[inline(always)]
    pub fn spd12(&mut self) -> Spd12W<'_, SpdSpec> {
        Spd12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port 13 output max speed bits"]
    #[inline(always)]
    pub fn spd13(&mut self) -> Spd13W<'_, SpdSpec> {
        Spd13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port 14 output max speed bits"]
    #[inline(always)]
    pub fn spd14(&mut self) -> Spd14W<'_, SpdSpec> {
        Spd14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port 15 output max speed bits"]
    #[inline(always)]
    pub fn spd15(&mut self) -> Spd15W<'_, SpdSpec> {
        Spd15W::new(self, 15)
    }
}
#[doc = "Port bit speed register\n\nYou can [`read`](crate::Reg::read) this register and get [`spd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct SpdSpec;
