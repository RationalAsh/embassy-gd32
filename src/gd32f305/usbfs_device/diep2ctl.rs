...
impl W {
    #[doc = "Bits 0:10 - maximum packet length"]
    #[inline(always)]
    pub fn mpl(&mut self) -> MplW<'_, Diep2ctlSpec> {
        MplW::new(self, 0)
    }
    #[doc = "Bit 15 - Endpoint active"]
    #[inline(always)]
    pub fn epact(&mut self) -> EpactW<'_, Diep2ctlSpec> {
        EpactW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn sd0pid_sevenfrm(&mut self) -> Sd0pidSevenfrmW<'_, Diep2ctlSpec> {
        Sd0pidSevenfrmW::new(self, 28)
    }
    #[doc = "Bit 29 - Set DATA1 PID/Set odd frame"]
    #[inline(always)]
    pub fn sd1pid_soddfrm(&mut self) -> Sd1pidSoddfrmW<'_, Diep2ctlSpec> {
        Sd1pidSoddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint disable"]
    #[inline(always)]
    pub fn epd(&mut self) -> EpdW<'_, Diep2ctlSpec> {
        EpdW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    pub fn epen(&mut self) -> EpenW<'_, Diep2ctlSpec> {
        EpenW::new(self, 31)
    }
}
