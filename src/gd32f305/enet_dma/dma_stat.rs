...
impl W {
    #[doc = "Bit 0 - Transmit status"]
    #[inline(always)]
    pub fn ts(&mut self) -> TsW<'_, DmaStatSpec> {
        TsW::new(self, 0)
    }
    #[doc = "Bit 1 - Transmit process stopped status"]
    #[inline(always)]
    pub fn tps(&mut self) -> TpsW<'_, DmaStatSpec> {
        TpsW::new(self, 1)
    }
    #[doc = "Bit 2 - Transmit buffer unavailable status"]
    #[inline(always)]
    pub fn tbu(&mut self) -> TbuW<'_, DmaStatSpec> {
        TbuW::new(self, 2)
    }
    #[doc = "Bit 3 - Transmit jabber timeout status"]
    #[inline(always)]
    pub fn tjt(&mut self) -> TjtW<'_, DmaStatSpec> {
        TjtW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive overflow status"]
    #[inline(always)]
    pub fn ro(&mut self) -> RoW<'_, DmaStatSpec> {
        RoW::new(self, 4)
    }
    #[doc = "Bit 5 - Transmit underflow status"]
    #[inline(always)]
    pub fn tu(&mut self) -> TuW<'_, DmaStatSpec> {
        TuW::new(self, 5)
    }
    #[doc = "Bit 6 - Receive status"]
    #[inline(always)]
    pub fn rs(&mut self) -> RsW<'_, DmaStatSpec> {
        RsW::new(self, 6)
    }
    #[doc = "Bit 7 - Receive buffer unavailable status"]
    #[inline(always)]
    pub fn rbu(&mut self) -> RbuW<'_, DmaStatSpec> {
        RbuW::new(self, 7)
    }
    #[doc = "Bit 8 - Receive process stopped status"]
    #[inline(always)]
    pub fn rps(&mut self) -> RpsW<'_, DmaStatSpec> {
        RpsW::new(self, 8)
    }
    #[doc = "Bit 9 - Receive watchdog timeout status"]
    #[inline(always)]
    pub fn rwt(&mut self) -> RwtW<'_, DmaStatSpec> {
        RwtW::new(self, 9)
    }
    #[doc = "Bit 10 - Early transmit status"]
    #[inline(always)]
    pub fn et(&mut self) -> EtW<'_, DmaStatSpec> {
        EtW::new(self, 10)
    }
    #[doc = "Bit 13 - Fatal bus error status"]
    #[inline(always)]
    pub fn fbe(&mut self) -> FbeW<'_, DmaStatSpec> {
        FbeW::new(self, 13)
    }
    #[doc = "Bit 14 - Early receive status"]
    #[inline(always)]
    pub fn er(&mut self) -> ErW<'_, DmaStatSpec> {
        ErW::new(self, 14)
    }
    #[doc = "Bit 15 - Abnormal interrupt summary"]
    #[inline(always)]
    pub fn ai(&mut self) -> AiW<'_, DmaStatSpec> {
        AiW::new(self, 15)
    }
    #[doc = "Bit 16 - Normal interrupt summary"]
    #[inline(always)]
    pub fn ni(&mut self) -> NiW<'_, DmaStatSpec> {
        NiW::new(self, 16)
    }
}
