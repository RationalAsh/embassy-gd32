...
impl W {
    #[doc = "Bits 0:7 - SCL low period"]
    #[inline(always)]
    pub fn scll(&mut self) -> ScllW<'_, TimingSpec> {
        ScllW::new(self, 0)
    }
    #[doc = "Bits 8:15 - SCL high period"]
    #[inline(always)]
    pub fn sclh(&mut self) -> SclhW<'_, TimingSpec> {
        SclhW::new(self, 8)
    }
    #[doc = "Bits 16:19 - Data hold time"]
    #[inline(always)]
    pub fn sdadely(&mut self) -> SdadelyW<'_, TimingSpec> {
        SdadelyW::new(self, 16)
    }
    #[doc = "Bits 20:23 - Data setup time"]
    #[inline(always)]
    pub fn scldely(&mut self) -> ScldelyW<'_, TimingSpec> {
        ScldelyW::new(self, 20)
    }
    #[doc = "Bits 28:31 - Timing prescaler"]
    #[inline(always)]
    pub fn psc(&mut self) -> PscW<'_, TimingSpec> {
        PscW::new(self, 28)
    }
}
