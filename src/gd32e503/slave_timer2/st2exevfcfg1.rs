#[doc = "Register `ST2EXEVFCFG1` reader"]
pub type R = crate::R<St2exevfcfg1Spec>;
#[doc = "Register `ST2EXEVFCFG1` writer"]
pub type W = crate::W<St2exevfcfg1Spec>;
...
impl W {
    #[doc = "Bit 0 - External event 5 memorized enable"]
    #[inline(always)]
    pub fn exev5meen(&mut self) -> Exev5meenW<'_, St2exevfcfg1Spec> {
        Exev5meenW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External event 5 filter mode"]
    #[inline(always)]
    pub fn exev5fm(&mut self) -> Exev5fmW<'_, St2exevfcfg1Spec> {
        Exev5fmW::new(self, 1)
    }
    #[doc = "Bit 6 - External event 6 memorized enable"]
    #[inline(always)]
    pub fn exev6meen(&mut self) -> Exev6meenW<'_, St2exevfcfg1Spec> {
        Exev6meenW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External event 6 filter mode"]
    #[inline(always)]
    pub fn exev6fm(&mut self) -> Exev6fmW<'_, St2exevfcfg1Spec> {
        Exev6fmW::new(self, 7)
    }
    #[doc = "Bit 12 - External event 7 memorized enable"]
    #[inline(always)]
    pub fn exev7meen(&mut self) -> Exev7meenW<'_, St2exevfcfg1Spec> {
        Exev7meenW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External event 7 filter mode"]
    #[inline(always)]
    pub fn exev7fm(&mut self) -> Exev7fmW<'_, St2exevfcfg1Spec> {
        Exev7fmW::new(self, 13)
    }
    #[doc = "Bit 18 - External event 8 memorized enable"]
    #[inline(always)]
    pub fn exev8meen(&mut self) -> Exev8meenW<'_, St2exevfcfg1Spec> {
        Exev8meenW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External event 8 filter mode"]
    #[inline(always)]
    pub fn exev8fm(&mut self) -> Exev8fmW<'_, St2exevfcfg1Spec> {
        Exev8fmW::new(self, 19)
    }
    #[doc = "Bit 24 - External event 9 memorized enable"]
    #[inline(always)]
    pub fn exev9meen(&mut self) -> Exev9meenW<'_, St2exevfcfg1Spec> {
        Exev9meenW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External event 9 filter mode"]
    #[inline(always)]
    pub fn exev9fm(&mut self) -> Exev9fmW<'_, St2exevfcfg1Spec> {
        Exev9fmW::new(self, 25)
    }
}
#[doc = "SHRTIMER Slave_TIMERx external event filter configuration register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`st2exevfcfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st2exevfcfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St2exevfcfg1Spec;
impl crate::RegisterSpec for St2exevfcfg1Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2exevfcfg1::R`](R) reader structure"]
impl crate::Readable for St2exevfcfg1Spec {}
#[doc = "`write(|w| ..)` method takes [`st2exevfcfg1::W`](W) writer structure"]
impl crate::Writable for St2exevfcfg1Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST2EXEVFCFG1 to value 0"]
impl crate::Resettable for St2exevfcfg1Spec {}
