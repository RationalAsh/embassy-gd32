...
impl W {
    #[doc = "Bit 0 - DLL calibration start once"]
    #[inline(always)]
    pub fn clbstrt(&mut self) -> ClbstrtW<'_, DllcctlSpec> {
        ClbstrtW::new(self, 0)
    }
    #[doc = "Bit 1 - DLL periodic calibration enable"]
    #[inline(always)]
    pub fn clbperen(&mut self) -> ClbperenW<'_, DllcctlSpec> {
        ClbperenW::new(self, 1)
    }
    #[doc = "Bits 2:3 - DLL calibration period"]
    #[inline(always)]
    pub fn clbper(&mut self) -> ClbperW<'_, DllcctlSpec> {
        ClbperW::new(self, 2)
    }
}
#[doc = "SHRTIMER DLL calibration control register\n\nYou can [`read`](crate::Reg::read) this register and get [`dllcctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dllcctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
