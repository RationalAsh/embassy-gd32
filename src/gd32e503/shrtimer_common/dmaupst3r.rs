...
impl W {
    #[doc = "Bit 0 - SHRTIMER_ST3CTL0 update by DMA mode"]
    #[inline(always)]
    pub fn st3ctl0(&mut self) -> St3ctl0W<'_, Dmaupst3rSpec> {
        St3ctl0W::new(self, 0)
    }
    #[doc = "Bit 1 - SHRTIMER_ST3INTC update by DMA mode"]
    #[inline(always)]
    pub fn st3intc(&mut self) -> St3intcW<'_, Dmaupst3rSpec> {
        St3intcW::new(self, 1)
    }
    #[doc = "Bit 2 - SHRTIMER_ST3DMAINTEN update by DMA mode"]
    #[inline(always)]
    pub fn st3dmainten(&mut self) -> St3dmaintenW<'_, Dmaupst3rSpec> {
        St3dmaintenW::new(self, 2)
    }
    #[doc = "Bit 3 - SHRTIMER_ST3CNT update by DMA mode"]
    #[inline(always)]
    pub fn st3cnt(&mut self) -> St3cntW<'_, Dmaupst3rSpec> {
        St3cntW::new(self, 3)
    }
    #[doc = "Bit 4 - SHRTIMER_ST3CAR update by DMA mode"]
    #[inline(always)]
    pub fn st3car(&mut self) -> St3carW<'_, Dmaupst3rSpec> {
        St3carW::new(self, 4)
    }
    #[doc = "Bit 5 - SHRTIMER_ST3CREP update by DMA mode"]
    #[inline(always)]
    pub fn st3crep(&mut self) -> St3crepW<'_, Dmaupst3rSpec> {
        St3crepW::new(self, 5)
    }
    #[doc = "Bit 6 - SHRTIMER_ST3CMP0V update by DMA mode"]
    #[inline(always)]
    pub fn st3cmp0v(&mut self) -> St3cmp0vW<'_, Dmaupst3rSpec> {
        St3cmp0vW::new(self, 6)
    }
    #[doc = "Bit 7 - SHRTIMER_ST3CMP1V update by DMA mode"]
    #[inline(always)]
    pub fn st3cmp1v(&mut self) -> St3cmp1vW<'_, Dmaupst3rSpec> {
        St3cmp1vW::new(self, 7)
    }
    #[doc = "Bit 8 - SHRTIMER_ST3CMP2V update by DMA mode"]
    #[inline(always)]
    pub fn st3cmp2v(&mut self) -> St3cmp2vW<'_, Dmaupst3rSpec> {
        St3cmp2vW::new(self, 8)
    }
    #[doc = "Bit 9 - SHRTIMER_ST3CMP3V update by DMA mode"]
    #[inline(always)]
    pub fn st3cmp3v(&mut self) -> St3cmp3vW<'_, Dmaupst3rSpec> {
        St3cmp3vW::new(self, 9)
    }
    #[doc = "Bit 10 - SHRTIMER_ST3DTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st3dtctl(&mut self) -> St3dtctlW<'_, Dmaupst3rSpec> {
        St3dtctlW::new(self, 10)
    }
    #[doc = "Bit 11 - SHRTIMER_ST3CH0SET update by DMA mode"]
    #[inline(always)]
    pub fn st3ch0set(&mut self) -> St3ch0setW<'_, Dmaupst3rSpec> {
        St3ch0setW::new(self, 11)
    }
    #[doc = "Bit 12 - SHRTIMER_ST3CH0RST update by DMA mode"]
    #[inline(always)]
    pub fn st3ch0rst(&mut self) -> St3ch0rstW<'_, Dmaupst3rSpec> {
        St3ch0rstW::new(self, 12)
    }
    #[doc = "Bit 13 - SHRTIMER_ST3CH1SET update by DMA mode"]
    #[inline(always)]
    pub fn st3ch1set(&mut self) -> St3ch1setW<'_, Dmaupst3rSpec> {
        St3ch1setW::new(self, 13)
    }
    #[doc = "Bit 14 - SHRTIMER_ST3CH1RST update by DMA mode"]
    #[inline(always)]
    pub fn st3ch1rst(&mut self) -> St3ch1rstW<'_, Dmaupst3rSpec> {
        St3ch1rstW::new(self, 14)
    }
    #[doc = "Bit 15 - SHRTIMER_ST3EXEVFCFG0update by DMA mode"]
    #[inline(always)]
    pub fn st3exevfcfg0(&mut self) -> St3exevfcfg0W<'_, Dmaupst3rSpec> {
        St3exevfcfg0W::new(self, 15)
    }
    #[doc = "Bit 16 - SHRTIMER_ST3EXEVFCFG1update by DMA mode"]
    #[inline(always)]
    pub fn st3exevfcfg1(&mut self) -> St3exevfcfg1W<'_, Dmaupst3rSpec> {
        St3exevfcfg1W::new(self, 16)
    }
    #[doc = "Bit 17 - SHRTIMER_ST3CNTRST update by DMA mode"]
    #[inline(always)]
    pub fn st3cntrst(&mut self) -> St3cntrstW<'_, Dmaupst3rSpec> {
        St3cntrstW::new(self, 17)
    }
    #[doc = "Bit 18 - SHRTIMER_ST3CSCTL update by DMA mode"]
    #[inline(always)]
    pub fn st3csctl(&mut self) -> St3csctlW<'_, Dmaupst3rSpec> {
        St3csctlW::new(self, 18)
    }
    #[doc = "Bit 19 - SHRTIMER_ST3CHOCTL update by DMA mode"]
    #[inline(always)]
    pub fn st3choctl(&mut self) -> St3choctlW<'_, Dmaupst3rSpec> {
        St3choctlW::new(self, 19)
    }
    #[doc = "Bit 20 - SHRTIMER_ST3FLTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st3fltctl(&mut self) -> St3fltctlW<'_, Dmaupst3rSpec> {
        St3fltctlW::new(self, 20)
    }
    #[doc = "Bit 31 - SHRTIMER_ST3ACTL update by DMA mode"]
    #[inline(always)]
    pub fn st3actl(&mut self) -> St3actlW<'_, Dmaupst3rSpec> {
        St3actlW::new(self, 31)
    }
}
#[doc = "SHRTIMER DMA update Slave_TIMER3 register\n\nYou can [`read`](crate::Reg::read) this register and get [`dmaupst3r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmaupst3r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
