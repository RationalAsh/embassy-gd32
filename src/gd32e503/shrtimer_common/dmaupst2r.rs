...
impl W {
    #[doc = "Bit 0 - SHRTIMER_ST2CTL0 update by DMA mode"]
    #[inline(always)]
    pub fn st2ctl0(&mut self) -> St2ctl0W<'_, Dmaupst2rSpec> {
        St2ctl0W::new(self, 0)
    }
    #[doc = "Bit 1 - SHRTIMER_ST2INTC update by DMA mode"]
    #[inline(always)]
    pub fn st2intc(&mut self) -> St2intcW<'_, Dmaupst2rSpec> {
        St2intcW::new(self, 1)
    }
    #[doc = "Bit 2 - SHRTIMER_ST2DMAINTEN update by DMA mode"]
    #[inline(always)]
    pub fn st2dmainten(&mut self) -> St2dmaintenW<'_, Dmaupst2rSpec> {
        St2dmaintenW::new(self, 2)
    }
    #[doc = "Bit 3 - SHRTIMER_ST2CNT update by DMA mode"]
    #[inline(always)]
    pub fn st2cnt(&mut self) -> St2cntW<'_, Dmaupst2rSpec> {
        St2cntW::new(self, 3)
    }
    #[doc = "Bit 4 - SHRTIMER_ST2CAR update by DMA mode"]
    #[inline(always)]
    pub fn st2car(&mut self) -> St2carW<'_, Dmaupst2rSpec> {
        St2carW::new(self, 4)
    }
    #[doc = "Bit 5 - SHRTIMER_ST2CREP update by DMA mode"]
    #[inline(always)]
    pub fn st2crep(&mut self) -> St2crepW<'_, Dmaupst2rSpec> {
        St2crepW::new(self, 5)
    }
    #[doc = "Bit 6 - SHRTIMER_ST2CMP0V update by DMA mode"]
    #[inline(always)]
    pub fn st2cmp0v(&mut self) -> St2cmp0vW<'_, Dmaupst2rSpec> {
        St2cmp0vW::new(self, 6)
    }
    #[doc = "Bit 7 - SHRTIMER_ST2CMP1V update by DMA mode"]
    #[inline(always)]
    pub fn st2cmp1v(&mut self) -> St2cmp1vW<'_, Dmaupst2rSpec> {
        St2cmp1vW::new(self, 7)
    }
    #[doc = "Bit 8 - SHRTIMER_ST2CMP2V update by DMA mode"]
    #[inline(always)]
    pub fn st2cmp2v(&mut self) -> St2cmp2vW<'_, Dmaupst2rSpec> {
        St2cmp2vW::new(self, 8)
    }
    #[doc = "Bit 9 - SHRTIMER_ST2CMP3V update by DMA mode"]
    #[inline(always)]
    pub fn st2cmp3v(&mut self) -> St2cmp3vW<'_, Dmaupst2rSpec> {
        St2cmp3vW::new(self, 9)
    }
    #[doc = "Bit 10 - SHRTIMER_ST2DTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st2dtctl(&mut self) -> St2dtctlW<'_, Dmaupst2rSpec> {
        St2dtctlW::new(self, 10)
    }
    #[doc = "Bit 11 - SHRTIMER_ST2CH0SET update by DMA mode"]
    #[inline(always)]
    pub fn st2ch0set(&mut self) -> St2ch0setW<'_, Dmaupst2rSpec> {
        St2ch0setW::new(self, 11)
    }
    #[doc = "Bit 12 - SHRTIMER_ST2CH0RST update by DMA mode"]
    #[inline(always)]
    pub fn st2ch0rst(&mut self) -> St2ch0rstW<'_, Dmaupst2rSpec> {
        St2ch0rstW::new(self, 12)
    }
    #[doc = "Bit 13 - SHRTIMER_ST2CH1SET update by DMA mode"]
    #[inline(always)]
    pub fn st2ch1set(&mut self) -> St2ch1setW<'_, Dmaupst2rSpec> {
        St2ch1setW::new(self, 13)
    }
    #[doc = "Bit 14 - SHRTIMER_ST2CH1RST update by DMA mode"]
    #[inline(always)]
    pub fn st2ch1rst(&mut self) -> St2ch1rstW<'_, Dmaupst2rSpec> {
        St2ch1rstW::new(self, 14)
    }
    #[doc = "Bit 15 - SHRTIMER_ST2EXEVFCFG0update by DMA mode"]
    #[inline(always)]
    pub fn st2exevfcfg0(&mut self) -> St2exevfcfg0W<'_, Dmaupst2rSpec> {
        St2exevfcfg0W::new(self, 15)
    }
    #[doc = "Bit 16 - SHRTIMER_ST2EXEVFCFG1update by DMA mode"]
    #[inline(always)]
    pub fn st2exevfcfg1(&mut self) -> St2exevfcfg1W<'_, Dmaupst2rSpec> {
        St2exevfcfg1W::new(self, 16)
    }
    #[doc = "Bit 17 - SHRTIMER_ST2CNTRST update by DMA mode"]
    #[inline(always)]
    pub fn st2cntrst(&mut self) -> St2cntrstW<'_, Dmaupst2rSpec> {
        St2cntrstW::new(self, 17)
    }
    #[doc = "Bit 18 - SHRTIMER_ST2CSCTL update by DMA mode"]
    #[inline(always)]
    pub fn st2csctl(&mut self) -> St2csctlW<'_, Dmaupst2rSpec> {
        St2csctlW::new(self, 18)
    }
    #[doc = "Bit 19 - SHRTIMER_ST2CHOCTL update by DMA mode"]
    #[inline(always)]
    pub fn st2choctl(&mut self) -> St2choctlW<'_, Dmaupst2rSpec> {
        St2choctlW::new(self, 19)
    }
    #[doc = "Bit 20 - SHRTIMER_ST2FLTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st2fltctl(&mut self) -> St2fltctlW<'_, Dmaupst2rSpec> {
        St2fltctlW::new(self, 20)
    }
    #[doc = "Bit 31 - SHRTIMER_ST2ACTL update by DMA mode"]
    #[inline(always)]
    pub fn st2actl(&mut self) -> St2actlW<'_, Dmaupst2rSpec> {
        St2actlW::new(self, 31)
    }
}
#[doc = "SHRTIMER DMA update Slave_TIMER2 register\n\nYou can [`read`](crate::Reg::read) this register and get [`dmaupst2r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmaupst2r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
