...
impl W {
    #[doc = "Bit 0 - Slave_TIMER0 channel 0 output (ST0CH0_O) enable"]
    #[inline(always)]
    pub fn st0ch0en(&mut self) -> St0ch0enW<'_, ChoutenSpec> {
        St0ch0enW::new(self, 0)
    }
    #[doc = "Bit 1 - Slave_TIMER0 channel 1 output (ST0CH1_O) enable"]
    #[inline(always)]
    pub fn st0ch1en(&mut self) -> St0ch1enW<'_, ChoutenSpec> {
        St0ch1enW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave_TIMER1 channel 0 output (ST1CH0_O) enable"]
    #[inline(always)]
    pub fn st1ch0en(&mut self) -> St1ch0enW<'_, ChoutenSpec> {
        St1ch0enW::new(self, 2)
    }
    #[doc = "Bit 3 - Slave_TIMER1 channel 1 output (ST1CH1_O) enable"]
    #[inline(always)]
    pub fn st1ch1en(&mut self) -> St1ch1enW<'_, ChoutenSpec> {
        St1ch1enW::new(self, 3)
    }
    #[doc = "Bit 4 - Slave_TIMER2 channel 0 output (ST2CH0_O) enable"]
    #[inline(always)]
    pub fn st2ch0en(&mut self) -> St2ch0enW<'_, ChoutenSpec> {
        St2ch0enW::new(self, 4)
    }
    #[doc = "Bit 5 - Slave_TIMER2 channel 1 output (ST2CH1_O) enable"]
    #[inline(always)]
    pub fn st2ch1en(&mut self) -> St2ch1enW<'_, ChoutenSpec> {
        St2ch1enW::new(self, 5)
    }
    #[doc = "Bit 6 - Slave_TIMER3 channel 0 output (ST3CH0_O) enable"]
    #[inline(always)]
    pub fn st3ch0en(&mut self) -> St3ch0enW<'_, ChoutenSpec> {
        St3ch0enW::new(self, 6)
    }
    #[doc = "Bit 7 - Slave_TIMER3 channel 1 output (ST3CH1_O) enable"]
    #[inline(always)]
    pub fn st3ch1en(&mut self) -> St3ch1enW<'_, ChoutenSpec> {
        St3ch1enW::new(self, 7)
    }
    #[doc = "Bit 8 - Slave_TIMER4 channel 0 output (ST4CH0_O) enable"]
    #[inline(always)]
    pub fn st4ch0en(&mut self) -> St4ch0enW<'_, ChoutenSpec> {
        St4ch0enW::new(self, 8)
    }
    #[doc = "Bit 9 - Slave_TIMER4 channel 1 output (ST4CH1_O) enable"]
    #[inline(always)]
    pub fn st4ch1en(&mut self) -> St4ch1enW<'_, ChoutenSpec> {
        St4ch1enW::new(self, 9)
    }
}
#[doc = "SHRTIMER channel output enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`chouten::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`chouten::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
