...
impl W {
    #[doc = "Bit 0 - SHRTIMER_ST1CTL0 update by DMA mode"]
    #[inline(always)]
    pub fn st1ctl0(&mut self) -> St1ctl0W<'_, Dmaupst1rSpec> {
        St1ctl0W::new(self, 0)
    }
    #[doc = "Bit 1 - SHRTIMER_ST1INTC update by DMA mode"]
    #[inline(always)]
    pub fn st1intc(&mut self) -> St1intcW<'_, Dmaupst1rSpec> {
        St1intcW::new(self, 1)
    }
    #[doc = "Bit 2 - SHRTIMER_ST1DMAINTEN update by DMA mode"]
    #[inline(always)]
    pub fn st1dmainten(&mut self) -> St1dmaintenW<'_, Dmaupst1rSpec> {
        St1dmaintenW::new(self, 2)
    }
    #[doc = "Bit 3 - SHRTIMER_ST1CNT update by DMA mode"]
    #[inline(always)]
    pub fn st1cnt(&mut self) -> St1cntW<'_, Dmaupst1rSpec> {
        St1cntW::new(self, 3)
    }
    #[doc = "Bit 4 - SHRTIMER_ST1CAR update by DMA mode"]
    #[inline(always)]
    pub fn st1car(&mut self) -> St1carW<'_, Dmaupst1rSpec> {
        St1carW::new(self, 4)
    }
    #[doc = "Bit 5 - SHRTIMER_ST1CREP update by DMA mode"]
    #[inline(always)]
    pub fn st1crep(&mut self) -> St1crepW<'_, Dmaupst1rSpec> {
        St1crepW::new(self, 5)
    }
    #[doc = "Bit 6 - SHRTIMER_ST1CMP0V update by DMA mode"]
    #[inline(always)]
    pub fn st1cmp0v(&mut self) -> St1cmp0vW<'_, Dmaupst1rSpec> {
        St1cmp0vW::new(self, 6)
    }
    #[doc = "Bit 7 - SHRTIMER_ST1CMP1V update by DMA mode"]
    #[inline(always)]
    pub fn st1cmp1v(&mut self) -> St1cmp1vW<'_, Dmaupst1rSpec> {
        St1cmp1vW::new(self, 7)
    }
    #[doc = "Bit 8 - SHRTIMER_ST1CMP2V update by DMA mode"]
    #[inline(always)]
    pub fn st1cmp2v(&mut self) -> St1cmp2vW<'_, Dmaupst1rSpec> {
        St1cmp2vW::new(self, 8)
    }
    #[doc = "Bit 9 - SHRTIMER_ST1CMP3V update by DMA mode"]
    #[inline(always)]
    pub fn st1cmp3v(&mut self) -> St1cmp3vW<'_, Dmaupst1rSpec> {
        St1cmp3vW::new(self, 9)
    }
    #[doc = "Bit 10 - SHRTIMER_ST1DTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st1dtctl(&mut self) -> St1dtctlW<'_, Dmaupst1rSpec> {
        St1dtctlW::new(self, 10)
    }
    #[doc = "Bit 11 - SHRTIMER_ST1CH0SET update by DMA mode"]
    #[inline(always)]
    pub fn st1ch0set(&mut self) -> St1ch0setW<'_, Dmaupst1rSpec> {
        St1ch0setW::new(self, 11)
    }
    #[doc = "Bit 12 - SHRTIMER_ST1CH0RST update by DMA mode"]
    #[inline(always)]
    pub fn st1ch0rst(&mut self) -> St1ch0rstW<'_, Dmaupst1rSpec> {
        St1ch0rstW::new(self, 12)
    }
    #[doc = "Bit 13 - SHRTIMER_ST1CH1SET update by DMA mode"]
    #[inline(always)]
    pub fn st1ch1set(&mut self) -> St1ch1setW<'_, Dmaupst1rSpec> {
        St1ch1setW::new(self, 13)
    }
    #[doc = "Bit 14 - SHRTIMER_ST1CH1RST update by DMA mode"]
    #[inline(always)]
    pub fn st1ch1rst(&mut self) -> St1ch1rstW<'_, Dmaupst1rSpec> {
        St1ch1rstW::new(self, 14)
    }
    #[doc = "Bit 15 - SHRTIMER_ST1EXEVFCFG0update by DMA mode"]
    #[inline(always)]
    pub fn st1exevfcfg0(&mut self) -> St1exevfcfg0W<'_, Dmaupst1rSpec> {
        St1exevfcfg0W::new(self, 15)
    }
    #[doc = "Bit 16 - SHRTIMER_ST1EXEVFCFG1update by DMA mode"]
    #[inline(always)]
    pub fn st1exevfcfg1(&mut self) -> St1exevfcfg1W<'_, Dmaupst1rSpec> {
        St1exevfcfg1W::new(self, 16)
    }
    #[doc = "Bit 17 - SHRTIMER_ST1CNTRST update by DMA mode"]
    #[inline(always)]
    pub fn st1cntrst(&mut self) -> St1cntrstW<'_, Dmaupst1rSpec> {
        St1cntrstW::new(self, 17)
    }
    #[doc = "Bit 18 - SHRTIMER_ST1CSCTL update by DMA mode"]
    #[inline(always)]
    pub fn st1csctl(&mut self) -> St1csctlW<'_, Dmaupst1rSpec> {
        St1csctlW::new(self, 18)
    }
    #[doc = "Bit 19 - SHRTIMER_ST1CHOCTL update by DMA mode"]
    #[inline(always)]
    pub fn st1choctl(&mut self) -> St1choctlW<'_, Dmaupst1rSpec> {
        St1choctlW::new(self, 19)
    }
    #[doc = "Bit 20 - SHRTIMER_ST1FLTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st1fltctl(&mut self) -> St1fltctlW<'_, Dmaupst1rSpec> {
        St1fltctlW::new(self, 20)
    }
    #[doc = "Bit 31 - SHRTIMER_ST1ACTL update by DMA mode"]
    #[inline(always)]
    pub fn st1actl(&mut self) -> St1actlW<'_, Dmaupst1rSpec> {
        St1actlW::new(self, 31)
    }
}
#[doc = "SHRTIMER DMA update Slave_TIMER1 register\n\nYou can [`read`](crate::Reg::read) this register and get [`dmaupst1r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmaupst1r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
