#[doc = "Register `ST3ACTL` reader"]
pub type R = crate::R<St3actlSpec>;
#[doc = "Register `ST3ACTL` writer"]
pub type W = crate::W<St3actlSpec>;
...
impl W {
    #[doc = "Bit 3 - Counter clock division"]
    #[inline(always)]
    pub fn cntckdiv_3(&mut self) -> Cntckdiv3W<'_, St3actlSpec> {
        Cntckdiv3W::new(self, 3)
    }
    #[doc = "Bits 9:15 - Rising edge dead-time value configure"]
    #[inline(always)]
    pub fn dtrcfg_15_9(&mut self) -> Dtrcfg15_9W<'_, St3actlSpec> {
        Dtrcfg15_9W::new(self, 9)
    }
    #[doc = "Bits 25:31 - Falling edge dead-time value configure"]
    #[inline(always)]
    pub fn dtfcfg_15_9(&mut self) -> Dtfcfg15_9W<'_, St3actlSpec> {
        Dtfcfg15_9W::new(self, 25)
    }
}
#[doc = "SHRTIMER Slave_TIMERx additional control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st3actl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st3actl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St3actlSpec;
impl crate::RegisterSpec for St3actlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3actl::R`](R) reader structure"]
impl crate::Readable for St3actlSpec {}
#[doc = "`write(|w| ..)` method takes [`st3actl::W`](W) writer structure"]
impl crate::Writable for St3actlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST3ACTL to value 0"]
impl crate::Resettable for St3actlSpec {}
