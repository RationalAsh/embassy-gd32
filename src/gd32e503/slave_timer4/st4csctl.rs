...
pub type R = crate::R<St4csctlSpec>;
#[doc = "Register `ST4CSCTL` writer"]
pub type W = crate::W<St4csctlSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Carrier signal period"]
    #[inline(always)]
    pub fn csprd(&mut self) -> CsprdW<'_, St4csctlSpec> {
        CsprdW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Carrier signal duty cycle"]
    #[inline(always)]
    pub fn csdty(&mut self) -> CsdtyW<'_, St4csctlSpec> {
        CsdtyW::new(self, 4)
    }
    #[doc = "Bits 7:10 - First carrier-signal pulse width"]
    #[inline(always)]
    pub fn csfstpw(&mut self) -> CsfstpwW<'_, St4csctlSpec> {
        CsfstpwW::new(self, 7)
    }
}
#[doc = "SHRTIMER Slave_TIMERx carrier-signal control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st4csctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st4csctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St4csctlSpec;
impl crate::RegisterSpec for St4csctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4csctl::R`](R) reader structure"]
impl crate::Readable for St4csctlSpec {}
#[doc = "`write(|w| ..)` method takes [`st4csctl::W`](W) writer structure"]
impl crate::Writable for St4csctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST4CSCTL to value 0"]
impl crate::Resettable for St4csctlSpec {}
