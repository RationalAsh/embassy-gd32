...
impl W {
    #[doc = "Bits 0:15 - Compare 0 value"]
    #[inline(always)]
    pub fn cmp0val(&mut self) -> Cmp0valW<'_, St4cmp0vSpec> {
        Cmp0valW::new(self, 0)
    }
}
#[doc = "SHRTIMER Slave_TIMER4 compare 0 value register\n\nYou can [`read`](crate::Reg::read) this register and get [`st4cmp0v::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st4cmp0v::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
