...
#[doc = "Field `USBDPSC_2` reader - Bit 2 of USBHSPSC"]
pub type Usbdpsc2R = crate::BitReader;
#[doc = "Field `USBDPSC_2` writer - Bit 2 of USBHSPSC"]
...
impl R {
    ...
    #[doc = "Bit 29 - Bit 5 of PLLMF"]
    #[inline(always)]
    pub fn pllmf_5(&self) -> Pllmf5R {
        Pllmf5R::new(((self.bits >> 29) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bit 17 - PREDV0 division factor"]
    #[inline(always)]
    pub fn predv0(&mut self) -> Predv0W<'_, Cfg0Spec> {
        Predv0W::new(self, 17)
    }
    #[doc = "Bits 18:21 - The PLL clock multiplication factor"]
    #[inline(always)]
    ...
    #[doc = "Bit 27 - Bit 4 of PLLMF"]
    #[inline(always)]
    pub fn pllmf_4(&mut self) -> Pllmf4W<'_, Cfg0Spec> {
        Pllmf4W::new(self, 27)
    }
    #[doc = "Bit 28 - Bit 2 of ADCPSC"]
    #[inline(always)]
    ...
    #[doc = "Bit 29 - Bit 5 of PLLMF"]
    #[inline(always)]
    pub fn pllmf_5(&mut self) -> Pllmf5W<'_, Cfg0Spec> {
        Pllmf5W::new(self, 29)
    }
    #[doc = "Bit 31 - Bit 2 of USBHSPSC"]
    #[inline(always)]
    pub fn usbdpsc_2(&mut self) -> Usbdpsc2W<'_, Cfg0Spec> {
