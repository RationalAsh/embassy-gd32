...
pub type R = crate::R<St1cap1trgSpec>;
#[doc = "Register `ST1CAP1TRG` writer"]
pub type W = crate::W<St1cap1trgSpec>;
...
impl W {
    #[doc = "Bit 0 - Capture 1 triggered by software"]
    #[inline(always)]
    pub fn cp1bsw(&mut self) -> Cp1bswW<'_, St1cap1trgSpec> {
        Cp1bswW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture 1 triggered by update event"]
    #[inline(always)]
    pub fn cp1bup(&mut self) -> Cp1bupW<'_, St1cap1trgSpec> {
        Cp1bupW::new(self, 1)
    }
    #[doc = "Bit 2 - Capture 1 triggered by external event 0"]
    #[inline(always)]
    pub fn cp1bexev0(&mut self) -> Cp1bexev0W<'_, St1cap1trgSpec> {
        Cp1bexev0W::new(self, 2)
    }
    #[doc = "Bit 3 - Capture 1 triggered by external event 1"]
    #[inline(always)]
    pub fn cp1bexev1(&mut self) -> Cp1bexev1W<'_, St1cap1trgSpec> {
        Cp1bexev1W::new(self, 3)
    }
    #[doc = "Bit 4 - Capture 1 triggered by external event 2"]
    #[inline(always)]
    pub fn cp1bexev2(&mut self) -> Cp1bexev2W<'_, St1cap1trgSpec> {
        Cp1bexev2W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture 1 triggered by external event 3"]
    #[inline(always)]
    pub fn cp1bexev3(&mut self) -> Cp1bexev3W<'_, St1cap1trgSpec> {
        Cp1bexev3W::new(self, 5)
    }
    #[doc = "Bit 6 - Capture 1 triggered by external event 4"]
    #[inline(always)]
    pub fn cp1bexev4(&mut self) -> Cp1bexev4W<'_, St1cap1trgSpec> {
        Cp1bexev4W::new(self, 6)
    }
    #[doc = "Bit 7 - Capture 1 triggered by external event 5"]
    #[inline(always)]
    pub fn cp1bexev5(&mut self) -> Cp1bexev5W<'_, St1cap1trgSpec> {
        Cp1bexev5W::new(self, 7)
    }
    #[doc = "Bit 8 - Capture 1 triggered by external event 6"]
    #[inline(always)]
    pub fn cp1bexev6(&mut self) -> Cp1bexev6W<'_, St1cap1trgSpec> {
        Cp1bexev6W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture 1 triggered by external event 7"]
    #[inline(always)]
    pub fn cp1bexev7(&mut self) -> Cp1bexev7W<'_, St1cap1trgSpec> {
        Cp1bexev7W::new(self, 9)
    }
    #[doc = "Bit 10 - Capture 1 triggered by external event 8"]
    #[inline(always)]
    pub fn cp1bexev8(&mut self) -> Cp1bexev8W<'_, St1cap1trgSpec> {
        Cp1bexev8W::new(self, 10)
    }
    #[doc = "Bit 11 - Capture 1 triggered by external event 9"]
    #[inline(always)]
    pub fn cp1bexev9(&mut self) -> Cp1bexev9W<'_, St1cap1trgSpec> {
        Cp1bexev9W::new(self, 11)
    }
    #[doc = "Bit 16 - Capture 1 triggered by ST1CH0_O output inactive to active transition"]
    #[inline(always)]
    pub fn cp1bst1a(&mut self) -> Cp1bst1aW<'_, St1cap1trgSpec> {
        Cp1bst1aW::new(self, 16)
    }
    #[doc = "Bit 17 - Capture 1 triggered by ST1CH0_O output active to inactive transition"]
    #[inline(always)]
    pub fn cp1bst1na(&mut self) -> Cp1bst1naW<'_, St1cap1trgSpec> {
        Cp1bst1naW::new(self, 17)
    }
    #[doc = "Bit 18 - Capture 1 triggered by compare 0 event of Slave_TIMER1"]
    #[inline(always)]
    pub fn cp1bst1cmp0(&mut self) -> Cp1bst1cmp0W<'_, St1cap1trgSpec> {
        Cp1bst1cmp0W::new(self, 18)
    }
    #[doc = "Bit 19 - Capture 1 triggered by compare 1 event of Slave_TIMER1"]
    #[inline(always)]
    pub fn cp1bst1cmp1(&mut self) -> Cp1bst1cmp1W<'_, St1cap1trgSpec> {
        Cp1bst1cmp1W::new(self, 19)
    }
}
#[doc = "SHRTIMER Slave_TIMERx capture 1 trigger register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1cap1trg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1cap1trg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St1cap1trgSpec;
impl crate::RegisterSpec for St1cap1trgSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1cap1trg::R`](R) reader structure"]
impl crate::Readable for St1cap1trgSpec {}
#[doc = "`write(|w| ..)` method takes [`st1cap1trg::W`](W) writer structure"]
impl crate::Writable for St1cap1trgSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST1CAP1TRG to value 0"]
impl crate::Resettable for St1cap1trgSpec {}
