...
impl W {
    #[doc = "Bits 0:8 - Falling edge dead-time value"]
    #[inline(always)]
    pub fn dtrcfg(&mut self) -> DtrcfgW<'_, St1dtctlSpec> {
        DtrcfgW::new(self, 0)
    }
    #[doc = "Bit 9 - The sign of falling edge dead-time value"]
    #[inline(always)]
    pub fn dtrs(&mut self) -> DtrsW<'_, St1dtctlSpec> {
        DtrsW::new(self, 9)
    }
    #[doc = "Bits 10:13 - Dead time generator clock division"]
    #[inline(always)]
    pub fn dtgckdiv(&mut self) -> DtgckdivW<'_, St1dtctlSpec> {
        DtgckdivW::new(self, 10)
    }
    #[doc = "Bit 14 - Dead-time rising edge protection for sign"]
    #[inline(always)]
    pub fn dtrsprot(&mut self) -> DtrsprotW<'_, St1dtctlSpec> {
        DtrsprotW::new(self, 14)
    }
    #[doc = "Bit 15 - Dead-time rising edge protection for value and sign"]
    #[inline(always)]
    pub fn dtrsvprot(&mut self) -> DtrsvprotW<'_, St1dtctlSpec> {
        DtrsvprotW::new(self, 15)
    }
    #[doc = "Bits 16:24 - Falling edge dead-time value"]
    #[inline(always)]
    pub fn dtfcfg(&mut self) -> DtfcfgW<'_, St1dtctlSpec> {
        DtfcfgW::new(self, 16)
    }
    #[doc = "Bit 25 - The sign of falling edge dead-time value"]
    #[inline(always)]
    pub fn dtfs(&mut self) -> DtfsW<'_, St1dtctlSpec> {
        DtfsW::new(self, 25)
    }
    #[doc = "Bit 30 - Dead-time falling edge protection for sign"]
    #[inline(always)]
    pub fn dtfsprot(&mut self) -> DtfsprotW<'_, St1dtctlSpec> {
        DtfsprotW::new(self, 30)
    }
    #[doc = "Bit 31 - Dead-time falling edge protection for value and sign"]
    #[inline(always)]
    pub fn dtfsvprot(&mut self) -> DtfsvprotW<'_, St1dtctlSpec> {
        DtfsvprotW::new(self, 31)
    }
}
#[doc = "SHRTIMER Slave_TIMER1 dead-time control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1dtctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1dtctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
