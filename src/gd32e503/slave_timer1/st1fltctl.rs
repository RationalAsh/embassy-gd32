...
impl W {
    #[doc = "Bit 0 - Fault 0 enable"]
    #[inline(always)]
    pub fn flt0en(&mut self) -> Flt0enW<'_, St1fltctlSpec> {
        Flt0enW::new(self, 0)
    }
    #[doc = "Bit 1 - Fault 1 enable"]
    #[inline(always)]
    pub fn flt1en(&mut self) -> Flt1enW<'_, St1fltctlSpec> {
        Flt1enW::new(self, 1)
    }
    #[doc = "Bit 2 - Fault 2 enable"]
    #[inline(always)]
    pub fn flt2en(&mut self) -> Flt2enW<'_, St1fltctlSpec> {
        Flt2enW::new(self, 2)
    }
    #[doc = "Bit 3 - Fault 3 enable"]
    #[inline(always)]
    pub fn flt3en(&mut self) -> Flt3enW<'_, St1fltctlSpec> {
        Flt3enW::new(self, 3)
    }
    #[doc = "Bit 4 - Fault 4 enable"]
    #[inline(always)]
    pub fn flt4en(&mut self) -> Flt4enW<'_, St1fltctlSpec> {
        Flt4enW::new(self, 4)
    }
    #[doc = "Bit 31 - Protect fault enable"]
    #[inline(always)]
    pub fn fltenprot(&mut self) -> FltenprotW<'_, St1fltctlSpec> {
        FltenprotW::new(self, 31)
    }
}
#[doc = "SHRTIMER Slave_TIMERx fault control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1fltctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1fltctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
