#[doc = "Register `ST1DMAINTEN` reader"]
pub type R = crate::R<St1dmaintenSpec>;
#[doc = "Register `ST1DMAINTEN` writer"]
pub type W = crate::W<St1dmaintenSpec>;
...
impl W {
    #[doc = "Bit 0 - Compare 0 interrupt enable"]
    #[inline(always)]
    pub fn cmp0ie(&mut self) -> Cmp0ieW<'_, St1dmaintenSpec> {
        Cmp0ieW::new(self, 0)
    }
    #[doc = "Bit 1 - Compare 1 interrupt enable"]
    #[inline(always)]
    pub fn cmp1ie(&mut self) -> Cmp1ieW<'_, St1dmaintenSpec> {
        Cmp1ieW::new(self, 1)
    }
    #[doc = "Bit 2 - Compare 2 interrupt enable"]
    #[inline(always)]
    pub fn cmp2ie(&mut self) -> Cmp2ieW<'_, St1dmaintenSpec> {
        Cmp2ieW::new(self, 2)
    }
    #[doc = "Bit 3 - Compare 3 interrupt enable"]
    #[inline(always)]
    pub fn cmp3ie(&mut self) -> Cmp3ieW<'_, St1dmaintenSpec> {
        Cmp3ieW::new(self, 3)
    }
    #[doc = "Bit 4 - Repetition interrupt enable"]
    #[inline(always)]
    pub fn repie(&mut self) -> RepieW<'_, St1dmaintenSpec> {
        RepieW::new(self, 4)
    }
    #[doc = "Bit 6 - Update interrupt enable"]
    #[inline(always)]
    pub fn upie(&mut self) -> UpieW<'_, St1dmaintenSpec> {
        UpieW::new(self, 6)
    }
    #[doc = "Bit 7 - Capture 0 interrupt enable"]
    #[inline(always)]
    pub fn cap0ie(&mut self) -> Cap0ieW<'_, St1dmaintenSpec> {
        Cap0ieW::new(self, 7)
    }
    #[doc = "Bit 8 - Capture 1 interrupt enable"]
    #[inline(always)]
    pub fn cap1ie(&mut self) -> Cap1ieW<'_, St1dmaintenSpec> {
        Cap1ieW::new(self, 8)
    }
    #[doc = "Bit 9 - Channel 0 output active interrupt enable"]
    #[inline(always)]
    pub fn ch0oaie(&mut self) -> Ch0oaieW<'_, St1dmaintenSpec> {
        Ch0oaieW::new(self, 9)
    }
    #[doc = "Bit 10 - Channel 0 output inactive interrupt enable"]
    #[inline(always)]
    pub fn ch0onaie(&mut self) -> Ch0onaieW<'_, St1dmaintenSpec> {
        Ch0onaieW::new(self, 10)
    }
    #[doc = "Bit 11 - Channel 1 output active interrupt enable"]
    #[inline(always)]
    pub fn ch1oaie(&mut self) -> Ch1oaieW<'_, St1dmaintenSpec> {
        Ch1oaieW::new(self, 11)
    }
    #[doc = "Bit 12 - Channel 1 output inactive interrupt enable"]
    #[inline(always)]
    pub fn ch1onaie(&mut self) -> Ch1onaieW<'_, St1dmaintenSpec> {
        Ch1onaieW::new(self, 12)
    }
    #[doc = "Bit 13 - Counter reset interrupt enable"]
    #[inline(always)]
    pub fn rstie(&mut self) -> RstieW<'_, St1dmaintenSpec> {
        RstieW::new(self, 13)
    }
    #[doc = "Bit 14 - Delayed IDLE mode entry interrupt enable"]
    #[inline(always)]
    pub fn dlyiie(&mut self) -> DlyiieW<'_, St1dmaintenSpec> {
        DlyiieW::new(self, 14)
    }
    #[doc = "Bit 16 - Compare 0 DMA request enable"]
    #[inline(always)]
    pub fn cmp0den(&mut self) -> Cmp0denW<'_, St1dmaintenSpec> {
        Cmp0denW::new(self, 16)
    }
    #[doc = "Bit 17 - Compare 1 DMA request enable"]
    #[inline(always)]
    pub fn cmp1den(&mut self) -> Cmp1denW<'_, St1dmaintenSpec> {
        Cmp1denW::new(self, 17)
    }
    #[doc = "Bit 18 - Compare 2 DMA request enable"]
    #[inline(always)]
    pub fn cmp2den(&mut self) -> Cmp2denW<'_, St1dmaintenSpec> {
        Cmp2denW::new(self, 18)
    }
    #[doc = "Bit 19 - Compare 3 DMA request enable"]
    #[inline(always)]
    pub fn cmp3den(&mut self) -> Cmp3denW<'_, St1dmaintenSpec> {
        Cmp3denW::new(self, 19)
    }
    #[doc = "Bit 20 - Repetition DMA request enable"]
    #[inline(always)]
    pub fn repden(&mut self) -> RepdenW<'_, St1dmaintenSpec> {
        RepdenW::new(self, 20)
    }
    #[doc = "Bit 22 - Update DMA request enable"]
    #[inline(always)]
    pub fn upden(&mut self) -> UpdenW<'_, St1dmaintenSpec> {
        UpdenW::new(self, 22)
    }
    #[doc = "Bit 23 - Capture 0 DMA request enable"]
    #[inline(always)]
    pub fn cap0den(&mut self) -> Cap0denW<'_, St1dmaintenSpec> {
        Cap0denW::new(self, 23)
    }
    #[doc = "Bit 24 - Capture 1 DMA request enable"]
    #[inline(always)]
    pub fn cap1den(&mut self) -> Cap1denW<'_, St1dmaintenSpec> {
        Cap1denW::new(self, 24)
    }
    #[doc = "Bit 25 - Channel 0 output active DMA request enable"]
    #[inline(always)]
    pub fn ch0aden(&mut self) -> Ch0adenW<'_, St1dmaintenSpec> {
        Ch0adenW::new(self, 25)
    }
    #[doc = "Bit 26 - Channel 0 output inactive DMA request enable"]
    #[inline(always)]
    pub fn ch0onaden(&mut self) -> Ch0onadenW<'_, St1dmaintenSpec> {
        Ch0onadenW::new(self, 26)
    }
    #[doc = "Bit 27 - Channel 1 output active DMA request enable"]
    #[inline(always)]
    pub fn ch1oaden(&mut self) -> Ch1oadenW<'_, St1dmaintenSpec> {
        Ch1oadenW::new(self, 27)
    }
    #[doc = "Bit 28 - Channel 1 output inactive DMA request enable"]
    #[inline(always)]
    pub fn ch1onaden(&mut self) -> Ch1onadenW<'_, St1dmaintenSpec> {
        Ch1onadenW::new(self, 28)
    }
    #[doc = "Bit 29 - Counter reset DMA request enable"]
    #[inline(always)]
    pub fn rstden(&mut self) -> RstdenW<'_, St1dmaintenSpec> {
        RstdenW::new(self, 29)
    }
    #[doc = "Bit 30 - Delayed IDLE mode entry DMA request enable"]
    #[inline(always)]
    pub fn dlyiden(&mut self) -> DlyidenW<'_, St1dmaintenSpec> {
        DlyidenW::new(self, 30)
    }
}
#[doc = "SHRTIMER Slave_TIMER1 DMA and interrupt enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1dmainten::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1dmainten::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St1dmaintenSpec;
impl crate::RegisterSpec for St1dmaintenSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1dmainten::R`](R) reader structure"]
impl crate::Readable for St1dmaintenSpec {}
#[doc = "`write(|w| ..)` method takes [`st1dmainten::W`](W) writer structure"]
impl crate::Writable for St1dmaintenSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST1DMAINTEN to value 0"]
impl crate::Resettable for St1dmaintenSpec {}
