#[doc = "Register `ST1CH1SET` reader"]
pub type R = crate::R<St1ch1setSpec>;
#[doc = "Register `ST1CH1SET` writer"]
pub type W = crate::W<St1ch1setSpec>;
...
impl W {
    #[doc = "Bit 0 - Software event generates channel 1"]
    #[inline(always)]
    pub fn ch1ssev(&mut self) -> Ch1ssevW<'_, St1ch1setSpec> {
        Ch1ssevW::new(self, 0)
    }
    #[doc = "Bit 1 - Slave_TIMERx reset event generates channel 1"]
    #[inline(always)]
    pub fn ch1srst(&mut self) -> Ch1srstW<'_, St1ch1setSpec> {
        Ch1srstW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave_TIMERx period event generates channel 1"]
    #[inline(always)]
    pub fn ch1sper(&mut self) -> Ch1sperW<'_, St1ch1setSpec> {
        Ch1sperW::new(self, 2)
    }
    #[doc = "Bit 3 - Slave_TIMERx compare 0 event generates channel 1"]
    #[inline(always)]
    pub fn ch1scmp0(&mut self) -> Ch1scmp0W<'_, St1ch1setSpec> {
        Ch1scmp0W::new(self, 3)
    }
    #[doc = "Bit 4 - Slave_TIMERx compare 1 event generates channel 1"]
    #[inline(always)]
    pub fn ch1scmp1(&mut self) -> Ch1scmp1W<'_, St1ch1setSpec> {
        Ch1scmp1W::new(self, 4)
    }
    #[doc = "Bit 5 - Slave_TIMERx compare 2 event generates channel 1"]
    #[inline(always)]
    pub fn ch1scmp2(&mut self) -> Ch1scmp2W<'_, St1ch1setSpec> {
        Ch1scmp2W::new(self, 5)
    }
    #[doc = "Bit 6 - Slave_TIMERx compare 3 event generates channel 1"]
    #[inline(always)]
    pub fn ch1scmp3(&mut self) -> Ch1scmp3W<'_, St1ch1setSpec> {
        Ch1scmp3W::new(self, 6)
    }
    #[doc = "Bit 7 - Master_TIMER period event generates channel 1"]
    #[inline(always)]
    pub fn ch1smtper(&mut self) -> Ch1smtperW<'_, St1ch1setSpec> {
        Ch1smtperW::new(self, 7)
    }
    #[doc = "Bit 8 - Master_TIMER compare 0 event generates channel 1"]
    #[inline(always)]
    pub fn ch1smtcmp0(&mut self) -> Ch1smtcmp0W<'_, St1ch1setSpec> {
        Ch1smtcmp0W::new(self, 8)
    }
    #[doc = "Bit 9 - Master_TIMER compare 1 event generates channel 1"]
    #[inline(always)]
    pub fn ch1smtcmp1(&mut self) -> Ch1smtcmp1W<'_, St1ch1setSpec> {
        Ch1smtcmp1W::new(self, 9)
    }
    #[doc = "Bit 10 - Master_TIMER compare 2 event generates channel 1"]
    #[inline(always)]
    pub fn ch1smtcmp2(&mut self) -> Ch1smtcmp2W<'_, St1ch1setSpec> {
        Ch1smtcmp2W::new(self, 10)
    }
    #[doc = "Bit 11 - Master_TIMER compare 3 event generates channel 1"]
    #[inline(always)]
    pub fn ch1smtcmp3(&mut self) -> Ch1smtcmp3W<'_, St1ch1setSpec> {
        Ch1smtcmp3W::new(self, 11)
    }
    #[doc = "Bit 12 - Slave_TIMERx interconnection event 0 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev0(&mut self) -> Ch1sstev0W<'_, St1ch1setSpec> {
        Ch1sstev0W::new(self, 12)
    }
    #[doc = "Bit 13 - Slave_TIMERx interconnection event 1 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev1(&mut self) -> Ch1sstev1W<'_, St1ch1setSpec> {
        Ch1sstev1W::new(self, 13)
    }
    #[doc = "Bit 14 - Slave_TIMERx interconnection event 2 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev2(&mut self) -> Ch1sstev2W<'_, St1ch1setSpec> {
        Ch1sstev2W::new(self, 14)
    }
    #[doc = "Bit 15 - Slave_TIMERx interconnection event 3 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev3(&mut self) -> Ch1sstev3W<'_, St1ch1setSpec> {
        Ch1sstev3W::new(self, 15)
    }
    #[doc = "Bit 16 - Slave_TIMERx interconnection event 4 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev4(&mut self) -> Ch1sstev4W<'_, St1ch1setSpec> {
        Ch1sstev4W::new(self, 16)
    }
    #[doc = "Bit 17 - Slave_TIMERx interconnection event 5 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev5(&mut self) -> Ch1sstev5W<'_, St1ch1setSpec> {
        Ch1sstev5W::new(self, 17)
    }
    #[doc = "Bit 18 - Slave_TIMERx interconnection event 6 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev6(&mut self) -> Ch1sstev6W<'_, St1ch1setSpec> {
        Ch1sstev6W::new(self, 18)
    }
    #[doc = "Bit 19 - Slave_TIMERx interconnection event 7 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev7(&mut self) -> Ch1sstev7W<'_, St1ch1setSpec> {
        Ch1sstev7W::new(self, 19)
    }
    #[doc = "Bit 20 - Slave_TIMERx interconnection event 8 generates channel 1"]
    #[inline(always)]
    pub fn ch1sstev8(&mut self) -> Ch1sstev8W<'_, St1ch1setSpec> {
        Ch1sstev8W::new(self, 20)
    }
    #[doc = "Bit 21 - External event 0 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev0(&mut self) -> Ch1sexev0W<'_, St1ch1setSpec> {
        Ch1sexev0W::new(self, 21)
    }
    #[doc = "Bit 22 - External event 1 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev1(&mut self) -> Ch1sexev1W<'_, St1ch1setSpec> {
        Ch1sexev1W::new(self, 22)
    }
    #[doc = "Bit 23 - External event 2 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev2(&mut self) -> Ch1sexev2W<'_, St1ch1setSpec> {
        Ch1sexev2W::new(self, 23)
    }
    #[doc = "Bit 24 - External event 3 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev3(&mut self) -> Ch1sexev3W<'_, St1ch1setSpec> {
        Ch1sexev3W::new(self, 24)
    }
    #[doc = "Bit 25 - External event 4 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev4(&mut self) -> Ch1sexev4W<'_, St1ch1setSpec> {
        Ch1sexev4W::new(self, 25)
    }
    #[doc = "Bit 26 - External event 5 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev5(&mut self) -> Ch1sexev5W<'_, St1ch1setSpec> {
        Ch1sexev5W::new(self, 26)
    }
    #[doc = "Bit 27 - External event 6 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev6(&mut self) -> Ch1sexev6W<'_, St1ch1setSpec> {
        Ch1sexev6W::new(self, 27)
    }
    #[doc = "Bit 28 - External event 7 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev7(&mut self) -> Ch1sexev7W<'_, St1ch1setSpec> {
        Ch1sexev7W::new(self, 28)
    }
    #[doc = "Bit 29 - External event 8 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev8(&mut self) -> Ch1sexev8W<'_, St1ch1setSpec> {
        Ch1sexev8W::new(self, 29)
    }
    #[doc = "Bit 30 - External event 9 generates channel 1"]
    #[inline(always)]
    pub fn ch1sexev9(&mut self) -> Ch1sexev9W<'_, St1ch1setSpec> {
        Ch1sexev9W::new(self, 30)
    }
    #[doc = "Bit 31 - Update event generates channel 1"]
    #[inline(always)]
    pub fn ch1sup(&mut self) -> Ch1supW<'_, St1ch1setSpec> {
        Ch1supW::new(self, 31)
    }
}
#[doc = "SHRTIMER Slave_TIMER1 channel 1 set request register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1ch1set::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1ch1set::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St1ch1setSpec;
impl crate::RegisterSpec for St1ch1setSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1ch1set::R`](R) reader structure"]
impl crate::Readable for St1ch1setSpec {}
#[doc = "`write(|w| ..)` method takes [`st1ch1set::W`](W) writer structure"]
impl crate::Writable for St1ch1setSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST1CH1SET to value 0"]
impl crate::Resettable for St1ch1setSpec {}
