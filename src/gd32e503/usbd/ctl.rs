...
impl W {
    #[doc = "Bit 0 - Set reset"]
    #[inline(always)]
    pub fn setrst(&mut self) -> SetrstW<'_, CtlSpec> {
        SetrstW::new(self, 0)
    }
    #[doc = "Bit 1 - Close state"]
    #[inline(always)]
    pub fn close(&mut self) -> CloseW<'_, CtlSpec> {
        CloseW::new(self, 1)
    }
    #[doc = "Bit 2 - Low-power mode"]
    #[inline(always)]
    pub fn lowm(&mut self) -> LowmW<'_, CtlSpec> {
        LowmW::new(self, 2)
    }
    #[doc = "Bit 3 - Set suspend"]
    #[inline(always)]
    pub fn setsps(&mut self) -> SetspsW<'_, CtlSpec> {
        SetspsW::new(self, 3)
    }
    #[doc = "Bit 4 - Resume request"]
    #[inline(always)]
    pub fn rsreq(&mut self) -> RsreqW<'_, CtlSpec> {
        RsreqW::new(self, 4)
    }
    #[doc = "Bit 5 - LPM L1 resume request"]
    #[inline(always)]
    pub fn l1rsreq(&mut self) -> L1rsreqW<'_, CtlSpec> {
        L1rsreqW::new(self, 5)
    }
    #[doc = "Bit 7 - LPM L1 state request interrupt enable"]
    #[inline(always)]
    pub fn l1reqie(&mut self) -> L1reqieW<'_, CtlSpec> {
        L1reqieW::new(self, 7)
    }
    #[doc = "Bit 8 - Expected start of frame interrupt enable"]
    #[inline(always)]
    pub fn esofie(&mut self) -> EsofieW<'_, CtlSpec> {
        EsofieW::new(self, 8)
    }
    #[doc = "Bit 9 - Start of frame interrupt mask"]
    #[inline(always)]
    pub fn sofie(&mut self) -> SofieW<'_, CtlSpec> {
        SofieW::new(self, 9)
    }
    #[doc = "Bit 10 - USB reset interrupt mask"]
    #[inline(always)]
    pub fn rstie(&mut self) -> RstieW<'_, CtlSpec> {
        RstieW::new(self, 10)
    }
    #[doc = "Bit 11 - Suspend mode interrupt mask"]
    #[inline(always)]
    pub fn spsie(&mut self) -> SpsieW<'_, CtlSpec> {
        SpsieW::new(self, 11)
    }
    #[doc = "Bit 12 - Wakeup interrupt enable"]
    #[inline(always)]
    pub fn wkupie(&mut self) -> WkupieW<'_, CtlSpec> {
        WkupieW::new(self, 12)
    }
    #[doc = "Bit 13 - Error interrupt mask"]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - Packet memory area over / underrun interrupt enable"]
    #[inline(always)]
    pub fn pmouie(&mut self) -> PmouieW<'_, CtlSpec> {
        PmouieW::new(self, 14)
    }
    #[doc = "Bit 15 - Successful transfer interrupt enable"]
    #[inline(always)]
    pub fn stie(&mut self) -> StieW<'_, CtlSpec> {
        StieW::new(self, 15)
    }
}
