...
pub type Adc0EtrginjRemapR = crate::BitReader;
#[doc = "Field `ADC0_ETRGINJ_REMAP` writer - ADC 0 external trigger injected conversion remapping"]
pub type Adc0EtrginjRemapW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[inline(always)]
    pub fn adc0_etrginj_remap(&self) -> Adc0EtrginjRemapR {
        Adc0EtrginjRemapR::new(((self.bits >> 17) & 1) != 0)
    }
    ...
    pub fn adc1_etrginj_remap(&self) -> Adc1EtrginjRemapR {
        Adc1EtrginjRemapR::new(((self.bits >> 19) & 1) != 0)
    }
...
impl W {
    ...
    #[doc = "Bits 13:14 - CAN interface remapping"]
    #[inline(always)]
    pub fn can_remap(&mut self) -> CanRemapW<'_, Pcf0Spec> {
    ...
    #[doc = "Bit 17 - ADC 0 external trigger injected conversion remapping"]
    #[inline(always)]
    pub fn adc0_etrginj_remap(&mut self) -> Adc0EtrginjRemapW<'_, Pcf0Spec> {
        Adc0EtrginjRemapW::new(self, 17)
    }
    #[doc = "Bit 18 - ADC 0 external trigger regular conversion remapping"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - ADC 1 external trigger injected conversion remapping"]
    #[inline(always)]
    pub fn adc1_etrginj_remap(&mut self) -> Adc1EtrginjRemapW<'_, Pcf0Spec> {
        Adc1EtrginjRemapW::new(self, 19)
    }
    #[doc = "Bit 20 - ADC 1 external trigger regular conversion remapping"]
    #[inline(always)]
