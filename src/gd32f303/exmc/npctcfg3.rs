...
impl W {
    #[doc = "Bits 0:7 - Common memory setup time"]
    #[inline(always)]
    pub fn comset(&mut self) -> ComsetW<'_, Npctcfg3Spec> {
        ComsetW::new(self, 0)
    }
    #[doc = "Bits 8:15 - Common memory wait time"]
    #[inline(always)]
    pub fn comwait(&mut self) -> ComwaitW<'_, Npctcfg3Spec> {
        ComwaitW::new(self, 8)
    }
    #[doc = "Bits 16:23 - Common memory hold time"]
    #[inline(always)]
    pub fn comhld(&mut self) -> ComhldW<'_, Npctcfg3Spec> {
        ComhldW::new(self, 16)
    }
    #[doc = "Bits 24:31 - Common memory data bus HiZ time"]
    #[inline(always)]
    pub fn comhiz(&mut self) -> ComhizW<'_, Npctcfg3Spec> {
        ComhizW::new(self, 24)
    }
}
