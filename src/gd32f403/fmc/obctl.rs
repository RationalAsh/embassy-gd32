...
#[doc = "Field `DATA` reader - Store DATA\\[15:0\\] of option bytes block after system reset"]
...
#[doc = "Option byte control register\n\nYou can [`read`](crate::Reg::read) this register and get [`obctl::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
