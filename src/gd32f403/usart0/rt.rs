...
pub type RtW<'a, REG> = crate::FieldWriter<'a, REG, 24, u32, crate::Safe>;
#[doc = "Field `BL` reader - Block Length"]
pub type BlR = crate::FieldReader;
#[doc = "Field `BL` writer - Block Length"]
pub type BlW<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
impl R {
...
impl W {
    #[doc = "Bits 0:23 - Receiver timeout threshold"]
    #[inline(always)]
    pub fn rt(&mut self) -> RtW<'_, RtSpec> {
        RtW::new(self, 0)
    }
    #[doc = "Bits 24:31 - Block Length"]
    #[inline(always)]
    pub fn bl(&mut self) -> BlW<'_, RtSpec> {
        BlW::new(self, 24)
    }
}
