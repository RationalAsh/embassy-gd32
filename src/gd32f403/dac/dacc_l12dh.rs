...
pub type Dac0DhW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16, crate::Safe>;
...
pub type Dac1DhW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16, crate::Safe>;
impl R {
...
impl W {
    #[doc = "Bits 4:15 - DAC0 12-bit left-aligned data"]
    #[inline(always)]
    pub fn dac0_dh(&mut self) -> Dac0DhW<'_, DaccL12dhSpec> {
        Dac0DhW::new(self, 4)
    }
    #[doc = "Bits 20:31 - DAC1 12-bit left-aligned data"]
    #[inline(always)]
    pub fn dac1_dh(&mut self) -> Dac1DhW<'_, DaccL12dhSpec> {
        Dac1DhW::new(self, 20)
    }
}
