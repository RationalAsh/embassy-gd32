...
impl W {
    #[doc = "Bit 1 - Wait feature enable"]
    #[inline(always)]
    pub fn ndwten(&mut self) -> NdwtenW<'_, Npctl3Spec> {
        NdwtenW::new(self, 1)
    }
    #[doc = "Bit 2 - NAND bank enable"]
    #[inline(always)]
    pub fn ndbken(&mut self) -> NdbkenW<'_, Npctl3Spec> {
        NdbkenW::new(self, 2)
    }
    #[doc = "Bit 3 - NAND bank memory type"]
    #[inline(always)]
    pub fn ndtp(&mut self) -> NdtpW<'_, Npctl3Spec> {
        NdtpW::new(self, 3)
    }
    #[doc = "Bits 4:5 - NAND bank memory data bus width"]
    #[inline(always)]
    pub fn ndw(&mut self) -> NdwW<'_, Npctl3Spec> {
        NdwW::new(self, 4)
    }
    #[doc = "Bit 6 - ECC enable"]
    #[inline(always)]
    pub fn eccen(&mut self) -> EccenW<'_, Npctl3Spec> {
        EccenW::new(self, 6)
    }
    #[doc = "Bits 9:12 - CLE to RE delay"]
    #[inline(always)]
    pub fn ctr(&mut self) -> CtrW<'_, Npctl3Spec> {
        CtrW::new(self, 9)
    }
    #[doc = "Bits 13:16 - ALE to RE delay"]
    #[inline(always)]
    pub fn atr(&mut self) -> AtrW<'_, Npctl3Spec> {
        AtrW::new(self, 13)
    }
    #[doc = "Bits 17:19 - ECC size"]
    #[inline(always)]
    pub fn eccsz(&mut self) -> EccszW<'_, Npctl3Spec> {
        EccszW::new(self, 17)
    }
}
