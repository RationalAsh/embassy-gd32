...
impl W {
    #[doc = "Bits 0:7 - IO space setup time"]
    #[inline(always)]
    pub fn ioset(&mut self) -> IosetW<'_, Piotcfg3Spec> {
        IosetW::new(self, 0)
    }
    #[doc = "Bits 8:15 - IO space wait time"]
    #[inline(always)]
    pub fn iowait(&mut self) -> IowaitW<'_, Piotcfg3Spec> {
        IowaitW::new(self, 8)
    }
    #[doc = "Bits 16:23 - IO space hold time"]
    #[inline(always)]
    pub fn iohld(&mut self) -> IohldW<'_, Piotcfg3Spec> {
        IohldW::new(self, 16)
    }
    #[doc = "Bits 24:31 - IO space data bus HiZ time"]
    #[inline(always)]
    pub fn iohiz(&mut self) -> IohizW<'_, Piotcfg3Spec> {
        IohizW::new(self, 24)
    }
}
