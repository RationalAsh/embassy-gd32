...
impl W {
    #[doc = "Bit 0 - Cortex-M4 LOCKUP output lock"]
    #[inline(always)]
    pub fn lockup_lock(&mut self) -> LockupLockW<'_, Cfg2Spec> {
        LockupLockW::new(self, 0)
    }
    #[doc = "Bit 1 - SRAM parity check error lock"]
    #[inline(always)]
    pub fn sram_parity_error_lock(&mut self) -> SramParityErrorLockW<'_, Cfg2Spec> {
        SramParityErrorLockW::new(self, 1)
    }
    #[doc = "Bit 2 - LVD lock"]
    #[inline(always)]
    pub fn lvd_lock(&mut self) -> LvdLockW<'_, Cfg2Spec> {
        LvdLockW::new(self, 2)
    }
    #[doc = "Bit 8 - SRAM parity check error flag"]
    #[inline(always)]
    pub fn sram_pcef(&mut self) -> SramPcefW<'_, Cfg2Spec> {
