...
impl W {
    #[doc = "Bits 0:3 - EXTI 4 sources selection"]
    #[inline(always)]
    pub fn exti4_ss(&mut self) -> Exti4SsW<'_, Extiss1Spec> {
        Exti4SsW::new(self, 0)
    }
    #[doc = "Bits 4:7 - EXTI 5 sources selection"]
    #[inline(always)]
    pub fn exti5_ss(&mut self) -> Exti5SsW<'_, Extiss1Spec> {
        Exti5SsW::new(self, 4)
    }
    #[doc = "Bits 8:11 - EXTI 6 sources selection"]
    #[inline(always)]
    pub fn exti6_ss(&mut self) -> Exti6SsW<'_, Extiss1Spec> {
        Exti6SsW::new(self, 8)
    }
    #[doc = "Bits 12:15 - EXTI 7 sources selection"]
    #[inline(always)]
    pub fn exti7_ss(&mut self) -> Exti7SsW<'_, Extiss1Spec> {
