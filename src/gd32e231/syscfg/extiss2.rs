...
impl crate::IsEnum for Exti10Ss {}
...
impl crate::IsEnum for Exti11Ss {}
...
impl W {
    #[doc = "Bits 0:3 - EXTI 8 sources selection"]
    #[inline(always)]
    pub fn exti8_ss(&mut self) -> Exti8SsW<'_, Extiss2Spec> {
        Exti8SsW::new(self, 0)
    }
    #[doc = "Bits 4:7 - EXTI 9 sources selection"]
    #[inline(always)]
    pub fn exti9_ss(&mut self) -> Exti9SsW<'_, Extiss2Spec> {
        Exti9SsW::new(self, 4)
    }
    #[doc = "Bits 8:11 - EXTI 10 sources selection"]
    #[inline(always)]
    pub fn exti10_ss(&mut self) -> Exti10SsW<'_, Extiss2Spec> {
        Exti10SsW::new(self, 8)
    }
    #[doc = "Bits 12:15 - EXTI 11 sources selection"]
    #[inline(always)]
    pub fn exti11_ss(&mut self) -> Exti11SsW<'_, Extiss2Spec> {
