...
pub use CfgcmpenR as DbgmcuenR;
...
pub use CfgcmpenW as DbgmcuenW;
impl R {
    ...
    pub fn dbgmcuen(&self) -> DbgmcuenR {
        DbgmcuenR::new(((self.bits >> 22) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - System configuration and comparator clock enable"]
    #[inline(always)]
    pub fn cfgcmpen(&mut self) -> CfgcmpenW<'_, Apb2enSpec> {
    ...
    #[doc = "Bit 16 - TIMER14 timer clock enable"]
    #[inline(always)]
    pub fn timer14en(&mut self) -> Timer14enW<'_, Apb2enSpec> {
        Timer14enW::new(self, 16)
    }
    #[doc = "Bit 17 - TIMER15 timer clock enable"]
    #[inline(always)]
    pub fn timer15en(&mut self) -> Timer15enW<'_, Apb2enSpec> {
        Timer15enW::new(self, 17)
    }
    #[doc = "Bit 18 - TIMER16 timer clock enable"]
    #[inline(always)]
    pub fn timer16en(&mut self) -> Timer16enW<'_, Apb2enSpec> {
        Timer16enW::new(self, 18)
    }
    #[doc = "Bit 22 - DBGMCU clock enable"]
    #[inline(always)]
    pub fn dbgmcuen(&mut self) -> DbgmcuenW<'_, Apb2enSpec> {
        DbgmcuenW::new(self, 22)
    }
}
