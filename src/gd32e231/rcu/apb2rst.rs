...
impl W {
    #[doc = "Bit 0 - System configuration and comparator reset"]
    #[inline(always)]
    pub fn cfgcmprst(&mut self) -> CfgcmprstW<'_, Apb2rstSpec> {
    ...
    #[doc = "Bit 16 - TIMER14 reset"]
    #[inline(always)]
    pub fn timer14rst(&mut self) -> Timer14rstW<'_, Apb2rstSpec> {
        Timer14rstW::new(self, 16)
    }
    #[doc = "Bit 17 - TIMER15 reset"]
    #[inline(always)]
    pub fn timer15rst(&mut self) -> Timer15rstW<'_, Apb2rstSpec> {
        Timer15rstW::new(self, 17)
    }
    #[doc = "Bit 18 - TIMER16 reset"]
    #[inline(always)]
    pub fn timer16rst(&mut self) -> Timer16rstW<'_, Apb2rstSpec> {
