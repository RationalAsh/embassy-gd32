...
impl R {
    #[doc = "Bits 0:4 - 6th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq6(&self) -> Rsq6R {
        Rsq6R::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bits 5:9 - 7th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq7(&self) -> Rsq7R {
        Rsq7R::new(((self.bits >> 5) & 0x1f) as u8)
    }
    #[doc = "Bits 10:14 - 8th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq8(&self) -> Rsq8R {
        Rsq8R::new(((self.bits >> 10) & 0x1f) as u8)
    }
    #[doc = "Bits 15:19 - 9th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq9(&self) -> Rsq9R {
        Rsq9R::new(((self.bits >> 15) & 0x1f) as u8)
    }
    #[doc = "Bits 20:24 - 10th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq10(&self) -> Rsq10R {
        Rsq10R::new(((self.bits >> 20) & 0x1f) as u8)
    }
    #[doc = "Bits 25:29 - 11th conversion in regular sequence"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:4 - 6th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq6(&mut self) -> Rsq6W<'_, Rsq1Spec> {
        Rsq6W::new(self, 0)
    }
    #[doc = "Bits 5:9 - 7th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq7(&mut self) -> Rsq7W<'_, Rsq1Spec> {
        Rsq7W::new(self, 5)
    }
    #[doc = "Bits 10:14 - 8th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq8(&mut self) -> Rsq8W<'_, Rsq1Spec> {
        Rsq8W::new(self, 10)
    }
    #[doc = "Bits 15:19 - 9th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq9(&mut self) -> Rsq9W<'_, Rsq1Spec> {
        Rsq9W::new(self, 15)
    }
    #[doc = "Bits 20:24 - 10th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq10(&mut self) -> Rsq10W<'_, Rsq1Spec> {
        Rsq10W::new(self, 20)
    }
    #[doc = "Bits 25:29 - 11th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq11(&mut self) -> Rsq11W<'_, Rsq1Spec> {
        Rsq11W::new(self, 25)
    }
}
