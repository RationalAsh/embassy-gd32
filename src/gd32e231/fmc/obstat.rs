...
#[doc = "Option bytes read error bit\n\nValue on reset: 0"]
...
#[doc = "Option bytes security protection level\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
#[repr(u8)]
pub enum Plevel {
...
impl crate::IsEnum for Plevel {}
#[doc = "Field `PLEVEL` reader - Option bytes security protection level"]
...
#[doc = "Field `OB_USER` reader - Store USER of option bytes block after system reset"]
pub type ObUserR = crate::FieldReader;
#[doc = "Field `OB_DATA` reader - Store DATA\\[15:0\\] of option bytes block after system reset"]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Store DATA\\[15:0\\] of option bytes block after system reset"]
    #[inline(always)]
