...
pub type PscW<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
#[doc = "Field `GUAT` reader - Guard time value"]
pub type GuatR = crate::FieldReader;
#[doc = "Field `GUAT` writer - Guard time value"]
pub type GuatW<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
impl R {
...
impl W {
    ...
    #[doc = "Bits 8:15 - Guard time value"]
    #[inline(always)]
    pub fn guat(&mut self) -> GuatW<'_, GpSpec> {
        GuatW::new(self, 8)
    }
}
