...
impl W {
    #[doc = "Bit 0 - Early NKEN when smartcard mode is selected"]
    #[inline(always)]
    pub fn elnack(&mut self) -> ElnackW<'_, RfcsSpec> {
        ElnackW::new(self, 0)
    }
    #[doc = "Bit 8 - Receive FIFO enable"]
    #[inline(always)]
    pub fn rfen(&mut self) -> RfenW<'_, RfcsSpec> {
        RfenW::new(self, 8)
    }
    #[doc = "Bit 9 - Receive FIFO full interrupt enable"]
    #[inline(always)]
    pub fn rffie(&mut self) -> RffieW<'_, RfcsSpec> {
        RffieW::new(self, 9)
    }
    #[doc = "Bit 15 - Receive FIFO full interrupt flag"]
    #[inline(always)]
    pub fn rffint(&mut self) -> RffintW<'_, RfcsSpec> {
        RffintW::new(self, 15)
    }
}
#[doc = "USART receive FIFO control and status register\n\nYou can [`read`](crate::Reg::read) this register and get [`rfcs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rfcs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RfcsSpec;
