...
pub type CmpmW<'a, REG> = crate::FieldWriter<'a, REG, 2, Cmpm, crate::Safe>;
...
pub type CmposelW<'a, REG> = crate::FieldWriter<'a, REG, 3, Cmposel, crate::Safe>;
...
pub type CmphstW<'a, REG> = crate::FieldWriter<'a, REG, 2, Cmphst, crate::Safe>;
...
impl W {
    #[doc = "Bit 0 - Comparator enable"]
    #[inline(always)]
    pub fn cmpen(&mut self) -> CmpenW<'_, CsSpec> {
        CmpenW::new(self, 0)
    }
    #[doc = "Bit 1 - Comparator switch"]
    #[inline(always)]
    pub fn cmpsw(&mut self) -> CmpswW<'_, CsSpec> {
        CmpswW::new(self, 1)
    }
    #[doc = "Bits 2:3 - Comparator mode"]
    #[inline(always)]
    pub fn cmpm(&mut self) -> CmpmW<'_, CsSpec> {
        CmpmW::new(self, 2)
    }
    #[doc = "Bits 4:6 - Comparator input selection"]
    #[inline(always)]
    pub fn cmpmsel(&mut self) -> CmpmselW<'_, CsSpec> {
        CmpmselW::new(self, 4)
    }
    #[doc = "Bits 8:10 - Comparator output selection"]
    #[inline(always)]
    pub fn cmposel(&mut self) -> CmposelW<'_, CsSpec> {
        CmposelW::new(self, 8)
    }
    #[doc = "Bit 11 - Polarity of comparator output"]
    #[inline(always)]
    pub fn cmppl(&mut self) -> CmpplW<'_, CsSpec> {
        CmpplW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Comparator hysteresis"]
    #[inline(always)]
    pub fn cmphst(&mut self) -> CmphstW<'_, CsSpec> {
        CmphstW::new(self, 12)
    }
    #[doc = "Bit 15 - Comparator 0 lock"]
    #[inline(always)]
    pub fn cmplk(&mut self) -> CmplkW<'_, CsSpec> {
        CmplkW::new(self, 15)
    }
}
