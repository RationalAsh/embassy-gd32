...
impl W {
    ...
    #[inline(always)]
    pub fn cr0(&mut self) -> Cr0W<'_, BcSpec> {
        Cr0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port cleat bit"]
    #[inline(always)]
    pub fn cr1(&mut self) -> Cr1W<'_, BcSpec> {
        Cr1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port cleat bit"]
    #[inline(always)]
    pub fn cr2(&mut self) -> Cr2W<'_, BcSpec> {
        Cr2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port cleat bit"]
    #[inline(always)]
    pub fn cr3(&mut self) -> Cr3W<'_, BcSpec> {
        Cr3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port cleat bit"]
    #[inline(always)]
    pub fn cr4(&mut self) -> Cr4W<'_, BcSpec> {
        Cr4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port cleat bit"]
    #[inline(always)]
    pub fn cr5(&mut self) -> Cr5W<'_, BcSpec> {
        Cr5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port cleat bit"]
    #[inline(always)]
    pub fn cr6(&mut self) -> Cr6W<'_, BcSpec> {
        Cr6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port cleat bit"]
    #[inline(always)]
    pub fn cr7(&mut self) -> Cr7W<'_, BcSpec> {
        Cr7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port cleat bit"]
    #[inline(always)]
    pub fn cr8(&mut self) -> Cr8W<'_, BcSpec> {
        Cr8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port cleat bit"]
    #[inline(always)]
    pub fn cr9(&mut self) -> Cr9W<'_, BcSpec> {
        Cr9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port cleat bit"]
    #[inline(always)]
    pub fn cr10(&mut self) -> Cr10W<'_, BcSpec> {
        Cr10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port cleat bit"]
    #[inline(always)]
    pub fn cr11(&mut self) -> Cr11W<'_, BcSpec> {
        Cr11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port cleat bit"]
    #[inline(always)]
    pub fn cr12(&mut self) -> Cr12W<'_, BcSpec> {
        Cr12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port cleat bit"]
    #[inline(always)]
    pub fn cr13(&mut self) -> Cr13W<'_, BcSpec> {
        Cr13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port cleat bit"]
    #[inline(always)]
    pub fn cr14(&mut self) -> Cr14W<'_, BcSpec> {
        Cr14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port cleat bit"]
    #[inline(always)]
    pub fn cr15(&mut self) -> Cr15W<'_, BcSpec> {
        Cr15W::new(self, 15)
    }
}
