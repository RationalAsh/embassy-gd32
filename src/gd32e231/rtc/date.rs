...
impl W {
    #[doc = "Bits 0:3 - Date units in BCD code"]
    #[inline(always)]
    pub fn dayu(&mut self) -> DayuW<'_, DateSpec> {
        DayuW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Date tens in BCD code"]
    #[inline(always)]
    pub fn dayt(&mut self) -> DaytW<'_, DateSpec> {
        DaytW::new(self, 4)
    }
    #[doc = "Bits 8:11 - Month units in BCD code"]
    #[inline(always)]
    pub fn monu(&mut self) -> MonuW<'_, DateSpec> {
        MonuW::new(self, 8)
    }
    #[doc = "Bit 12 - Month tens in BCD code"]
    #[inline(always)]
    pub fn mont(&mut self) -> MontW<'_, DateSpec> {
        MontW::new(self, 12)
    }
    #[doc = "Bits 13:15 - Days of the week"]
    #[inline(always)]
    pub fn dow(&mut self) -> DowW<'_, DateSpec> {
        DowW::new(self, 13)
    }
    #[doc = "Bits 16:19 - Year units in BCD code"]
    #[inline(always)]
    pub fn yru(&mut self) -> YruW<'_, DateSpec> {
        YruW::new(self, 16)
    }
    #[doc = "Bits 20:23 - Year tens in BCD code"]
    #[inline(always)]
    pub fn yrt(&mut self) -> YrtW<'_, DateSpec> {
        YrtW::new(self, 20)
    }
}
