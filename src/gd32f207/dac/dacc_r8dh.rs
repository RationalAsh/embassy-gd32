...
pub type Dac0DhW<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
...
pub type Dac1DhW<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
impl R {
...
impl W {
    #[doc = "Bits 0:7 - DAC0 8-bit right-aligned data"]
    #[inline(always)]
    pub fn dac0_dh(&mut self) -> Dac0DhW<'_, DaccR8dhSpec> {
        Dac0DhW::new(self, 0)
    }
    #[doc = "Bits 8:15 - DAC1 8-bit right-aligned data"]
    #[inline(always)]
    pub fn dac1_dh(&mut self) -> Dac1DhW<'_, DaccR8dhSpec> {
        Dac1DhW::new(self, 8)
    }
}
