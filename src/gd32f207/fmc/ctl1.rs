...
impl W {
    #[doc = "Bit 0 - Main flash program for bank1 command bit"]
    #[inline(always)]
    pub fn pg(&mut self) -> PgW<'_, Ctl1Spec> {
        PgW::new(self, 0)
    }
    #[doc = "Bit 1 - Main flash page erase for bank1 command bit"]
    #[inline(always)]
    pub fn per(&mut self) -> PerW<'_, Ctl1Spec> {
        PerW::new(self, 1)
    }
    #[doc = "Bit 2 - Main flash mass erase for bank1 command bit"]
    #[inline(always)]
    pub fn mer(&mut self) -> MerW<'_, Ctl1Spec> {
        MerW::new(self, 2)
    }
    #[doc = "Bit 6 - Send erase command to FMC bit"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - FMC_CTL1 lock bit"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<'_, Ctl1Spec> {
        LkW::new(self, 7)
    }
    #[doc = "Bit 10 - Error interrupt enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - End of operation interrupt enable"]
    #[inline(always)]
    pub fn endie(&mut self) -> EndieW<'_, Ctl1Spec> {
        EndieW::new(self, 12)
    }
}
