...
impl W {
    #[doc = "Bit 0 - Port output control"]
    #[inline(always)]
    pub fn octl0(&mut self) -> Octl0W<'_, OctlSpec> {
        Octl0W::new(self, 0)
    }
    #[doc = "Bit 1 - Port output control"]
    #[inline(always)]
    pub fn octl1(&mut self) -> Octl1W<'_, OctlSpec> {
        Octl1W::new(self, 1)
    }
    #[doc = "Bit 2 - Port output control"]
    #[inline(always)]
    pub fn octl2(&mut self) -> Octl2W<'_, OctlSpec> {
        Octl2W::new(self, 2)
    }
    #[doc = "Bit 3 - Port output control"]
    #[inline(always)]
    pub fn octl3(&mut self) -> Octl3W<'_, OctlSpec> {
        Octl3W::new(self, 3)
    }
    #[doc = "Bit 4 - Port output control"]
    #[inline(always)]
    pub fn octl4(&mut self) -> Octl4W<'_, OctlSpec> {
        Octl4W::new(self, 4)
    }
    #[doc = "Bit 5 - Port output control"]
    #[inline(always)]
    pub fn octl5(&mut self) -> Octl5W<'_, OctlSpec> {
        Octl5W::new(self, 5)
    }
    #[doc = "Bit 6 - Port output control"]
    #[inline(always)]
    pub fn octl6(&mut self) -> Octl6W<'_, OctlSpec> {
        Octl6W::new(self, 6)
    }
    #[doc = "Bit 7 - Port output control"]
    #[inline(always)]
    pub fn octl7(&mut self) -> Octl7W<'_, OctlSpec> {
        Octl7W::new(self, 7)
    }
    #[doc = "Bit 8 - Port output control"]
    #[inline(always)]
    pub fn octl8(&mut self) -> Octl8W<'_, OctlSpec> {
        Octl8W::new(self, 8)
    }
    #[doc = "Bit 9 - Port output control"]
    #[inline(always)]
    pub fn octl9(&mut self) -> Octl9W<'_, OctlSpec> {
        Octl9W::new(self, 9)
    }
    #[doc = "Bit 10 - Port output control"]
    #[inline(always)]
    pub fn octl10(&mut self) -> Octl10W<'_, OctlSpec> {
        Octl10W::new(self, 10)
    }
    #[doc = "Bit 11 - Port output control"]
    #[inline(always)]
    pub fn octl11(&mut self) -> Octl11W<'_, OctlSpec> {
        Octl11W::new(self, 11)
    }
    #[doc = "Bit 12 - Port output control"]
    #[inline(always)]
    pub fn octl12(&mut self) -> Octl12W<'_, OctlSpec> {
        Octl12W::new(self, 12)
    }
    #[doc = "Bit 13 - Port output control"]
    #[inline(always)]
    pub fn octl13(&mut self) -> Octl13W<'_, OctlSpec> {
        Octl13W::new(self, 13)
    }
    #[doc = "Bit 14 - Port output control"]
    #[inline(always)]
    pub fn octl14(&mut self) -> Octl14W<'_, OctlSpec> {
        Octl14W::new(self, 14)
    }
    #[doc = "Bit 15 - Port output control"]
    #[inline(always)]
    pub fn octl15(&mut self) -> Octl15W<'_, OctlSpec> {
        Octl15W::new(self, 15)
    }
}
