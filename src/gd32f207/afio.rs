...
pub mod pcf1;
#[doc = "PCF2 (rw) register accessor: AFIO port configuration register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`pcf2::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcf2::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcf2`] module"]
#[doc(alias = "PCF2")]
pub type Pcf2 = crate::Reg<pcf2::Pcf2Spec>;
#[doc = "AFIO port configuration register 2"]
pub mod pcf2;
#[doc = "PCF3 (rw) register accessor: AFIO port configuration register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`pcf3::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcf3::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcf3`] module"]
#[doc(alias = "PCF3")]
pub type Pcf3 = crate::Reg<pcf3::Pcf3Spec>;
#[doc = "AFIO port configuration register 3"]
pub mod pcf3;
#[doc = "PCF4 (rw) register accessor: AFIO port configuration register 4\n\nYou can [`read`](crate::Reg::read) this register and get [`pcf4::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcf4::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcf4`] module"]
#[doc(alias = "PCF4")]
pub type Pcf4 = crate::Reg<pcf4::Pcf4Spec>;
#[doc = "AFIO port configuration register 4"]
pub mod pcf4;
#[doc = "PCF5 (rw) register accessor: AFIO port configuration register 5\n\nYou can [`read`](crate::Reg::read) this register and get [`pcf5::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcf5::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcf5`] module"]
#[doc(alias = "PCF5")]
