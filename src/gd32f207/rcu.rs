...
pub mod ahb2en;
#[doc = "ADDAPB2EN (rw) register accessor: APB2 additional enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`addapb2en::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addapb2en::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@addapb2en`] module"]
#[doc(alias = "ADDAPB2EN")]
...
pub mod ahb2rst;
#[doc = "ADDAPB2RST (rw) register accessor: APB2 additional enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`addapb2rst::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addapb2rst::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@addapb2rst`] module"]
...
pub mod cfg2;
#[doc = "PLLTCTL (rw) register accessor: PLLT control register\n\nYou can [`read`](crate::Reg::read) this register and get [`plltctl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`plltctl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@plltctl`] module"]
#[doc(alias = "PLLTCTL")]
pub type Plltctl = crate::Reg<plltctl::PlltctlSpec>;
#[doc = "PLLT control register"]
pub mod plltctl;
#[doc = "PLLTINT (rw) register accessor: PLLT interrupt register\n\nYou can [`read`](crate::Reg::read) this register and get [`plltint::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`plltint::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@plltint`] module"]
#[doc(alias = "PLLTINT")]
pub type Plltint = crate::Reg<plltint::PlltintSpec>;
#[doc = "PLLT interrupt register"]
pub mod plltint;
#[doc = "PLLTCFG (rw) register accessor: PLLT configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`plltcfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`plltcfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@plltcfg`] module"]
#[doc(alias = "PLLTCFG")]
