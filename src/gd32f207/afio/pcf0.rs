...
#[doc = "Field `ADC0_ETRGINS_REMAP` reader - ADC 0 external trigger inserted conversion remapping"]
pub type Adc0EtrginsRemapR = crate::BitReader;
#[doc = "Field `ADC0_ETRGINS_REMAP` writer - ADC 0 external trigger inserted conversion remapping"]
...
#[doc = "Field `ADC1_ETRGINS_REMAP` reader - ADC 1 external trigger inserted conversion remapping"]
pub type Adc1EtrginsRemapR = crate::BitReader;
#[doc = "Field `ADC1_ETRGINS_REMAP` writer - ADC 1 external trigger inserted conversion remapping"]
...
impl R {
    ...
    #[doc = "Bit 17 - ADC 0 external trigger inserted conversion remapping"]
    #[inline(always)]
    ...
    #[doc = "Bit 19 - ADC 1 external trigger inserted conversion remapping"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - SPI0 remapping"]
    #[inline(always)]
    pub fn spi0_remap(&mut self) -> Spi0RemapW<'_, Pcf0Spec> {
        Spi0RemapW::new(self, 0)
    }
    #[doc = "Bit 1 - I2C0 remapping"]
    #[inline(always)]
    pub fn i2c0_remap(&mut self) -> I2c0RemapW<'_, Pcf0Spec> {
        I2c0RemapW::new(self, 1)
    }
    #[doc = "Bit 2 - USART0 remapping"]
    #[inline(always)]
    pub fn usart0_remap(&mut self) -> Usart0RemapW<'_, Pcf0Spec> {
        Usart0RemapW::new(self, 2)
    }
    #[doc = "Bit 3 - USART1 remapping"]
    #[inline(always)]
    pub fn usart1_remap(&mut self) -> Usart1RemapW<'_, Pcf0Spec> {
        Usart1RemapW::new(self, 3)
    }
    #[doc = "Bits 4:5 - USART2 remapping"]
    #[inline(always)]
    pub fn usart2_remap(&mut self) -> Usart2RemapW<'_, Pcf0Spec> {
        Usart2RemapW::new(self, 4)
    }
    #[doc = "Bits 6:7 - TIMER0 remapping"]
    #[inline(always)]
    pub fn timer0_remap(&mut self) -> Timer0RemapW<'_, Pcf0Spec> {
        Timer0RemapW::new(self, 6)
    }
    #[doc = "Bits 8:9 - TIMER1 remapping"]
    #[inline(always)]
    pub fn timer1_remap(&mut self) -> Timer1RemapW<'_, Pcf0Spec> {
        Timer1RemapW::new(self, 8)
    }
    #[doc = "Bits 10:11 - TIMER2 remapping"]
    #[inline(always)]
    pub fn timer2_remap(&mut self) -> Timer2RemapW<'_, Pcf0Spec> {
        Timer2RemapW::new(self, 10)
    }
    #[doc = "Bit 12 - TIMER3 remapping"]
    #[inline(always)]
    pub fn timer3_remap(&mut self) -> Timer3RemapW<'_, Pcf0Spec> {
        Timer3RemapW::new(self, 12)
    }
    #[doc = "Bits 13:14 - CAN0 alternate interface remapping"]
    #[inline(always)]
    pub fn can0_remap(&mut self) -> Can0RemapW<'_, Pcf0Spec> {
        Can0RemapW::new(self, 13)
    }
    #[doc = "Bit 15 - Port D0/Port D1 mapping on OSC_IN/OSC_OUT"]
    #[inline(always)]
    pub fn pd01_remap(&mut self) -> Pd01RemapW<'_, Pcf0Spec> {
        Pd01RemapW::new(self, 15)
    }
    #[doc = "Bit 16 - TIMER4 channel3 internal remapping"]
    #[inline(always)]
    pub fn timer4ch3_iremap(&mut self) -> Timer4ch3IremapW<'_, Pcf0Spec> {
        Timer4ch3IremapW::new(self, 16)
    }
    #[doc = "Bit 17 - ADC 0 external trigger inserted conversion remapping"]
    #[inline(always)]
    pub fn adc0_etrgins_remap(&mut self) -> Adc0EtrginsRemapW<'_, Pcf0Spec> {
        Adc0EtrginsRemapW::new(self, 17)
    }
    #[doc = "Bit 18 - ADC 0 external trigger regular conversion remapping"]
    #[inline(always)]
    pub fn adc0_etrgreg_remap(&mut self) -> Adc0EtrgregRemapW<'_, Pcf0Spec> {
        Adc0EtrgregRemapW::new(self, 18)
    }
    #[doc = "Bit 19 - ADC 1 external trigger inserted conversion remapping"]
    #[inline(always)]
    pub fn adc1_etrgins_remap(&mut self) -> Adc1EtrginsRemapW<'_, Pcf0Spec> {
        Adc1EtrginsRemapW::new(self, 19)
    }
    #[doc = "Bit 20 - ADC 1 external trigger regular conversion remapping"]
    #[inline(always)]
    pub fn adc1_etrgreg_remap(&mut self) -> Adc1EtrgregRemapW<'_, Pcf0Spec> {
        Adc1EtrgregRemapW::new(self, 20)
    }
    #[doc = "Bit 21 - Ethernet MAC I/O remapping"]
    #[inline(always)]
    pub fn enet_remap(&mut self) -> EnetRemapW<'_, Pcf0Spec> {
        EnetRemapW::new(self, 21)
    }
    #[doc = "Bit 22 - CAN1 I/O remapping"]
    #[inline(always)]
    pub fn can1_remap(&mut self) -> Can1RemapW<'_, Pcf0Spec> {
        Can1RemapW::new(self, 22)
    }
    #[doc = "Bit 23 - Ethernet MII or RMII PHY selection"]
    #[inline(always)]
    pub fn enet_phy_sel(&mut self) -> EnetPhySelW<'_, Pcf0Spec> {
        EnetPhySelW::new(self, 23)
    }
    #[doc = "Bits 24:26 - Serial wire JTAG configuration"]
    #[inline(always)]
    pub fn swj_cfg(&mut self) -> SwjCfgW<'_, Pcf0Spec> {
        SwjCfgW::new(self, 24)
    }
    #[doc = "Bit 28 - SPI2/I2S2 remapping"]
    #[inline(always)]
    pub fn spi2_remap(&mut self) -> Spi2RemapW<'_, Pcf0Spec> {
        Spi2RemapW::new(self, 28)
    }
    #[doc = "Bit 29 - TIMER1 internal trigger 0 remapping"]
    #[inline(always)]
    pub fn timer1itr0_remap(&mut self) -> Timer1itr0RemapW<'_, Pcf0Spec> {
        Timer1itr0RemapW::new(self, 29)
    }
    #[doc = "Bit 30 - Ethernet PTP PPS remapping"]
    #[inline(always)]
    pub fn ptp_pps_remap(&mut self) -> PtpPpsRemapW<'_, Pcf0Spec> {
