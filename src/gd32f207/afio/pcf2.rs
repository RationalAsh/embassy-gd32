...
impl W {
    #[doc = "Bits 0:1 - DCI_VSYNC remapping"]
    #[inline(always)]
    pub fn dci_vsync_remap(&mut self) -> DciVsyncRemapW<'_, Pcf2Spec> {
        DciVsyncRemapW::new(self, 0)
    }
    #[doc = "Bits 2:3 - DCI_D0 remapping"]
    #[inline(always)]
    pub fn dci_d0_remap(&mut self) -> DciD0RemapW<'_, Pcf2Spec> {
        DciD0RemapW::new(self, 2)
    }
    #[doc = "Bits 4:5 - DCI_D1 remapping"]
    #[inline(always)]
    pub fn dci_d1_remap(&mut self) -> DciD1RemapW<'_, Pcf2Spec> {
        DciD1RemapW::new(self, 4)
    }
    #[doc = "Bits 6:7 - DCI_D2 remapping"]
    #[inline(always)]
    pub fn dci_d2_remap(&mut self) -> DciD2RemapW<'_, Pcf2Spec> {
        DciD2RemapW::new(self, 6)
    }
    #[doc = "Bits 8:9 - DCI_D3 remapping"]
    #[inline(always)]
    pub fn dci_d3_remap(&mut self) -> DciD3RemapW<'_, Pcf2Spec> {
        DciD3RemapW::new(self, 8)
    }
    #[doc = "Bits 10:11 - DCI_D4 remapping"]
    #[inline(always)]
    pub fn dci_d4_remap(&mut self) -> DciD4RemapW<'_, Pcf2Spec> {
        DciD4RemapW::new(self, 10)
    }
    #[doc = "Bits 12:13 - DCI_D5 remapping"]
    #[inline(always)]
    pub fn dci_d5_remap(&mut self) -> DciD5RemapW<'_, Pcf2Spec> {
        DciD5RemapW::new(self, 12)
    }
    #[doc = "Bits 14:15 - DCI_D6 remapping"]
    #[inline(always)]
    pub fn dci_d6_remap(&mut self) -> DciD6RemapW<'_, Pcf2Spec> {
        DciD6RemapW::new(self, 14)
    }
    #[doc = "Bits 16:17 - DCI_D7 remapping"]
    #[inline(always)]
    pub fn dci_d7_remap(&mut self) -> DciD7RemapW<'_, Pcf2Spec> {
        DciD7RemapW::new(self, 16)
    }
    #[doc = "Bits 18:19 - DCI_D8 remapping"]
    #[inline(always)]
    pub fn dci_d8_remap(&mut self) -> DciD8RemapW<'_, Pcf2Spec> {
        DciD8RemapW::new(self, 18)
    }
    #[doc = "Bits 20:21 - DCI_D9 remapping"]
    #[inline(always)]
    pub fn dci_d9_remap(&mut self) -> DciD9RemapW<'_, Pcf2Spec> {
        DciD9RemapW::new(self, 20)
    }
    #[doc = "Bits 22:23 - DCI_D10 remapping"]
    #[inline(always)]
    pub fn dci_d10_remap(&mut self) -> DciD10RemapW<'_, Pcf2Spec> {
        DciD10RemapW::new(self, 22)
    }
    #[doc = "Bits 24:25 - DCI_D11 remapping"]
    #[inline(always)]
    pub fn dci_d11_remap(&mut self) -> DciD11RemapW<'_, Pcf2Spec> {
        DciD11RemapW::new(self, 24)
    }
    #[doc = "Bit 26 - DCI_D12 remapping"]
    #[inline(always)]
    pub fn dci_d12_remap(&mut self) -> DciD12RemapW<'_, Pcf2Spec> {
        DciD12RemapW::new(self, 26)
    }
    #[doc = "Bits 27:28 - DCI_D13 remapping"]
    #[inline(always)]
    pub fn dci_d13_remap(&mut self) -> DciD13RemapW<'_, Pcf2Spec> {
        DciD13RemapW::new(self, 27)
    }
    #[doc = "Bit 29 - DCI_HSYNC remapping"]
    #[inline(always)]
    pub fn dci_hsync_remap(&mut self) -> DciHsyncRemapW<'_, Pcf2Spec> {
        DciHsyncRemapW::new(self, 29)
    }
    #[doc = "Bit 31 - PH0/PH1 remapping"]
    #[inline(always)]
    pub fn ph01_remap(&mut self) -> Ph01RemapW<'_, Pcf2Spec> {
        Ph01RemapW::new(self, 31)
    }
}
#[doc = "AFIO port configuration register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`pcf2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcf2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pcf2Spec;
