...
impl W {
    #[doc = "Bit 0 - I2C2 remapping 0"]
    #[inline(always)]
    pub fn i2c2_remap0(&mut self) -> I2c2Remap0W<'_, Pcf5Spec> {
        I2c2Remap0W::new(self, 0)
    }
    #[doc = "Bit 1 - I2C2 remapping 1"]
    #[inline(always)]
    pub fn i2c2_remap1(&mut self) -> I2c2Remap1W<'_, Pcf5Spec> {
        I2c2Remap1W::new(self, 1)
    }
    #[doc = "Bit 2 - TIMER1_CH0 remapping"]
    #[inline(always)]
    pub fn timer1_ch0_remap(&mut self) -> Timer1Ch0RemapW<'_, Pcf5Spec> {
        Timer1Ch0RemapW::new(self, 2)
    }
    #[doc = "Bit 3 - TIMER4 remapping"]
    #[inline(always)]
    pub fn timer4_remap(&mut self) -> Timer4RemapW<'_, Pcf5Spec> {
        Timer4RemapW::new(self, 3)
    }
    #[doc = "Bits 4:5 - TIMER7_CHON remapping"]
    #[inline(always)]
    pub fn timer7_chon_remap(&mut self) -> Timer7ChonRemapW<'_, Pcf5Spec> {
        Timer7ChonRemapW::new(self, 4)
    }
    #[doc = "Bit 6 - TIMER7_CH remapping"]
    #[inline(always)]
    pub fn timer7_ch_remap(&mut self) -> Timer7ChRemapW<'_, Pcf5Spec> {
        Timer7ChRemapW::new(self, 6)
    }
    #[doc = "Bits 7:8 - I2C1 remapping"]
    #[inline(always)]
    pub fn i2c1_remap(&mut self) -> I2c1RemapW<'_, Pcf5Spec> {
        I2c1RemapW::new(self, 7)
    }
    #[doc = "Bits 9:10 - SPI1_NSCK remapping"]
    #[inline(always)]
    pub fn spi1_nsck_remap(&mut self) -> Spi1NsckRemapW<'_, Pcf5Spec> {
        Spi1NsckRemapW::new(self, 9)
    }
    #[doc = "Bits 11:12 - SPI1_IO remapping"]
    #[inline(always)]
    pub fn spi1_io_remap(&mut self) -> Spi1IoRemapW<'_, Pcf5Spec> {
        Spi1IoRemapW::new(self, 11)
    }
    #[doc = "Bit 13 - UART3 remapping"]
    #[inline(always)]
    pub fn uart3_remap(&mut self) -> Uart3RemapW<'_, Pcf5Spec> {
        Uart3RemapW::new(self, 13)
    }
    #[doc = "Bit 14 - TIMER11 remapping"]
    #[inline(always)]
    pub fn timer11_remap(&mut self) -> Timer11RemapW<'_, Pcf5Spec> {
        Timer11RemapW::new(self, 14)
    }
    #[doc = "Bit 15 - CAN0_ADD remapping"]
    #[inline(always)]
    pub fn can0_add_remap(&mut self) -> Can0AddRemapW<'_, Pcf5Spec> {
        Can0AddRemapW::new(self, 15)
    }
    #[doc = "Bit 16 - ENET _TXD3 remapping"]
    #[inline(always)]
    pub fn enet_txd3_remap(&mut self) -> EnetTxd3RemapW<'_, Pcf5Spec> {
        EnetTxd3RemapW::new(self, 16)
    }
    #[doc = "Bit 17 - PPS_HI remapping"]
    #[inline(always)]
    pub fn pps_hi_remap(&mut self) -> PpsHiRemapW<'_, Pcf5Spec> {
        PpsHiRemapW::new(self, 17)
    }
    #[doc = "Bit 18 - ENET_TXD01 remapping"]
    #[inline(always)]
    pub fn enet_txd01_remap(&mut self) -> EnetTxd01RemapW<'_, Pcf5Spec> {
        EnetTxd01RemapW::new(self, 18)
    }
    #[doc = "Bit 19 - ENET_CRSCOL remapping"]
    #[inline(always)]
    pub fn enet_crscol_remap(&mut self) -> EnetCrscolRemapW<'_, Pcf5Spec> {
        EnetCrscolRemapW::new(self, 19)
    }
    #[doc = "Bit 20 - ENET _RX_HI remapping"]
    #[inline(always)]
    pub fn enet_rx_hi_remap(&mut self) -> EnetRxHiRemapW<'_, Pcf5Spec> {
        EnetRxHiRemapW::new(self, 20)
    }
    #[doc = "Bit 21 - UART6 remapping"]
    #[inline(always)]
    pub fn uart6_remap(&mut self) -> Uart6RemapW<'_, Pcf5Spec> {
        Uart6RemapW::new(self, 21)
    }
    #[doc = "Bit 22 - USART5_CK remapping"]
    #[inline(always)]
    pub fn usart5_ck_remap(&mut self) -> Usart5CkRemapW<'_, Pcf5Spec> {
        Usart5CkRemapW::new(self, 22)
    }
    #[doc = "Bit 23 - USART5_RTS remapping"]
    #[inline(always)]
    pub fn usart5_rts_remap(&mut self) -> Usart5RtsRemapW<'_, Pcf5Spec> {
        Usart5RtsRemapW::new(self, 23)
    }
    #[doc = "Bit 24 - USART5_CTS remapping"]
    #[inline(always)]
    pub fn usart5_cts_remap(&mut self) -> Usart5CtsRemapW<'_, Pcf5Spec> {
        Usart5CtsRemapW::new(self, 24)
    }
    #[doc = "Bit 25 - USART5_TX remapping"]
    #[inline(always)]
    pub fn usart5_tx_remap(&mut self) -> Usart5TxRemapW<'_, Pcf5Spec> {
        Usart5TxRemapW::new(self, 25)
    }
    #[doc = "Bit 26 - USART5_RX remapping"]
    #[inline(always)]
    pub fn usart5_rx_remap(&mut self) -> Usart5RxRemapW<'_, Pcf5Spec> {
        Usart5RxRemapW::new(self, 26)
    }
    #[doc = "Bit 27 - EXMC_SDNWE remapping"]
    #[inline(always)]
    pub fn exmc_sdnwe_remap(&mut self) -> ExmcSdnweRemapW<'_, Pcf5Spec> {
        ExmcSdnweRemapW::new(self, 27)
    }
    #[doc = "Bit 28 - EXMC_SDCKE0 remapping"]
    #[inline(always)]
    pub fn exmc_sdcke0_remap(&mut self) -> ExmcSdcke0RemapW<'_, Pcf5Spec> {
        ExmcSdcke0RemapW::new(self, 28)
    }
    #[doc = "Bit 29 - EXMC_SDCKE1 remapping"]
    #[inline(always)]
    pub fn exmc_sdcke1_remap(&mut self) -> ExmcSdcke1RemapW<'_, Pcf5Spec> {
        ExmcSdcke1RemapW::new(self, 29)
    }
    #[doc = "Bit 30 - EXMC_SDNE0 remapping"]
    #[inline(always)]
    pub fn exmc_sdne0_remap(&mut self) -> ExmcSdne0RemapW<'_, Pcf5Spec> {
        ExmcSdne0RemapW::new(self, 30)
    }
    #[doc = "Bit 31 - EXMC_SDNE1 remapping"]
    #[inline(always)]
    pub fn exmc_sdne1_remap(&mut self) -> ExmcSdne1RemapW<'_, Pcf5Spec> {
        ExmcSdne1RemapW::new(self, 31)
    }
}
#[doc = "AFIO port configuration register 5\n\nYou can [`read`](crate::Reg::read) this register and get [`pcf5::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcf5::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pcf5Spec;
