...
impl W {
    #[doc = "Bit 0 - Tamper0 event reset"]
    #[inline(always)]
    pub fn ter0(&mut self) -> Ter0W<'_, TpcsSpec> {
        Ter0W::new(self, 0)
    }
    #[doc = "Bit 1 - Tamper0 interrupt reset"]
    #[inline(always)]
    pub fn tir0(&mut self) -> Tir0W<'_, TpcsSpec> {
        Tir0W::new(self, 1)
    }
    #[doc = "Bit 2 - Tamper0 interrupt enable"]
    #[inline(always)]
    pub fn tpie0(&mut self) -> Tpie0W<'_, TpcsSpec> {
        Tpie0W::new(self, 2)
    }
    #[doc = "Bit 5 - Tamper1 event reset"]
    #[inline(always)]
    pub fn ter1(&mut self) -> Ter1W<'_, TpcsSpec> {
        Ter1W::new(self, 5)
    }
    #[doc = "Bit 6 - Tamper1 interrupt reset"]
    #[inline(always)]
    pub fn tir1(&mut self) -> Tir1W<'_, TpcsSpec> {
        Tir1W::new(self, 6)
    }
    #[doc = "Bit 7 - Tamper1interrupt enable"]
    #[inline(always)]
    pub fn tpie1(&mut self) -> Tpie1W<'_, TpcsSpec> {
        Tpie1W::new(self, 7)
    }
    #[doc = "Bit 8 - Tamper0 event flag"]
    #[inline(always)]
    pub fn tef0(&mut self) -> Tef0W<'_, TpcsSpec> {
        Tef0W::new(self, 8)
    }
    #[doc = "Bit 9 - Tamper0 interrupt flag"]
    #[inline(always)]
    pub fn tif0(&mut self) -> Tif0W<'_, TpcsSpec> {
        Tif0W::new(self, 9)
    }
    #[doc = "Bit 14 - Tamper1 event flag"]
    #[inline(always)]
    pub fn tef1(&mut self) -> Tef1W<'_, TpcsSpec> {
        Tef1W::new(self, 14)
    }
    #[doc = "Bit 15 - Tamper1 interrupt flag"]
    #[inline(always)]
    pub fn tif1(&mut self) -> Tif1W<'_, TpcsSpec> {
        Tif1W::new(self, 15)
    }
}
