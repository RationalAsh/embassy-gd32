...
impl W {
    #[doc = "Bit 8 - TAMPER1 detection enable"]
    #[inline(always)]
    pub fn tpen1(&mut self) -> Tpen1W<'_, Tpctl1Spec> {
        Tpen1W::new(self, 8)
    }
    #[doc = "Bit 9 - TAMPER1 pin active level"]
    #[inline(always)]
    pub fn tpal1(&mut self) -> Tpal1W<'_, Tpctl1Spec> {
        Tpal1W::new(self, 9)
    }
    #[doc = "Bit 14 - The second waveform detection enable"]
    #[inline(always)]
    pub fn tpm2(&mut self) -> Tpm2W<'_, Tpctl1Spec> {
        Tpm2W::new(self, 14)
    }
    #[doc = "Bit 15 - The first waveform detection enable"]
    #[inline(always)]
    pub fn tpm1(&mut self) -> Tpm1W<'_, Tpctl1Spec> {
        Tpm1W::new(self, 15)
    }
}
#[doc = "Tamper pin control register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`tpctl1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tpctl1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
