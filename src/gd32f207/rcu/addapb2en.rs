...
impl W {
    #[doc = "Bit 24 - USART5 clock enable"]
    #[inline(always)]
    pub fn usart5en(&mut self) -> Usart5enW<'_, Addapb2enSpec> {
        Usart5enW::new(self, 24)
    }
    #[doc = "Bit 26 - TLI clock enable"]
    #[inline(always)]
    pub fn tlien(&mut self) -> TlienW<'_, Addapb2enSpec> {
        TlienW::new(self, 26)
    }
    #[doc = "Bit 30 - GPIO port H clock enable"]
    #[inline(always)]
    pub fn phen(&mut self) -> PhenW<'_, Addapb2enSpec> {
        PhenW::new(self, 30)
    }
    #[doc = "Bit 31 - GPIO port I clock enable"]
    #[inline(always)]
    pub fn pien(&mut self) -> PienW<'_, Addapb2enSpec> {
        PienW::new(self, 31)
    }
}
#[doc = "APB2 additional enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`addapb2en::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addapb2en::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
