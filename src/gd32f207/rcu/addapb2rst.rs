...
impl W {
    #[doc = "Bit 24 - USART5 reset"]
    #[inline(always)]
    pub fn usart5rst(&mut self) -> Usart5rstW<'_, Addapb2rstSpec> {
        Usart5rstW::new(self, 24)
    }
    #[doc = "Bit 26 - TLI reset"]
    #[inline(always)]
    pub fn tlirst(&mut self) -> TlirstW<'_, Addapb2rstSpec> {
        TlirstW::new(self, 26)
    }
    #[doc = "Bit 30 - GPIO port H reset"]
    #[inline(always)]
    pub fn phrst(&mut self) -> PhrstW<'_, Addapb2rstSpec> {
        PhrstW::new(self, 30)
    }
    #[doc = "Bit 31 - GPIO port I reset"]
    #[inline(always)]
    pub fn pirst(&mut self) -> PirstW<'_, Addapb2rstSpec> {
        PirstW::new(self, 31)
    }
}
#[doc = "APB2 additional enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`addapb2rst::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addapb2rst::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
