...
impl W {
    #[doc = "Bits 0:5 - PLLT prescaler selection"]
    #[inline(always)]
    pub fn plltpsc(&mut self) -> PlltpscW<'_, PlltcfgSpec> {
        PlltpscW::new(self, 0)
    }
    #[doc = "Bits 6:14 - PLLT multiply factor for VCO"]
    #[inline(always)]
    pub fn plltmf(&mut self) -> PlltmfW<'_, PlltcfgSpec> {
        PlltmfW::new(self, 6)
    }
    #[doc = "Bits 16:17 - TLI prescaler selection"]
    #[inline(always)]
    pub fn tlipsc(&mut self) -> TlipscW<'_, PlltcfgSpec> {
        TlipscW::new(self, 16)
    }
    #[doc = "Bits 28:30 - PLLTR prescaler selection"]
    #[inline(always)]
    pub fn plltrpsc(&mut self) -> PlltrpscW<'_, PlltcfgSpec> {
        PlltrpscW::new(self, 28)
    }
    #[doc = "Bit 31 - PLLT clock source select"]
    #[inline(always)]
    pub fn plltsel(&mut self) -> PlltselW<'_, PlltcfgSpec> {
        PlltselW::new(self, 31)
    }
}
#[doc = "PLLT configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`plltcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`plltcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
