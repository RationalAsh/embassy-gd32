...
impl W {
    #[doc = "Bits 0:7 - Data byte 0"]
    #[inline(always)]
    pub fn db0(&mut self) -> Db0W<'_, Tmdata01Spec> {
        Db0W::new(self, 0)
    }
    #[doc = "Bits 8:15 - Data byte 1"]
    #[inline(always)]
    pub fn db1(&mut self) -> Db1W<'_, Tmdata01Spec> {
        Db1W::new(self, 8)
    }
    #[doc = "Bits 16:23 - Data byte 2"]
    #[inline(always)]
    pub fn db2(&mut self) -> Db2W<'_, Tmdata01Spec> {
        Db2W::new(self, 16)
    }
    #[doc = "Bits 24:31 - Data byte 3"]
    #[inline(always)]
    pub fn db3(&mut self) -> Db3W<'_, Tmdata01Spec> {
        Db3W::new(self, 24)
    }
}
