...
impl W {
    #[doc = "Bits 0:31 - The initialization vector for DES,TDES,AES"]
    #[inline(always)]
    pub fn iv1l(&mut self) -> Iv1lW<'_, Iv1lSpec> {
        Iv1lW::new(self, 0)
    }
}
#[doc = "CAU initialization register\n\nYou can [`read`](crate::Reg::read) this register and get [`iv1l::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`iv1l::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Iv1lSpec;
