...
impl W {
    #[doc = "Bit 2 - CAU direction"]
    #[inline(always)]
    pub fn caudir(&mut self) -> CaudirW<'_, CtlSpec> {
        CaudirW::new(self, 2)
    }
    #[doc = "Bits 3:5 - Encryption/decryption algorithm mode"]
    #[inline(always)]
    pub fn algm(&mut self) -> AlgmW<'_, CtlSpec> {
        AlgmW::new(self, 3)
    }
    #[doc = "Bits 6:7 - Data swapping type mode configuration"]
    #[inline(always)]
    ...
    #[doc = "Bits 8:9 - AES key size mode configuration"]
    #[inline(always)]
    pub fn keym(&mut self) -> KeymW<'_, CtlSpec> {
        KeymW::new(self, 8)
    }
    #[doc = "Bit 14 - FIFO flush"]
    #[inline(always)]
    pub fn fflush(&mut self) -> FflushW<'_, CtlSpec> {
        FflushW::new(self, 14)
    }
    #[doc = "Bit 15 - Cryptographic module enable"]
    #[inline(always)]
    pub fn cauen(&mut self) -> CauenW<'_, CtlSpec> {
        CauenW::new(self, 15)
    }
}
