...
impl W {
    ...
    #[inline(always)]
    pub fn key0l(&mut self) -> Key0lW<'_, Key0lSpec> {
        Key0lW::new(self, 0)
    }
}
#[doc = "CAU key register\n\nYou can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`key0l::W`](W). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
