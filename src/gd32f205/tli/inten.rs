...
impl W {
    #[doc = "Bit 0 - Line Mark Interrupt Enable"]
    #[inline(always)]
    pub fn lmie(&mut self) -> LmieW<'_, IntenSpec> {
        LmieW::new(self, 0)
    }
    #[doc = "Bit 1 - FIFO Error Interrupt Enable"]
    #[inline(always)]
    pub fn feie(&mut self) -> FeieW<'_, IntenSpec> {
        FeieW::new(self, 1)
    }
    #[doc = "Bit 2 - Transaction Error Interrupt Enable"]
    #[inline(always)]
    pub fn teie(&mut self) -> TeieW<'_, IntenSpec> {
        TeieW::new(self, 2)
    }
    #[doc = "Bit 3 - Layer Configuration Reloaded Interrupt Enable"]
    #[inline(always)]
    pub fn lcrie(&mut self) -> LcrieW<'_, IntenSpec> {
        LcrieW::new(self, 3)
    }
}
