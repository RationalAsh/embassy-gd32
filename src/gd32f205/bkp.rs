...
pub mod octl;
#[doc = "TPCTL0 (rw) register accessor: Tamper pin control register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`tpctl0::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tpctl0::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tpctl0`] module"]
#[doc(alias = "TPCTL0")]
pub type Tpctl0 = crate::Reg<tpctl0::Tpctl0Spec>;
#[doc = "Tamper pin control register 0"]
pub mod tpctl0;
#[doc = "TPCS (rw) register accessor: Tamper control and status register\n\nYou can [`read`](crate::Reg::read) this register and get [`tpcs::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tpcs::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tpcs`] module"]
#[doc(alias = "TPCS")]
pub type Tpcs = crate::Reg<tpcs::TpcsSpec>;
#[doc = "Tamper control and status register"]
pub mod tpcs;
#[doc = "TPCTL1 (rw) register accessor: Tamper pin control register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`tpctl1::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`tpctl1::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@tpctl1`] module"]
#[doc(alias = "TPCTL1")]
