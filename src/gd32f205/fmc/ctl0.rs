...
impl W {
    #[doc = "Bit 0 - Main flash program for bank0 command bit"]
    #[inline(always)]
    pub fn pg(&mut self) -> PgW<'_, Ctl0Spec> {
        PgW::new(self, 0)
    }
    #[doc = "Bit 1 - Main flash page erase for bank0 command bit"]
    #[inline(always)]
    pub fn per(&mut self) -> PerW<'_, Ctl0Spec> {
        PerW::new(self, 1)
    }
    #[doc = "Bit 2 - Main flash mass erase for bank0 command bit"]
    #[inline(always)]
    pub fn mer(&mut self) -> MerW<'_, Ctl0Spec> {
        MerW::new(self, 2)
    }
    #[doc = "Bit 4 - Option byte programming"]
    #[inline(always)]
    pub fn obpg(&mut self) -> ObpgW<'_, Ctl0Spec> {
        ObpgW::new(self, 4)
    }
    #[doc = "Bit 5 - Option byte erase"]
    #[inline(always)]
    pub fn ober(&mut self) -> OberW<'_, Ctl0Spec> {
        OberW::new(self, 5)
    }
    #[doc = "Bit 6 - Send erase command to FMC bit"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - FMC_CTL0 lock bit"]
    #[inline(always)]
    pub fn lk(&mut self) -> LkW<'_, Ctl0Spec> {
        LkW::new(self, 7)
    }
    #[doc = "Bit 9 - Option byte erase/program enable bit"]
    #[inline(always)]
    pub fn obwen(&mut self) -> ObwenW<'_, Ctl0Spec> {
        ObwenW::new(self, 9)
    }
    #[doc = "Bit 10 - Error interrupt enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 12 - End of operation interrupt enable"]
    #[inline(always)]
    pub fn endie(&mut self) -> EndieW<'_, Ctl0Spec> {
        EndieW::new(self, 12)
    }
}
