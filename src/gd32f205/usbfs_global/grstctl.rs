...
#[doc = "Field `AHBMIDL` reader - AHB master idle"]
pub type AhbmidlR = crate::BitReader;
impl R {
    ...
    #[inline(always)]
    pub fn ahbmidl(&self) -> AhbmidlR {
        AhbmidlR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Core soft reset"]
    ...
    #[doc = "Bit 1 - HCLK soft reset"]
    #[inline(always)]
    pub fn hcsrst(&mut self) -> HcsrstW<'_, GrstctlSpec> {
        HcsrstW::new(self, 1)
    }
    #[doc = "Bit 2 - Host frame counter reset"]
    #[inline(always)]
    pub fn hfcrst(&mut self) -> HfcrstW<'_, GrstctlSpec> {
        HfcrstW::new(self, 2)
    }
    #[doc = "Bit 4 - RxFIFO flush"]
    #[inline(always)]
    pub fn rxff(&mut self) -> RxffW<'_, GrstctlSpec> {
        RxffW::new(self, 4)
    }
    #[doc = "Bit 5 - TxFIFO flush"]
    #[inline(always)]
    pub fn txff(&mut self) -> TxffW<'_, GrstctlSpec> {
        TxffW::new(self, 5)
    }
    #[doc = "Bits 6:10 - TxFIFO number"]
    #[inline(always)]
