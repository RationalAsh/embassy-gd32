...
impl W {
    #[doc = "Bit 0 - TLI_B5_PA3 remapping"]
    #[inline(always)]
    pub fn tli_b5_pa3_remap(&mut self) -> TliB5Pa3RemapW<'_, Pcf3Spec> {
        TliB5Pa3RemapW::new(self, 0)
    }
    #[doc = "Bit 1 - TLI_VSYNC_PA4 remapping"]
    #[inline(always)]
    pub fn tli_vsync_pa4_remap(&mut self) -> TliVsyncPa4RemapW<'_, Pcf3Spec> {
        TliVsyncPa4RemapW::new(self, 1)
    }
    #[doc = "Bit 2 - TLI_G2_PA6 remapping"]
    #[inline(always)]
    pub fn tli_g2_pa6_remap(&mut self) -> TliG2Pa6RemapW<'_, Pcf3Spec> {
        TliG2Pa6RemapW::new(self, 2)
    }
    #[doc = "Bit 3 - TLI_R6_PA8 remapping"]
    #[inline(always)]
    pub fn tli_r6_pa8_remap(&mut self) -> TliR6Pa8RemapW<'_, Pcf3Spec> {
        TliR6Pa8RemapW::new(self, 3)
    }
    #[doc = "Bit 4 - TLI_R4_PA11 remapping"]
    #[inline(always)]
    pub fn tli_r4_pa11_remap(&mut self) -> TliR4Pa11RemapW<'_, Pcf3Spec> {
        TliR4Pa11RemapW::new(self, 4)
    }
    #[doc = "Bit 5 - TLI_R5_PA12 remapping"]
    #[inline(always)]
    pub fn tli_r5_pa12_remap(&mut self) -> TliR5Pa12RemapW<'_, Pcf3Spec> {
        TliR5Pa12RemapW::new(self, 5)
    }
    #[doc = "Bit 6 - TLI_R3_PB0 remapping"]
    #[inline(always)]
    pub fn tli_r3_pb0_remap(&mut self) -> TliR3Pb0RemapW<'_, Pcf3Spec> {
        TliR3Pb0RemapW::new(self, 6)
    }
    #[doc = "Bit 7 - TLI_R6_PB1 remapping"]
    #[inline(always)]
    pub fn tli_r6_pb1_remap(&mut self) -> TliR6Pb1RemapW<'_, Pcf3Spec> {
        TliR6Pb1RemapW::new(self, 7)
    }
    #[doc = "Bit 8 - TLI_B6_PB8 remapping"]
    #[inline(always)]
    pub fn tli_b6_pb8_remap(&mut self) -> TliB6Pb8RemapW<'_, Pcf3Spec> {
        TliB6Pb8RemapW::new(self, 8)
    }
    #[doc = "Bit 9 - TLI_B7_PB9 remapping"]
    #[inline(always)]
    pub fn tli_b7_pb9_remap(&mut self) -> TliB7Pb9RemapW<'_, Pcf3Spec> {
        TliB7Pb9RemapW::new(self, 9)
    }
    #[doc = "Bit 10 - TLI_G4_PB10 remapping"]
    #[inline(always)]
    pub fn tli_g4_pb10_remap(&mut self) -> TliG4Pb10RemapW<'_, Pcf3Spec> {
        TliG4Pb10RemapW::new(self, 10)
    }
    #[doc = "Bit 11 - TLI_G5_PB11 remapping"]
    #[inline(always)]
    pub fn tli_g5_pb11_remap(&mut self) -> TliG5Pb11RemapW<'_, Pcf3Spec> {
        TliG5Pb11RemapW::new(self, 11)
    }
    #[doc = "Bit 12 - TLI_HSYNC_PC6 remapping"]
    #[inline(always)]
    pub fn tli_hsync_pc6_remap(&mut self) -> TliHsyncPc6RemapW<'_, Pcf3Spec> {
        TliHsyncPc6RemapW::new(self, 12)
    }
    #[doc = "Bit 13 - TLI_G6_PC7 remapping"]
    #[inline(always)]
    pub fn tli_g6_pc7_remap(&mut self) -> TliG6Pc7RemapW<'_, Pcf3Spec> {
        TliG6Pc7RemapW::new(self, 13)
    }
    #[doc = "Bit 14 - TLI_R2_PC10 remapping"]
    #[inline(always)]
    pub fn tli_r2_pc10_remap(&mut self) -> TliR2Pc10RemapW<'_, Pcf3Spec> {
        TliR2Pc10RemapW::new(self, 14)
    }
    #[doc = "Bit 15 - TLI_G7_PD3 remapping"]
    #[inline(always)]
    pub fn tli_g7_pd3_remap(&mut self) -> TliG7Pd3RemapW<'_, Pcf3Spec> {
        TliG7Pd3RemapW::new(self, 15)
    }
    #[doc = "Bit 16 - TLI_B2_PD6 remapping"]
    #[inline(always)]
    pub fn tli_b2_pd6_remap(&mut self) -> TliB2Pd6RemapW<'_, Pcf3Spec> {
        TliB2Pd6RemapW::new(self, 16)
    }
    #[doc = "Bit 17 - TLI_B3_PD10 remapping"]
    #[inline(always)]
    pub fn tli_b3_pd10_remap(&mut self) -> TliB3Pd10RemapW<'_, Pcf3Spec> {
        TliB3Pd10RemapW::new(self, 17)
    }
    #[doc = "Bit 18 - TLI_B0_PE4 remapping"]
    #[inline(always)]
    pub fn tli_b0_pe4_remap(&mut self) -> TliB0Pe4RemapW<'_, Pcf3Spec> {
        TliB0Pe4RemapW::new(self, 18)
    }
    #[doc = "Bit 19 - TLI_G0_PE5 remapping"]
    #[inline(always)]
    pub fn tli_g0_pe5_remap(&mut self) -> TliG0Pe5RemapW<'_, Pcf3Spec> {
        TliG0Pe5RemapW::new(self, 19)
    }
    #[doc = "Bit 20 - TLI_G1_PE6 remapping"]
    #[inline(always)]
    pub fn tli_g1_pe6_remap(&mut self) -> TliG1Pe6RemapW<'_, Pcf3Spec> {
        TliG1Pe6RemapW::new(self, 20)
    }
    #[doc = "Bit 21 - TLI_G3_PE11 remapping"]
    #[inline(always)]
    pub fn tli_g3_pe11_remap(&mut self) -> TliG3Pe11RemapW<'_, Pcf3Spec> {
        TliG3Pe11RemapW::new(self, 21)
    }
    #[doc = "Bit 22 - TLI_B4_PE12 remapping"]
    #[inline(always)]
    pub fn tli_b4_pe12_remap(&mut self) -> TliB4Pe12RemapW<'_, Pcf3Spec> {
        TliB4Pe12RemapW::new(self, 22)
    }
    #[doc = "Bit 23 - TLI_DE_PE13 remapping"]
    #[inline(always)]
    pub fn tli_de_pe13_remap(&mut self) -> TliDePe13RemapW<'_, Pcf3Spec> {
        TliDePe13RemapW::new(self, 23)
    }
    #[doc = "Bit 24 - TLI_CLK_PE14 remapping"]
    #[inline(always)]
    pub fn tli_clk_pe14_remap(&mut self) -> TliClkPe14RemapW<'_, Pcf3Spec> {
        TliClkPe14RemapW::new(self, 24)
    }
    #[doc = "Bit 25 - TLI_R7_PE15 remapping"]
    #[inline(always)]
    pub fn tli_r7_pe15_remap(&mut self) -> TliR7Pe15RemapW<'_, Pcf3Spec> {
        TliR7Pe15RemapW::new(self, 25)
    }
    #[doc = "Bit 26 - TLI_DE_PF10 remapping"]
    #[inline(always)]
    pub fn tli_de_pf10_remap(&mut self) -> TliDePf10RemapW<'_, Pcf3Spec> {
        TliDePf10RemapW::new(self, 26)
    }
    #[doc = "Bit 27 - TLI_R7_PG6 remapping"]
    #[inline(always)]
    pub fn tli_r7_pg6_remap(&mut self) -> TliR7Pg6RemapW<'_, Pcf3Spec> {
        TliR7Pg6RemapW::new(self, 27)
    }
    #[doc = "Bit 28 - TLI_CLK_PG7 remapping"]
    #[inline(always)]
    pub fn tli_clk_pg7_remap(&mut self) -> TliClkPg7RemapW<'_, Pcf3Spec> {
        TliClkPg7RemapW::new(self, 28)
    }
    #[doc = "Bit 29 - TLI_G3_PG10 remapping"]
    #[inline(always)]
    pub fn tli_g3_pg10_remap(&mut self) -> TliG3Pg10RemapW<'_, Pcf3Spec> {
        TliG3Pg10RemapW::new(self, 29)
    }
    #[doc = "Bit 30 - TLI_B2_PG10 remapping"]
    #[inline(always)]
    pub fn tli_b2_pg10_remap(&mut self) -> TliB2Pg10RemapW<'_, Pcf3Spec> {
        TliB2Pg10RemapW::new(self, 30)
    }
    #[doc = "Bit 31 - TLI_B3_PG11 remapping"]
    #[inline(always)]
    pub fn tli_b3_pg11_remap(&mut self) -> TliB3Pg11RemapW<'_, Pcf3Spec> {
        TliB3Pg11RemapW::new(self, 31)
    }
}
#[doc = "AFIO port configuration register 3\n\nYou can [`read`](crate::Reg::read) this register and get [`pcf3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcf3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pcf3Spec;
