...
impl W {
    #[doc = "Bit 0 - TLI_B4_PG12 remapping"]
    #[inline(always)]
    pub fn tli_b4_pg12_remap(&mut self) -> TliB4Pg12RemapW<'_, Pcf4Spec> {
        TliB4Pg12RemapW::new(self, 0)
    }
    #[doc = "Bit 1 - TLI_B1_PG12 remapping"]
    #[inline(always)]
    pub fn tli_b1_pg12_remap(&mut self) -> TliB1Pg12RemapW<'_, Pcf4Spec> {
        TliB1Pg12RemapW::new(self, 1)
    }
    #[doc = "Bit 2 - TLI_R0_PH2 remapping"]
    #[inline(always)]
    pub fn tli_r0_ph2_remap(&mut self) -> TliR0Ph2RemapW<'_, Pcf4Spec> {
        TliR0Ph2RemapW::new(self, 2)
    }
    #[doc = "Bit 3 - TLI_R1_PH3 remapping"]
    #[inline(always)]
    pub fn tli_r1_ph3_remap(&mut self) -> TliR1Ph3RemapW<'_, Pcf4Spec> {
        TliR1Ph3RemapW::new(self, 3)
    }
    #[doc = "Bit 4 - TLI_R2_PH8 remapping"]
    #[inline(always)]
    pub fn tli_r2_ph8_remap(&mut self) -> TliR2Ph8RemapW<'_, Pcf4Spec> {
        TliR2Ph8RemapW::new(self, 4)
    }
    #[doc = "Bit 5 - TLI_R3_PH9 remapping"]
    #[inline(always)]
    pub fn tli_r3_ph9_remap(&mut self) -> TliR3Ph9RemapW<'_, Pcf4Spec> {
        TliR3Ph9RemapW::new(self, 5)
    }
    #[doc = "Bit 6 - TLI_R4_PH10 remapping"]
    #[inline(always)]
    pub fn tli_r4_ph10_remap(&mut self) -> TliR4Ph10RemapW<'_, Pcf4Spec> {
        TliR4Ph10RemapW::new(self, 6)
    }
    #[doc = "Bit 7 - TLI_R5_PH11 remapping"]
    #[inline(always)]
    pub fn tli_r5_ph11_remap(&mut self) -> TliR5Ph11RemapW<'_, Pcf4Spec> {
        TliR5Ph11RemapW::new(self, 7)
    }
    #[doc = "Bit 8 - TLI_R6_PH12 remapping"]
    #[inline(always)]
    pub fn tli_r6_ph12_remap(&mut self) -> TliR6Ph12RemapW<'_, Pcf4Spec> {
        TliR6Ph12RemapW::new(self, 8)
    }
    #[doc = "Bit 9 - TLI_G2_PH13 remapping"]
    #[inline(always)]
    pub fn tli_g2_ph13_remap(&mut self) -> TliG2Ph13RemapW<'_, Pcf4Spec> {
        TliG2Ph13RemapW::new(self, 9)
    }
    #[doc = "Bit 10 - TLI_G3_PH14 remapping"]
    #[inline(always)]
    pub fn tli_g3_ph14_remap(&mut self) -> TliG3Ph14RemapW<'_, Pcf4Spec> {
        TliG3Ph14RemapW::new(self, 10)
    }
    #[doc = "Bit 11 - TLI_G4_PH15 remapping"]
    #[inline(always)]
    pub fn tli_g4_ph15_remap(&mut self) -> TliG4Ph15RemapW<'_, Pcf4Spec> {
        TliG4Ph15RemapW::new(self, 11)
    }
    #[doc = "Bit 12 - TLI_G5_PI0 remapping"]
    #[inline(always)]
    pub fn tli_g5_pi0_remap(&mut self) -> TliG5Pi0RemapW<'_, Pcf4Spec> {
        TliG5Pi0RemapW::new(self, 12)
    }
    #[doc = "Bit 13 - TLI_G6_PI1 remapping"]
    #[inline(always)]
    pub fn tli_g6_pi1_remap(&mut self) -> TliG6Pi1RemapW<'_, Pcf4Spec> {
        TliG6Pi1RemapW::new(self, 13)
    }
    #[doc = "Bit 14 - TLI_G7_PI2 remapping"]
    #[inline(always)]
    pub fn tli_g7_pi2_remap(&mut self) -> TliG7Pi2RemapW<'_, Pcf4Spec> {
        TliG7Pi2RemapW::new(self, 14)
    }
    #[doc = "Bit 15 - TLI_B4_PI4 remapping"]
    #[inline(always)]
    pub fn tli_b4_pi4_remap(&mut self) -> TliB4Pi4RemapW<'_, Pcf4Spec> {
        TliB4Pi4RemapW::new(self, 15)
    }
    #[doc = "Bit 16 - TLI_B5_PI5 remapping"]
    #[inline(always)]
    pub fn tli_b5_pi5_remap(&mut self) -> TliB5Pi5RemapW<'_, Pcf4Spec> {
        TliB5Pi5RemapW::new(self, 16)
    }
    #[doc = "Bit 17 - TLI_B6_PI6 remapping"]
    #[inline(always)]
    pub fn tli_b6_pi6_remap(&mut self) -> TliB6Pi6RemapW<'_, Pcf4Spec> {
        TliB6Pi6RemapW::new(self, 17)
    }
    #[doc = "Bit 18 - TLI_B7_PI7 remapping"]
    #[inline(always)]
    pub fn tli_b7_pi7_remap(&mut self) -> TliB7Pi7RemapW<'_, Pcf4Spec> {
        TliB7Pi7RemapW::new(self, 18)
    }
    #[doc = "Bit 19 - TLI_VSYNC_PI9 remapping"]
    #[inline(always)]
    pub fn tli_vsync_pi9_remap(&mut self) -> TliVsyncPi9RemapW<'_, Pcf4Spec> {
        TliVsyncPi9RemapW::new(self, 19)
    }
    #[doc = "Bit 20 - TLI_HSYNC_PI10 remapping"]
    #[inline(always)]
    pub fn tli_hsync_pi10_remap(&mut self) -> TliHsyncPi10RemapW<'_, Pcf4Spec> {
        TliHsyncPi10RemapW::new(self, 20)
    }
    #[doc = "Bit 21 - TLI_R0_PH4 remapping"]
    #[inline(always)]
    pub fn tli_r0_ph4_remap(&mut self) -> TliR0Ph4RemapW<'_, Pcf4Spec> {
        TliR0Ph4RemapW::new(self, 21)
    }
    #[doc = "Bit 22 - TLI_R1_PI3 remapping"]
    #[inline(always)]
    pub fn tli_r1_pi3_remap(&mut self) -> TliR1Pi3RemapW<'_, Pcf4Spec> {
        TliR1Pi3RemapW::new(self, 22)
    }
    #[doc = "Bit 23 - SPI1_SCK remapping"]
    #[inline(always)]
    pub fn spi1_sck_remap(&mut self) -> Spi1SckRemapW<'_, Pcf4Spec> {
        Spi1SckRemapW::new(self, 23)
    }
    #[doc = "Bit 24 - SPI2_MOSI remapping"]
    #[inline(always)]
    pub fn spi2_mosi_remap(&mut self) -> Spi2MosiRemapW<'_, Pcf4Spec> {
        Spi2MosiRemapW::new(self, 24)
    }
}
#[doc = "AFIO port configuration register 4\n\nYou can [`read`](crate::Reg::read) this register and get [`pcf4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcf4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Pcf4Spec;
