...
impl W {
    #[doc = "Bits 0:15 - MAC address1 high"]
    #[inline(always)]
    pub fn addr1h(&mut self) -> Addr1hW<'_, MacAddr1hSpec> {
        Addr1hW::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask byte"]
    #[inline(always)]
    pub fn mb(&mut self) -> MbW<'_, MacAddr1hSpec> {
        MbW::new(self, 24)
    }
    #[doc = "Bit 30 - Source address filter"]
    #[inline(always)]
    pub fn saf(&mut self) -> SafW<'_, MacAddr1hSpec> {
        SafW::new(self, 30)
    }
    #[doc = "Bit 31 - Address filter enable"]
    #[inline(always)]
    pub fn afe(&mut self) -> AfeW<'_, MacAddr1hSpec> {
        AfeW::new(self, 31)
    }
}
