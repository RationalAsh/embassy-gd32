...
impl W {
    ...
    #[doc = "Bit 13 - PLL1 Stabilization Interrupt Enable"]
    #[inline(always)]
    pub fn pll1stbie(&mut self) -> Pll1stbieW<'_, IntSpec> {
        Pll1stbieW::new(self, 13)
    }
    #[doc = "Bit 14 - PLL2 Stabilization Interrupt Enable"]
    #[inline(always)]
    pub fn pll2stbie(&mut self) -> Pll2stbieW<'_, IntSpec> {
    ...
    #[inline(always)]
    pub fn pll1stbic(&mut self) -> Pll1stbicW<'_, IntSpec> {
        Pll1stbicW::new(self, 21)
    }
    #[doc = "Bit 22 - PLL2 stabilization Interrupt Clear"]
    #[inline(always)]
    pub fn pll2stbic(&mut self) -> Pll2stbicW<'_, IntSpec> {
