...
#[repr(u8)]
pub enum Adcpsc {
    #[doc = "4: CK_APB2 divided by 12"]
    Div12 = 4,
    #[doc = "5: CK_APB2 divided by 16"]
    Div16 = 5,
...
impl AdcpscR {
    ...
    #[doc = "CK_APB2 divided by 12"]
    #[inline(always)]
    pub fn is_div12(&self) -> bool {
        *self == Adcpsc::Div12
    }
    #[doc = "CK_APB2 divided by 16"]
    #[inline(always)]
    pub fn is_div16(&self) -> bool {
        *self == Adcpsc::Div16
    }
    ...
    REG::Ux: From<u8>,
{
    ...
    pub fn div12(self) -> &'a mut crate::W<REG> {
        self.variant(Adcpsc::Div12)
    }
    #[doc = "CK_APB2 divided by 16"]
    #[inline(always)]
    pub fn div16(self) -> &'a mut crate::W<REG> {
        self.variant(Adcpsc::Div16)
    }
    #[doc = "CK_APB2 divided by 2"]
    #[inline(always)]
    pub fn div2(self) -> &'a mut crate::W<REG> {
...
pub type UsbfspscR = crate::FieldReader;
#[doc = "Field `USBFSPSC` writer - USBFS clock prescaler selection"]
pub type UsbfspscW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
#[doc = "Field `PLLMF_MSB` reader - Bit 4 of PLLMF"]
...
#[doc = "Field `PLLMF_MSB` writer - Bit 4 of PLLMF"]
...
impl R {
    ...
    pub fn pllmf_msb(&self) -> PllmfMsbR {
        PllmfMsbR::new(((self.bits >> 29) & 1) != 0)
    }
}
impl W {
    #[doc = "Bits 0:1 - System clock switch"]
    ...
    #[doc = "Bits 22:23 - USBFS clock prescaler selection"]
    #[inline(always)]
    pub fn usbfspsc(&mut self) -> UsbfspscW<'_, Cfg0Spec> {
