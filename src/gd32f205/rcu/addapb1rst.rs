...
impl W {
    #[doc = "Bit 23 - I2C2 reset"]
    #[inline(always)]
    pub fn i2c2rst(&mut self) -> I2c2rstW<'_, Addapb1rstSpec> {
        I2c2rstW::new(self, 23)
    }
    #[doc = "Bit 30 - UART6 reset"]
    #[inline(always)]
    pub fn uart6rst(&mut self) -> Uart6rstW<'_, Addapb1rstSpec> {
        Uart6rstW::new(self, 30)
    }
    #[doc = "Bit 31 - UART7 reset"]
    #[inline(always)]
    pub fn uart7rst(&mut self) -> Uart7rstW<'_, Addapb1rstSpec> {
