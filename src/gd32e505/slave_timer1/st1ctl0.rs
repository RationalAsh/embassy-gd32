#[doc = "Register `ST1CTL0` reader"]
pub type R = crate::R<St1ctl0Spec>;
#[doc = "Register `ST1CTL0` writer"]
pub type W = crate::W<St1ctl0Spec>;
...
impl W {
    #[doc = "Bits 0:2 - Counter clock division"]
    #[inline(always)]
    pub fn cntckdiv(&mut self) -> CntckdivW<'_, St1ctl0Spec> {
        CntckdivW::new(self, 0)
    }
    #[doc = "Bit 3 - Continuous mode"]
    #[inline(always)]
    pub fn ctnm(&mut self) -> CtnmW<'_, St1ctl0Spec> {
        CtnmW::new(self, 3)
    }
    #[doc = "Bit 4 - Counter reset mode"]
    #[inline(always)]
    pub fn cntrstm(&mut self) -> CntrstmW<'_, St1ctl0Spec> {
        CntrstmW::new(self, 4)
    }
    #[doc = "Bit 5 - Half mode"]
    #[inline(always)]
    pub fn halfm(&mut self) -> HalfmW<'_, St1ctl0Spec> {
        HalfmW::new(self, 5)
    }
    #[doc = "Bit 6 - Balanced mode enable"]
    #[inline(always)]
    pub fn blnmen(&mut self) -> BlnmenW<'_, St1ctl0Spec> {
        BlnmenW::new(self, 6)
    }
    #[doc = "Bit 10 - Synchronization input reset counter"]
    #[inline(always)]
    pub fn synirst(&mut self) -> SynirstW<'_, St1ctl0Spec> {
        SynirstW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronization input start counter"]
    #[inline(always)]
    pub fn synistrt(&mut self) -> SynistrtW<'_, St1ctl0Spec> {
        SynistrtW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Compare 1 delayed mode"]
    #[inline(always)]
    pub fn delcmp1m(&mut self) -> Delcmp1mW<'_, St1ctl0Spec> {
        Delcmp1mW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Compare 3 delayed mode"]
    #[inline(always)]
    pub fn delcmp3m(&mut self) -> Delcmp3mW<'_, St1ctl0Spec> {
        Delcmp3mW::new(self, 14)
    }
    #[doc = "Bit 17 - Update event generated by repetition event"]
    #[inline(always)]
    pub fn uprep(&mut self) -> UprepW<'_, St1ctl0Spec> {
        UprepW::new(self, 17)
    }
    #[doc = "Bit 18 - Update event generated by reset event"]
    #[inline(always)]
    pub fn uprst(&mut self) -> UprstW<'_, St1ctl0Spec> {
        UprstW::new(self, 18)
    }
    #[doc = "Bit 19 - Update by Slave_TIMER0 update event"]
    #[inline(always)]
    pub fn upbst0(&mut self) -> Upbst0W<'_, St1ctl0Spec> {
        Upbst0W::new(self, 19)
    }
    #[doc = "Bit 21 - Update by Slave_TIMER2 update event"]
    #[inline(always)]
    pub fn upbst2(&mut self) -> Upbst2W<'_, St1ctl0Spec> {
        Upbst2W::new(self, 21)
    }
    #[doc = "Bit 22 - Update by Slave_TIMER3 update event"]
    #[inline(always)]
    pub fn upbst3(&mut self) -> Upbst3W<'_, St1ctl0Spec> {
        Upbst3W::new(self, 22)
    }
    #[doc = "Bit 23 - Update by Slave_TIMER4 update event"]
    #[inline(always)]
    pub fn upbst4(&mut self) -> Upbst4W<'_, St1ctl0Spec> {
        Upbst4W::new(self, 23)
    }
    #[doc = "Bit 24 - Update by Master_TIMER update event"]
    #[inline(always)]
    pub fn upbmt(&mut self) -> UpbmtW<'_, St1ctl0Spec> {
        UpbmtW::new(self, 24)
    }
    #[doc = "Bits 25:26 - Trigger source to DAC"]
    #[inline(always)]
    pub fn dactrgs(&mut self) -> DactrgsW<'_, St1ctl0Spec> {
        DactrgsW::new(self, 25)
    }
    #[doc = "Bit 27 - Shadow registers enable"]
    #[inline(always)]
    pub fn shwen(&mut self) -> ShwenW<'_, St1ctl0Spec> {
        ShwenW::new(self, 27)
    }
    #[doc = "Bits 28:31 - Update event selection"]
    #[inline(always)]
    pub fn upsel(&mut self) -> UpselW<'_, St1ctl0Spec> {
        UpselW::new(self, 28)
    }
}
#[doc = "SHRTIMER Slave_TIMER1 control register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`st1ctl0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1ctl0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St1ctl0Spec;
impl crate::RegisterSpec for St1ctl0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1ctl0::R`](R) reader structure"]
impl crate::Readable for St1ctl0Spec {}
#[doc = "`write(|w| ..)` method takes [`st1ctl0::W`](W) writer structure"]
impl crate::Writable for St1ctl0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST1CTL0 to value 0"]
impl crate::Resettable for St1ctl0Spec {}
