...
impl W {
    #[doc = "Bit 0 - Capture 0 triggered by software"]
    #[inline(always)]
    pub fn cp0bsw(&mut self) -> Cp0bswW<'_, St1cap0trgSpec> {
        Cp0bswW::new(self, 0)
    }
    #[doc = "Bit 1 - Capture 0 triggered by update event"]
    #[inline(always)]
    pub fn cp0bup(&mut self) -> Cp0bupW<'_, St1cap0trgSpec> {
        Cp0bupW::new(self, 1)
    }
    #[doc = "Bit 2 - Capture 0 triggered by external event 0"]
    #[inline(always)]
    pub fn cp0bexev0(&mut self) -> Cp0bexev0W<'_, St1cap0trgSpec> {
        Cp0bexev0W::new(self, 2)
    }
    #[doc = "Bit 3 - Capture 0 triggered by external event 1"]
    #[inline(always)]
    pub fn cp0bexev1(&mut self) -> Cp0bexev1W<'_, St1cap0trgSpec> {
        Cp0bexev1W::new(self, 3)
    }
    #[doc = "Bit 4 - Capture 0 triggered by external event 2"]
    #[inline(always)]
    pub fn cp0bexev2(&mut self) -> Cp0bexev2W<'_, St1cap0trgSpec> {
        Cp0bexev2W::new(self, 4)
    }
    #[doc = "Bit 5 - Capture 0 triggered by external event 3"]
    #[inline(always)]
    pub fn cp0bexev3(&mut self) -> Cp0bexev3W<'_, St1cap0trgSpec> {
        Cp0bexev3W::new(self, 5)
    }
    #[doc = "Bit 6 - Capture 0 triggered by external event 4"]
    #[inline(always)]
    pub fn cp0bexev4(&mut self) -> Cp0bexev4W<'_, St1cap0trgSpec> {
        Cp0bexev4W::new(self, 6)
    }
    #[doc = "Bit 7 - Capture 0 triggered by external event 5"]
    #[inline(always)]
    pub fn cp0bexev5(&mut self) -> Cp0bexev5W<'_, St1cap0trgSpec> {
        Cp0bexev5W::new(self, 7)
    }
    #[doc = "Bit 8 - Capture 0 triggered by external event 6"]
    #[inline(always)]
    pub fn cp0bexev6(&mut self) -> Cp0bexev6W<'_, St1cap0trgSpec> {
        Cp0bexev6W::new(self, 8)
    }
    #[doc = "Bit 9 - Capture 0 triggered by external event 7"]
    #[inline(always)]
    pub fn cp0bexev7(&mut self) -> Cp0bexev7W<'_, St1cap0trgSpec> {
        Cp0bexev7W::new(self, 9)
    }
    #[doc = "Bit 10 - Capture 0 triggered by external event 8"]
    #[inline(always)]
    pub fn cp0bexev8(&mut self) -> Cp0bexev8W<'_, St1cap0trgSpec> {
        Cp0bexev8W::new(self, 10)
    }
    #[doc = "Bit 11 - Capture 0 triggered by external event 9"]
    #[inline(always)]
    pub fn cp0bexev9(&mut self) -> Cp0bexev9W<'_, St1cap0trgSpec> {
        Cp0bexev9W::new(self, 11)
    }
    #[doc = "Bit 12 - Capture 0 triggered by ST0CH0_O output inactive to active transition"]
    #[inline(always)]
    pub fn cp0bst0a(&mut self) -> Cp0bst0aW<'_, St1cap0trgSpec> {
        Cp0bst0aW::new(self, 12)
    }
    #[doc = "Bit 13 - Capture 0 triggered by ST0CH0_O output active to inactive transition"]
    #[inline(always)]
    pub fn cp0bst0na(&mut self) -> Cp0bst0naW<'_, St1cap0trgSpec> {
        Cp0bst0naW::new(self, 13)
    }
    #[doc = "Bit 14 - Capture 0 triggered by compare 0 event of Slave_TIMER0"]
    #[inline(always)]
    pub fn cp0bst0cmp0(&mut self) -> Cp0bst0cmp0W<'_, St1cap0trgSpec> {
        Cp0bst0cmp0W::new(self, 14)
    }
    #[doc = "Bit 15 - Capture 0 triggered by compare 1 event of Slave_TIMER0"]
    #[inline(always)]
    pub fn cp0bst0cmp1(&mut self) -> Cp0bst0cmp1W<'_, St1cap0trgSpec> {
        Cp0bst0cmp1W::new(self, 15)
    }
    #[doc = "Bit 20 - Capture 0 triggered by ST2CH0_O output inactive to active transition"]
    #[inline(always)]
    pub fn cp0bst2a(&mut self) -> Cp0bst2aW<'_, St1cap0trgSpec> {
        Cp0bst2aW::new(self, 20)
    }
    #[doc = "Bit 21 - Capture 0 triggered by ST2CH0_O output active to inactive transition"]
    #[inline(always)]
    pub fn cp0bst2na(&mut self) -> Cp0bst2naW<'_, St1cap0trgSpec> {
        Cp0bst2naW::new(self, 21)
    }
    #[doc = "Bit 22 - Capture 0 triggered by compare 0 event of Slave_TIMER2"]
    #[inline(always)]
    pub fn cp0bst2cmp0(&mut self) -> Cp0bst2cmp0W<'_, St1cap0trgSpec> {
        Cp0bst2cmp0W::new(self, 22)
    }
    #[doc = "Bit 23 - Capture 0 triggered by compare 1 event of Slave_TIMER2"]
    #[inline(always)]
    pub fn cp0bst2cmp1(&mut self) -> Cp0bst2cmp1W<'_, St1cap0trgSpec> {
        Cp0bst2cmp1W::new(self, 23)
    }
    #[doc = "Bit 24 - Capture 0 triggered by ST3CH0_O output inactive to active transition"]
    #[inline(always)]
    pub fn cp0bst3a(&mut self) -> Cp0bst3aW<'_, St1cap0trgSpec> {
        Cp0bst3aW::new(self, 24)
    }
    #[doc = "Bit 25 - Capture 0 triggered by ST3CH0_O output active to inactive transition"]
    #[inline(always)]
    pub fn cp0bst3na(&mut self) -> Cp0bst3naW<'_, St1cap0trgSpec> {
        Cp0bst3naW::new(self, 25)
    }
    #[doc = "Bit 26 - Capture 0 triggered by compare 0 event of Slave_TIMER3"]
    #[inline(always)]
    pub fn cp0bst3cmp0(&mut self) -> Cp0bst3cmp0W<'_, St1cap0trgSpec> {
        Cp0bst3cmp0W::new(self, 26)
    }
    #[doc = "Bit 27 - Capture 0 triggered by compare 1 event of Slave_TIMER3"]
    #[inline(always)]
    pub fn cp0bst3cmp1(&mut self) -> Cp0bst3cmp1W<'_, St1cap0trgSpec> {
        Cp0bst3cmp1W::new(self, 27)
    }
    #[doc = "Bit 28 - Capture 0 triggered by ST4CH0_O output inactive to active transition"]
    #[inline(always)]
    pub fn cp0bst4a(&mut self) -> Cp0bst4aW<'_, St1cap0trgSpec> {
        Cp0bst4aW::new(self, 28)
    }
    #[doc = "Bit 29 - Capture 0 triggered by ST4CH0_O output active to inactive transition"]
    #[inline(always)]
    pub fn cp0bst4na(&mut self) -> Cp0bst4naW<'_, St1cap0trgSpec> {
        Cp0bst4naW::new(self, 29)
    }
    #[doc = "Bit 30 - Capture 0 triggered by compare 0 event of Slave_TIMER4"]
    #[inline(always)]
    pub fn cp0bst4cmp0(&mut self) -> Cp0bst4cmp0W<'_, St1cap0trgSpec> {
        Cp0bst4cmp0W::new(self, 30)
    }
    #[doc = "Bit 31 - Capture 0 triggered by compare 1 event of Slave_TIMER4"]
    #[inline(always)]
    pub fn cp0bst4cmp1(&mut self) -> Cp0bst4cmp1W<'_, St1cap0trgSpec> {
        Cp0bst4cmp1W::new(self, 31)
    }
}
#[doc = "SHRTIMER Slave_TIMERx capture 0 trigger register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1cap0trg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1cap0trg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
