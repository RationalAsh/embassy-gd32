...
pub type R = crate::R<St1cmp0cpSpec>;
#[doc = "Register `ST1CMP0CP` writer"]
pub type W = crate::W<St1cmp0cpSpec>;
...
impl W {
    #[doc = "Bits 0:15 - Compare 0 value"]
    #[inline(always)]
    pub fn cmp0val(&mut self) -> Cmp0valW<'_, St1cmp0cpSpec> {
        Cmp0valW::new(self, 0)
    }
    #[doc = "Bits 16:23 - Counter repetition value"]
    #[inline(always)]
    pub fn crep(&mut self) -> CrepW<'_, St1cmp0cpSpec> {
        CrepW::new(self, 16)
    }
}
#[doc = "SHRTIMER Slave_TIMER1 compare 0 composite register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1cmp0cp::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1cmp0cp::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St1cmp0cpSpec;
impl crate::RegisterSpec for St1cmp0cpSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1cmp0cp::R`](R) reader structure"]
impl crate::Readable for St1cmp0cpSpec {}
#[doc = "`write(|w| ..)` method takes [`st1cmp0cp::W`](W) writer structure"]
impl crate::Writable for St1cmp0cpSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST1CMP0CP to value 0"]
impl crate::Resettable for St1cmp0cpSpec {}
