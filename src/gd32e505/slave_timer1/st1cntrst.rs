#[doc = "Register `ST1CNTRST` reader"]
pub type R = crate::R<St1cntrstSpec>;
#[doc = "Register `ST1CNTRST` writer"]
pub type W = crate::W<St1cntrstSpec>;
#[doc = "Field `UPRST` reader - Slave_TIMER1 update event resets counter"]
pub type UprstR = crate::BitReader;
#[doc = "Field `UPRST` writer - Slave_TIMER1 update event resets counter"]
pub type UprstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CMP1RST` reader - Slave_TIMER1 compare 1 event resets counter"]
pub type Cmp1rstR = crate::BitReader;
#[doc = "Field `CMP1RST` writer - Slave_TIMER1 compare 1 event resets counter"]
pub type Cmp1rstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CMP3RST` reader - Slave_TIMER1 compare 3 event resets counter"]
pub type Cmp3rstR = crate::BitReader;
#[doc = "Field `CMP3RST` writer - Slave_TIMER1 compare 3 event resets counter"]
...
impl R {
    #[doc = "Bit 1 - Slave_TIMER1 update event resets counter"]
    #[inline(always)]
    pub fn uprst(&self) -> UprstR {
        UprstR::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Slave_TIMER1 compare 1 event resets counter"]
    #[inline(always)]
    pub fn cmp1rst(&self) -> Cmp1rstR {
        Cmp1rstR::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Slave_TIMER1 compare 3 event resets counter"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 1 - Slave_TIMER1 update event resets counter"]
    #[inline(always)]
    pub fn uprst(&mut self) -> UprstW<'_, St1cntrstSpec> {
        UprstW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave_TIMER1 compare 1 event resets counter"]
    #[inline(always)]
    pub fn cmp1rst(&mut self) -> Cmp1rstW<'_, St1cntrstSpec> {
        Cmp1rstW::new(self, 2)
    }
    #[doc = "Bit 3 - Slave_TIMER1 compare 3 event resets counter"]
    #[inline(always)]
    pub fn cmp3rst(&mut self) -> Cmp3rstW<'_, St1cntrstSpec> {
        Cmp3rstW::new(self, 3)
    }
    #[doc = "Bit 4 - Master_TIMER period event resets counter"]
    #[inline(always)]
    pub fn mtperrst(&mut self) -> MtperrstW<'_, St1cntrstSpec> {
        MtperrstW::new(self, 4)
    }
    #[doc = "Bit 5 - Master_TIMER compare 0 event resets counter"]
    #[inline(always)]
    pub fn mtcmp0rst(&mut self) -> Mtcmp0rstW<'_, St1cntrstSpec> {
        Mtcmp0rstW::new(self, 5)
    }
    #[doc = "Bit 6 - Master_TIMER compare 1 event resets counter"]
    #[inline(always)]
    pub fn mtcmp1rst(&mut self) -> Mtcmp1rstW<'_, St1cntrstSpec> {
        Mtcmp1rstW::new(self, 6)
    }
    #[doc = "Bit 7 - Master_TIMER compare 2 event resets counter"]
    #[inline(always)]
    pub fn mtcmp2rst(&mut self) -> Mtcmp2rstW<'_, St1cntrstSpec> {
        Mtcmp2rstW::new(self, 7)
    }
    #[doc = "Bit 8 - Master_TIMER compare 3 event resets counter"]
    #[inline(always)]
    pub fn mtcmp3rst(&mut self) -> Mtcmp3rstW<'_, St1cntrstSpec> {
        Mtcmp3rstW::new(self, 8)
    }
    #[doc = "Bit 9 - External event 0 resets counter"]
    #[inline(always)]
    pub fn exev0rst(&mut self) -> Exev0rstW<'_, St1cntrstSpec> {
        Exev0rstW::new(self, 9)
    }
    #[doc = "Bit 10 - External event 1 resets counter"]
    #[inline(always)]
    pub fn exev1rst(&mut self) -> Exev1rstW<'_, St1cntrstSpec> {
        Exev1rstW::new(self, 10)
    }
    #[doc = "Bit 11 - External event 2 resets counter"]
    #[inline(always)]
    pub fn exev2rst(&mut self) -> Exev2rstW<'_, St1cntrstSpec> {
        Exev2rstW::new(self, 11)
    }
    #[doc = "Bit 12 - External event 3 resets counter"]
    #[inline(always)]
    pub fn exev3rst(&mut self) -> Exev3rstW<'_, St1cntrstSpec> {
        Exev3rstW::new(self, 12)
    }
    #[doc = "Bit 13 - External event 4 resets counter"]
    #[inline(always)]
    pub fn exev4rst(&mut self) -> Exev4rstW<'_, St1cntrstSpec> {
        Exev4rstW::new(self, 13)
    }
    #[doc = "Bit 14 - External event 5 resets counter"]
    #[inline(always)]
    pub fn exev5rst(&mut self) -> Exev5rstW<'_, St1cntrstSpec> {
        Exev5rstW::new(self, 14)
    }
    #[doc = "Bit 15 - External event 6 resets counter"]
    #[inline(always)]
    pub fn exev6rst(&mut self) -> Exev6rstW<'_, St1cntrstSpec> {
        Exev6rstW::new(self, 15)
    }
    #[doc = "Bit 16 - External event 7 resets counter"]
    #[inline(always)]
    pub fn exev7rst(&mut self) -> Exev7rstW<'_, St1cntrstSpec> {
        Exev7rstW::new(self, 16)
    }
    #[doc = "Bit 17 - External event 8 resets counter"]
    #[inline(always)]
    pub fn exev8rst(&mut self) -> Exev8rstW<'_, St1cntrstSpec> {
        Exev8rstW::new(self, 17)
    }
    #[doc = "Bit 18 - External event 9 resets counter"]
    #[inline(always)]
    pub fn exev9rst(&mut self) -> Exev9rstW<'_, St1cntrstSpec> {
        Exev9rstW::new(self, 18)
    }
    #[doc = "Bit 19 - Slave_TIMER0 compare 0 event resets counter"]
    #[inline(always)]
    pub fn st0cmp0rst(&mut self) -> St0cmp0rstW<'_, St1cntrstSpec> {
        St0cmp0rstW::new(self, 19)
    }
    #[doc = "Bit 20 - Slave_TIMER0 compare 1 event resets counter"]
    #[inline(always)]
    pub fn st0cmp1rst(&mut self) -> St0cmp1rstW<'_, St1cntrstSpec> {
        St0cmp1rstW::new(self, 20)
    }
    #[doc = "Bit 21 - Slave_TIMER0 compare 3 event resets counter"]
    #[inline(always)]
    pub fn st0cmp3rst(&mut self) -> St0cmp3rstW<'_, St1cntrstSpec> {
        St0cmp3rstW::new(self, 21)
    }
    #[doc = "Bit 22 - Slave_TIMER2 compare 0 event resets counter"]
    #[inline(always)]
    pub fn st2cmp0rst(&mut self) -> St2cmp0rstW<'_, St1cntrstSpec> {
        St2cmp0rstW::new(self, 22)
    }
    #[doc = "Bit 23 - Slave_TIMER2 compare 1 event resets counter"]
    #[inline(always)]
    pub fn st2cmp1rst(&mut self) -> St2cmp1rstW<'_, St1cntrstSpec> {
        St2cmp1rstW::new(self, 23)
    }
    #[doc = "Bit 24 - Slave_TIMER2 compare 3 event resets counter"]
    #[inline(always)]
    pub fn st2cmp3rst(&mut self) -> St2cmp3rstW<'_, St1cntrstSpec> {
        St2cmp3rstW::new(self, 24)
    }
    #[doc = "Bit 25 - Slave_TIMER3 compare 0 event resets counter"]
    #[inline(always)]
    pub fn st3cmp0rst(&mut self) -> St3cmp0rstW<'_, St1cntrstSpec> {
        St3cmp0rstW::new(self, 25)
    }
    #[doc = "Bit 26 - Slave_TIMER3 compare 1 event resets counter"]
    #[inline(always)]
    pub fn st3cmp1rst(&mut self) -> St3cmp1rstW<'_, St1cntrstSpec> {
        St3cmp1rstW::new(self, 26)
    }
    #[doc = "Bit 27 - Slave_TIMER3 compare 3 event resets counter"]
    #[inline(always)]
    pub fn st3cmp3rst(&mut self) -> St3cmp3rstW<'_, St1cntrstSpec> {
        St3cmp3rstW::new(self, 27)
    }
    #[doc = "Bit 28 - Slave_TIMER4 compare 0 event resets counter"]
    #[inline(always)]
    pub fn st4cmp0rst(&mut self) -> St4cmp0rstW<'_, St1cntrstSpec> {
        St4cmp0rstW::new(self, 28)
    }
    #[doc = "Bit 29 - Slave_TIMER4 compare 1 event resets counter"]
    #[inline(always)]
    pub fn st4cmp1rst(&mut self) -> St4cmp1rstW<'_, St1cntrstSpec> {
        St4cmp1rstW::new(self, 29)
    }
    #[doc = "Bit 30 - Slave_TIMER4 compare 3 event resets counter"]
    #[inline(always)]
    pub fn st4cmp3rst(&mut self) -> St4cmp3rstW<'_, St1cntrstSpec> {
        St4cmp3rstW::new(self, 30)
    }
}
#[doc = "SHRTIMER Slave_TIMERx counter reset register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1cntrst::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1cntrst::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St1cntrstSpec;
impl crate::RegisterSpec for St1cntrstSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1cntrst::R`](R) reader structure"]
impl crate::Readable for St1cntrstSpec {}
#[doc = "`write(|w| ..)` method takes [`st1cntrst::W`](W) writer structure"]
impl crate::Writable for St1cntrstSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST1CNTRST to value 0"]
impl crate::Resettable for St1cntrstSpec {}
