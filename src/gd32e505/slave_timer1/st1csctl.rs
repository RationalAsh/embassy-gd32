#[doc = "Register `ST1CSCTL` reader"]
pub type R = crate::R<St1csctlSpec>;
#[doc = "Register `ST1CSCTL` writer"]
pub type W = crate::W<St1csctlSpec>;
...
impl W {
    #[doc = "Bits 0:3 - Carrier signal period"]
    #[inline(always)]
    pub fn csprd(&mut self) -> CsprdW<'_, St1csctlSpec> {
        CsprdW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Carrier signal duty cycle"]
    #[inline(always)]
    pub fn csdty(&mut self) -> CsdtyW<'_, St1csctlSpec> {
        CsdtyW::new(self, 4)
    }
    #[doc = "Bits 7:10 - First carrier-signal pulse width"]
    #[inline(always)]
    pub fn csfstpw(&mut self) -> CsfstpwW<'_, St1csctlSpec> {
        CsfstpwW::new(self, 7)
    }
}
#[doc = "SHRTIMER Slave_TIMERx carrier-signal control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1csctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st1csctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St1csctlSpec;
impl crate::RegisterSpec for St1csctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1csctl::R`](R) reader structure"]
impl crate::Readable for St1csctlSpec {}
#[doc = "`write(|w| ..)` method takes [`st1csctl::W`](W) writer structure"]
impl crate::Writable for St1csctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST1CSCTL to value 0"]
impl crate::Resettable for St1csctlSpec {}
