#[doc = "Register `ST4CH0SET` reader"]
pub type R = crate::R<St4ch0setSpec>;
#[doc = "Register `ST4CH0SET` writer"]
pub type W = crate::W<St4ch0setSpec>;
...
impl W {
    #[doc = "Bit 0 - Software event generates channel 0"]
    #[inline(always)]
    pub fn ch0ssev(&mut self) -> Ch0ssevW<'_, St4ch0setSpec> {
        Ch0ssevW::new(self, 0)
    }
    #[doc = "Bit 1 - Slave_TIMERx reset event generates channel 0"]
    #[inline(always)]
    pub fn ch0srst(&mut self) -> Ch0srstW<'_, St4ch0setSpec> {
        Ch0srstW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave_TIMERx period event generates channel 0"]
    #[inline(always)]
    pub fn ch0sper(&mut self) -> Ch0sperW<'_, St4ch0setSpec> {
        Ch0sperW::new(self, 2)
    }
    #[doc = "Bit 3 - Slave_TIMERx compare 0 event generates channel 0"]
    #[inline(always)]
    pub fn ch0scmp0(&mut self) -> Ch0scmp0W<'_, St4ch0setSpec> {
        Ch0scmp0W::new(self, 3)
    }
    #[doc = "Bit 4 - Slave_TIMERx compare 1 event generates channel 0"]
    #[inline(always)]
    pub fn ch0scmp1(&mut self) -> Ch0scmp1W<'_, St4ch0setSpec> {
        Ch0scmp1W::new(self, 4)
    }
    #[doc = "Bit 5 - Slave_TIMERx compare 2 event generates channel 0"]
    #[inline(always)]
    pub fn ch0scmp2(&mut self) -> Ch0scmp2W<'_, St4ch0setSpec> {
        Ch0scmp2W::new(self, 5)
    }
    #[doc = "Bit 6 - Slave_TIMERx compare 3 event generates channel 0"]
    #[inline(always)]
    pub fn ch0scmp3(&mut self) -> Ch0scmp3W<'_, St4ch0setSpec> {
        Ch0scmp3W::new(self, 6)
    }
    #[doc = "Bit 7 - Master_TIMER period event generates channel 0"]
    #[inline(always)]
    pub fn ch0smtper(&mut self) -> Ch0smtperW<'_, St4ch0setSpec> {
        Ch0smtperW::new(self, 7)
    }
    #[doc = "Bit 8 - Master_TIMER compare 0 event generates channel 0"]
    #[inline(always)]
    pub fn ch0smtcmp0(&mut self) -> Ch0smtcmp0W<'_, St4ch0setSpec> {
        Ch0smtcmp0W::new(self, 8)
    }
    #[doc = "Bit 9 - Master_TIMER compare 1 event generates channel 0"]
    #[inline(always)]
    pub fn ch0smtcmp1(&mut self) -> Ch0smtcmp1W<'_, St4ch0setSpec> {
        Ch0smtcmp1W::new(self, 9)
    }
    #[doc = "Bit 10 - Master_TIMER compare 2 event generates channel 0"]
    #[inline(always)]
    pub fn ch0smtcmp2(&mut self) -> Ch0smtcmp2W<'_, St4ch0setSpec> {
        Ch0smtcmp2W::new(self, 10)
    }
    #[doc = "Bit 11 - Master_TIMER compare 3 event generates channel 0"]
    #[inline(always)]
    pub fn ch0smtcmp3(&mut self) -> Ch0smtcmp3W<'_, St4ch0setSpec> {
        Ch0smtcmp3W::new(self, 11)
    }
    #[doc = "Bit 12 - Slave_TIMERx interconnection event 0 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev0(&mut self) -> Ch0sstev0W<'_, St4ch0setSpec> {
        Ch0sstev0W::new(self, 12)
    }
    #[doc = "Bit 13 - Slave_TIMERx interconnection event 1 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev1(&mut self) -> Ch0sstev1W<'_, St4ch0setSpec> {
        Ch0sstev1W::new(self, 13)
    }
    #[doc = "Bit 14 - Slave_TIMERx interconnection event 2 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev2(&mut self) -> Ch0sstev2W<'_, St4ch0setSpec> {
        Ch0sstev2W::new(self, 14)
    }
    #[doc = "Bit 15 - Slave_TIMERx interconnection event 3 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev3(&mut self) -> Ch0sstev3W<'_, St4ch0setSpec> {
        Ch0sstev3W::new(self, 15)
    }
    #[doc = "Bit 16 - Slave_TIMERx interconnection event 4 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev4(&mut self) -> Ch0sstev4W<'_, St4ch0setSpec> {
        Ch0sstev4W::new(self, 16)
    }
    #[doc = "Bit 17 - Slave_TIMERx interconnection event 5 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev5(&mut self) -> Ch0sstev5W<'_, St4ch0setSpec> {
        Ch0sstev5W::new(self, 17)
    }
    #[doc = "Bit 18 - Slave_TIMERx interconnection event 6 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev6(&mut self) -> Ch0sstev6W<'_, St4ch0setSpec> {
        Ch0sstev6W::new(self, 18)
    }
    #[doc = "Bit 19 - Slave_TIMER1 interconnection event 7 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev7(&mut self) -> Ch0sstev7W<'_, St4ch0setSpec> {
        Ch0sstev7W::new(self, 19)
    }
    #[doc = "Bit 20 - Slave_TIMERx interconnection event 8 generates channel 0"]
    #[inline(always)]
    pub fn ch0sstev8(&mut self) -> Ch0sstev8W<'_, St4ch0setSpec> {
        Ch0sstev8W::new(self, 20)
    }
    #[doc = "Bit 21 - External event 0 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev0(&mut self) -> Ch0sexev0W<'_, St4ch0setSpec> {
        Ch0sexev0W::new(self, 21)
    }
    #[doc = "Bit 22 - External event 1 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev1(&mut self) -> Ch0sexev1W<'_, St4ch0setSpec> {
        Ch0sexev1W::new(self, 22)
    }
    #[doc = "Bit 23 - External event 2 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev2(&mut self) -> Ch0sexev2W<'_, St4ch0setSpec> {
        Ch0sexev2W::new(self, 23)
    }
    #[doc = "Bit 24 - External event 3 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev3(&mut self) -> Ch0sexev3W<'_, St4ch0setSpec> {
        Ch0sexev3W::new(self, 24)
    }
    #[doc = "Bit 25 - External event 4 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev4(&mut self) -> Ch0sexev4W<'_, St4ch0setSpec> {
        Ch0sexev4W::new(self, 25)
    }
    #[doc = "Bit 26 - External event 5 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev5(&mut self) -> Ch0sexev5W<'_, St4ch0setSpec> {
        Ch0sexev5W::new(self, 26)
    }
    #[doc = "Bit 27 - External event 6 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev6(&mut self) -> Ch0sexev6W<'_, St4ch0setSpec> {
        Ch0sexev6W::new(self, 27)
    }
    #[doc = "Bit 28 - External event 7 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev7(&mut self) -> Ch0sexev7W<'_, St4ch0setSpec> {
        Ch0sexev7W::new(self, 28)
    }
    #[doc = "Bit 29 - External event 8 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev8(&mut self) -> Ch0sexev8W<'_, St4ch0setSpec> {
        Ch0sexev8W::new(self, 29)
    }
    #[doc = "Bit 30 - External event 9 generates channel 0"]
    #[inline(always)]
    pub fn ch0sexev9(&mut self) -> Ch0sexev9W<'_, St4ch0setSpec> {
        Ch0sexev9W::new(self, 30)
    }
    #[doc = "Bit 31 - Update event generates channel 0"]
    #[inline(always)]
    pub fn ch0sup(&mut self) -> Ch0supW<'_, St4ch0setSpec> {
        Ch0supW::new(self, 31)
    }
}
#[doc = "SHRTIMER Slave_TIMERx channel 0 set request register\n\nYou can [`read`](crate::Reg::read) this register and get [`st4ch0set::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st4ch0set::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St4ch0setSpec;
impl crate::RegisterSpec for St4ch0setSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4ch0set::R`](R) reader structure"]
impl crate::Readable for St4ch0setSpec {}
#[doc = "`write(|w| ..)` method takes [`st4ch0set::W`](W) writer structure"]
impl crate::Writable for St4ch0setSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST4CH0SET to value 0"]
impl crate::Resettable for St4ch0setSpec {}
