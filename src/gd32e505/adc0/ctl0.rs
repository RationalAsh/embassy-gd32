...
pub type SyncmW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl R {
    ...
    pub fn syncm(&self) -> SyncmR {
        SyncmR::new(((self.bits >> 16) & 0x0f) as u8)
    }
...
impl W {
    #[doc = "Bits 0:4 - Analog watchdog 0 channel select"]
    #[inline(always)]
    pub fn wd0chsel(&mut self) -> Wd0chselW<'_, Ctl0Spec> {
    ...
    #[doc = "Bit 6 - Interrupt enable for WDE0"]
    #[inline(always)]
    pub fn wde0ie(&mut self) -> Wde0ieW<'_, Ctl0Spec> {
        Wde0ieW::new(self, 6)
    }
    #[doc = "Bit 7 - Interrupt enable for EOIC"]
    #[inline(always)]
    ...
    #[doc = "Bit 9 - When in scan mode, analog watchdog 0 is effective on a single channel"]
    #[inline(always)]
    pub fn wd0sc(&mut self) -> Wd0scW<'_, Ctl0Spec> {
        Wd0scW::new(self, 9)
    }
    #[doc = "Bit 10 - Inserted channel group convert automatically"]
    #[inline(always)]
    ...
    #[doc = "Bits 16:19 - sync mode selection"]
    #[inline(always)]
    pub fn syncm(&mut self) -> SyncmW<'_, Ctl0Spec> {
        SyncmW::new(self, 16)
    }
    #[doc = "Bit 22 - Inserted channel analog watchdog 0 enable"]
    #[inline(always)]
    pub fn iwd0en(&mut self) -> Iwd0enW<'_, Ctl0Spec> {
        Iwd0enW::new(self, 22)
    }
    #[doc = "Bit 23 - Regular channel analog watchdog 0 enable"]
    #[inline(always)]
    pub fn rwd0en(&mut self) -> Rwd0enW<'_, Ctl0Spec> {
        Rwd0enW::new(self, 23)
    }
    #[doc = "Bit 30 - Interrupt enable for WDE1"]
    #[inline(always)]
    pub fn wde1ie(&mut self) -> Wde1ieW<'_, Ctl0Spec> {
        Wde1ieW::new(self, 30)
    }
    #[doc = "Bit 31 - Interrupt enable for WDE2"]
    #[inline(always)]
    pub fn wde2ie(&mut self) -> Wde2ieW<'_, Ctl0Spec> {
        Wde2ieW::new(self, 31)
    }
}
