...
impl W {
    #[doc = "Bits 0:17 - Analog watchdog 1 channel selection"]
    #[inline(always)]
    pub fn awd1cs(&mut self) -> Awd1csW<'_, Wd1srSpec> {
        Awd1csW::new(self, 0)
    }
}
#[doc = "Watchdog 1 Channel Selection Register\n\nYou can [`read`](crate::Reg::read) this register and get [`wd1sr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wd1sr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
