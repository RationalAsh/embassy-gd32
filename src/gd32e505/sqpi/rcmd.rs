...
impl W {
    #[doc = "Bits 0:15 - SQPI read command for AHB read transfer"]
    #[inline(always)]
    pub fn sqpi_rcmd(&mut self) -> SqpiRcmdW<'_, RcmdSpec> {
        SqpiRcmdW::new(self, 0)
    }
    #[doc = "Bits 16:19 - SQPI read command waitcycle number after address phase"]
    #[inline(always)]
    pub fn sqpi_rwaitcycle(&mut self) -> SqpiRwaitcycleW<'_, RcmdSpec> {
        SqpiRwaitcycleW::new(self, 16)
    }
    #[doc = "Bits 20:22 - SQPI controller read command mode"]
    #[inline(always)]
    pub fn sqpi_rmode(&mut self) -> SqpiRmodeW<'_, RcmdSpec> {
        SqpiRmodeW::new(self, 20)
    }
    #[doc = "Bit 31 - Send read ID command"]
    #[inline(always)]
    pub fn sqpi_rid(&mut self) -> SqpiRidW<'_, RcmdSpec> {
        SqpiRidW::new(self, 31)
    }
}
#[doc = "SQPI Read Command Register\n\nYou can [`read`](crate::Reg::read) this register and get [`rcmd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcmd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct RcmdSpec;
