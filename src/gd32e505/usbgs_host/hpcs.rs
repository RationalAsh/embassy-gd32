...
#[doc = "Field `PTEST` reader - Port Test control"]
pub type PtestR = crate::FieldReader;
#[doc = "Field `PTEST` writer - Port Test control"]
pub type PtestW<'a, REG> = crate::FieldWriter<'a, REG, 4>;
...
impl R {
    ...
    #[inline(always)]
    pub fn ptest(&self) -> PtestR {
        PtestR::new(((self.bits >> 13) & 0x0f) as u8)
    }
...
impl W {
    #[doc = "Bit 1 - Port connect detected"]
    #[inline(always)]
    pub fn pcd(&mut self) -> PcdW<'_, HpcsSpec> {
        PcdW::new(self, 1)
    }
    #[doc = "Bit 2 - Port enable"]
    #[inline(always)]
    pub fn pe(&mut self) -> PeW<'_, HpcsSpec> {
        PeW::new(self, 2)
    }
    #[doc = "Bit 3 - Port enable/disable change"]
    #[inline(always)]
    pub fn pedc(&mut self) -> PedcW<'_, HpcsSpec> {
        PedcW::new(self, 3)
    }
    #[doc = "Bit 6 - Port resume"]
    #[inline(always)]
    pub fn prem(&mut self) -> PremW<'_, HpcsSpec> {
        PremW::new(self, 6)
    }
    #[doc = "Bit 7 - Port suspend"]
    #[inline(always)]
    pub fn psp(&mut self) -> PspW<'_, HpcsSpec> {
        PspW::new(self, 7)
    }
    #[doc = "Bit 8 - Port reset"]
    #[inline(always)]
    pub fn prst(&mut self) -> PrstW<'_, HpcsSpec> {
        PrstW::new(self, 8)
    }
    #[doc = "Bit 12 - Port power"]
    #[inline(always)]
    pub fn pp(&mut self) -> PpW<'_, HpcsSpec> {
        PpW::new(self, 12)
    }
    #[doc = "Bits 13:16 - Port Test control"]
    #[inline(always)]
    pub fn ptest(&mut self) -> PtestW<'_, HpcsSpec> {
        PtestW::new(self, 13)
    }
}
