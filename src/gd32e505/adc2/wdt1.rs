...
impl W {
    #[doc = "Bits 0:7 - Analog watchdog 1 low threshold"]
    #[inline(always)]
    pub fn wdlt1(&mut self) -> Wdlt1W<'_, Wdt1Spec> {
        Wdlt1W::new(self, 0)
    }
    #[doc = "Bits 16:23 - Analog watchdog 1 high threshold"]
    #[inline(always)]
    pub fn wdht1(&mut self) -> Wdht1W<'_, Wdt1Spec> {
        Wdht1W::new(self, 16)
    }
}
#[doc = "Watchdog threshold register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`wdt1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wdt1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Wdt1Spec;
