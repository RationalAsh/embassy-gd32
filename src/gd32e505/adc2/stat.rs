...
impl W {
    #[doc = "Bit 0 - Analog watchdog event flag"]
    #[inline(always)]
    pub fn wde0(&mut self) -> Wde0W<'_, StatSpec> {
        Wde0W::new(self, 0)
    }
    #[doc = "Bit 1 - End of group conversion flag"]
    #[inline(always)]
    pub fn eoc(&mut self) -> EocW<'_, StatSpec> {
        EocW::new(self, 1)
    }
    #[doc = "Bit 2 - End of inserted group conversion flag"]
    #[inline(always)]
    pub fn eoic(&mut self) -> EoicW<'_, StatSpec> {
        EoicW::new(self, 2)
    }
    #[doc = "Bit 3 - Start flag of inserted channel group"]
    #[inline(always)]
    pub fn stic(&mut self) -> SticW<'_, StatSpec> {
        SticW::new(self, 3)
    }
    #[doc = "Bit 4 - Start flag of regular channel group"]
    #[inline(always)]
    pub fn strc(&mut self) -> StrcW<'_, StatSpec> {
        StrcW::new(self, 4)
    }
    #[doc = "Bit 30 - Analog watchdog 1 event flag"]
    #[inline(always)]
    pub fn wde1(&mut self) -> Wde1W<'_, StatSpec> {
        Wde1W::new(self, 30)
    }
    #[doc = "Bit 31 - Analog watchdog 2 event flag"]
    #[inline(always)]
    pub fn wde2(&mut self) -> Wde2W<'_, StatSpec> {
        Wde2W::new(self, 31)
    }
}
