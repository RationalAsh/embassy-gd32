...
impl W {
    #[doc = "Bits 0:7 - Analog watchdog 2 low threshold"]
    #[inline(always)]
    pub fn wdlt2(&mut self) -> Wdlt2W<'_, Wdt2Spec> {
        Wdlt2W::new(self, 0)
    }
    #[doc = "Bits 16:23 - Analog watchdog 2 high threshold"]
    #[inline(always)]
    pub fn wdht2(&mut self) -> Wdht2W<'_, Wdt2Spec> {
        Wdht2W::new(self, 16)
    }
}
#[doc = "Watchdog threshold register 2\n\nYou can [`read`](crate::Reg::read) this register and get [`wdt2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wdt2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Wdt2Spec;
