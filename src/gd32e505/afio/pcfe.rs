...
impl W {
    #[doc = "Bits 0:1 - PE0 AF function configuration bitse"]
    #[inline(always)]
    pub fn pe0_afcfg(&mut self) -> Pe0AfcfgW<'_, PcfeSpec> {
        Pe0AfcfgW::new(self, 0)
    }
    #[doc = "Bits 2:3 - PE1 AF function configuration bitse"]
    #[inline(always)]
    pub fn pe1_afcfg(&mut self) -> Pe1AfcfgW<'_, PcfeSpec> {
        Pe1AfcfgW::new(self, 2)
    }
    #[doc = "Bits 16:17 - PE8 AF function configuration bitse"]
    #[inline(always)]
    pub fn pe8_afcfg(&mut self) -> Pe8AfcfgW<'_, PcfeSpec> {
        Pe8AfcfgW::new(self, 16)
    }
    #[doc = "Bits 18:19 - PE9 AF function configuration bitse"]
    #[inline(always)]
    pub fn pe9_afcfg(&mut self) -> Pe9AfcfgW<'_, PcfeSpec> {
        Pe9AfcfgW::new(self, 18)
    }
    #[doc = "Bit 20 - PE10 AF function configuration bitse"]
    #[inline(always)]
    pub fn pe10_afcfg(&mut self) -> Pe10AfcfgW<'_, PcfeSpec> {
        Pe10AfcfgW::new(self, 20)
    }
    #[doc = "Bits 22:23 - PE11 AF function configuration bitse"]
    #[inline(always)]
    pub fn pe11_afcfg(&mut self) -> Pe11AfcfgW<'_, PcfeSpec> {
        Pe11AfcfgW::new(self, 22)
    }
    #[doc = "Bit 24 - PE12 AF function configuration bitse"]
    #[inline(always)]
    pub fn pe12_afcfg(&mut self) -> Pe12AfcfgW<'_, PcfeSpec> {
        Pe12AfcfgW::new(self, 24)
    }
    #[doc = "Bit 26 - PE13 AF function configuration bitse"]
    #[inline(always)]
    pub fn pe13_afcfg(&mut self) -> Pe13AfcfgW<'_, PcfeSpec> {
        Pe13AfcfgW::new(self, 26)
    }
}
#[doc = "AFIO port configuration register E\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfe::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfe::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcfeSpec;
