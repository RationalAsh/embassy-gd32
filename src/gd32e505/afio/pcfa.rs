...
impl W {
    #[doc = "Bit 4 - PA2 AF function configuration bitse"]
    #[inline(always)]
    pub fn pa2_afcfg(&mut self) -> Pa2AfcfgW<'_, PcfaSpec> {
        Pa2AfcfgW::new(self, 4)
    }
    #[doc = "Bit 6 - PA3 AF function configuration bitse"]
    #[inline(always)]
    pub fn pa3_afcfg(&mut self) -> Pa3AfcfgW<'_, PcfaSpec> {
        Pa3AfcfgW::new(self, 6)
    }
    #[doc = "Bit 10 - PA5 AF function configuration bitse"]
    #[inline(always)]
    pub fn pa5_afcfg(&mut self) -> Pa5AfcfgW<'_, PcfaSpec> {
        Pa5AfcfgW::new(self, 10)
    }
    #[doc = "Bits 16:17 - PA8 AF function configuration bitse"]
    #[inline(always)]
    pub fn pa8_afcfg(&mut self) -> Pa8AfcfgW<'_, PcfaSpec> {
        Pa8AfcfgW::new(self, 16)
    }
    #[doc = "Bits 18:19 - PA9 AF function configuration bitse"]
    #[inline(always)]
    pub fn pa9_afcfg(&mut self) -> Pa9AfcfgW<'_, PcfaSpec> {
        Pa9AfcfgW::new(self, 18)
    }
    #[doc = "Bits 20:21 - PA10 AF function configuration bitse"]
    #[inline(always)]
    pub fn pa10_afcfg(&mut self) -> Pa10AfcfgW<'_, PcfaSpec> {
        Pa10AfcfgW::new(self, 20)
    }
    #[doc = "Bits 22:23 - PA11 AF function configuration bitse"]
    #[inline(always)]
    pub fn pa11_afcfg(&mut self) -> Pa11AfcfgW<'_, PcfaSpec> {
        Pa11AfcfgW::new(self, 22)
    }
    #[doc = "Bits 24:25 - PA12 AF function configuration bitse"]
    #[inline(always)]
    pub fn pa12_afcfg(&mut self) -> Pa12AfcfgW<'_, PcfaSpec> {
        Pa12AfcfgW::new(self, 24)
    }
    #[doc = "Bit 30 - PA15 AF function configuration bit"]
    #[inline(always)]
    pub fn pa15_afcfg(&mut self) -> Pa15AfcfgW<'_, PcfaSpec> {
        Pa15AfcfgW::new(self, 30)
    }
}
#[doc = "AFIO port configuration register A\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfa::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfa::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcfaSpec;
