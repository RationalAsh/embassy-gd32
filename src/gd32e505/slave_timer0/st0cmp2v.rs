...
impl W {
    #[doc = "Bits 0:15 - Compare 2 value"]
    #[inline(always)]
    pub fn cmp2val(&mut self) -> Cmp2valW<'_, St0cmp2vSpec> {
        Cmp2valW::new(self, 0)
    }
}
#[doc = "SHRTIMER Slave_TIMER0 compare 2 value register\n\nYou can [`read`](crate::Reg::read) this register and get [`st0cmp2v::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st0cmp2v::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
