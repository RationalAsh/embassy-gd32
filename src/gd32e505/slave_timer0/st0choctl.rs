#[doc = "Register `ST0CHOCTL` reader"]
pub type R = crate::R<St0choctlSpec>;
#[doc = "Register `ST0CHOCTL` writer"]
pub type W = crate::W<St0choctlSpec>;
...
impl W {
    #[doc = "Bit 1 - Channel 0 output polarity"]
    #[inline(always)]
    pub fn ch0p(&mut self) -> Ch0pW<'_, St0choctlSpec> {
        Ch0pW::new(self, 1)
    }
    #[doc = "Bit 2 - Channel 0 IDLE state enable in bunch mode"]
    #[inline(always)]
    pub fn bmch0ien(&mut self) -> Bmch0ienW<'_, St0choctlSpec> {
        Bmch0ienW::new(self, 2)
    }
    #[doc = "Bit 3 - Channel 0 output idle state"]
    #[inline(always)]
    pub fn iso0(&mut self) -> Iso0W<'_, St0choctlSpec> {
        Iso0W::new(self, 3)
    }
    #[doc = "Bits 4:5 - Channel 0 Fault output state"]
    #[inline(always)]
    pub fn ch0fltos(&mut self) -> Ch0fltosW<'_, St0choctlSpec> {
        Ch0fltosW::new(self, 4)
    }
    #[doc = "Bit 6 - Channel 0 carrier-signal mode enable"]
    #[inline(always)]
    pub fn ch0csen(&mut self) -> Ch0csenW<'_, St0choctlSpec> {
        Ch0csenW::new(self, 6)
    }
    #[doc = "Bit 7 - Channel 0 dead-time insert in bunch mode"]
    #[inline(always)]
    pub fn bmch0dti(&mut self) -> Bmch0dtiW<'_, St0choctlSpec> {
        Bmch0dtiW::new(self, 7)
    }
    #[doc = "Bit 8 - Dead time enable"]
    #[inline(always)]
    pub fn dten(&mut self) -> DtenW<'_, St0choctlSpec> {
        DtenW::new(self, 8)
    }
    #[doc = "Bit 9 - Delayed IDLE state mode enable"]
    #[inline(always)]
    pub fn dlyismen(&mut self) -> DlyismenW<'_, St0choctlSpec> {
        DlyismenW::new(self, 9)
    }
    #[doc = "Bits 10:12 - Delayed IDLE source and channel"]
    #[inline(always)]
    pub fn dlyisch(&mut self) -> DlyischW<'_, St0choctlSpec> {
        DlyischW::new(self, 10)
    }
    #[doc = "Bit 17 - Channel 1 output polarity"]
    #[inline(always)]
    pub fn ch1p(&mut self) -> Ch1pW<'_, St0choctlSpec> {
        Ch1pW::new(self, 17)
    }
    #[doc = "Bit 18 - Channel 1 IDLE state enable in bunch mode"]
    #[inline(always)]
    pub fn bmch1ien(&mut self) -> Bmch1ienW<'_, St0choctlSpec> {
        Bmch1ienW::new(self, 18)
    }
    #[doc = "Bit 19 - channel 1 output idle state"]
    #[inline(always)]
    pub fn iso1(&mut self) -> Iso1W<'_, St0choctlSpec> {
        Iso1W::new(self, 19)
    }
    #[doc = "Bits 20:21 - Channel 1 Fault output state"]
    #[inline(always)]
    pub fn ch1fltos(&mut self) -> Ch1fltosW<'_, St0choctlSpec> {
        Ch1fltosW::new(self, 20)
    }
    #[doc = "Bit 22 - Channel 1 carrier-signal mode enable"]
    #[inline(always)]
    pub fn ch1csen(&mut self) -> Ch1csenW<'_, St0choctlSpec> {
        Ch1csenW::new(self, 22)
    }
    #[doc = "Bit 23 - Channel 1 dead-time insert in bunch mode"]
    #[inline(always)]
    pub fn bmch1dti(&mut self) -> Bmch1dtiW<'_, St0choctlSpec> {
        Bmch1dtiW::new(self, 23)
    }
}
#[doc = "SHRTIMER Slave_TIMERx channel output control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st0choctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st0choctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St0choctlSpec;
impl crate::RegisterSpec for St0choctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st0choctl::R`](R) reader structure"]
impl crate::Readable for St0choctlSpec {}
#[doc = "`write(|w| ..)` method takes [`st0choctl::W`](W) writer structure"]
impl crate::Writable for St0choctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST0CHOCTL to value 0"]
impl crate::Resettable for St0choctlSpec {}
