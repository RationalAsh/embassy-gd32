...
impl W {
    #[doc = "Bit 0 - Bit 0 of a 10-bit address"]
    #[inline(always)]
    pub fn address_0(&mut self) -> Address0W<'_, Saddr0Spec> {
        Address0W::new(self, 0)
    }
    #[doc = "Bits 1:7 - Highest two bits of a 10-bit address"]
    #[inline(always)]
    pub fn address_1_7(&mut self) -> Address1_7W<'_, Saddr0Spec> {
        Address1_7W::new(self, 1)
    }
    #[doc = "Bits 8:9 - 7-bit address or bits 7:1 of a 10-bit address"]
    #[inline(always)]
    pub fn address_8_9(&mut self) -> Address8_9W<'_, Saddr0Spec> {
    ...
    #[doc = "Bit 15 - I2C address enable"]
    #[inline(always)]
    pub fn addressen(&mut self) -> AddressenW<'_, Saddr0Spec> {
