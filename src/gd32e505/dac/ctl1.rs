...
impl W {
    #[doc = "Bit 0 - DAC_OUT0 data FIFO enable"]
    #[inline(always)]
    pub fn fifoen0(&mut self) -> Fifoen0W<'_, Ctl1Spec> {
        Fifoen0W::new(self, 0)
    }
    #[doc = "Bit 1 - DAC_OUT0 FIFO overflow interrupt enable"]
    #[inline(always)]
    pub fn fifoovrie0(&mut self) -> Fifoovrie0W<'_, Ctl1Spec> {
        Fifoovrie0W::new(self, 1)
    }
    #[doc = "Bit 2 - DAC_OUT0 FIFO underflow interrupt enable"]
    #[inline(always)]
    pub fn fifoudrie0(&mut self) -> Fifoudrie0W<'_, Ctl1Spec> {
        Fifoudrie0W::new(self, 2)
    }
    #[doc = "Bit 16 - DAC_OUT1 data FIFO enable"]
    #[inline(always)]
    pub fn fifoen1(&mut self) -> Fifoen1W<'_, Ctl1Spec> {
        Fifoen1W::new(self, 16)
    }
    #[doc = "Bit 17 - DAC_OUT1 FIFO overflow interrupt enable"]
    #[inline(always)]
    pub fn fifoovrie1(&mut self) -> Fifoovrie1W<'_, Ctl1Spec> {
        Fifoovrie1W::new(self, 17)
    }
    #[doc = "Bit 18 - DAC_OUT1 FIFO underflow interrupt enable"]
    #[inline(always)]
    pub fn fifoudrie1(&mut self) -> Fifoudrie1W<'_, Ctl1Spec> {
