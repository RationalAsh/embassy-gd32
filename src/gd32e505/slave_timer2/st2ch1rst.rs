#[doc = "Register `ST2CH1RST` reader"]
pub type R = crate::R<St2ch1rstSpec>;
#[doc = "Register `ST2CH1RST` writer"]
pub type W = crate::W<St2ch1rstSpec>;
...
impl W {
    #[doc = "Bit 0 - Software event generates channel 1"]
    #[inline(always)]
    pub fn ch1rssev(&mut self) -> Ch1rssevW<'_, St2ch1rstSpec> {
        Ch1rssevW::new(self, 0)
    }
    #[doc = "Bit 1 - Slave_TIMERx reset event generates channel 1"]
    #[inline(always)]
    pub fn ch1rsrst(&mut self) -> Ch1rsrstW<'_, St2ch1rstSpec> {
        Ch1rsrstW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave_TIMERx period event generates channel 1"]
    #[inline(always)]
    pub fn ch1rsper(&mut self) -> Ch1rsperW<'_, St2ch1rstSpec> {
        Ch1rsperW::new(self, 2)
    }
    #[doc = "Bit 3 - Slave_TIMERx compare 0 event generates channel 1"]
    #[inline(always)]
    pub fn ch1rscmp0(&mut self) -> Ch1rscmp0W<'_, St2ch1rstSpec> {
        Ch1rscmp0W::new(self, 3)
    }
    #[doc = "Bit 4 - Slave_TIMERx compare 1 event generates channel 1"]
    #[inline(always)]
    pub fn ch1rscmp1(&mut self) -> Ch1rscmp1W<'_, St2ch1rstSpec> {
        Ch1rscmp1W::new(self, 4)
    }
    #[doc = "Bit 5 - Slave_TIMERx compare 2 event generates channel 1"]
    #[inline(always)]
    pub fn ch1rscmp2(&mut self) -> Ch1rscmp2W<'_, St2ch1rstSpec> {
        Ch1rscmp2W::new(self, 5)
    }
    #[doc = "Bit 6 - Slave_TIMERx compare 3 event generates channel 1"]
    #[inline(always)]
    pub fn ch1rscmp3(&mut self) -> Ch1rscmp3W<'_, St2ch1rstSpec> {
        Ch1rscmp3W::new(self, 6)
    }
    #[doc = "Bit 7 - Master_TIMER period event generates channel 1"]
    #[inline(always)]
    pub fn ch1rsmtper(&mut self) -> Ch1rsmtperW<'_, St2ch1rstSpec> {
        Ch1rsmtperW::new(self, 7)
    }
    #[doc = "Bit 8 - Master_TIMER compare 0 event generates channel 1"]
    #[inline(always)]
    pub fn ch1rsmtcmp0(&mut self) -> Ch1rsmtcmp0W<'_, St2ch1rstSpec> {
        Ch1rsmtcmp0W::new(self, 8)
    }
    #[doc = "Bit 9 - Master_TIMER compare 1 event generates channel 1"]
    #[inline(always)]
    pub fn ch1rsmtcmp1(&mut self) -> Ch1rsmtcmp1W<'_, St2ch1rstSpec> {
        Ch1rsmtcmp1W::new(self, 9)
    }
    #[doc = "Bit 10 - Master_TIMER compare 2 event generates channel 1"]
    #[inline(always)]
    pub fn ch1rsmtcmp2(&mut self) -> Ch1rsmtcmp2W<'_, St2ch1rstSpec> {
        Ch1rsmtcmp2W::new(self, 10)
    }
    #[doc = "Bit 11 - Master_TIMER compare 3 event generates channel 1"]
    #[inline(always)]
    pub fn ch1rsmtcmp3(&mut self) -> Ch1rsmtcmp3W<'_, St2ch1rstSpec> {
        Ch1rsmtcmp3W::new(self, 11)
    }
    #[doc = "Bit 12 - Slave_TIMERx interconnection event 0 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev0(&mut self) -> Ch1rsstev0W<'_, St2ch1rstSpec> {
        Ch1rsstev0W::new(self, 12)
    }
    #[doc = "Bit 13 - Slave_TIMERx interconnection event 1 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev1(&mut self) -> Ch1rsstev1W<'_, St2ch1rstSpec> {
        Ch1rsstev1W::new(self, 13)
    }
    #[doc = "Bit 14 - Slave_TIMERx interconnection event 2 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev2(&mut self) -> Ch1rsstev2W<'_, St2ch1rstSpec> {
        Ch1rsstev2W::new(self, 14)
    }
    #[doc = "Bit 15 - Slave_TIMERx interconnection event 3 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev3(&mut self) -> Ch1rsstev3W<'_, St2ch1rstSpec> {
        Ch1rsstev3W::new(self, 15)
    }
    #[doc = "Bit 16 - Slave_TIMERx interconnection event 4 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev4(&mut self) -> Ch1rsstev4W<'_, St2ch1rstSpec> {
        Ch1rsstev4W::new(self, 16)
    }
    #[doc = "Bit 17 - Slave_TIMERx interconnection event 5 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev5(&mut self) -> Ch1rsstev5W<'_, St2ch1rstSpec> {
        Ch1rsstev5W::new(self, 17)
    }
    #[doc = "Bit 18 - Slave_TIMERx interconnection event 6 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev6(&mut self) -> Ch1rsstev6W<'_, St2ch1rstSpec> {
        Ch1rsstev6W::new(self, 18)
    }
    #[doc = "Bit 19 - Slave_TIMERx interconnection event 7 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev7(&mut self) -> Ch1rsstev7W<'_, St2ch1rstSpec> {
        Ch1rsstev7W::new(self, 19)
    }
    #[doc = "Bit 20 - Slave_TIMERx interconnection event 8 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsstev8(&mut self) -> Ch1rsstev8W<'_, St2ch1rstSpec> {
        Ch1rsstev8W::new(self, 20)
    }
    #[doc = "Bit 21 - External event 0 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev0(&mut self) -> Ch1rsexev0W<'_, St2ch1rstSpec> {
        Ch1rsexev0W::new(self, 21)
    }
    #[doc = "Bit 22 - External event 1 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev1(&mut self) -> Ch1rsexev1W<'_, St2ch1rstSpec> {
        Ch1rsexev1W::new(self, 22)
    }
    #[doc = "Bit 23 - External event 2 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev2(&mut self) -> Ch1rsexev2W<'_, St2ch1rstSpec> {
        Ch1rsexev2W::new(self, 23)
    }
    #[doc = "Bit 24 - External event 3 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev3(&mut self) -> Ch1rsexev3W<'_, St2ch1rstSpec> {
        Ch1rsexev3W::new(self, 24)
    }
    #[doc = "Bit 25 - External event 4 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev4(&mut self) -> Ch1rsexev4W<'_, St2ch1rstSpec> {
        Ch1rsexev4W::new(self, 25)
    }
    #[doc = "Bit 26 - External event 5 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev5(&mut self) -> Ch1rsexev5W<'_, St2ch1rstSpec> {
        Ch1rsexev5W::new(self, 26)
    }
    #[doc = "Bit 27 - External event 6 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev6(&mut self) -> Ch1rsexev6W<'_, St2ch1rstSpec> {
        Ch1rsexev6W::new(self, 27)
    }
    #[doc = "Bit 28 - External event 7 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev7(&mut self) -> Ch1rsexev7W<'_, St2ch1rstSpec> {
        Ch1rsexev7W::new(self, 28)
    }
    #[doc = "Bit 29 - External event 8 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev8(&mut self) -> Ch1rsexev8W<'_, St2ch1rstSpec> {
        Ch1rsexev8W::new(self, 29)
    }
    #[doc = "Bit 30 - External event 9 generates channel 1"]
    #[inline(always)]
    pub fn ch1rsexev9(&mut self) -> Ch1rsexev9W<'_, St2ch1rstSpec> {
        Ch1rsexev9W::new(self, 30)
    }
    #[doc = "Bit 31 - Update event generates channel 1"]
    #[inline(always)]
    pub fn ch1rsup(&mut self) -> Ch1rsupW<'_, St2ch1rstSpec> {
        Ch1rsupW::new(self, 31)
    }
}
#[doc = "SHRTIMER Slave_TIMERx channel 1 reset request register\n\nYou can [`read`](crate::Reg::read) this register and get [`st2ch1rst::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st2ch1rst::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St2ch1rstSpec;
impl crate::RegisterSpec for St2ch1rstSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2ch1rst::R`](R) reader structure"]
impl crate::Readable for St2ch1rstSpec {}
#[doc = "`write(|w| ..)` method takes [`st2ch1rst::W`](W) writer structure"]
impl crate::Writable for St2ch1rstSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST2CH1RST to value 0"]
impl crate::Resettable for St2ch1rstSpec {}
