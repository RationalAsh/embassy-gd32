...
#[doc = "Field `LPMIF` reader - LPM interrupt flag"]
pub type LpmifR = crate::BitReader;
#[doc = "Field `LPMIF` writer - LPM interrupt flag"]
pub type LpmifW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 27 - LPM interrupt flag"]
    #[inline(always)]
    pub fn lpmif(&self) -> LpmifR {
        LpmifR::new(((self.bits >> 27) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 1 - Mode fault interrupt flag"]
    #[inline(always)]
    pub fn mfif(&mut self) -> MfifW<'_, GintfSpec> {
        MfifW::new(self, 1)
    }
    #[doc = "Bit 3 - Start of frame"]
    #[inline(always)]
    pub fn sof(&mut self) -> SofW<'_, GintfSpec> {
        SofW::new(self, 3)
    }
    #[doc = "Bit 10 - Early suspend"]
    #[inline(always)]
    pub fn esp(&mut self) -> EspW<'_, GintfSpec> {
        EspW::new(self, 10)
    }
    #[doc = "Bit 11 - USB suspend"]
    #[inline(always)]
    pub fn sp(&mut self) -> SpW<'_, GintfSpec> {
        SpW::new(self, 11)
    }
    #[doc = "Bit 12 - USB reset"]
    #[inline(always)]
    pub fn rst(&mut self) -> RstW<'_, GintfSpec> {
        RstW::new(self, 12)
    }
    #[doc = "Bit 13 - Enumeration finished"]
    #[inline(always)]
    pub fn enumf(&mut self) -> EnumfW<'_, GintfSpec> {
        EnumfW::new(self, 13)
    }
    #[doc = "Bit 14 - Isochronous OUT packet dropped interrupt"]
    #[inline(always)]
    pub fn isoopdif(&mut self) -> IsoopdifW<'_, GintfSpec> {
        IsoopdifW::new(self, 14)
    }
    #[doc = "Bit 15 - End of periodic frame interrupt flag"]
    #[inline(always)]
    pub fn eopfif(&mut self) -> EopfifW<'_, GintfSpec> {
        EopfifW::new(self, 15)
    }
    #[doc = "Bit 20 - Isochronous IN transfer Not Complete Interrupt Flag"]
    #[inline(always)]
    pub fn isoincif(&mut self) -> IsoincifW<'_, GintfSpec> {
        IsoincifW::new(self, 20)
    }
    #[doc = "Bit 21 - periodic transfer not complete interrupt flag(Host mode)/isochronous OUT transfer not complete interrupt flag(Device mode)"]
    #[inline(always)]
    pub fn pxncif_isooncif(&mut self) -> PxncifIsooncifW<'_, GintfSpec> {
        PxncifIsooncifW::new(self, 21)
    }
    #[doc = "Bit 27 - LPM interrupt flag"]
    #[inline(always)]
    pub fn lpmif(&mut self) -> LpmifW<'_, GintfSpec> {
        LpmifW::new(self, 27)
    }
    #[doc = "Bit 28 - ID pin status change"]
    #[inline(always)]
    pub fn idpsc(&mut self) -> IdpscW<'_, GintfSpec> {
        IdpscW::new(self, 28)
    }
    #[doc = "Bit 29 - Disconnect interrupt flag"]
    #[inline(always)]
    pub fn discif(&mut self) -> DiscifW<'_, GintfSpec> {
        DiscifW::new(self, 29)
    }
    #[doc = "Bit 30 - Session interrupt flag"]
    #[inline(always)]
    pub fn sesif(&mut self) -> SesifW<'_, GintfSpec> {
        SesifW::new(self, 30)
    }
    #[doc = "Bit 31 - Wakeup interrupt flag"]
    #[inline(always)]
    pub fn wkupif(&mut self) -> WkupifW<'_, GintfSpec> {
        WkupifW::new(self, 31)
    }
}
