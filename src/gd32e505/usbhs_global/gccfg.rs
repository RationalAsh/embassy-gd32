...
impl W {
    #[doc = "Bit 0 - Data connect detection status"]
    #[inline(always)]
    pub fn dcdf(&mut self) -> DcdfW<'_, GccfgSpec> {
        DcdfW::new(self, 0)
    }
    #[doc = "Bit 1 - Primary detection status"]
    #[inline(always)]
    pub fn pdf(&mut self) -> PdfW<'_, GccfgSpec> {
        PdfW::new(self, 1)
    }
    #[doc = "Bit 2 - Secondary detection status"]
    #[inline(always)]
    pub fn sdf(&mut self) -> SdfW<'_, GccfgSpec> {
        SdfW::new(self, 2)
    }
    #[doc = "Bit 3 - PS2 detection status"]
    #[inline(always)]
    pub fn ps2f(&mut self) -> Ps2fW<'_, GccfgSpec> {
        Ps2fW::new(self, 3)
    }
    #[doc = "Bit 12 - Battery charging detection enable"]
    #[inline(always)]
    pub fn bcden(&mut self) -> BcdenW<'_, GccfgSpec> {
        BcdenW::new(self, 12)
    }
    #[doc = "Bit 13 - Data connect detection mode enable"]
    #[inline(always)]
    pub fn dcdmen(&mut self) -> DcdmenW<'_, GccfgSpec> {
        DcdmenW::new(self, 13)
    }
    #[doc = "Bit 14 - Primary detection mode enable"]
    #[inline(always)]
    pub fn pdmen(&mut self) -> PdmenW<'_, GccfgSpec> {
        PdmenW::new(self, 14)
    }
    #[doc = "Bit 15 - Secondary detection mode enable"]
    #[inline(always)]
    pub fn sdmen(&mut self) -> SdmenW<'_, GccfgSpec> {
        SdmenW::new(self, 15)
    }
    #[doc = "Bit 16 - Power on"]
    #[inline(always)]
    pub fn pwron(&mut self) -> PwronW<'_, GccfgSpec> {
        PwronW::new(self, 16)
    }
    #[doc = "Bit 20 - SOF output enable"]
    #[inline(always)]
    pub fn sofoen(&mut self) -> SofoenW<'_, GccfgSpec> {
        SofoenW::new(self, 20)
    }
    #[doc = "Bit 21 - Enable of VBUS sensing comparator to detect VBUS valid"]
    #[inline(always)]
    pub fn vden(&mut self) -> VdenW<'_, GccfgSpec> {
        VdenW::new(self, 21)
    }
}
