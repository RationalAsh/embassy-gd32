...
impl W {
    #[doc = "Bits 0:2 - Timeout calibration"]
    #[inline(always)]
    pub fn toc(&mut self) -> TocW<'_, GusbcsSpec> {
        TocW::new(self, 0)
    }
    #[doc = "Bit 4 - HS current software enable"]
    #[inline(always)]
    pub fn hs_cur_fe(&mut self) -> HsCurFeW<'_, GusbcsSpec> {
        HsCurFeW::new(self, 4)
    }
    #[doc = "Bit 5 - Embedded HS PHY selected"]
    #[inline(always)]
    pub fn embphy_hs(&mut self) -> EmbphyHsW<'_, GusbcsSpec> {
        EmbphyHsW::new(self, 5)
    }
    #[doc = "Bit 6 - Embedded FS PHY selected"]
    #[inline(always)]
    pub fn embphy_fs(&mut self) -> EmbphyFsW<'_, GusbcsSpec> {
        EmbphyFsW::new(self, 6)
    }
    #[doc = "Bit 8 - SRP capability enable"]
    #[inline(always)]
    pub fn srpcen(&mut self) -> SrpcenW<'_, GusbcsSpec> {
        SrpcenW::new(self, 8)
    }
    #[doc = "Bit 9 - HNP capability enable"]
    #[inline(always)]
    pub fn hnpcen(&mut self) -> HnpcenW<'_, GusbcsSpec> {
        HnpcenW::new(self, 9)
    }
    #[doc = "Bits 10:13 - USB turnaround time"]
    #[inline(always)]
    pub fn utt(&mut self) -> UttW<'_, GusbcsSpec> {
        UttW::new(self, 10)
    }
    #[doc = "Bit 20 - ULPI external VBUS driver"]
    #[inline(always)]
    pub fn ulpievd(&mut self) -> UlpievdW<'_, GusbcsSpec> {
        UlpievdW::new(self, 20)
    }
    #[doc = "Bit 21 - ULPI external over-current indicator"]
    #[inline(always)]
    pub fn ulpieoi(&mut self) -> UlpieoiW<'_, GusbcsSpec> {
        UlpieoiW::new(self, 21)
    }
    #[doc = "Bit 29 - Force host mode"]
    #[inline(always)]
    pub fn fhm(&mut self) -> FhmW<'_, GusbcsSpec> {
        FhmW::new(self, 29)
    }
    #[doc = "Bit 30 - Force device mode"]
    #[inline(always)]
    pub fn fdm(&mut self) -> FdmW<'_, GusbcsSpec> {
        FdmW::new(self, 30)
    }
}
