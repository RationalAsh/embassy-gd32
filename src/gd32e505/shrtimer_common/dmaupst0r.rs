...
impl W {
    #[doc = "Bit 0 - SHRTIMER_ST0CTL0 update by DMA mode"]
    #[inline(always)]
    pub fn st0ctl0(&mut self) -> St0ctl0W<'_, Dmaupst0rSpec> {
        St0ctl0W::new(self, 0)
    }
    #[doc = "Bit 1 - SHRTIMER_ST0INTC update by DMA mode"]
    #[inline(always)]
    pub fn st0intc(&mut self) -> St0intcW<'_, Dmaupst0rSpec> {
        St0intcW::new(self, 1)
    }
    #[doc = "Bit 2 - SHRTIMER_ST0DMAINTEN update by DMA mode"]
    #[inline(always)]
    pub fn st0dmainten(&mut self) -> St0dmaintenW<'_, Dmaupst0rSpec> {
        St0dmaintenW::new(self, 2)
    }
    #[doc = "Bit 3 - SHRTIMER_ST0CNT update by DMA mode"]
    #[inline(always)]
    pub fn st0cnt(&mut self) -> St0cntW<'_, Dmaupst0rSpec> {
        St0cntW::new(self, 3)
    }
    #[doc = "Bit 4 - SHRTIMER_ST0CAR update by DMA mode"]
    #[inline(always)]
    pub fn st0car(&mut self) -> St0carW<'_, Dmaupst0rSpec> {
        St0carW::new(self, 4)
    }
    #[doc = "Bit 5 - SHRTIMER_ST0CREP update by DMA mode"]
    #[inline(always)]
    pub fn st0crep(&mut self) -> St0crepW<'_, Dmaupst0rSpec> {
        St0crepW::new(self, 5)
    }
    #[doc = "Bit 6 - SHRTIMER_ST0CMP0V update by DMA mode"]
    #[inline(always)]
    pub fn st0cmp0v(&mut self) -> St0cmp0vW<'_, Dmaupst0rSpec> {
        St0cmp0vW::new(self, 6)
    }
    #[doc = "Bit 7 - SHRTIMER_ST0CMP1V update by DMA mode"]
    #[inline(always)]
    pub fn st0cmp1v(&mut self) -> St0cmp1vW<'_, Dmaupst0rSpec> {
        St0cmp1vW::new(self, 7)
    }
    #[doc = "Bit 8 - SHRTIMER_ST0CMP2V update by DMA mode"]
    #[inline(always)]
    pub fn st0cmp2v(&mut self) -> St0cmp2vW<'_, Dmaupst0rSpec> {
        St0cmp2vW::new(self, 8)
    }
    #[doc = "Bit 9 - SHRTIMER_ST0CMP3V update by DMA mode"]
    #[inline(always)]
    pub fn st0cmp3v(&mut self) -> St0cmp3vW<'_, Dmaupst0rSpec> {
        St0cmp3vW::new(self, 9)
    }
    #[doc = "Bit 10 - SHRTIMER_ST0DTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st0dtctl(&mut self) -> St0dtctlW<'_, Dmaupst0rSpec> {
        St0dtctlW::new(self, 10)
    }
    #[doc = "Bit 11 - SHRTIMER_ST0CH0SET update by DMA mode"]
    #[inline(always)]
    pub fn st0ch0set(&mut self) -> St0ch0setW<'_, Dmaupst0rSpec> {
        St0ch0setW::new(self, 11)
    }
    #[doc = "Bit 12 - SHRTIMER_ST0CH0RST update by DMA mode"]
    #[inline(always)]
    pub fn st0ch0rst(&mut self) -> St0ch0rstW<'_, Dmaupst0rSpec> {
        St0ch0rstW::new(self, 12)
    }
    #[doc = "Bit 13 - SHRTIMER_ST0CH1SET update by DMA mode"]
    #[inline(always)]
    pub fn st0ch1set(&mut self) -> St0ch1setW<'_, Dmaupst0rSpec> {
        St0ch1setW::new(self, 13)
    }
    #[doc = "Bit 14 - SHRTIMER_ST0CH1RST update by DMA mode"]
    #[inline(always)]
    pub fn st0ch1rst(&mut self) -> St0ch1rstW<'_, Dmaupst0rSpec> {
        St0ch1rstW::new(self, 14)
    }
    #[doc = "Bit 15 - SHRTIMER_ST0EXEVFCFG0update by DMA mode"]
    #[inline(always)]
    pub fn st0exevfcfg0(&mut self) -> St0exevfcfg0W<'_, Dmaupst0rSpec> {
        St0exevfcfg0W::new(self, 15)
    }
    #[doc = "Bit 16 - SHRTIMER_ST0EXEVFCFG1update by DMA mode"]
    #[inline(always)]
    pub fn st0exevfcfg1(&mut self) -> St0exevfcfg1W<'_, Dmaupst0rSpec> {
        St0exevfcfg1W::new(self, 16)
    }
    #[doc = "Bit 17 - SHRTIMER_ST0CNTRST update by DMA mode"]
    #[inline(always)]
    pub fn st0cntrst(&mut self) -> St0cntrstW<'_, Dmaupst0rSpec> {
        St0cntrstW::new(self, 17)
    }
    #[doc = "Bit 18 - SHRTIMER_ST0CSCTL update by DMA mode"]
    #[inline(always)]
    pub fn st0csctl(&mut self) -> St0csctlW<'_, Dmaupst0rSpec> {
        St0csctlW::new(self, 18)
    }
    #[doc = "Bit 19 - SHRTIMER_ST0CHOCTL update by DMA mode"]
    #[inline(always)]
    pub fn st0choctl(&mut self) -> St0choctlW<'_, Dmaupst0rSpec> {
        St0choctlW::new(self, 19)
    }
    #[doc = "Bit 20 - SHRTIMER_ST0FLTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st0fltctl(&mut self) -> St0fltctlW<'_, Dmaupst0rSpec> {
        St0fltctlW::new(self, 20)
    }
    #[doc = "Bit 31 - SHRTIMER_ST0ACTL update by DMA mode"]
    #[inline(always)]
    pub fn st0actl(&mut self) -> St0actlW<'_, Dmaupst0rSpec> {
        St0actlW::new(self, 31)
    }
}
#[doc = "SHRTIMER DMA update Slave_TIMER0 register\n\nYou can [`read`](crate::Reg::read) this register and get [`dmaupst0r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmaupst0r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
