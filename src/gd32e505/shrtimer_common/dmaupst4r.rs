...
impl W {
    #[doc = "Bit 0 - SHRTIMER_ST4CTL0 update by DMA mode"]
    #[inline(always)]
    pub fn st4ctl0(&mut self) -> St4ctl0W<'_, Dmaupst4rSpec> {
        St4ctl0W::new(self, 0)
    }
    #[doc = "Bit 1 - SHRTIMER_ST4INTC update by DMA mode"]
    #[inline(always)]
    pub fn st4intc(&mut self) -> St4intcW<'_, Dmaupst4rSpec> {
        St4intcW::new(self, 1)
    }
    #[doc = "Bit 2 - SHRTIMER_ST4DMAINTEN update by DMA mode"]
    #[inline(always)]
    pub fn st4dmainten(&mut self) -> St4dmaintenW<'_, Dmaupst4rSpec> {
        St4dmaintenW::new(self, 2)
    }
    #[doc = "Bit 3 - SHRTIMER_ST4CNT update by DMA mode"]
    #[inline(always)]
    pub fn st4cnt(&mut self) -> St4cntW<'_, Dmaupst4rSpec> {
        St4cntW::new(self, 3)
    }
    #[doc = "Bit 4 - SHRTIMER_ST4CAR update by DMA mode"]
    #[inline(always)]
    pub fn st4car(&mut self) -> St4carW<'_, Dmaupst4rSpec> {
        St4carW::new(self, 4)
    }
    #[doc = "Bit 5 - SHRTIMER_ST4CREP update by DMA mode"]
    #[inline(always)]
    pub fn st4crep(&mut self) -> St4crepW<'_, Dmaupst4rSpec> {
        St4crepW::new(self, 5)
    }
    #[doc = "Bit 6 - SHRTIMER_ST4CMP0V update by DMA mode"]
    #[inline(always)]
    pub fn st4cmp0v(&mut self) -> St4cmp0vW<'_, Dmaupst4rSpec> {
        St4cmp0vW::new(self, 6)
    }
    #[doc = "Bit 7 - SHRTIMER_ST4CMP1V update by DMA mode"]
    #[inline(always)]
    pub fn st4cmp1v(&mut self) -> St4cmp1vW<'_, Dmaupst4rSpec> {
        St4cmp1vW::new(self, 7)
    }
    #[doc = "Bit 8 - SHRTIMER_ST4CMP2V update by DMA mode"]
    #[inline(always)]
    pub fn st4cmp2v(&mut self) -> St4cmp2vW<'_, Dmaupst4rSpec> {
        St4cmp2vW::new(self, 8)
    }
    #[doc = "Bit 9 - SHRTIMER_ST4CMP3V update by DMA mode"]
    #[inline(always)]
    pub fn st4cmp3v(&mut self) -> St4cmp3vW<'_, Dmaupst4rSpec> {
        St4cmp3vW::new(self, 9)
    }
    #[doc = "Bit 10 - SHRTIMER_ST4DTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st4dtctl(&mut self) -> St4dtctlW<'_, Dmaupst4rSpec> {
        St4dtctlW::new(self, 10)
    }
    #[doc = "Bit 11 - SHRTIMER_ST4CH0SET update by DMA mode"]
    #[inline(always)]
    pub fn st4ch0set(&mut self) -> St4ch0setW<'_, Dmaupst4rSpec> {
        St4ch0setW::new(self, 11)
    }
    #[doc = "Bit 12 - SHRTIMER_ST4CH0RST update by DMA mode"]
    #[inline(always)]
    pub fn st4ch0rst(&mut self) -> St4ch0rstW<'_, Dmaupst4rSpec> {
        St4ch0rstW::new(self, 12)
    }
    #[doc = "Bit 13 - SHRTIMER_ST4CH1SET update by DMA mode"]
    #[inline(always)]
    pub fn st4ch1set(&mut self) -> St4ch1setW<'_, Dmaupst4rSpec> {
        St4ch1setW::new(self, 13)
    }
    #[doc = "Bit 14 - SHRTIMER_ST4CH1RST update by DMA mode"]
    #[inline(always)]
    pub fn st4ch1rst(&mut self) -> St4ch1rstW<'_, Dmaupst4rSpec> {
        St4ch1rstW::new(self, 14)
    }
    #[doc = "Bit 15 - SHRTIMER_ST4EXEVFCFG0update by DMA mode"]
    #[inline(always)]
    pub fn st4exevfcfg0(&mut self) -> St4exevfcfg0W<'_, Dmaupst4rSpec> {
        St4exevfcfg0W::new(self, 15)
    }
    #[doc = "Bit 16 - SHRTIMER_ST4EXEVFCFG1update by DMA mode"]
    #[inline(always)]
    pub fn st4exevfcfg1(&mut self) -> St4exevfcfg1W<'_, Dmaupst4rSpec> {
        St4exevfcfg1W::new(self, 16)
    }
    #[doc = "Bit 17 - SHRTIMER_ST4CNTRST update by DMA mode"]
    #[inline(always)]
    pub fn st4cntrst(&mut self) -> St4cntrstW<'_, Dmaupst4rSpec> {
        St4cntrstW::new(self, 17)
    }
    #[doc = "Bit 18 - SHRTIMER_ST4CSCTL update by DMA mode"]
    #[inline(always)]
    pub fn st4csctl(&mut self) -> St4csctlW<'_, Dmaupst4rSpec> {
        St4csctlW::new(self, 18)
    }
    #[doc = "Bit 19 - SHRTIMER_ST4CHOCTL update by DMA mode"]
    #[inline(always)]
    pub fn st4choctl(&mut self) -> St4choctlW<'_, Dmaupst4rSpec> {
        St4choctlW::new(self, 19)
    }
    #[doc = "Bit 20 - SHRTIMER_ST4FLTCTL update by DMA mode"]
    #[inline(always)]
    pub fn st4fltctl(&mut self) -> St4fltctlW<'_, Dmaupst4rSpec> {
        St4fltctlW::new(self, 20)
    }
    #[doc = "Bit 31 - SHRTIMER_ST4ACTL update by DMA mode"]
    #[inline(always)]
    pub fn st4actl(&mut self) -> St4actlW<'_, Dmaupst4rSpec> {
        St4actlW::new(self, 31)
    }
}
#[doc = "SHRTIMER DMA update Slave_TIMER4 register\n\nYou can [`read`](crate::Reg::read) this register and get [`dmaupst4r::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmaupst4r::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
