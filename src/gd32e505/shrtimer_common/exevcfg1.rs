...
impl W {
    #[doc = "Bits 0:1 - External event 0 source"]
    #[inline(always)]
    pub fn exev5src(&mut self) -> Exev5srcW<'_, Exevcfg1Spec> {
        Exev5srcW::new(self, 0)
    }
    #[doc = "Bit 2 - External event 0 polarity"]
    #[inline(always)]
    pub fn exev5p(&mut self) -> Exev5pW<'_, Exevcfg1Spec> {
        Exev5pW::new(self, 2)
    }
    #[doc = "Bits 3:4 - External event 0 edge sensitivity"]
    #[inline(always)]
    pub fn exev5eg(&mut self) -> Exev5egW<'_, Exevcfg1Spec> {
        Exev5egW::new(self, 3)
    }
    #[doc = "Bits 6:7 - External event 1 source"]
    #[inline(always)]
    pub fn exev6src(&mut self) -> Exev6srcW<'_, Exevcfg1Spec> {
        Exev6srcW::new(self, 6)
    }
    #[doc = "Bit 8 - External event 1 polarity"]
    #[inline(always)]
    pub fn exev6p(&mut self) -> Exev6pW<'_, Exevcfg1Spec> {
        Exev6pW::new(self, 8)
    }
    #[doc = "Bits 9:10 - External event 6 edge sensitivity"]
    #[inline(always)]
    pub fn exev6eg(&mut self) -> Exev6egW<'_, Exevcfg1Spec> {
        Exev6egW::new(self, 9)
    }
    #[doc = "Bits 12:13 - External event 7 source"]
    #[inline(always)]
    pub fn exev7src(&mut self) -> Exev7srcW<'_, Exevcfg1Spec> {
        Exev7srcW::new(self, 12)
    }
    #[doc = "Bit 14 - External event 7polarity"]
    #[inline(always)]
    pub fn exev7p(&mut self) -> Exev7pW<'_, Exevcfg1Spec> {
        Exev7pW::new(self, 14)
    }
    #[doc = "Bits 15:16 - External event 7 edge sensitivity"]
    #[inline(always)]
    pub fn exev7eg(&mut self) -> Exev7egW<'_, Exevcfg1Spec> {
        Exev7egW::new(self, 15)
    }
    #[doc = "Bits 18:19 - External event 8 source"]
    #[inline(always)]
    pub fn exev8src(&mut self) -> Exev8srcW<'_, Exevcfg1Spec> {
        Exev8srcW::new(self, 18)
    }
    #[doc = "Bit 20 - External event 8 polarity"]
    #[inline(always)]
    pub fn exev8p(&mut self) -> Exev8pW<'_, Exevcfg1Spec> {
        Exev8pW::new(self, 20)
    }
    #[doc = "Bits 21:22 - External event 8 edge sensitivity"]
    #[inline(always)]
    pub fn exev8eg(&mut self) -> Exev8egW<'_, Exevcfg1Spec> {
        Exev8egW::new(self, 21)
    }
    #[doc = "Bits 24:25 - External event 9 source"]
    #[inline(always)]
    pub fn exev9src(&mut self) -> Exev9srcW<'_, Exevcfg1Spec> {
        Exev9srcW::new(self, 24)
    }
    #[doc = "Bit 26 - External event 9 polarity"]
    #[inline(always)]
    pub fn exev9p(&mut self) -> Exev9pW<'_, Exevcfg1Spec> {
        Exev9pW::new(self, 26)
    }
    #[doc = "Bits 27:28 - External event 9 edge sensitivity"]
    #[inline(always)]
    pub fn exev9eg(&mut self) -> Exev9egW<'_, Exevcfg1Spec> {
        Exev9egW::new(self, 27)
    }
}
#[doc = "SHRTIMER external event configuration register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`exevcfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`exevcfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
