...
impl W {
    #[doc = "Bit 0 - SHRTIMER_MTCTL0 update by DMA mode"]
    #[inline(always)]
    pub fn mtctl0(&mut self) -> Mtctl0W<'_, DmaupmtrSpec> {
        Mtctl0W::new(self, 0)
    }
    #[doc = "Bit 1 - SHRTIMER_MTINTC update by DMA mode"]
    #[inline(always)]
    pub fn mtintc(&mut self) -> MtintcW<'_, DmaupmtrSpec> {
        MtintcW::new(self, 1)
    }
    #[doc = "Bit 2 - SHRTIMER_MTDMAINTEN update by DMA mode"]
    #[inline(always)]
    pub fn mtdmainten(&mut self) -> MtdmaintenW<'_, DmaupmtrSpec> {
        MtdmaintenW::new(self, 2)
    }
    #[doc = "Bit 3 - SHRTIMER_MTCNT update by DMA mode"]
    #[inline(always)]
    pub fn mtcnt(&mut self) -> MtcntW<'_, DmaupmtrSpec> {
        MtcntW::new(self, 3)
    }
    #[doc = "Bit 4 - SHRTIMER_MTCAR update by DMA mode"]
    #[inline(always)]
    pub fn mtcar(&mut self) -> MtcarW<'_, DmaupmtrSpec> {
        MtcarW::new(self, 4)
    }
    #[doc = "Bit 5 - SHRTIMER_MTCAR update by DMA mode"]
    #[inline(always)]
    pub fn mtcrep(&mut self) -> MtcrepW<'_, DmaupmtrSpec> {
        MtcrepW::new(self, 5)
    }
    #[doc = "Bit 6 - SHRTIMER_MTCMP0V update by DMA mode"]
    #[inline(always)]
    pub fn mtcmp0v(&mut self) -> Mtcmp0vW<'_, DmaupmtrSpec> {
        Mtcmp0vW::new(self, 6)
    }
    #[doc = "Bit 7 - SHRTIMER_MTCMP1V update by DMA mode"]
    #[inline(always)]
    pub fn mtcmp1v(&mut self) -> Mtcmp1vW<'_, DmaupmtrSpec> {
        Mtcmp1vW::new(self, 7)
    }
    #[doc = "Bit 8 - SHRTIMER_MTCMP2V update by DMA mode"]
    #[inline(always)]
    pub fn mtcmp2v(&mut self) -> Mtcmp2vW<'_, DmaupmtrSpec> {
        Mtcmp2vW::new(self, 8)
    }
    #[doc = "Bit 9 - SHRTIMER_MTCMP3V update by DMA mode"]
    #[inline(always)]
    pub fn mtcmp3v(&mut self) -> Mtcmp3vW<'_, DmaupmtrSpec> {
        Mtcmp3vW::new(self, 9)
    }
    #[doc = "Bit 31 - SHRTIMER_MTACTL update by DMA mode"]
    #[inline(always)]
    pub fn mtactl(&mut self) -> MtactlW<'_, DmaupmtrSpec> {
        MtactlW::new(self, 31)
    }
}
#[doc = "SHRTIMER DMA update Master_TIMER register\n\nYou can [`read`](crate::Reg::read) this register and get [`dmaupmtr::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dmaupmtr::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
