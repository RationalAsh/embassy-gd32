...
impl W {
    #[doc = "Bit 0 - Fault 0 input enable"]
    #[inline(always)]
    pub fn flt0inen(&mut self) -> Flt0inenW<'_, Fltincfg0Spec> {
        Flt0inenW::new(self, 0)
    }
    #[doc = "Bit 1 - Fault 0 input polarity"]
    #[inline(always)]
    pub fn flt0inp(&mut self) -> Flt0inpW<'_, Fltincfg0Spec> {
        Flt0inpW::new(self, 1)
    }
    #[doc = "Bit 2 - Fault 0 input source"]
    #[inline(always)]
    pub fn flt0insrc(&mut self) -> Flt0insrcW<'_, Fltincfg0Spec> {
        Flt0insrcW::new(self, 2)
    }
    #[doc = "Bits 3:6 - Fault 0 input filter control"]
    #[inline(always)]
    pub fn flt0infc(&mut self) -> Flt0infcW<'_, Fltincfg0Spec> {
        Flt0infcW::new(self, 3)
    }
    #[doc = "Bit 7 - Protect fault 0 input configuration"]
    #[inline(always)]
    pub fn flt0inprot(&mut self) -> Flt0inprotW<'_, Fltincfg0Spec> {
        Flt0inprotW::new(self, 7)
    }
    #[doc = "Bit 8 - Fault 1 input enable"]
    #[inline(always)]
    pub fn flt1inen(&mut self) -> Flt1inenW<'_, Fltincfg0Spec> {
        Flt1inenW::new(self, 8)
    }
    #[doc = "Bit 9 - Fault 1 input polarity"]
    #[inline(always)]
    pub fn flt1inp(&mut self) -> Flt1inpW<'_, Fltincfg0Spec> {
        Flt1inpW::new(self, 9)
    }
    #[doc = "Bit 10 - Fault 2 input source"]
    #[inline(always)]
    pub fn flt1insrc(&mut self) -> Flt1insrcW<'_, Fltincfg0Spec> {
        Flt1insrcW::new(self, 10)
    }
    #[doc = "Bits 11:14 - Fault 1 input filter control"]
    #[inline(always)]
    pub fn flt1infc(&mut self) -> Flt1infcW<'_, Fltincfg0Spec> {
        Flt1infcW::new(self, 11)
    }
    #[doc = "Bit 15 - Protect fault 1 input configuration"]
    #[inline(always)]
    pub fn flt1inprot(&mut self) -> Flt1inprotW<'_, Fltincfg0Spec> {
        Flt1inprotW::new(self, 15)
    }
    #[doc = "Bit 16 - Fault 2 input enable"]
    #[inline(always)]
    pub fn flt2inen(&mut self) -> Flt2inenW<'_, Fltincfg0Spec> {
        Flt2inenW::new(self, 16)
    }
    #[doc = "Bit 17 - Fault 2 input polarity"]
    #[inline(always)]
    pub fn flt2inp(&mut self) -> Flt2inpW<'_, Fltincfg0Spec> {
        Flt2inpW::new(self, 17)
    }
    #[doc = "Bit 18 - Fault 2 input source"]
    #[inline(always)]
    pub fn flt2insrc(&mut self) -> Flt2insrcW<'_, Fltincfg0Spec> {
        Flt2insrcW::new(self, 18)
    }
    #[doc = "Bits 19:22 - Fault 2 input filter control"]
    #[inline(always)]
    pub fn flt2infc(&mut self) -> Flt2infcW<'_, Fltincfg0Spec> {
        Flt2infcW::new(self, 19)
    }
    #[doc = "Bit 23 - Protect fault 2 input configuration"]
    #[inline(always)]
    pub fn flt2inprot(&mut self) -> Flt2inprotW<'_, Fltincfg0Spec> {
        Flt2inprotW::new(self, 23)
    }
    #[doc = "Bit 24 - Fault 3 input enable"]
    #[inline(always)]
    pub fn flt3inen(&mut self) -> Flt3inenW<'_, Fltincfg0Spec> {
        Flt3inenW::new(self, 24)
    }
    #[doc = "Bit 25 - Fault 3 input polarity"]
    #[inline(always)]
    pub fn flt3inp(&mut self) -> Flt3inpW<'_, Fltincfg0Spec> {
        Flt3inpW::new(self, 25)
    }
    #[doc = "Bit 26 - Fault 3 input source"]
    #[inline(always)]
    pub fn flt3insrc(&mut self) -> Flt3insrcW<'_, Fltincfg0Spec> {
        Flt3insrcW::new(self, 26)
    }
    #[doc = "Bits 27:30 - Fault 3 input filter control"]
    #[inline(always)]
    pub fn flt3infc(&mut self) -> Flt3infcW<'_, Fltincfg0Spec> {
        Flt3infcW::new(self, 27)
    }
    #[doc = "Bit 31 - Protect fault 3 input configuration"]
    #[inline(always)]
    pub fn flt3inprot(&mut self) -> Flt3inprotW<'_, Fltincfg0Spec> {
        Flt3inprotW::new(self, 31)
    }
}
#[doc = "SHRTIMER fault input configuration register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`fltincfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fltincfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
