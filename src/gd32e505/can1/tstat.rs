...
impl W {
    #[doc = "Bit 0 - Mailbox 0 transmit finished"]
    #[inline(always)]
    pub fn mtf0(&mut self) -> Mtf0W<'_, TstatSpec> {
        Mtf0W::new(self, 0)
    }
    #[doc = "Bit 1 - Mailbox 0 transmit finished and no error"]
    #[inline(always)]
    pub fn mtfnerr0(&mut self) -> Mtfnerr0W<'_, TstatSpec> {
        Mtfnerr0W::new(self, 1)
    }
    #[doc = "Bit 2 - Mailbox 0 arbitration lost"]
    #[inline(always)]
    pub fn mal0(&mut self) -> Mal0W<'_, TstatSpec> {
        Mal0W::new(self, 2)
    }
    #[doc = "Bit 3 - Mailbox 0 transmit error"]
    #[inline(always)]
    pub fn mte0(&mut self) -> Mte0W<'_, TstatSpec> {
        Mte0W::new(self, 3)
    }
    #[doc = "Bit 7 - Mailbox 0 stop transmitting"]
    #[inline(always)]
    pub fn mst0(&mut self) -> Mst0W<'_, TstatSpec> {
        Mst0W::new(self, 7)
    }
    #[doc = "Bit 8 - Mailbox 1 transmit finished"]
    #[inline(always)]
    pub fn mtf1(&mut self) -> Mtf1W<'_, TstatSpec> {
        Mtf1W::new(self, 8)
    }
    #[doc = "Bit 9 - Mailbox 1 transmit finished and no error"]
    #[inline(always)]
    pub fn mtfnerr1(&mut self) -> Mtfnerr1W<'_, TstatSpec> {
        Mtfnerr1W::new(self, 9)
    }
    #[doc = "Bit 10 - Mailbox 1 arbitration lost"]
    #[inline(always)]
    pub fn mal1(&mut self) -> Mal1W<'_, TstatSpec> {
        Mal1W::new(self, 10)
    }
    #[doc = "Bit 11 - Mailbox 1 transmit error"]
    #[inline(always)]
    pub fn mte1(&mut self) -> Mte1W<'_, TstatSpec> {
        Mte1W::new(self, 11)
    }
    #[doc = "Bit 15 - Mailbox 1 stop transmitting"]
    #[inline(always)]
    pub fn mst1(&mut self) -> Mst1W<'_, TstatSpec> {
        Mst1W::new(self, 15)
    }
    #[doc = "Bit 16 - Mailbox 2 transmit finished"]
    #[inline(always)]
    pub fn mtf2(&mut self) -> Mtf2W<'_, TstatSpec> {
        Mtf2W::new(self, 16)
    }
    #[doc = "Bit 17 - Mailbox 2 transmit finished and no error"]
    #[inline(always)]
    pub fn mtfnerr2(&mut self) -> Mtfnerr2W<'_, TstatSpec> {
        Mtfnerr2W::new(self, 17)
    }
    #[doc = "Bit 18 - Mailbox 2 arbitration lost"]
    #[inline(always)]
    pub fn mal2(&mut self) -> Mal2W<'_, TstatSpec> {
        Mal2W::new(self, 18)
    }
    #[doc = "Bit 19 - Mailbox 2 transmit error"]
    #[inline(always)]
    pub fn mte2(&mut self) -> Mte2W<'_, TstatSpec> {
        Mte2W::new(self, 19)
    }
    #[doc = "Bit 23 - Mailbox 2 stop transmitting"]
    #[inline(always)]
    pub fn mst2(&mut self) -> Mst2W<'_, TstatSpec> {
        Mst2W::new(self, 23)
    }
}
