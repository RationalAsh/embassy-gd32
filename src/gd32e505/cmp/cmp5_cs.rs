...
impl W {
    #[doc = "Bit 0 - Comparator 5 enable"]
    #[inline(always)]
    pub fn cmp5en(&mut self) -> Cmp5enW<'_, Cmp5CsSpec> {
        Cmp5enW::new(self, 0)
    }
    #[doc = "Bits 4:6 - Comparator 5 input selection"]
    #[inline(always)]
    pub fn cmp5msel(&mut self) -> Cmp5mselW<'_, Cmp5CsSpec> {
        Cmp5mselW::new(self, 4)
    }
    #[doc = "Bits 10:13 - Comparator 5 output selection"]
    #[inline(always)]
    pub fn cmp5osel(&mut self) -> Cmp5oselW<'_, Cmp5CsSpec> {
        Cmp5oselW::new(self, 10)
    }
    #[doc = "Bit 15 - Polarity of comparator 5 output"]
    #[inline(always)]
    pub fn cmp5pl(&mut self) -> Cmp5plW<'_, Cmp5CsSpec> {
        Cmp5plW::new(self, 15)
    }
    #[doc = "Bits 18:20 - CMP5 output blanking source"]
    #[inline(always)]
    pub fn cmp5blk(&mut self) -> Cmp5blkW<'_, Cmp5CsSpec> {
        Cmp5blkW::new(self, 18)
    }
    #[doc = "Bit 22 - CMP5_IM input selection"]
    #[inline(always)]
    pub fn cmp5msel_3(&mut self) -> Cmp5msel3W<'_, Cmp5CsSpec> {
        Cmp5msel3W::new(self, 22)
    }
    #[doc = "Bit 31 - Comparator 5 lock"]
    #[inline(always)]
    pub fn cmp5lk(&mut self) -> Cmp5lkW<'_, Cmp5CsSpec> {
        Cmp5lkW::new(self, 31)
    }
}
#[doc = "CMP5 control and status register\n\nYou can [`read`](crate::Reg::read) this register and get [`cmp5_cs::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`cmp5_cs::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
