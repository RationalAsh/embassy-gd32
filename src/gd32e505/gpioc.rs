...
pub mod lock;
#[doc = "SPD (rw) register accessor: Port bit speed register\n\nYou can [`read`](crate::Reg::read) this register and get [`spd::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`spd::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@spd`] module"]
#[doc(alias = "SPD")]
