...
pub mod gp;
#[doc = "GDCTL (rw) register accessor: GD control register\n\nYou can [`read`](crate::Reg::read) this register and get [`gdctl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`gdctl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@gdctl`] module"]
#[doc(alias = "GDCTL")]
