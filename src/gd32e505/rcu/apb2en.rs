...
pub type ShrtimerenR = crate::BitReader;
#[doc = "Field `SHRTIMEREN` writer - SHRTIMER clock enable"]
pub type ShrtimerenW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CMPEN` reader - CMP clock enable"]
pub type CmpenR = crate::BitReader;
#[doc = "Field `CMPEN` writer - CMP clock enable"]
...
impl R {
    ...
    pub fn usart5en(&self) -> Usart5enR {
        Usart5enR::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - SHRTIMER clock enable"]
    #[inline(always)]
    pub fn shrtimeren(&self) -> ShrtimerenR {
        ShrtimerenR::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 31 - CMP clock enable"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Alternate function IO clock enable"]
    #[inline(always)]
    pub fn afen(&mut self) -> AfenW<'_, Apb2enSpec> {
        AfenW::new(self, 0)
    }
    #[doc = "Bit 2 - GPIO port A clock enable"]
    #[inline(always)]
    pub fn paen(&mut self) -> PaenW<'_, Apb2enSpec> {
        PaenW::new(self, 2)
    }
    #[doc = "Bit 3 - GPIO port B clock enable"]
    #[inline(always)]
    pub fn pben(&mut self) -> PbenW<'_, Apb2enSpec> {
        PbenW::new(self, 3)
    }
    #[doc = "Bit 4 - GPIO port C clock enable"]
    #[inline(always)]
    pub fn pcen(&mut self) -> PcenW<'_, Apb2enSpec> {
        PcenW::new(self, 4)
    }
    #[doc = "Bit 5 - GPIO port D clock enable"]
    #[inline(always)]
    pub fn pden(&mut self) -> PdenW<'_, Apb2enSpec> {
        PdenW::new(self, 5)
    }
    #[doc = "Bit 6 - GPIO port E clock enable"]
    #[inline(always)]
    pub fn peen(&mut self) -> PeenW<'_, Apb2enSpec> {
        PeenW::new(self, 6)
    }
    #[doc = "Bit 7 - GPIO port F clock enable"]
    #[inline(always)]
    pub fn pfen(&mut self) -> PfenW<'_, Apb2enSpec> {
        PfenW::new(self, 7)
    }
    #[doc = "Bit 8 - GPIO port G clock enable"]
    #[inline(always)]
    pub fn pgen(&mut self) -> PgenW<'_, Apb2enSpec> {
        PgenW::new(self, 8)
    }
    #[doc = "Bit 9 - ADC0 clock enable"]
    #[inline(always)]
    pub fn adc0en(&mut self) -> Adc0enW<'_, Apb2enSpec> {
        Adc0enW::new(self, 9)
    }
    #[doc = "Bit 10 - ADC1 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - TIMER0 clock enable"]
    #[inline(always)]
    pub fn timer0en(&mut self) -> Timer0enW<'_, Apb2enSpec> {
        Timer0enW::new(self, 11)
    }
    #[doc = "Bit 12 - SPI0 clock enable"]
    #[inline(always)]
    pub fn spi0en(&mut self) -> Spi0enW<'_, Apb2enSpec> {
        Spi0enW::new(self, 12)
    }
    #[doc = "Bit 13 - TIMER7 clock enable"]
    #[inline(always)]
    pub fn timer7en(&mut self) -> Timer7enW<'_, Apb2enSpec> {
        Timer7enW::new(self, 13)
    }
    #[doc = "Bit 14 - USART0 clock enable"]
    #[inline(always)]
    pub fn usart0en(&mut self) -> Usart0enW<'_, Apb2enSpec> {
    ...
    #[doc = "Bit 19 - TIMER8 clock enable"]
    #[inline(always)]
    pub fn timer8en(&mut self) -> Timer8enW<'_, Apb2enSpec> {
        Timer8enW::new(self, 19)
    }
    #[doc = "Bit 20 - TIMER9 clock enable"]
    #[inline(always)]
    pub fn timer9en(&mut self) -> Timer9enW<'_, Apb2enSpec> {
        Timer9enW::new(self, 20)
    }
    #[doc = "Bit 21 - TIMER10 clock enable"]
    #[inline(always)]
    pub fn timer10en(&mut self) -> Timer10enW<'_, Apb2enSpec> {
        Timer10enW::new(self, 21)
    }
    #[doc = "Bit 28 - USART5 clock enable"]
    #[inline(always)]
    pub fn usart5en(&mut self) -> Usart5enW<'_, Apb2enSpec> {
        Usart5enW::new(self, 28)
    }
    #[doc = "Bit 29 - SHRTIMER clock enable"]
    #[inline(always)]
    pub fn shrtimeren(&mut self) -> ShrtimerenW<'_, Apb2enSpec> {
        ShrtimerenW::new(self, 29)
    }
    #[doc = "Bit 31 - CMP clock enable"]
    #[inline(always)]
    pub fn cmpen(&mut self) -> CmpenW<'_, Apb2enSpec> {
        CmpenW::new(self, 31)
    }
}
