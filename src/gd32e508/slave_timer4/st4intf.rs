#[doc = "Register `ST4INTF` reader"]
pub type R = crate::R<St4intfSpec>;
...
#[doc = "SHRTIMER Slave_TIMERx interrupt flag register\n\nYou can [`read`](crate::Reg::read) this register and get [`st4intf::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St4intfSpec;
impl crate::RegisterSpec for St4intfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4intf::R`](R) reader structure"]
impl crate::Readable for St4intfSpec {}
#[doc = "`reset()` method sets ST4INTF to value 0"]
impl crate::Resettable for St4intfSpec {}
