#[doc = "Register `ST4FLTCTL` reader"]
pub type R = crate::R<St4fltctlSpec>;
#[doc = "Register `ST4FLTCTL` writer"]
pub type W = crate::W<St4fltctlSpec>;
...
impl W {
    #[doc = "Bit 0 - Fault 0 enable"]
    #[inline(always)]
    pub fn flt0en(&mut self) -> Flt0enW<'_, St4fltctlSpec> {
        Flt0enW::new(self, 0)
    }
    #[doc = "Bit 1 - Fault 1 enable"]
    #[inline(always)]
    pub fn flt1en(&mut self) -> Flt1enW<'_, St4fltctlSpec> {
        Flt1enW::new(self, 1)
    }
    #[doc = "Bit 2 - Fault 2 enable"]
    #[inline(always)]
    pub fn flt2en(&mut self) -> Flt2enW<'_, St4fltctlSpec> {
        Flt2enW::new(self, 2)
    }
    #[doc = "Bit 3 - Fault 3 enable"]
    #[inline(always)]
    pub fn flt3en(&mut self) -> Flt3enW<'_, St4fltctlSpec> {
        Flt3enW::new(self, 3)
    }
    #[doc = "Bit 4 - Fault 4 enable"]
    #[inline(always)]
    pub fn flt4en(&mut self) -> Flt4enW<'_, St4fltctlSpec> {
        Flt4enW::new(self, 4)
    }
    #[doc = "Bit 31 - Protect fault enable"]
    #[inline(always)]
    pub fn fltenprot(&mut self) -> FltenprotW<'_, St4fltctlSpec> {
        FltenprotW::new(self, 31)
    }
}
#[doc = "SHRTIMER Slave_TIMERx fault control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st4fltctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st4fltctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St4fltctlSpec;
impl crate::RegisterSpec for St4fltctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st4fltctl::R`](R) reader structure"]
impl crate::Readable for St4fltctlSpec {}
#[doc = "`write(|w| ..)` method takes [`st4fltctl::W`](W) writer structure"]
impl crate::Writable for St4fltctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST4FLTCTL to value 0"]
impl crate::Resettable for St4fltctlSpec {}
