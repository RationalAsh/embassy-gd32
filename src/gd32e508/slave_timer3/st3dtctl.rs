#[doc = "Register `ST3DTCTL` reader"]
pub type R = crate::R<St3dtctlSpec>;
#[doc = "Register `ST3DTCTL` writer"]
pub type W = crate::W<St3dtctlSpec>;
...
impl W {
    #[doc = "Bits 0:8 - Falling edge dead-time value"]
    #[inline(always)]
    pub fn dtrcfg(&mut self) -> DtrcfgW<'_, St3dtctlSpec> {
        DtrcfgW::new(self, 0)
    }
    #[doc = "Bit 9 - The sign of falling edge dead-time value"]
    #[inline(always)]
    pub fn dtrs(&mut self) -> DtrsW<'_, St3dtctlSpec> {
        DtrsW::new(self, 9)
    }
    #[doc = "Bits 10:13 - Dead time generator clock division"]
    #[inline(always)]
    pub fn dtgckdiv(&mut self) -> DtgckdivW<'_, St3dtctlSpec> {
        DtgckdivW::new(self, 10)
    }
    #[doc = "Bit 14 - Dead-time rising edge protection for sign"]
    #[inline(always)]
    pub fn dtrsprot(&mut self) -> DtrsprotW<'_, St3dtctlSpec> {
        DtrsprotW::new(self, 14)
    }
    #[doc = "Bit 15 - Dead-time rising edge protection for value and sign"]
    #[inline(always)]
    pub fn dtrsvprot(&mut self) -> DtrsvprotW<'_, St3dtctlSpec> {
        DtrsvprotW::new(self, 15)
    }
    #[doc = "Bits 16:24 - Falling edge dead-time value"]
    #[inline(always)]
    pub fn dtfcfg(&mut self) -> DtfcfgW<'_, St3dtctlSpec> {
        DtfcfgW::new(self, 16)
    }
    #[doc = "Bit 25 - The sign of falling edge dead-time value"]
    #[inline(always)]
    pub fn dtfs(&mut self) -> DtfsW<'_, St3dtctlSpec> {
        DtfsW::new(self, 25)
    }
    #[doc = "Bit 30 - Dead-time falling edge protection for sign"]
    #[inline(always)]
    pub fn dtfsprot(&mut self) -> DtfsprotW<'_, St3dtctlSpec> {
        DtfsprotW::new(self, 30)
    }
    #[doc = "Bit 31 - Dead-time falling edge protection for value and sign"]
    #[inline(always)]
    pub fn dtfsvprot(&mut self) -> DtfsvprotW<'_, St3dtctlSpec> {
        DtfsvprotW::new(self, 31)
    }
}
#[doc = "SHRTIMER Slave_TIMERx dead-time control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st3dtctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st3dtctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St3dtctlSpec;
impl crate::RegisterSpec for St3dtctlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3dtctl::R`](R) reader structure"]
impl crate::Readable for St3dtctlSpec {}
#[doc = "`write(|w| ..)` method takes [`st3dtctl::W`](W) writer structure"]
impl crate::Writable for St3dtctlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST3DTCTL to value 0"]
impl crate::Resettable for St3dtctlSpec {}
