...
impl W {
    #[doc = "Bits 0:9 - Slave address to be sent"]
    #[inline(always)]
    pub fn saddress(&mut self) -> SaddressW<'_, Ctl1Spec> {
        SaddressW::new(self, 0)
    }
    #[doc = "Bit 10 - Transfer direction in master mode"]
    #[inline(always)]
    pub fn trdir(&mut self) -> TrdirW<'_, Ctl1Spec> {
        TrdirW::new(self, 10)
    }
    #[doc = "Bit 11 - 10-bit addressing mode enable in master mode"]
    #[inline(always)]
    pub fn add10en(&mut self) -> Add10enW<'_, Ctl1Spec> {
        Add10enW::new(self, 11)
    }
    #[doc = "Bit 12 - 10-bit address header executes read direction only in master receive mode"]
    #[inline(always)]
    pub fn head10r(&mut self) -> Head10rW<'_, Ctl1Spec> {
        Head10rW::new(self, 12)
    }
    #[doc = "Bit 13 - Generate a START condition on I2C bus"]
    #[inline(always)]
    pub fn start(&mut self) -> StartW<'_, Ctl1Spec> {
        StartW::new(self, 13)
    }
    #[doc = "Bit 14 - Generate a STOP condition on I2C bus"]
    #[inline(always)]
    pub fn stop(&mut self) -> StopW<'_, Ctl1Spec> {
        StopW::new(self, 14)
    }
    #[doc = "Bit 15 - Generate NACK in slave mode"]
    #[inline(always)]
    pub fn nacken(&mut self) -> NackenW<'_, Ctl1Spec> {
        NackenW::new(self, 15)
    }
    #[doc = "Bits 16:23 - Number of bytes to be transferred"]
    #[inline(always)]
    pub fn bytenum(&mut self) -> BytenumW<'_, Ctl1Spec> {
        BytenumW::new(self, 16)
    }
    #[doc = "Bit 24 - Reload mode"]
    #[inline(always)]
    pub fn reload(&mut self) -> ReloadW<'_, Ctl1Spec> {
        ReloadW::new(self, 24)
    }
    #[doc = "Bit 25 - Automatic end mode in master mode"]
    #[inline(always)]
    pub fn autoend(&mut self) -> AutoendW<'_, Ctl1Spec> {
        AutoendW::new(self, 25)
    }
    #[doc = "Bit 26 - PEC Transfer"]
    #[inline(always)]
    pub fn pectrans(&mut self) -> PectransW<'_, Ctl1Spec> {
