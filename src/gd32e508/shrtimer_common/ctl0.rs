...
impl W {
    #[doc = "Bit 0 - Master_TIMER update disable"]
    #[inline(always)]
    pub fn mtupdis(&mut self) -> MtupdisW<'_, Ctl0Spec> {
        MtupdisW::new(self, 0)
    }
    #[doc = "Bit 1 - Slave_TIMER0 update disable"]
    #[inline(always)]
    pub fn st0updis(&mut self) -> St0updisW<'_, Ctl0Spec> {
        St0updisW::new(self, 1)
    }
    #[doc = "Bit 3 - Slave_TIMER2 update disable"]
    #[inline(always)]
    pub fn st2updis(&mut self) -> St2updisW<'_, Ctl0Spec> {
        St2updisW::new(self, 3)
    }
    #[doc = "Bit 4 - Slave_TIMER3 update disable"]
    #[inline(always)]
    pub fn st3updis(&mut self) -> St3updisW<'_, Ctl0Spec> {
        St3updisW::new(self, 4)
    }
    #[doc = "Bit 5 - Slave_TIMER4 update disable"]
    #[inline(always)]
    pub fn st4updis(&mut self) -> St4updisW<'_, Ctl0Spec> {
        St4updisW::new(self, 5)
    }
    #[doc = "Bits 16:18 - SHRTIMER_ADCTRIG0 update source"]
    #[inline(always)]
    pub fn adtg0usrc(&mut self) -> Adtg0usrcW<'_, Ctl0Spec> {
        Adtg0usrcW::new(self, 16)
    }
    #[doc = "Bits 19:21 - SHRTIMER_ADCTRIG1 update source"]
    #[inline(always)]
    pub fn adtg1usrc(&mut self) -> Adtg1usrcW<'_, Ctl0Spec> {
        Adtg1usrcW::new(self, 19)
    }
    #[doc = "Bits 22:24 - SHRTIMER_ADCTRIG2 update source"]
    #[inline(always)]
    pub fn adtg2usrc(&mut self) -> Adtg2usrcW<'_, Ctl0Spec> {
        Adtg2usrcW::new(self, 22)
    }
    #[doc = "Bits 25:27 - SHRTIMER_ADCTRIG3 update source"]
    #[inline(always)]
    pub fn adtg3usrc(&mut self) -> Adtg3usrcW<'_, Ctl0Spec> {
