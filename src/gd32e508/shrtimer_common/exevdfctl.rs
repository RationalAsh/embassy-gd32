...
impl W {
    #[doc = "Bits 0:3 - External event 5 filter control"]
    #[inline(always)]
    pub fn exev5fc(&mut self) -> Exev5fcW<'_, ExevdfctlSpec> {
        Exev5fcW::new(self, 0)
    }
    #[doc = "Bits 6:9 - External event 6 filter control"]
    #[inline(always)]
    pub fn exev6fc(&mut self) -> Exev6fcW<'_, ExevdfctlSpec> {
        Exev6fcW::new(self, 6)
    }
    #[doc = "Bits 12:15 - External event 7 filter control"]
    #[inline(always)]
    pub fn exev7fc(&mut self) -> Exev7fcW<'_, ExevdfctlSpec> {
        Exev7fcW::new(self, 12)
    }
    #[doc = "Bits 18:21 - External event 8 filter control"]
    #[inline(always)]
    pub fn exev8fc(&mut self) -> Exev8fcW<'_, ExevdfctlSpec> {
        Exev8fcW::new(self, 18)
    }
    #[doc = "Bits 24:27 - External event 9 filter control"]
    #[inline(always)]
    pub fn exev9fc(&mut self) -> Exev9fcW<'_, ExevdfctlSpec> {
        Exev9fcW::new(self, 24)
    }
    #[doc = "Bits 30:31 - External event digital filter clock division"]
    #[inline(always)]
    pub fn exevfdiv(&mut self) -> ExevfdivW<'_, ExevdfctlSpec> {
        ExevfdivW::new(self, 30)
    }
}
#[doc = "SHRTIMER external event digital filter control register\n\nYou can [`read`](crate::Reg::read) this register and get [`exevdfctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`exevdfctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
