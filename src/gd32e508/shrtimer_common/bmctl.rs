...
impl W {
    #[doc = "Bit 0 - Bunch mode enable"]
    #[inline(always)]
    pub fn bmen(&mut self) -> BmenW<'_, BmctlSpec> {
        BmenW::new(self, 0)
    }
    #[doc = "Bit 1 - Continuous mode in bunch mode"]
    #[inline(always)]
    pub fn bmctn(&mut self) -> BmctnW<'_, BmctlSpec> {
        BmctnW::new(self, 1)
    }
    #[doc = "Bits 2:5 - Bunch mode clock source"]
    #[inline(always)]
    pub fn bmclks(&mut self) -> BmclksW<'_, BmctlSpec> {
        BmclksW::new(self, 2)
    }
    #[doc = "Bits 6:9 - Bunch mode clock division"]
    #[inline(always)]
    pub fn bmpsc(&mut self) -> BmpscW<'_, BmctlSpec> {
        BmpscW::new(self, 6)
    }
    #[doc = "Bit 10 - Bunch mode shadow enable"]
    #[inline(always)]
    pub fn bmse(&mut self) -> BmseW<'_, BmctlSpec> {
        BmseW::new(self, 10)
    }
    #[doc = "Bit 16 - Master_TIMER bunch mode"]
    #[inline(always)]
    pub fn bmmt(&mut self) -> BmmtW<'_, BmctlSpec> {
        BmmtW::new(self, 16)
    }
    #[doc = "Bit 17 - Slave_TIMER0 bunch mode"]
    #[inline(always)]
    pub fn bmst0(&mut self) -> Bmst0W<'_, BmctlSpec> {
        Bmst0W::new(self, 17)
    }
    #[doc = "Bit 18 - Slave_TIMER1 bunch mode"]
    #[inline(always)]
    pub fn bmst1(&mut self) -> Bmst1W<'_, BmctlSpec> {
        Bmst1W::new(self, 18)
    }
    #[doc = "Bit 19 - Slave_TIMER2 bunch mode"]
    #[inline(always)]
    pub fn bmst2(&mut self) -> Bmst2W<'_, BmctlSpec> {
        Bmst2W::new(self, 19)
    }
    #[doc = "Bit 20 - Slave_TIMER3 bunch mode"]
    #[inline(always)]
    pub fn bmst3(&mut self) -> Bmst3W<'_, BmctlSpec> {
        Bmst3W::new(self, 20)
    }
    #[doc = "Bit 21 - Slave_TIMER4 bunch mode"]
    #[inline(always)]
    pub fn bmst4(&mut self) -> Bmst4W<'_, BmctlSpec> {
        Bmst4W::new(self, 21)
    }
    #[doc = "Bit 31 - Bunch mode operating flag"]
    #[inline(always)]
    pub fn bmoptf(&mut self) -> BmoptfW<'_, BmctlSpec> {
        BmoptfW::new(self, 31)
    }
}
#[doc = "SHRTIMER bunch mode control register\n\nYou can [`read`](crate::Reg::read) this register and get [`bmctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`bmctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
