...
impl W {
    #[doc = "Bit 0 - Master_TIMER software update"]
    #[inline(always)]
    pub fn mtsup(&mut self) -> MtsupW<'_, Ctl1Spec> {
        MtsupW::new(self, 0)
    }
    #[doc = "Bit 1 - Slave_TIMER0 software update"]
    #[inline(always)]
    pub fn st0sup(&mut self) -> St0supW<'_, Ctl1Spec> {
        St0supW::new(self, 1)
    }
    #[doc = "Bit 2 - Slave_TIMER1 software update"]
    #[inline(always)]
    pub fn st1sup(&mut self) -> St1supW<'_, Ctl1Spec> {
        St1supW::new(self, 2)
    }
    #[doc = "Bit 3 - Slave_TIMER2 software update"]
    #[inline(always)]
    pub fn st2sup(&mut self) -> St2supW<'_, Ctl1Spec> {
        St2supW::new(self, 3)
    }
    #[doc = "Bit 4 - Slave_TIMER3 software update"]
    #[inline(always)]
    pub fn st3sup(&mut self) -> St3supW<'_, Ctl1Spec> {
        St3supW::new(self, 4)
    }
    #[doc = "Bit 5 - Slave_TIMER4 software update"]
    #[inline(always)]
    pub fn st4sup(&mut self) -> St4supW<'_, Ctl1Spec> {
        St4supW::new(self, 5)
    }
    #[doc = "Bit 8 - Master_TIMER software reset"]
    #[inline(always)]
    pub fn mtsrst(&mut self) -> MtsrstW<'_, Ctl1Spec> {
        MtsrstW::new(self, 8)
    }
    #[doc = "Bit 9 - Slave_TIMER0 software reset"]
    #[inline(always)]
    pub fn st0srst(&mut self) -> St0srstW<'_, Ctl1Spec> {
        St0srstW::new(self, 9)
    }
    #[doc = "Bit 10 - Slave_TIMER1 software reset"]
    #[inline(always)]
    pub fn st1srst(&mut self) -> St1srstW<'_, Ctl1Spec> {
        St1srstW::new(self, 10)
    }
    #[doc = "Bit 11 - Slave_TIMER2 software reset"]
    #[inline(always)]
    pub fn st2srst(&mut self) -> St2srstW<'_, Ctl1Spec> {
        St2srstW::new(self, 11)
    }
    #[doc = "Bit 12 - Slave_TIMER3 software reset"]
    #[inline(always)]
    pub fn st3srst(&mut self) -> St3srstW<'_, Ctl1Spec> {
        St3srstW::new(self, 12)
    }
    #[doc = "Bit 13 - Slave_TIMER4 software reset"]
    #[inline(always)]
    pub fn st4srst(&mut self) -> St4srstW<'_, Ctl1Spec> {
