...
impl W {
    #[doc = "Bits 0:1 - External event 0 source"]
    #[inline(always)]
    pub fn exev0src(&mut self) -> Exev0srcW<'_, Exevcfg0Spec> {
        Exev0srcW::new(self, 0)
    }
    #[doc = "Bit 2 - External event 0 polarity"]
    #[inline(always)]
    pub fn exev0p(&mut self) -> Exev0pW<'_, Exevcfg0Spec> {
        Exev0pW::new(self, 2)
    }
    #[doc = "Bits 3:4 - External event 0 edge sensitivity"]
    #[inline(always)]
    pub fn exev0eg(&mut self) -> Exev0egW<'_, Exevcfg0Spec> {
        Exev0egW::new(self, 3)
    }
    #[doc = "Bits 6:7 - External event 1 source"]
    #[inline(always)]
    pub fn exev1src(&mut self) -> Exev1srcW<'_, Exevcfg0Spec> {
        Exev1srcW::new(self, 6)
    }
    #[doc = "Bit 8 - External event 1 polarity"]
    #[inline(always)]
    pub fn exev1p(&mut self) -> Exev1pW<'_, Exevcfg0Spec> {
        Exev1pW::new(self, 8)
    }
    #[doc = "Bits 9:10 - External event 1 edge sensitivity"]
    #[inline(always)]
    pub fn exev1eg(&mut self) -> Exev1egW<'_, Exevcfg0Spec> {
        Exev1egW::new(self, 9)
    }
    #[doc = "Bits 12:13 - External event 2 source"]
    #[inline(always)]
    pub fn exev2src(&mut self) -> Exev2srcW<'_, Exevcfg0Spec> {
        Exev2srcW::new(self, 12)
    }
    #[doc = "Bit 14 - External event 2 polarity"]
    #[inline(always)]
    pub fn exev2p(&mut self) -> Exev2pW<'_, Exevcfg0Spec> {
        Exev2pW::new(self, 14)
    }
    #[doc = "Bits 15:16 - External event 2 edge sensitivity"]
    #[inline(always)]
    pub fn exev2eg(&mut self) -> Exev2egW<'_, Exevcfg0Spec> {
        Exev2egW::new(self, 15)
    }
    #[doc = "Bits 18:19 - External event 3 source"]
    #[inline(always)]
    pub fn exev3src(&mut self) -> Exev3srcW<'_, Exevcfg0Spec> {
        Exev3srcW::new(self, 18)
    }
    #[doc = "Bit 20 - External event 3 polarity"]
    #[inline(always)]
    pub fn exev3p(&mut self) -> Exev3pW<'_, Exevcfg0Spec> {
        Exev3pW::new(self, 20)
    }
    #[doc = "Bits 21:22 - External event 3 edge sensitivity"]
    #[inline(always)]
    pub fn exev3eg(&mut self) -> Exev3egW<'_, Exevcfg0Spec> {
        Exev3egW::new(self, 21)
    }
    #[doc = "Bits 24:25 - External event 4 source"]
    #[inline(always)]
    pub fn exev4src(&mut self) -> Exev4srcW<'_, Exevcfg0Spec> {
        Exev4srcW::new(self, 24)
    }
    #[doc = "Bit 26 - External event 4 polarity"]
    #[inline(always)]
    pub fn exev4p(&mut self) -> Exev4pW<'_, Exevcfg0Spec> {
        Exev4pW::new(self, 26)
    }
    #[doc = "Bits 27:28 - External event 4 edge sensitivity"]
    #[inline(always)]
    pub fn exev4eg(&mut self) -> Exev4egW<'_, Exevcfg0Spec> {
        Exev4egW::new(self, 27)
    }
}
#[doc = "SHRTIMER external event configuration register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`exevcfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`exevcfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
