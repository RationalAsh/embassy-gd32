#[doc = "Register `ST2ACTL` reader"]
pub type R = crate::R<St2actlSpec>;
#[doc = "Register `ST2ACTL` writer"]
pub type W = crate::W<St2actlSpec>;
...
impl W {
    #[doc = "Bit 3 - Counter clock division"]
    #[inline(always)]
    pub fn cntckdiv_3(&mut self) -> Cntckdiv3W<'_, St2actlSpec> {
        Cntckdiv3W::new(self, 3)
    }
    #[doc = "Bits 9:15 - Rising edge dead-time value configure"]
    #[inline(always)]
    pub fn dtrcfg_15_9(&mut self) -> Dtrcfg15_9W<'_, St2actlSpec> {
        Dtrcfg15_9W::new(self, 9)
    }
    #[doc = "Bits 25:31 - Falling edge dead-time value configure"]
    #[inline(always)]
    pub fn dtfcfg_15_9(&mut self) -> Dtfcfg15_9W<'_, St2actlSpec> {
        Dtfcfg15_9W::new(self, 25)
    }
}
#[doc = "SHRTIMER Slave_TIMERx additional control register\n\nYou can [`read`](crate::Reg::read) this register and get [`st2actl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st2actl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St2actlSpec;
impl crate::RegisterSpec for St2actlSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2actl::R`](R) reader structure"]
impl crate::Readable for St2actlSpec {}
#[doc = "`write(|w| ..)` method takes [`st2actl::W`](W) writer structure"]
impl crate::Writable for St2actlSpec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST2ACTL to value 0"]
impl crate::Resettable for St2actlSpec {}
