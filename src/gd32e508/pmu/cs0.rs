...
impl W {
    #[doc = "Bit 7 - Enable WKUP pin6"]
    #[inline(always)]
    pub fn wupen6(&mut self) -> Wupen6W<'_, Cs0Spec> {
        Wupen6W::new(self, 7)
    }
    #[doc = "Bit 8 - Enable WKUP pin0"]
    #[inline(always)]
    pub fn wupen0(&mut self) -> Wupen0W<'_, Cs0Spec> {
        Wupen0W::new(self, 8)
    }
    #[doc = "Bit 9 - Enable WKUP pin1"]
    #[inline(always)]
    pub fn wupen1(&mut self) -> Wupen1W<'_, Cs0Spec> {
        Wupen1W::new(self, 9)
    }
    #[doc = "Bit 10 - Enable WKUP pin2"]
    #[inline(always)]
    pub fn wupen2(&mut self) -> Wupen2W<'_, Cs0Spec> {
        Wupen2W::new(self, 10)
    }
    #[doc = "Bit 11 - Enable WKUP pin3"]
    #[inline(always)]
    pub fn wupen3(&mut self) -> Wupen3W<'_, Cs0Spec> {
        Wupen3W::new(self, 11)
    }
    #[doc = "Bit 12 - Enable WKUP pin4"]
    #[inline(always)]
    pub fn wupen4(&mut self) -> Wupen4W<'_, Cs0Spec> {
        Wupen4W::new(self, 12)
    }
    #[doc = "Bit 13 - Enable WKUP pin5"]
    #[inline(always)]
    pub fn wupen5(&mut self) -> Wupen5W<'_, Cs0Spec> {
        Wupen5W::new(self, 13)
    }
    #[doc = "Bit 15 - Enable WKUP Pin7(PF8)"]
    #[inline(always)]
    pub fn wupen7(&mut self) -> Wupen7W<'_, Cs0Spec> {
        Wupen7W::new(self, 15)
    }
    #[doc = "Bits 18:19 - Low-driver mode ready flag"]
    #[inline(always)]
    pub fn ldrf(&mut self) -> LdrfW<'_, Cs0Spec> {
        LdrfW::new(self, 18)
    }
}
