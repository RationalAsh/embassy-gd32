...
impl W {
    #[doc = "Bits 0:15 - SQPI write command for AHB write transfer"]
    #[inline(always)]
    pub fn spi_wcmd(&mut self) -> SpiWcmdW<'_, WcmdSpec> {
        SpiWcmdW::new(self, 0)
    }
    #[doc = "Bits 16:19 - SQPI write command waitcycle number after address phase"]
    #[inline(always)]
    pub fn sqpi_wwaitcycle(&mut self) -> SqpiWwaitcycleW<'_, WcmdSpec> {
        SqpiWwaitcycleW::new(self, 16)
    }
    #[doc = "Bits 20:22 - SQPI controller write command mode"]
    #[inline(always)]
    pub fn sqpi_wmode(&mut self) -> SqpiWmodeW<'_, WcmdSpec> {
        SqpiWmodeW::new(self, 20)
    }
    #[doc = "Bit 31 - Send special command"]
    #[inline(always)]
    pub fn sqpi_sc(&mut self) -> SqpiScW<'_, WcmdSpec> {
        SqpiScW::new(self, 31)
    }
}
#[doc = "Write Command Register\n\nYou can [`read`](crate::Reg::read) this register and get [`wcmd::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wcmd::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct WcmdSpec;
