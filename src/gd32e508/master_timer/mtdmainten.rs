...
impl W {
    #[doc = "Bit 0 - Compare 0 interrupt enable"]
    #[inline(always)]
    pub fn cmp0ie(&mut self) -> Cmp0ieW<'_, MtdmaintenSpec> {
        Cmp0ieW::new(self, 0)
    }
    #[doc = "Bit 1 - Compare 1 interrupt enable"]
    #[inline(always)]
    pub fn cmp1ie(&mut self) -> Cmp1ieW<'_, MtdmaintenSpec> {
        Cmp1ieW::new(self, 1)
    }
    #[doc = "Bit 2 - Compare 2 interrupt enable"]
    #[inline(always)]
    pub fn cmp2ie(&mut self) -> Cmp2ieW<'_, MtdmaintenSpec> {
        Cmp2ieW::new(self, 2)
    }
    #[doc = "Bit 3 - Compare 3 interrupt enable"]
    #[inline(always)]
    pub fn cmp3ie(&mut self) -> Cmp3ieW<'_, MtdmaintenSpec> {
        Cmp3ieW::new(self, 3)
    }
    #[doc = "Bit 4 - Repetition interrupt enable"]
    #[inline(always)]
    pub fn repie(&mut self) -> RepieW<'_, MtdmaintenSpec> {
        RepieW::new(self, 4)
    }
    #[doc = "Bit 5 - Synchronization input interrupt enable"]
    #[inline(always)]
    pub fn syniie(&mut self) -> SyniieW<'_, MtdmaintenSpec> {
        SyniieW::new(self, 5)
    }
    #[doc = "Bit 6 - Update interrupt enable"]
    #[inline(always)]
    pub fn upie(&mut self) -> UpieW<'_, MtdmaintenSpec> {
        UpieW::new(self, 6)
    }
    #[doc = "Bit 16 - Compare 0 DMA request enable"]
    #[inline(always)]
    pub fn cmp0den(&mut self) -> Cmp0denW<'_, MtdmaintenSpec> {
        Cmp0denW::new(self, 16)
    }
    #[doc = "Bit 17 - Compare 1 DMA request enable"]
    #[inline(always)]
    pub fn cmp1den(&mut self) -> Cmp1denW<'_, MtdmaintenSpec> {
        Cmp1denW::new(self, 17)
    }
    #[doc = "Bit 18 - Compare 2 DMA request enable"]
    #[inline(always)]
    pub fn cmp2den(&mut self) -> Cmp2denW<'_, MtdmaintenSpec> {
        Cmp2denW::new(self, 18)
    }
    #[doc = "Bit 19 - Compare 3 DMA request enable"]
    #[inline(always)]
    pub fn cmp3den(&mut self) -> Cmp3denW<'_, MtdmaintenSpec> {
        Cmp3denW::new(self, 19)
    }
    #[doc = "Bit 20 - Repetition DMA request enable"]
    #[inline(always)]
    pub fn repden(&mut self) -> RepdenW<'_, MtdmaintenSpec> {
        RepdenW::new(self, 20)
    }
    #[doc = "Bit 21 - Synchronization input DMA request enable"]
    #[inline(always)]
    pub fn syniden(&mut self) -> SynidenW<'_, MtdmaintenSpec> {
        SynidenW::new(self, 21)
    }
    #[doc = "Bit 22 - Update DMA request enable"]
    #[inline(always)]
    pub fn upden(&mut self) -> UpdenW<'_, MtdmaintenSpec> {
        UpdenW::new(self, 22)
    }
}
#[doc = "SHRTIMER Master_TIMER DMA and interrupt enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`mtdmainten::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mtdmainten::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
