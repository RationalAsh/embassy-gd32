...
impl W {
    #[doc = "Bit 0 - Software reset"]
    #[inline(always)]
    pub fn swr(&mut self) -> SwrW<'_, DmaBctlSpec> {
        SwrW::new(self, 0)
    }
    #[doc = "Bit 1 - DMA Arbitration"]
    #[inline(always)]
    pub fn dab(&mut self) -> DabW<'_, DmaBctlSpec> {
        DabW::new(self, 1)
    }
    #[doc = "Bits 2:6 - Descriptor skip length"]
    #[inline(always)]
    pub fn dpsl(&mut self) -> DpslW<'_, DmaBctlSpec> {
        DpslW::new(self, 2)
    }
    #[doc = "Bit 7 - Descriptor format mode"]
    #[inline(always)]
    pub fn dfm(&mut self) -> DfmW<'_, DmaBctlSpec> {
        DfmW::new(self, 7)
    }
    #[doc = "Bits 8:13 - Programmable burst length"]
    #[inline(always)]
    pub fn pgbl(&mut self) -> PgblW<'_, DmaBctlSpec> {
        PgblW::new(self, 8)
    }
    #[doc = "Bits 14:15 - RxDMA and TxDMA transfer priority ratio"]
    #[inline(always)]
    pub fn rtpr(&mut self) -> RtprW<'_, DmaBctlSpec> {
        RtprW::new(self, 14)
    }
    #[doc = "Bit 16 - Fixed burst"]
    #[inline(always)]
    pub fn fb(&mut self) -> FbW<'_, DmaBctlSpec> {
        FbW::new(self, 16)
    }
    #[doc = "Bits 17:22 - Rx DMA PGBL"]
    #[inline(always)]
    pub fn rxdp(&mut self) -> RxdpW<'_, DmaBctlSpec> {
        RxdpW::new(self, 17)
    }
    #[doc = "Bit 23 - Use independent PGBL"]
    #[inline(always)]
    pub fn uip(&mut self) -> UipW<'_, DmaBctlSpec> {
        UipW::new(self, 23)
    }
    #[doc = "Bit 24 - Four times PGBL mode"]
    #[inline(always)]
    pub fn fpbl(&mut self) -> FpblW<'_, DmaBctlSpec> {
        FpblW::new(self, 24)
    }
    #[doc = "Bit 25 - Address-aligned"]
    #[inline(always)]
    pub fn aa(&mut self) -> AaW<'_, DmaBctlSpec> {
        AaW::new(self, 25)
    }
    #[doc = "Bit 26 - Mixed burst"]
    #[inline(always)]
    pub fn mb(&mut self) -> MbW<'_, DmaBctlSpec> {
        MbW::new(self, 26)
    }
}
