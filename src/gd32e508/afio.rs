...
pub mod cpsctl;
#[doc = "PCFA (rw) register accessor: AFIO port configuration register A\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfa::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfa::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcfa`] module"]
#[doc(alias = "PCFA")]
pub type Pcfa = crate::Reg<pcfa::PcfaSpec>;
#[doc = "AFIO port configuration register A"]
pub mod pcfa;
#[doc = "PCFB (rw) register accessor: AFIO port configuration register B\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfb::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfb::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcfb`] module"]
#[doc(alias = "PCFB")]
pub type Pcfb = crate::Reg<pcfb::PcfbSpec>;
#[doc = "AFIO port configuration register B"]
pub mod pcfb;
#[doc = "PCFC (rw) register accessor: AFIO port configuration register C\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfc::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfc::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcfc`] module"]
#[doc(alias = "PCFC")]
pub type Pcfc = crate::Reg<pcfc::PcfcSpec>;
#[doc = "AFIO port configuration register C"]
pub mod pcfc;
#[doc = "PCFD (rw) register accessor: AFIO port configuration register D\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfd::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfd::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcfd`] module"]
#[doc(alias = "PCFD")]
pub type Pcfd = crate::Reg<pcfd::PcfdSpec>;
#[doc = "AFIO port configuration register D"]
pub mod pcfd;
#[doc = "PCFE (rw) register accessor: AFIO port configuration register E\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfe::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfe::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pcfe`] module"]
#[doc(alias = "PCFE")]
