...
pub type ShrtimerrstR = crate::BitReader;
#[doc = "Field `SHRTIMERRST` writer - SHRTIMER reset"]
pub type ShrtimerrstW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `CMPRST` reader - CMP reset"]
pub type CmprstR = crate::BitReader;
#[doc = "Field `CMPRST` writer - CMP reset"]
...
impl R {
    ...
    pub fn usart5rst(&self) -> Usart5rstR {
        Usart5rstR::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - SHRTIMER reset"]
    #[inline(always)]
    pub fn shrtimerrst(&self) -> ShrtimerrstR {
        ShrtimerrstR::new(((self.bits >> 29) & 1) != 0)
    }
    #[doc = "Bit 31 - CMP reset"]
    #[inline(always)]
    pub fn cmprst(&self) -> CmprstR {
        CmprstR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - Alternate function I/O reset"]
    #[inline(always)]
    pub fn afrst(&mut self) -> AfrstW<'_, Apb2rstSpec> {
        AfrstW::new(self, 0)
    }
    #[doc = "Bit 2 - GPIO port A reset"]
    #[inline(always)]
    pub fn parst(&mut self) -> ParstW<'_, Apb2rstSpec> {
        ParstW::new(self, 2)
    }
    #[doc = "Bit 3 - GPIO port B reset"]
    #[inline(always)]
    pub fn pbrst(&mut self) -> PbrstW<'_, Apb2rstSpec> {
        PbrstW::new(self, 3)
    }
    #[doc = "Bit 4 - GPIO port C reset"]
    #[inline(always)]
    pub fn pcrst(&mut self) -> PcrstW<'_, Apb2rstSpec> {
        PcrstW::new(self, 4)
    }
    #[doc = "Bit 5 - GPIO port D reset"]
    #[inline(always)]
    pub fn pdrst(&mut self) -> PdrstW<'_, Apb2rstSpec> {
        PdrstW::new(self, 5)
    }
    #[doc = "Bit 6 - GPIO port E reset"]
    #[inline(always)]
    pub fn perst(&mut self) -> PerstW<'_, Apb2rstSpec> {
        PerstW::new(self, 6)
    }
    #[doc = "Bit 7 - GPIO portF reset"]
    #[inline(always)]
    pub fn pfrst(&mut self) -> PfrstW<'_, Apb2rstSpec> {
        PfrstW::new(self, 7)
    }
    #[doc = "Bit 8 - GPIO port G reset"]
    #[inline(always)]
    pub fn pgrst(&mut self) -> PgrstW<'_, Apb2rstSpec> {
        PgrstW::new(self, 8)
    }
    #[doc = "Bit 9 - ADC0 reset"]
    #[inline(always)]
    pub fn adc0rst(&mut self) -> Adc0rstW<'_, Apb2rstSpec> {
        Adc0rstW::new(self, 9)
    }
    #[doc = "Bit 10 - ADC1 reset"]
    #[inline(always)]
    ...
    #[doc = "Bit 11 - Timer 0 reset"]
    #[inline(always)]
    pub fn timer0rst(&mut self) -> Timer0rstW<'_, Apb2rstSpec> {
        Timer0rstW::new(self, 11)
    }
    #[doc = "Bit 12 - SPI0 reset"]
    #[inline(always)]
    pub fn spi0rst(&mut self) -> Spi0rstW<'_, Apb2rstSpec> {
        Spi0rstW::new(self, 12)
    }
    #[doc = "Bit 13 - Timer 7 reset"]
    #[inline(always)]
    pub fn timer7rst(&mut self) -> Timer7rstW<'_, Apb2rstSpec> {
        Timer7rstW::new(self, 13)
    }
    #[doc = "Bit 14 - USART0 Reset"]
    #[inline(always)]
    pub fn usart0rst(&mut self) -> Usart0rstW<'_, Apb2rstSpec> {
    ...
    #[doc = "Bit 19 - Timer 8 reset"]
    #[inline(always)]
    pub fn timer8rst(&mut self) -> Timer8rstW<'_, Apb2rstSpec> {
        Timer8rstW::new(self, 19)
    }
    #[doc = "Bit 20 - Timer 9 reset"]
    #[inline(always)]
    pub fn timer9rst(&mut self) -> Timer9rstW<'_, Apb2rstSpec> {
        Timer9rstW::new(self, 20)
    }
    #[doc = "Bit 21 - Timer 10 reset"]
    #[inline(always)]
    pub fn timer10rst(&mut self) -> Timer10rstW<'_, Apb2rstSpec> {
        Timer10rstW::new(self, 21)
    }
    #[doc = "Bit 28 - USART5 reset"]
    #[inline(always)]
    pub fn usart5rst(&mut self) -> Usart5rstW<'_, Apb2rstSpec> {
        Usart5rstW::new(self, 28)
    }
    #[doc = "Bit 29 - SHRTIMER reset"]
    #[inline(always)]
    pub fn shrtimerrst(&mut self) -> ShrtimerrstW<'_, Apb2rstSpec> {
        ShrtimerrstW::new(self, 29)
    }
    #[doc = "Bit 31 - CMP reset"]
    #[inline(always)]
    pub fn cmprst(&mut self) -> CmprstW<'_, Apb2rstSpec> {
        CmprstW::new(self, 31)
    }
}
