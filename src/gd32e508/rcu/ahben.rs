...
impl W {
    #[doc = "Bit 0 - DMA0 clock enable"]
    #[inline(always)]
    pub fn dma0en(&mut self) -> Dma0enW<'_, AhbenSpec> {
        Dma0enW::new(self, 0)
    }
    #[doc = "Bit 1 - DMA1 clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 2 - SRAM interface clock enable when sleep mode"]
    #[inline(always)]
    pub fn sramspen(&mut self) -> SramspenW<'_, AhbenSpec> {
        SramspenW::new(self, 2)
    }
    #[doc = "Bit 4 - FMC clock enable when sleep mode"]
    #[inline(always)]
    pub fn fmcspen(&mut self) -> FmcspenW<'_, AhbenSpec> {
        FmcspenW::new(self, 4)
    }
    #[doc = "Bit 6 - CRC clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 8 - EXMC clock enable"]
    #[inline(always)]
    pub fn exmcen(&mut self) -> ExmcenW<'_, AhbenSpec> {
        ExmcenW::new(self, 8)
    }
    #[doc = "Bit 12 - USBFS clock enable"]
    #[inline(always)]
    pub fn usbhsen(&mut self) -> UsbhsenW<'_, AhbenSpec> {
        UsbhsenW::new(self, 12)
    }
    #[doc = "Bit 13 - ULPI clock enable"]
    #[inline(always)]
    pub fn ulpien(&mut self) -> UlpienW<'_, AhbenSpec> {
        UlpienW::new(self, 13)
    }
    #[doc = "Bit 14 - Ethernet clock enable"]
    #[inline(always)]
    pub fn eneten(&mut self) -> EnetenW<'_, AhbenSpec> {
        EnetenW::new(self, 14)
    }
    #[doc = "Bit 15 - Ethernet TX clock enable"]
    #[inline(always)]
    pub fn enettxen(&mut self) -> EnettxenW<'_, AhbenSpec> {
        EnettxenW::new(self, 15)
    }
    #[doc = "Bit 16 - Ethernet RX clock enable"]
    #[inline(always)]
    pub fn enetrxen(&mut self) -> EnetrxenW<'_, AhbenSpec> {
        EnetrxenW::new(self, 16)
    }
    #[doc = "Bit 30 - TMU clock enable"]
    #[inline(always)]
    pub fn tmuen(&mut self) -> TmuenW<'_, AhbenSpec> {
        TmuenW::new(self, 30)
    }
    #[doc = "Bit 31 - SQPI clock enable"]
    #[inline(always)]
    pub fn sqpien(&mut self) -> SqpienW<'_, AhbenSpec> {
        SqpienW::new(self, 31)
    }
}
