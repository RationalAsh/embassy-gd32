...
impl W {
    #[doc = "Bits 0:1 - 48MHz clock selection"]
    #[inline(always)]
    pub fn ck48msel(&mut self) -> Ck48mselW<'_, AddctlSpec> {
        Ck48mselW::new(self, 0)
    }
    #[doc = "Bit 2 - USBHS clock divider factor"]
    #[inline(always)]
    pub fn usbhssel(&mut self) -> UsbhsselW<'_, AddctlSpec> {
        UsbhsselW::new(self, 2)
    }
    #[doc = "Bits 3:5 - USBHS clock selection"]
    #[inline(always)]
    pub fn usbhsdv(&mut self) -> UsbhsdvW<'_, AddctlSpec> {
        UsbhsdvW::new(self, 3)
    }
    #[doc = "Bit 6 - USB clock source selection enable"]
    #[inline(always)]
    pub fn usbswen(&mut self) -> UsbswenW<'_, AddctlSpec> {
        UsbswenW::new(self, 6)
    }
    #[doc = "Bit 14 - PLLUSB enable"]
    #[inline(always)]
    pub fn pllusben(&mut self) -> PllusbenW<'_, AddctlSpec> {
        PllusbenW::new(self, 14)
    }
    #[doc = "Bit 15 - PLLUSB clock stabilization flag"]
    #[inline(always)]
    pub fn pllusbstb(&mut self) -> PllusbstbW<'_, AddctlSpec> {
        PllusbstbW::new(self, 15)
    }
    #[doc = "Bit 16 - Internal 48MHz RC oscillator enable"]
    #[inline(always)]
    pub fn irc48men(&mut self) -> Irc48menW<'_, AddctlSpec> {
