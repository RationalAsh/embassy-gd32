...
impl W {
    #[doc = "Bit 1 - SRP request"]
    #[inline(always)]
    pub fn srpreq(&mut self) -> SrpreqW<'_, GotgcsSpec> {
        SrpreqW::new(self, 1)
    }
    #[doc = "Bit 2 - Override enable of VBUS valid"]
    #[inline(always)]
    pub fn voe(&mut self) -> VoeW<'_, GotgcsSpec> {
        VoeW::new(self, 2)
    }
    #[doc = "Bit 3 - Override value of VBUS valid"]
    #[inline(always)]
    pub fn vov(&mut self) -> VovW<'_, GotgcsSpec> {
        VovW::new(self, 3)
    }
    #[doc = "Bit 4 - Override enable of A-peripheral session valid"]
    #[inline(always)]
    pub fn avoe(&mut self) -> AvoeW<'_, GotgcsSpec> {
        AvoeW::new(self, 4)
    }
    #[doc = "Bit 5 - Override value of A-peripheral session valid"]
    #[inline(always)]
    pub fn avov(&mut self) -> AvovW<'_, GotgcsSpec> {
        AvovW::new(self, 5)
    }
    #[doc = "Bit 6 - Override enable of B-peripheral session valid"]
    #[inline(always)]
    pub fn bvoe(&mut self) -> BvoeW<'_, GotgcsSpec> {
        BvoeW::new(self, 6)
    }
    #[doc = "Bit 7 - Override value of B-peripheral session valid"]
    #[inline(always)]
    pub fn bvov(&mut self) -> BvovW<'_, GotgcsSpec> {
        BvovW::new(self, 7)
    }
    #[doc = "Bit 9 - HNP request"]
    #[inline(always)]
    pub fn hnpreq(&mut self) -> HnpreqW<'_, GotgcsSpec> {
        HnpreqW::new(self, 9)
    }
    #[doc = "Bit 10 - Host HNP enable"]
    #[inline(always)]
    pub fn hhnpen(&mut self) -> HhnpenW<'_, GotgcsSpec> {
        HhnpenW::new(self, 10)
    }
    #[doc = "Bit 11 - Device HNP enabled"]
    #[inline(always)]
    pub fn dhnpen(&mut self) -> DhnpenW<'_, GotgcsSpec> {
        DhnpenW::new(self, 11)
    }
    #[doc = "Bit 12 - Embedded host enable"]
    #[inline(always)]
    pub fn ehe(&mut self) -> EheW<'_, GotgcsSpec> {
        EheW::new(self, 12)
    }
    #[doc = "Bit 20 - Select OTG version"]
    #[inline(always)]
    pub fn ov(&mut self) -> OvW<'_, GotgcsSpec> {
        OvW::new(self, 20)
    }
}
