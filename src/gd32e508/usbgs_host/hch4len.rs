...
impl W {
    #[doc = "Bits 0:18 - Transfer length"]
    #[inline(always)]
    pub fn tlen(&mut self) -> TlenW<'_, Hch4lenSpec> {
        TlenW::new(self, 0)
    }
    #[doc = "Bits 19:28 - Packet count"]
    #[inline(always)]
    pub fn pcnt(&mut self) -> PcntW<'_, Hch4lenSpec> {
        PcntW::new(self, 19)
    }
    #[doc = "Bits 29:30 - Data PID"]
    #[inline(always)]
    pub fn dpid(&mut self) -> DpidW<'_, Hch4lenSpec> {
        DpidW::new(self, 29)
    }
    #[doc = "Bit 31 - PING token request"]
    #[inline(always)]
    pub fn ping(&mut self) -> PingW<'_, Hch4lenSpec> {
        PingW::new(self, 31)
    }
}
