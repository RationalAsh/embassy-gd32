...
#[doc = "Field `RLD` reader - Watchdog counter reload value"]
pub type RldR = crate::FieldReader<u16>;
#[doc = "Field `RLD` writer - Watchdog counter reload value"]
pub type RldW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16, crate::Safe>;
impl R {
