...
#[doc = "Field `TP0EN` reader - Tamper 0 event trigger edge"]
pub type Tp0enR = crate::BitReader;
#[doc = "Field `TP0EN` writer - Tamper 0 event trigger edge"]
pub type Tp0enW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `TP0EG` reader - Active level for RTC_TAMP1 input"]
pub type Tp0egR = crate::BitReader;
#[doc = "Field `TP0EG` writer - Active level for RTC_TAMP1 input"]
...
#[doc = "Field `TPTS` reader - Activate timestamp on tamper detection event"]
pub type TptsR = crate::BitReader;
#[doc = "Field `TPTS` writer - Activate timestamp on tamper detection event"]
...
#[doc = "Field `PC13VAL` reader - RTC_ALARM output type/PC13 value"]
pub type Pc13valR = crate::BitReader;
#[doc = "Field `PC13VAL` writer - RTC_ALARM output type/PC13 value"]
