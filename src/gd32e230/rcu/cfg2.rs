...
impl crate::IsEnum for Usart0sel {}
...
pub type Usart0selW<'a, REG> = crate::FieldWriter<'a, REG, 2, Usart0sel, crate::Safe>;
...
impl W {
    #[doc = "Bits 0:1 - CK_USART0 clock source selection"]
    #[inline(always)]
    pub fn usart0sel(&mut self) -> Usart0selW<'_, Cfg2Spec> {
        Usart0selW::new(self, 0)
    }
    #[doc = "Bit 8 - CK_ADC clock source selection"]
    #[inline(always)]
    pub fn adcsel(&mut self) -> AdcselW<'_, Cfg2Spec> {
        AdcselW::new(self, 8)
    }
    #[doc = "Bit 16 - CK_IRC28M divider 2 or not"]
    #[inline(always)]
    pub fn irc28mdiv(&mut self) -> Irc28mdivW<'_, Cfg2Spec> {
        Irc28mdivW::new(self, 16)
    }
    #[doc = "Bit 31 - Bit 2 of ADCPSC"]
    #[inline(always)]
    pub fn adcpsc(&mut self) -> AdcpscW<'_, Cfg2Spec> {
        AdcpscW::new(self, 31)
    }
}
