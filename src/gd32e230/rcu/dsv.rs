...
#[repr(u8)]
pub enum Dslpvs {
    #[doc = "0: The core voltage is 1.0 V in deep-sleep mode"]
    V1_0 = 0,
    #[doc = "1: The core voltage is 0.9 V in deep-sleep mode"]
    V0_9 = 1,
    #[doc = "2: The core voltage is 0.8 V in deep-sleep mode"]
    V0_8 = 2,
...
impl DslpvsR {
    ...
    #[inline(always)]
    pub const fn variant(&self) -> Dslpvs {
        match self.bits {
            0 => Dslpvs::V1_0,
            1 => Dslpvs::V0_9,
            2 => Dslpvs::V0_8,
    ...
    #[doc = "The core voltage is 0.8 V in deep-sleep mode"]
    #[inline(always)]
...
pub type DslpvsW<'a, REG> = crate::FieldWriter<'a, REG, 2, Dslpvs, crate::Safe>;
    ...
    REG::Ux: From<u8>,
{
    ...
    #[doc = "The core voltage is 0.8 V in deep-sleep mode"]
    #[inline(always)]
    pub fn v0_8(self) -> &'a mut crate::W<REG> {
        self.variant(Dslpvs::V0_8)
    }
    #[doc = "The core voltage is 1.2 V in deep-sleep mode"]
    #[inline(always)]
