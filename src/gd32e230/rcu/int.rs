...
#[doc = "IRC28M stabilization interrupt flag\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Irc28mstbifr {
    #[doc = "0: No interrupt generated"]
    NotInterrupted = 0,
    #[doc = "1: IRC14M stabilisation interrupt generated"]
    Interrupted = 1,
}
impl From<Irc28mstbifr> for bool {
    #[inline(always)]
    fn from(variant: Irc28mstbifr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IRC28MSTBIF` reader - IRC28M stabilization interrupt flag"]
pub type Irc28mstbifR = crate::BitReader<Irc28mstbifr>;
impl Irc28mstbifR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Irc28mstbifr {
        match self.bits {
            false => Irc28mstbifr::NotInterrupted,
            true => Irc28mstbifr::Interrupted,
        }
    }
    #[doc = "No interrupt generated"]
    #[inline(always)]
    pub fn is_not_interrupted(&self) -> bool {
        *self == Irc28mstbifr::NotInterrupted
    }
    #[doc = "IRC14M stabilisation interrupt generated"]
    #[inline(always)]
    pub fn is_interrupted(&self) -> bool {
        *self == Irc28mstbifr::Interrupted
    }
}
...
#[doc = "IRC28M Stabilization Interrupt Enable\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Irc28mstbie {
    #[doc = "0: Interrupt disabled"]
    Disabled = 0,
    #[doc = "1: Interrupt enabled"]
    Enabled = 1,
}
impl From<Irc28mstbie> for bool {
    #[inline(always)]
    fn from(variant: Irc28mstbie) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IRC28MSTBIE` reader - IRC28M Stabilization Interrupt Enable"]
pub type Irc28mstbieR = crate::BitReader<Irc28mstbie>;
impl Irc28mstbieR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Irc28mstbie {
        match self.bits {
            false => Irc28mstbie::Disabled,
            true => Irc28mstbie::Enabled,
        }
    }
    #[doc = "Interrupt disabled"]
    #[inline(always)]
    pub fn is_disabled(&self) -> bool {
        *self == Irc28mstbie::Disabled
    }
    #[doc = "Interrupt enabled"]
    #[inline(always)]
    pub fn is_enabled(&self) -> bool {
        *self == Irc28mstbie::Enabled
    }
}
#[doc = "Field `IRC28MSTBIE` writer - IRC28M Stabilization Interrupt Enable"]
pub type Irc28mstbieW<'a, REG> = crate::BitWriter<'a, REG, Irc28mstbie>;
impl<'a, REG> Irc28mstbieW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Interrupt disabled"]
    #[inline(always)]
    pub fn disabled(self) -> &'a mut crate::W<REG> {
        self.variant(Irc28mstbie::Disabled)
    }
    #[doc = "Interrupt enabled"]
    #[inline(always)]
    pub fn enabled(self) -> &'a mut crate::W<REG> {
        self.variant(Irc28mstbie::Enabled)
    }
}
...
#[doc = "IRC28M stabilization Interrupt Clear\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Irc28mstbicw {
    #[doc = "1: Clear IRC28MSTBIF flag"]
    Clear = 1,
}
impl From<Irc28mstbicw> for bool {
    #[inline(always)]
    fn from(variant: Irc28mstbicw) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `IRC28MSTBIC` writer - IRC28M stabilization Interrupt Clear"]
pub type Irc28mstbicW<'a, REG> = crate::BitWriter<'a, REG, Irc28mstbicw>;
impl<'a, REG> Irc28mstbicW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Clear IRC28MSTBIF flag"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(Irc28mstbicw::Clear)
    }
}
...
impl R {
    ...
    #[inline(always)]
    pub fn irc28mstbif(&self) -> Irc28mstbifR {
        Irc28mstbifR::new(((self.bits >> 5) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn irc28mstbie(&self) -> Irc28mstbieR {
        Irc28mstbieR::new(((self.bits >> 13) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 8 - IRC40K Stabilization interrupt enable"]
    #[inline(always)]
    pub fn irc40kstbie(&mut self) -> Irc40kstbieW<'_, IntSpec> {
        Irc40kstbieW::new(self, 8)
    }
    #[doc = "Bit 9 - LXTAL Stabilization Interrupt Enable"]
    #[inline(always)]
    pub fn lxtalstbie(&mut self) -> LxtalstbieW<'_, IntSpec> {
        LxtalstbieW::new(self, 9)
    }
    #[doc = "Bit 10 - IRC8M Stabilization Interrupt Enable"]
    #[inline(always)]
    pub fn irc8mstbie(&mut self) -> Irc8mstbieW<'_, IntSpec> {
        Irc8mstbieW::new(self, 10)
    }
    #[doc = "Bit 11 - HXTAL Stabilization Interrupt Enable"]
    #[inline(always)]
    pub fn hxtalstbie(&mut self) -> HxtalstbieW<'_, IntSpec> {
        HxtalstbieW::new(self, 11)
    }
    #[doc = "Bit 12 - PLL Stabilization Interrupt Enable"]
    #[inline(always)]
    pub fn pllstbie(&mut self) -> PllstbieW<'_, IntSpec> {
        PllstbieW::new(self, 12)
    }
    #[doc = "Bit 13 - IRC28M Stabilization Interrupt Enable"]
    #[inline(always)]
    pub fn irc28mstbie(&mut self) -> Irc28mstbieW<'_, IntSpec> {
        Irc28mstbieW::new(self, 13)
    }
    #[doc = "Bit 16 - IRC40K Stabilization Interrupt Clear"]
    #[inline(always)]
    pub fn irc40kstbic(&mut self) -> Irc40kstbicW<'_, IntSpec> {
        Irc40kstbicW::new(self, 16)
    }
    #[doc = "Bit 17 - LXTAL Stabilization Interrupt Clear"]
    #[inline(always)]
    pub fn lxtalstbic(&mut self) -> LxtalstbicW<'_, IntSpec> {
        LxtalstbicW::new(self, 17)
    }
    #[doc = "Bit 18 - IRC8M Stabilization Interrupt Clear"]
    #[inline(always)]
    pub fn irc8mstbic(&mut self) -> Irc8mstbicW<'_, IntSpec> {
        Irc8mstbicW::new(self, 18)
    }
    #[doc = "Bit 19 - HXTAL Stabilization Interrupt Clear"]
    #[inline(always)]
    pub fn hxtalstbic(&mut self) -> HxtalstbicW<'_, IntSpec> {
        HxtalstbicW::new(self, 19)
    }
    #[doc = "Bit 20 - PLL stabilization Interrupt Clear"]
    #[inline(always)]
    pub fn pllstbic(&mut self) -> PllstbicW<'_, IntSpec> {
        PllstbicW::new(self, 20)
    }
    #[doc = "Bit 21 - IRC28M stabilization Interrupt Clear"]
    #[inline(always)]
    pub fn irc28mstbic(&mut self) -> Irc28mstbicW<'_, IntSpec> {
        Irc28mstbicW::new(self, 21)
    }
    #[doc = "Bit 23 - HXTAL Clock Stuck Interrupt Clear"]
    #[inline(always)]
    pub fn ckmic(&mut self) -> CkmicW<'_, IntSpec> {
        CkmicW::new(self, 23)
    }
}
