...
pub type Irc28madjW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
impl W {
    #[doc = "Bit 0 - IRC28M Internal 28M RC oscillator Enable"]
    #[inline(always)]
    pub fn irc28men(&mut self) -> Irc28menW<'_, Ctl1Spec> {
        Irc28menW::new(self, 0)
    }
    #[doc = "Bits 3:7 - Internal 28M RC Oscillator clock trim adjust value"]
    #[inline(always)]
    pub fn irc28madj(&mut self) -> Irc28madjW<'_, Ctl1Spec> {
