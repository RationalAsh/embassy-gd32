...
#[doc = "Field `FRADIV` reader - integer of baud-rate divider"]
pub type FradivR = crate::FieldReader;
#[doc = "Field `FRADIV` writer - integer of baud-rate divider"]
pub type FradivW<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
#[doc = "Field `INTDIV` reader - integer of baud-rate divider"]
pub type IntdivR = crate::FieldReader<u16>;
#[doc = "Field `INTDIV` writer - integer of baud-rate divider"]
pub type IntdivW<'a, REG> = crate::FieldWriter<'a, REG, 12, u16, crate::Safe>;
impl R {
