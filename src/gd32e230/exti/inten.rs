...
impl W {
    ...
    #[doc = "Bit 20 - Enable Interrupt on line 20"]
    #[inline(always)]
    pub fn inten20(&mut self) -> Inten20W<'_, IntenSpec> {
    ...
    #[doc = "Bit 22 - Enable Interrupt on line 22"]
    #[inline(always)]
    pub fn inten22(&mut self) -> Inten22W<'_, IntenSpec> {
        Inten22W::new(self, 22)
    }
    #[doc = "Bit 23 - Enable Interrupt on line 23"]
    #[inline(always)]
    pub fn inten23(&mut self) -> Inten23W<'_, IntenSpec> {
        Inten23W::new(self, 23)
    }
    #[doc = "Bit 24 - Enable Interrupt on line 24"]
    #[inline(always)]
    pub fn inten24(&mut self) -> Inten24W<'_, IntenSpec> {
        Inten24W::new(self, 24)
    }
    #[doc = "Bit 25 - Enable Interrupt on line 25"]
    #[inline(always)]
    pub fn inten25(&mut self) -> Inten25W<'_, IntenSpec> {
        Inten25W::new(self, 25)
    }
    #[doc = "Bit 26 - Enable Interrupt on line 26"]
    #[inline(always)]
    pub fn inten26(&mut self) -> Inten26W<'_, IntenSpec> {
        Inten26W::new(self, 26)
    }
    #[doc = "Bit 27 - Enable Interrupt on line 27"]
    #[inline(always)]
    pub fn inten27(&mut self) -> Inten27W<'_, IntenSpec> {
