...
#[doc = "Field `RSQ0` reader - conversion in regular sequence"]
pub type Rsq0R = crate::FieldReader;
#[doc = "Field `RSQ0` writer - conversion in regular sequence"]
...
impl R {
    #[doc = "Bits 0:4 - conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq0(&self) -> Rsq0R {
        Rsq0R::new((self.bits & 0x1f) as u8)
    }
    #[doc = "Bits 5:9 - 1st conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq1(&self) -> Rsq1R {
        Rsq1R::new(((self.bits >> 5) & 0x1f) as u8)
    }
    #[doc = "Bits 10:14 - 2nd conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq2(&self) -> Rsq2R {
        Rsq2R::new(((self.bits >> 10) & 0x1f) as u8)
    }
    #[doc = "Bits 15:19 - 3rd conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq3(&self) -> Rsq3R {
        Rsq3R::new(((self.bits >> 15) & 0x1f) as u8)
    }
    #[doc = "Bits 20:24 - 4th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq4(&self) -> Rsq4R {
        Rsq4R::new(((self.bits >> 20) & 0x1f) as u8)
    }
    #[doc = "Bits 25:29 - 5th conversion in regular sequence"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:4 - conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq0(&mut self) -> Rsq0W<'_, Rsq2Spec> {
        Rsq0W::new(self, 0)
    }
    #[doc = "Bits 5:9 - 1st conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq1(&mut self) -> Rsq1W<'_, Rsq2Spec> {
        Rsq1W::new(self, 5)
    }
    #[doc = "Bits 10:14 - 2nd conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq2(&mut self) -> Rsq2W<'_, Rsq2Spec> {
        Rsq2W::new(self, 10)
    }
    #[doc = "Bits 15:19 - 3rd conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq3(&mut self) -> Rsq3W<'_, Rsq2Spec> {
        Rsq3W::new(self, 15)
    }
    #[doc = "Bits 20:24 - 4th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq4(&mut self) -> Rsq4W<'_, Rsq2Spec> {
        Rsq4W::new(self, 20)
    }
    #[doc = "Bits 25:29 - 5th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq5(&mut self) -> Rsq5W<'_, Rsq2Spec> {
        Rsq5W::new(self, 25)
    }
}
