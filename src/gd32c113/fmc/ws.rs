...
impl W {
    #[doc = "Bits 0:2 - wait state counter register"]
    #[inline(always)]
    pub fn wscnt(&mut self) -> WscntW<'_, WsSpec> {
        WscntW::new(self, 0)
    }
    #[doc = "Bit 4 - Pre-fetch enable"]
    #[inline(always)]
    pub fn pfen(&mut self) -> PfenW<'_, WsSpec> {
        PfenW::new(self, 4)
    }
    #[doc = "Bit 9 - IBUS cache enable"]
    #[inline(always)]
    pub fn icen(&mut self) -> IcenW<'_, WsSpec> {
        IcenW::new(self, 9)
    }
    #[doc = "Bit 10 - DBUS cache enable"]
    #[inline(always)]
    pub fn dcen(&mut self) -> DcenW<'_, WsSpec> {
        DcenW::new(self, 10)
    }
    #[doc = "Bit 11 - IBUS cache reset"]
    #[inline(always)]
    pub fn icrst(&mut self) -> IcrstW<'_, WsSpec> {
        IcrstW::new(self, 11)
    }
    #[doc = "Bit 12 - DBUS cache reset"]
    #[inline(always)]
    pub fn dcrst(&mut self) -> DcrstW<'_, WsSpec> {
        DcrstW::new(self, 12)
    }
    #[doc = "Bit 15 - Program width to flash memory"]
    #[inline(always)]
    pub fn pgw(&mut self) -> PgwW<'_, WsSpec> {
        PgwW::new(self, 15)
    }
}
