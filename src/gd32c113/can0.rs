...
impl RegisterBlock {
    ...
    #[doc = "0x20 - FD control register"]
    #[inline(always)]
    pub const fn fdctl(&self) -> &Fdctl {
        &self.fdctl
    }
    #[doc = "0x24 - FD status register"]
    #[inline(always)]
    pub const fn fdstat(&self) -> &Fdstat {
        &self.fdstat
    }
    #[doc = "0x28 - FD transmitter delay compensation register"]
    #[inline(always)]
    pub const fn fdtdc(&self) -> &Fdtdc {
        &self.fdtdc
    }
    #[doc = "0x2c - Date Bit timing register"]
    #[inline(always)]
    pub const fn dbt(&self) -> &Dbt {
        &self.dbt
    }
...
pub mod bt;
#[doc = "FDCTL (rw) register accessor: FD control register\n\nYou can [`read`](crate::Reg::read) this register and get [`fdctl::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fdctl::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fdctl`] module"]
#[doc(alias = "FDCTL")]
pub type Fdctl = crate::Reg<fdctl::FdctlSpec>;
#[doc = "FD control register"]
pub mod fdctl;
#[doc = "FDSTAT (rw) register accessor: FD status register\n\nYou can [`read`](crate::Reg::read) this register and get [`fdstat::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fdstat::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fdstat`] module"]
#[doc(alias = "FDSTAT")]
pub type Fdstat = crate::Reg<fdstat::FdstatSpec>;
#[doc = "FD status register"]
pub mod fdstat;
#[doc = "FDTDC (rw) register accessor: FD transmitter delay compensation register\n\nYou can [`read`](crate::Reg::read) this register and get [`fdtdc::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fdtdc::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@fdtdc`] module"]
#[doc(alias = "FDTDC")]
pub type Fdtdc = crate::Reg<fdtdc::FdtdcSpec>;
#[doc = "FD transmitter delay compensation register"]
pub mod fdtdc;
#[doc = "DBT (rw) register accessor: Date Bit timing register\n\nYou can [`read`](crate::Reg::read) this register and get [`dbt::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dbt::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@dbt`] module"]
#[doc(alias = "DBT")]
pub type Dbt = crate::Reg<dbt::DbtSpec>;
