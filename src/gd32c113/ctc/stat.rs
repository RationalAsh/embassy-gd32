...
#[doc = "Field `EREFIF` reader - Expected reference interrupt flag"]
...
#[doc = "Field `REFDIR` reader - CTC trim counter direction"]
pub type RefdirR = crate::BitReader;
#[doc = "Field `REFCAP` reader - CTC counter capture value"]
...
impl R {
    ...
    #[doc = "Bit 3 - Expected reference interrupt flag"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - CTC trim counter direction"]
    #[inline(always)]
    pub fn refdir(&self) -> RefdirR {
        RefdirR::new(((self.bits >> 15) & 1) != 0)
    }
    #[doc = "Bits 16:31 - CTC counter capture value"]
    #[inline(always)]
