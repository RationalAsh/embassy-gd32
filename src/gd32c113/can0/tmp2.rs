...
pub type DlencW<'a, REG> = crate::FieldWriter<'a, REG, 4, u8, crate::Safe>;
...
pub type TsW<'a, REG> = crate::FieldWriter<'a, REG, 16, u16, crate::Safe>;
impl R {
...
impl W {
    #[doc = "Bits 0:3 - Data length code"]
    #[inline(always)]
    pub fn dlenc(&mut self) -> DlencW<'_, Tmp2Spec> {
        DlencW::new(self, 0)
    }
    #[doc = "Bit 4 - Error status indicator"]
    #[inline(always)]
    pub fn esi(&mut self) -> EsiW<'_, Tmp2Spec> {
        EsiW::new(self, 4)
    }
    #[doc = "Bit 5 - Bit rate of data switch"]
    #[inline(always)]
    pub fn brs(&mut self) -> BrsW<'_, Tmp2Spec> {
        BrsW::new(self, 5)
    }
    #[doc = "Bit 7 - CAN FD frame flag"]
    #[inline(always)]
    pub fn fdf(&mut self) -> FdfW<'_, Tmp2Spec> {
        FdfW::new(self, 7)
    }
    #[doc = "Bit 8 - Time stamp enable"]
    #[inline(always)]
    pub fn tsen(&mut self) -> TsenW<'_, Tmp2Spec> {
        TsenW::new(self, 8)
    }
    #[doc = "Bits 16:31 - Time stamp"]
    #[inline(always)]
    pub fn ts(&mut self) -> TsW<'_, Tmp2Spec> {
        TsW::new(self, 16)
    }
}
