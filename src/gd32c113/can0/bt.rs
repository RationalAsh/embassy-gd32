...
pub type BaudpscW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16, crate::Safe>;
#[doc = "Field `BS1H` reader - Bits 6:4 of BS1"]
pub type Bs1hR = crate::FieldReader;
#[doc = "Field `BS1H` writer - Bits 6:4 of BS1"]
pub type Bs1hW<'a, REG> = crate::FieldWriter<'a, REG, 3>;
#[doc = "Field `BS2H` reader - Bits 4:3 of BS1"]
pub type Bs2hR = crate::FieldReader;
#[doc = "Field `BS2H` writer - Bits 4:3 of BS1"]
pub type Bs2hW<'a, REG> = crate::FieldWriter<'a, REG, 2>;
...
pub type SjwW<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
impl R {
    ...
    #[doc = "Bits 10:12 - Bits 6:4 of BS1"]
    #[inline(always)]
    pub fn bs1h(&self) -> Bs1hR {
        Bs1hR::new(((self.bits >> 10) & 7) as u8)
    }
    #[doc = "Bits 13:14 - Bits 4:3 of BS1"]
    #[inline(always)]
    pub fn bs2h(&self) -> Bs2hR {
        Bs2hR::new(((self.bits >> 13) & 3) as u8)
    }
    ...
    pub fn sjw(&self) -> SjwR {
        SjwR::new(((self.bits >> 24) & 0x1f) as u8)
    }
...
impl W {
    #[doc = "Bits 0:9 - Baud rate prescaler"]
    #[inline(always)]
    pub fn baudpsc(&mut self) -> BaudpscW<'_, BtSpec> {
        BaudpscW::new(self, 0)
    }
    #[doc = "Bits 10:12 - Bits 6:4 of BS1"]
    #[inline(always)]
    pub fn bs1h(&mut self) -> Bs1hW<'_, BtSpec> {
        Bs1hW::new(self, 10)
    }
    #[doc = "Bits 13:14 - Bits 4:3 of BS1"]
    #[inline(always)]
    pub fn bs2h(&mut self) -> Bs2hW<'_, BtSpec> {
        Bs2hW::new(self, 13)
    }
    #[doc = "Bits 16:19 - Bit segment 1"]
    #[inline(always)]
    pub fn bs1(&mut self) -> Bs1W<'_, BtSpec> {
        Bs1W::new(self, 16)
    }
    #[doc = "Bits 20:22 - Bit segment 2"]
    #[inline(always)]
    pub fn bs2(&mut self) -> Bs2W<'_, BtSpec> {
        Bs2W::new(self, 20)
    }
    #[doc = "Bits 24:28 - Resynchronization jump width"]
    #[inline(always)]
    pub fn sjw(&mut self) -> SjwW<'_, BtSpec> {
        SjwW::new(self, 24)
    }
    #[doc = "Bit 30 - Loopback communication mode"]
    #[inline(always)]
    pub fn lcmod(&mut self) -> LcmodW<'_, BtSpec> {
        LcmodW::new(self, 30)
    }
    #[doc = "Bit 31 - Silent communication mode"]
    #[inline(always)]
    pub fn scmod(&mut self) -> ScmodW<'_, BtSpec> {
        ScmodW::new(self, 31)
    }
}
