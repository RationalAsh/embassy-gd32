...
impl W {
    #[doc = "Bits 0:3 - Data length code"]
    #[inline(always)]
    pub fn dlenc(&mut self) -> DlencW<'_, Tmp0Spec> {
        DlencW::new(self, 0)
    }
    #[doc = "Bit 4 - Error status indicator"]
    #[inline(always)]
    pub fn esi(&mut self) -> EsiW<'_, Tmp0Spec> {
        EsiW::new(self, 4)
    }
    #[doc = "Bit 5 - Bit rate of data switch"]
    #[inline(always)]
    pub fn brs(&mut self) -> BrsW<'_, Tmp0Spec> {
        BrsW::new(self, 5)
    }
    #[doc = "Bit 7 - CAN FD frame flag"]
    #[inline(always)]
    pub fn fdf(&mut self) -> FdfW<'_, Tmp0Spec> {
        FdfW::new(self, 7)
    }
    #[doc = "Bit 8 - Time stamp enable"]
    #[inline(always)]
    pub fn tsen(&mut self) -> TsenW<'_, Tmp0Spec> {
        TsenW::new(self, 8)
    }
    #[doc = "Bits 16:31 - Time stamp"]
    #[inline(always)]
    pub fn ts(&mut self) -> TsW<'_, Tmp0Spec> {
        TsW::new(self, 16)
    }
}
