...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ferrr {
    #[doc = "0: No format error"]
    NoError = 0,
    #[doc = "1: Format error"]
    Error = 1,
}
impl From<Ferrr> for bool {
    #[inline(always)]
    fn from(variant: Ferrr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FERR` reader - Format Error"]
pub type FerrR = crate::BitReader<Ferrr>;
impl FerrR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Ferrr {
        match self.bits {
            false => Ferrr::NoError,
            true => Ferrr::Error,
        }
...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum FerrwWO {
    #[doc = "0: Clear format error"]
    Clear = 0,
}
impl From<FerrwWO> for bool {
    #[inline(always)]
    fn from(variant: FerrwWO) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `FERR` writer - Format Error"]
pub type FerrW<'a, REG> = crate::BitWriter<'a, REG, FerrwWO>;
impl<'a, REG> FerrW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Clear format error"]
    #[inline(always)]
    pub fn clear(self) -> &'a mut crate::W<REG> {
        self.variant(FerrwWO::Clear)
    }
}
impl R {
...
impl W {
    #[doc = "Bit 4 - SPI CRC Error Bit"]
    #[inline(always)]
    pub fn crcerr(&mut self) -> CrcerrW<'_, StatSpec> {
        CrcerrW::new(self, 4)
    }
    #[doc = "Bit 8 - Format Error"]
    #[inline(always)]
    pub fn ferr(&mut self) -> FerrW<'_, StatSpec> {
        FerrW::new(self, 8)
    }
}
