...
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum TraceIoen {
    #[doc = "0: Disable trace pin allocation"]
    Disable = 0,
    #[doc = "1: Enable trace pin allocation"]
    Enable = 1,
}
...
impl TraceIoenR {
    ...
    pub const fn variant(&self) -> TraceIoen {
        match self.bits {
            false => TraceIoen::Disable,
            true => TraceIoen::Enable,
        }
    }
    #[doc = "Disable trace pin allocation"]
    #[inline(always)]
    pub fn is_disable(&self) -> bool {
        *self == TraceIoen::Disable
    }
    #[doc = "Enable trace pin allocation"]
    #[inline(always)]
    pub fn is_enable(&self) -> bool {
        *self == TraceIoen::Enable
    }
}
    ...
    REG: crate::Writable + crate::RegisterSpec,
{
    ...
    pub fn disable(self) -> &'a mut crate::W<REG> {
        self.variant(TraceIoen::Disable)
    }
    #[doc = "Enable trace pin allocation"]
    #[inline(always)]
    pub fn enable(self) -> &'a mut crate::W<REG> {
        self.variant(TraceIoen::Enable)
    }
}
#[doc = "FWDGT hold bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
#[doc = "Field `TIMER3_HOLD` reader - TIMER 3 hold bit"]
...
#[doc = "Field `TIMER3_HOLD` writer - TIMER 3 hold bit"]
