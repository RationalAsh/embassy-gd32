...
impl W {
    #[doc = "Bits 0:3 - address setup time"]
    #[inline(always)]
    pub fn aset(&mut self) -> AsetW<'_, SntcfgSpec> {
        AsetW::new(self, 0)
    }
    #[doc = "Bits 4:7 - address hold time"]
    #[inline(always)]
    pub fn ahld(&mut self) -> AhldW<'_, SntcfgSpec> {
        AhldW::new(self, 4)
    }
    #[doc = "Bits 8:15 - data setup time"]
    #[inline(always)]
    pub fn dset(&mut self) -> DsetW<'_, SntcfgSpec> {
        DsetW::new(self, 8)
    }
    #[doc = "Bits 16:19 - bus latency"]
    #[inline(always)]
    pub fn buslat(&mut self) -> BuslatW<'_, SntcfgSpec> {
        BuslatW::new(self, 16)
    }
    #[doc = "Bits 20:23 - synchronous clock divide ratio"]
    #[inline(always)]
    pub fn ckdiv(&mut self) -> CkdivW<'_, SntcfgSpec> {
        CkdivW::new(self, 20)
    }
    #[doc = "Bits 24:27 - data latency for NOR Flash"]
    #[inline(always)]
    pub fn dlat(&mut self) -> DlatW<'_, SntcfgSpec> {
        DlatW::new(self, 24)
    }
    #[doc = "Bits 28:29 - asynchronous access mode"]
    #[inline(always)]
    pub fn asyncmod(&mut self) -> AsyncmodW<'_, SntcfgSpec> {
        AsyncmodW::new(self, 28)
    }
}
#[doc = "SRAM/NOR Flash timing configuration registers\n\nYou can [`read`](crate::Reg::read) this register and get [`sntcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sntcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
