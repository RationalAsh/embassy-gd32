...
#[doc = "Enable bit for channel full transfer finish interrupt\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Ftfie {
...
#[doc = "Enable bit for channel half transfer finish interrupt\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Htfie {
...
#[doc = "Enable bit for channel error interrupt\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Errie {
...
pub type PrioW<'a, REG> = crate::FieldWriter<'a, REG, 2, Prio, crate::Safe>;
...
impl W {
    ...
    #[doc = "Bit 3 - Enable bit for channel error interrupt"]
    #[inline(always)]
    pub fn errie(&mut self) -> ErrieW<'_, Ch3ctlSpec> {
        ErrieW::new(self, 3)
    }
    #[doc = "Bit 4 - Transfer direction"]
    #[inline(always)]
    pub fn dir(&mut self) -> DirW<'_, Ch3ctlSpec> {
        DirW::new(self, 4)
    }
    #[doc = "Bit 5 - Circular mode enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - Memory to memory mode"]
    #[inline(always)]
    pub fn m2m(&mut self) -> M2mW<'_, Ch3ctlSpec> {
        M2mW::new(self, 14)
    }
}
