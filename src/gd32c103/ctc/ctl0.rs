...
#[doc = "Field `EREFIE` reader - EREFIF reference interrupt enable"]
pub type ErefieR = crate::BitReader;
#[doc = "Field `EREFIE` writer - EREFIF reference interrupt enable"]
...
#[doc = "Field `AUTOTRIM` reader - Hardware automatic trim mode"]
pub type AutotrimR = crate::BitReader;
#[doc = "Field `AUTOTRIM` writer - Hardware automatic trim mode"]
...
impl R {
    ...
    #[doc = "Bit 3 - EREFIF reference interrupt enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 6 - Hardware automatic trim mode"]
    #[inline(always)]
...
impl W {
    #[doc = "Bit 0 - Clock trim ok interrupt enable"]
    #[inline(always)]
    pub fn ckokie(&mut self) -> CkokieW<'_, Ctl0Spec> {
        CkokieW::new(self, 0)
    }
    #[doc = "Bit 1 - Clock trim warning interrupt enable"]
    #[inline(always)]
    pub fn ckwarnie(&mut self) -> CkwarnieW<'_, Ctl0Spec> {
    ...
    #[doc = "Bit 3 - EREFIF reference interrupt enable"]
    #[inline(always)]
    pub fn erefie(&mut self) -> ErefieW<'_, Ctl0Spec> {
        ErefieW::new(self, 3)
    }
    #[doc = "Bit 5 - CTC counter enable"]
    #[inline(always)]
    pub fn cnten(&mut self) -> CntenW<'_, Ctl0Spec> {
        CntenW::new(self, 5)
    }
    #[doc = "Bit 6 - Hardware automatic trim mode"]
    #[inline(always)]
    pub fn autotrim(&mut self) -> AutotrimW<'_, Ctl0Spec> {
        AutotrimW::new(self, 6)
    }
    #[doc = "Bit 7 - Software reference source sync pulse"]
    #[inline(always)]
    pub fn swrefpul(&mut self) -> SwrefpulW<'_, Ctl0Spec> {
        SwrefpulW::new(self, 7)
    }
    #[doc = "Bits 8:13 - IRC48M trim value"]
    #[inline(always)]
    pub fn trimvalue(&mut self) -> TrimvalueW<'_, Ctl0Spec> {
