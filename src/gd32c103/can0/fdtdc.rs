...
impl W {
    #[doc = "Bits 0:6 - Transmitter delay compensation filter"]
    #[inline(always)]
    pub fn tdcf(&mut self) -> TdcfW<'_, FdtdcSpec> {
        TdcfW::new(self, 0)
    }
    #[doc = "Bits 8:14 - Transmitter delay compensation offset"]
    #[inline(always)]
    pub fn tdco(&mut self) -> TdcoW<'_, FdtdcSpec> {
        TdcoW::new(self, 8)
    }
}
#[doc = "FD transmitter delay compensation register\n\nYou can [`read`](crate::Reg::read) this register and get [`fdtdc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fdtdc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
