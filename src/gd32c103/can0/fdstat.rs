...
impl W {
    #[doc = "Bits 0:6 - Transmitter delay compensation value"]
    #[inline(always)]
    pub fn tdcv(&mut self) -> TdcvW<'_, FdstatSpec> {
        TdcvW::new(self, 0)
    }
    #[doc = "Bit 16 - Protocol exception event"]
    #[inline(always)]
    pub fn pre(&mut self) -> PreW<'_, FdstatSpec> {
        PreW::new(self, 16)
    }
}
#[doc = "FD status register\n\nYou can [`read`](crate::Reg::read) this register and get [`fdstat::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fdstat::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
