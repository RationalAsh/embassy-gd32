...
impl W {
    #[doc = "Bits 0:9 - Baud rate prescaler"]
    #[inline(always)]
    pub fn dbaudpsc(&mut self) -> DbaudpscW<'_, DbtSpec> {
        DbaudpscW::new(self, 0)
    }
    #[doc = "Bits 16:19 - Bit segment 1"]
    #[inline(always)]
    pub fn dbs1(&mut self) -> Dbs1W<'_, DbtSpec> {
        Dbs1W::new(self, 16)
    }
    #[doc = "Bits 20:22 - Bit segment 2"]
    #[inline(always)]
    pub fn dbs2(&mut self) -> Dbs2W<'_, DbtSpec> {
        Dbs2W::new(self, 20)
    }
    #[doc = "Bits 24:26 - Resynchronization jump width"]
    #[inline(always)]
    pub fn dsjw(&mut self) -> DsjwW<'_, DbtSpec> {
        DsjwW::new(self, 24)
    }
}
#[doc = "Date Bit timing register\n\nYou can [`read`](crate::Reg::read) this register and get [`dbt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`dbt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct DbtSpec;
