...
impl RegisterBlock {
    ...
    #[inline(always)]
    pub const fn adden(&self) -> &Adden {
        &self.adden
    }
    #[doc = "0xfc - Additional reset register"]
    #[inline(always)]
    pub const fn addrst(&self) -> &Addrst {
        &self.addrst
    }
    ...
    #[doc = "0x138 - Power down voltage select register"]
    #[inline(always)]
    pub const fn pdvsel(&self) -> &Pdvsel {
        &self.pdvsel
    }
}
...
pub mod ctl1;
#[doc = "ADDEN (rw) register accessor: Additional enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`adden::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adden::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@adden`] module"]
#[doc(alias = "ADDEN")]
pub type Adden = crate::Reg<adden::AddenSpec>;
#[doc = "Additional enable register"]
pub mod adden;
#[doc = "ADDRST (rw) register accessor: Additional reset register\n\nYou can [`read`](crate::Reg::read) this register and get [`addrst::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addrst::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@addrst`] module"]
#[doc(alias = "ADDRST")]
pub type Addrst = crate::Reg<addrst::AddrstSpec>;
#[doc = "Additional reset register"]
pub mod addrst;
#[doc = "VKEY (rw) register accessor: Voltage key register\n\nYou can [`read`](crate::Reg::read) this register and get [`vkey::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`vkey::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@vkey`] module"]
#[doc(alias = "VKEY")]
...
pub mod dsv;
#[doc = "PDVSEL (rw) register accessor: Power down voltage select register\n\nYou can [`read`](crate::Reg::read) this register and get [`pdvsel::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pdvsel::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@pdvsel`] module"]
#[doc(alias = "PDVSEL")]
pub type Pdvsel = crate::Reg<pdvsel::PdvselSpec>;
