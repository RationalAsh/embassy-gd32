...
impl W {
    #[doc = "Bit 0 - G0P0 analog switch enable"]
    #[inline(always)]
    pub fn g0p0(&mut self) -> G0p0W<'_, AswSpec> {
        G0p0W::new(self, 0)
    }
    #[doc = "Bit 1 - G0P1 analog switch enable"]
    #[inline(always)]
    pub fn g0p1(&mut self) -> G0p1W<'_, AswSpec> {
        G0p1W::new(self, 1)
    }
    #[doc = "Bit 2 - G0P2 analog switch enable"]
    #[inline(always)]
    pub fn g0p2(&mut self) -> G0p2W<'_, AswSpec> {
        G0p2W::new(self, 2)
    }
    #[doc = "Bit 3 - G0P3 analog switch enable"]
    #[inline(always)]
    pub fn g0p3(&mut self) -> G0p3W<'_, AswSpec> {
        G0p3W::new(self, 3)
    }
    #[doc = "Bit 4 - G1P0 analog switch enable"]
    #[inline(always)]
    pub fn g1p0(&mut self) -> G1p0W<'_, AswSpec> {
        G1p0W::new(self, 4)
    }
    #[doc = "Bit 5 - G1P1 analog switch enable"]
    #[inline(always)]
    pub fn g1p1(&mut self) -> G1p1W<'_, AswSpec> {
        G1p1W::new(self, 5)
    }
    #[doc = "Bit 6 - G1P2 analog switch enable"]
    #[inline(always)]
    pub fn g1p2(&mut self) -> G1p2W<'_, AswSpec> {
        G1p2W::new(self, 6)
    }
    #[doc = "Bit 7 - G1P3 analog switch enable"]
    #[inline(always)]
    pub fn g1p3(&mut self) -> G1p3W<'_, AswSpec> {
        G1p3W::new(self, 7)
    }
    #[doc = "Bit 8 - G2P0 analog switch enable"]
    #[inline(always)]
    pub fn g2p0(&mut self) -> G2p0W<'_, AswSpec> {
        G2p0W::new(self, 8)
    }
    #[doc = "Bit 9 - G2P1 analog switch enable"]
    #[inline(always)]
    pub fn g2p1(&mut self) -> G2p1W<'_, AswSpec> {
        G2p1W::new(self, 9)
    }
    #[doc = "Bit 10 - G2P2 analog switch enable"]
    #[inline(always)]
    pub fn g2p2(&mut self) -> G2p2W<'_, AswSpec> {
        G2p2W::new(self, 10)
    }
    #[doc = "Bit 11 - G2P3 analog switch enable"]
    #[inline(always)]
    pub fn g2p3(&mut self) -> G2p3W<'_, AswSpec> {
        G2p3W::new(self, 11)
    }
    #[doc = "Bit 12 - G3P0 analog switch enable"]
    #[inline(always)]
    pub fn g3p0(&mut self) -> G3p0W<'_, AswSpec> {
        G3p0W::new(self, 12)
    }
    #[doc = "Bit 13 - G3P1 analog switch enable"]
    #[inline(always)]
    pub fn g3p1(&mut self) -> G3p1W<'_, AswSpec> {
        G3p1W::new(self, 13)
    }
    #[doc = "Bit 14 - G3P2 analog switch enable"]
    #[inline(always)]
    pub fn g3p2(&mut self) -> G3p2W<'_, AswSpec> {
        G3p2W::new(self, 14)
    }
    #[doc = "Bit 15 - G3P3 analog switch enable"]
    #[inline(always)]
    pub fn g3p3(&mut self) -> G3p3W<'_, AswSpec> {
        G3p3W::new(self, 15)
    }
    #[doc = "Bit 16 - G4P0 analog switch enable"]
    #[inline(always)]
    pub fn g4p0(&mut self) -> G4p0W<'_, AswSpec> {
        G4p0W::new(self, 16)
    }
    #[doc = "Bit 17 - G4P1 analog switch enable"]
    #[inline(always)]
    pub fn g4p1(&mut self) -> G4p1W<'_, AswSpec> {
        G4p1W::new(self, 17)
    }
    #[doc = "Bit 18 - G4P2 analog switch enable"]
    #[inline(always)]
    pub fn g4p2(&mut self) -> G4p2W<'_, AswSpec> {
        G4p2W::new(self, 18)
    }
    #[doc = "Bit 19 - G4P3 analog switch enable"]
    #[inline(always)]
    pub fn g4p3(&mut self) -> G4p3W<'_, AswSpec> {
        G4p3W::new(self, 19)
    }
    #[doc = "Bit 20 - G5P0 analog switch enable"]
    #[inline(always)]
    pub fn g5p0(&mut self) -> G5p0W<'_, AswSpec> {
        G5p0W::new(self, 20)
    }
    #[doc = "Bit 21 - G5P1 analog switch enable"]
    #[inline(always)]
    pub fn g5p1(&mut self) -> G5p1W<'_, AswSpec> {
        G5p1W::new(self, 21)
    }
    #[doc = "Bit 22 - G5P2 analog switch enable"]
    #[inline(always)]
    pub fn g5p2(&mut self) -> G5p2W<'_, AswSpec> {
        G5p2W::new(self, 22)
    }
    #[doc = "Bit 23 - G5P3 analog switch enable"]
    #[inline(always)]
    pub fn g5p3(&mut self) -> G5p3W<'_, AswSpec> {
        G5p3W::new(self, 23)
    }
}
#[doc = "I/O analog switch register\n\nYou can [`read`](crate::Reg::read) this register and get [`asw::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`asw::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct AswSpec;
