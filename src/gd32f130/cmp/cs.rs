...
pub type Cmp0mW<'a, REG> = crate::FieldWriter<'a, REG, 2, Cmp0m, crate::Safe>;
...
impl crate::IsEnum for Cmp0msel {}
...
impl crate::IsEnum for Cmp0osel {}
...
pub type Cmp0oselW<'a, REG> = crate::FieldWriter<'a, REG, 3, Cmp0osel, crate::Safe>;
...
pub type Cmp0hstW<'a, REG> = crate::FieldWriter<'a, REG, 2, Cmp0hst, crate::Safe>;
...
impl W {
    #[doc = "Bit 0 - CMP0 enable"]
    #[inline(always)]
    pub fn cmp0en(&mut self) -> Cmp0enW<'_, CsSpec> {
        Cmp0enW::new(self, 0)
    }
    #[doc = "Bit 1 - CMP0 switch"]
    #[inline(always)]
    pub fn cmp0sw(&mut self) -> Cmp0swW<'_, CsSpec> {
        Cmp0swW::new(self, 1)
    }
    #[doc = "Bits 2:3 - CMP0 mode"]
    #[inline(always)]
    pub fn cmp0m(&mut self) -> Cmp0mW<'_, CsSpec> {
        Cmp0mW::new(self, 2)
    }
    #[doc = "Bits 4:6 - CMP0_M input selection"]
    #[inline(always)]
    pub fn cmp0msel(&mut self) -> Cmp0mselW<'_, CsSpec> {
        Cmp0mselW::new(self, 4)
    }
    #[doc = "Bits 8:10 - Comparator 0 output selection"]
    #[inline(always)]
    pub fn cmp0osel(&mut self) -> Cmp0oselW<'_, CsSpec> {
        Cmp0oselW::new(self, 8)
    }
    #[doc = "Bit 11 - Polarity of CMP0 output"]
    #[inline(always)]
    pub fn cmp0pl(&mut self) -> Cmp0plW<'_, CsSpec> {
        Cmp0plW::new(self, 11)
    }
    #[doc = "Bits 12:13 - CMP0 hysteresis"]
    #[inline(always)]
    pub fn cmp0hst(&mut self) -> Cmp0hstW<'_, CsSpec> {
        Cmp0hstW::new(self, 12)
    }
    #[doc = "Bit 15 - CMP0 lock"]
    #[inline(always)]
    pub fn cmp0lk(&mut self) -> Cmp0lkW<'_, CsSpec> {
        Cmp0lkW::new(self, 15)
    }
    #[doc = "Bit 16 - CMP1 enable"]
    #[inline(always)]
    pub fn cmp1en(&mut self) -> Cmp1enW<'_, CsSpec> {
        Cmp1enW::new(self, 16)
    }
    #[doc = "Bits 18:19 - CMP1 mode"]
    #[inline(always)]
    pub fn cmp1m(&mut self) -> Cmp1mW<'_, CsSpec> {
        Cmp1mW::new(self, 18)
    }
    #[doc = "Bits 20:22 - CMP1_M input selection"]
    #[inline(always)]
    pub fn cmp1msel(&mut self) -> Cmp1mselW<'_, CsSpec> {
        Cmp1mselW::new(self, 20)
    }
    #[doc = "Bit 23 - Window mode enable"]
    #[inline(always)]
    pub fn wnden(&mut self) -> WndenW<'_, CsSpec> {
        WndenW::new(self, 23)
    }
    #[doc = "Bits 24:26 - CMP1 output selection"]
    #[inline(always)]
    pub fn cmp1osel(&mut self) -> Cmp1oselW<'_, CsSpec> {
        Cmp1oselW::new(self, 24)
    }
    #[doc = "Bit 27 - Polarity of CMP1 output"]
    #[inline(always)]
    pub fn cmp1pl(&mut self) -> Cmp1plW<'_, CsSpec> {
        Cmp1plW::new(self, 27)
    }
    #[doc = "Bits 28:29 - CMP1 hysteresis"]
    #[inline(always)]
    pub fn cmp1hst(&mut self) -> Cmp1hstW<'_, CsSpec> {
        Cmp1hstW::new(self, 28)
    }
    #[doc = "Bit 31 - CMP1 lock"]
    #[inline(always)]
    pub fn cmp1lk(&mut self) -> Cmp1lkW<'_, CsSpec> {
        Cmp1lkW::new(self, 31)
    }
}
