...
pub type DedW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type DeaW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
impl W {
    ...
    #[doc = "Bit 1 - USART enable in Deep-sleep mode"]
    #[inline(always)]
    pub fn uesm(&mut self) -> UesmW<'_, Ctl0Spec> {
        UesmW::new(self, 1)
    }
    #[doc = "Bit 2 - Receiver enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 13 - Mute mode enable"]
    #[inline(always)]
    pub fn men(&mut self) -> MenW<'_, Ctl0Spec> {
        MenW::new(self, 13)
    }
    #[doc = "Bit 14 - ADDR match interrupt enable"]
    #[inline(always)]
    pub fn amie(&mut self) -> AmieW<'_, Ctl0Spec> {
        AmieW::new(self, 14)
    }
    #[doc = "Bit 15 - Oversampling mode"]
    #[inline(always)]
    pub fn ovsmod(&mut self) -> OvsmodW<'_, Ctl0Spec> {
        OvsmodW::new(self, 15)
    }
    #[doc = "Bits 16:20 - Driver Enable deassertion time"]
    #[inline(always)]
    pub fn ded(&mut self) -> DedW<'_, Ctl0Spec> {
        DedW::new(self, 16)
    }
    #[doc = "Bits 21:25 - Driver Enable assertion time"]
    #[inline(always)]
    pub fn dea(&mut self) -> DeaW<'_, Ctl0Spec> {
        DeaW::new(self, 21)
    }
    #[doc = "Bit 26 - Receiver timeout interrupt enable"]
    #[inline(always)]
    pub fn rtie(&mut self) -> RtieW<'_, Ctl0Spec> {
        RtieW::new(self, 26)
    }
    #[doc = "Bit 27 - End of Block interrupt enable"]
    #[inline(always)]
    pub fn ebie(&mut self) -> EbieW<'_, Ctl0Spec> {
        EbieW::new(self, 27)
    }
}
