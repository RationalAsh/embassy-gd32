...
#[doc = "Field `WUPEN1` reader - WKUPN1 Pin Enable"]
pub type Wupen1R = crate::BitReader<Wupen1>;
impl Wupen1R {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
...
#[doc = "Field `WUPEN1` writer - WKUPN1 Pin Enable"]
pub type Wupen1W<'a, REG> = crate::BitWriter<'a, REG, Wupen1>;
...
impl W {
    #[doc = "Bit 8 - Enable WKUP pin"]
    #[inline(always)]
    pub fn wupen0(&mut self) -> Wupen0W<'_, CsSpec> {
        Wupen0W::new(self, 8)
    }
    #[doc = "Bit 9 - WKUPN1 Pin Enable"]
    #[inline(always)]
    pub fn wupen1(&mut self) -> Wupen1W<'_, CsSpec> {
        Wupen1W::new(self, 9)
    }
}
