...
pub type LxtaldriW<'a, REG> = crate::FieldWriter<'a, REG, 2, Lxtaldri, crate::Safe>;
...
impl W {
    #[doc = "Bit 0 - LXTAL enable"]
    #[inline(always)]
    pub fn lxtalen(&mut self) -> LxtalenW<'_, BdctlSpec> {
        LxtalenW::new(self, 0)
    }
    #[doc = "Bit 2 - LXTAL bypass mode enable"]
    #[inline(always)]
    pub fn lxtalbps(&mut self) -> LxtalbpsW<'_, BdctlSpec> {
        LxtalbpsW::new(self, 2)
    }
    #[doc = "Bits 3:4 - LXTAL drive capability"]
    #[inline(always)]
    pub fn lxtaldri(&mut self) -> LxtaldriW<'_, BdctlSpec> {
        LxtaldriW::new(self, 3)
    }
    #[doc = "Bits 8:9 - RTC clock entry selection"]
    #[inline(always)]
    pub fn rtcsrc(&mut self) -> RtcsrcW<'_, BdctlSpec> {
        RtcsrcW::new(self, 8)
    }
    #[doc = "Bit 15 - RTC clock enable"]
    #[inline(always)]
    pub fn rtcen(&mut self) -> RtcenW<'_, BdctlSpec> {
        RtcenW::new(self, 15)
    }
    #[doc = "Bit 16 - Backup domain reset"]
    #[inline(always)]
    pub fn bkprst(&mut self) -> BkprstW<'_, BdctlSpec> {
        BkprstW::new(self, 16)
    }
}
