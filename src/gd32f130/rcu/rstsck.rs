...
impl W {
    #[doc = "Bit 0 - IRC40K enable"]
    #[inline(always)]
    pub fn irc40ken(&mut self) -> Irc40kenW<'_, RstsckSpec> {
        Irc40kenW::new(self, 0)
    }
    #[doc = "Bit 23 - V12 domain Power reset flag"]
    #[inline(always)]
    pub fn v12rstf(&mut self) -> V12rstfW<'_, RstsckSpec> {
        V12rstfW::new(self, 23)
    }
    #[doc = "Bit 24 - Reset flag clear"]
    #[inline(always)]
    pub fn rstfc(&mut self) -> RstfcW<'_, RstsckSpec> {
        RstfcW::new(self, 24)
    }
    #[doc = "Bit 25 - Option byte loader reset flag"]
    #[inline(always)]
    pub fn oblrstf(&mut self) -> OblrstfW<'_, RstsckSpec> {
        OblrstfW::new(self, 25)
    }
    #[doc = "Bit 26 - External PIN reset flag"]
    #[inline(always)]
    pub fn eprstf(&mut self) -> EprstfW<'_, RstsckSpec> {
        EprstfW::new(self, 26)
    }
    #[doc = "Bit 27 - Power reset flag"]
    #[inline(always)]
    pub fn porrstf(&mut self) -> PorrstfW<'_, RstsckSpec> {
        PorrstfW::new(self, 27)
    }
    #[doc = "Bit 28 - Software reset flag"]
    #[inline(always)]
    pub fn swrstf(&mut self) -> SwrstfW<'_, RstsckSpec> {
        SwrstfW::new(self, 28)
    }
    #[doc = "Bit 29 - Free Watchdog timer reset flag"]
    #[inline(always)]
    pub fn fwdgtrstf(&mut self) -> FwdgtrstfW<'_, RstsckSpec> {
        FwdgtrstfW::new(self, 29)
    }
    #[doc = "Bit 30 - Window watchdog timer reset flag"]
    #[inline(always)]
    pub fn wwdgtrstf(&mut self) -> WwdgtrstfW<'_, RstsckSpec> {
        WwdgtrstfW::new(self, 30)
    }
    #[doc = "Bit 31 - Low-power reset flag"]
    #[inline(always)]
    pub fn lprstf(&mut self) -> LprstfW<'_, RstsckSpec> {
        LprstfW::new(self, 31)
    }
}
