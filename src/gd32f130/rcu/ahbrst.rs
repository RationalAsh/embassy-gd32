...
impl R {
    ...
    #[inline(always)]
    pub fn tsirst(&self) -> TsirstR {
        TsirstR::new(((self.bits >> 24) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 17 - GPIO port A reset"]
    #[inline(always)]
    pub fn parst(&mut self) -> ParstW<'_, AhbrstSpec> {
        ParstW::new(self, 17)
    }
    #[doc = "Bit 18 - GPIO port B reset"]
    #[inline(always)]
    pub fn pbrst(&mut self) -> PbrstW<'_, AhbrstSpec> {
        PbrstW::new(self, 18)
    }
    #[doc = "Bit 19 - GPIO port C reset"]
    #[inline(always)]
    pub fn pcrst(&mut self) -> PcrstW<'_, AhbrstSpec> {
        PcrstW::new(self, 19)
    }
    #[doc = "Bit 20 - GPIO port D reset"]
    #[inline(always)]
    pub fn pdrst(&mut self) -> PdrstW<'_, AhbrstSpec> {
        PdrstW::new(self, 20)
    }
    #[doc = "Bit 22 - GPIO port F reset"]
    #[inline(always)]
    pub fn pfrst(&mut self) -> PfrstW<'_, AhbrstSpec> {
        PfrstW::new(self, 22)
    }
    #[doc = "Bit 24 - TSI unit reset"]
    #[inline(always)]
    pub fn tsirst(&mut self) -> TsirstW<'_, AhbrstSpec> {
        TsirstW::new(self, 24)
    }
}
