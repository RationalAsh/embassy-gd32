...
impl W {
    #[doc = "Bits 0:1 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl0(&mut self) -> Ctl0W<'_, CtlSpec> {
        Ctl0W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl1(&mut self) -> Ctl1W<'_, CtlSpec> {
        Ctl1W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl2(&mut self) -> Ctl2W<'_, CtlSpec> {
        Ctl2W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl3(&mut self) -> Ctl3W<'_, CtlSpec> {
        Ctl3W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl4(&mut self) -> Ctl4W<'_, CtlSpec> {
        Ctl4W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl5(&mut self) -> Ctl5W<'_, CtlSpec> {
        Ctl5W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl6(&mut self) -> Ctl6W<'_, CtlSpec> {
        Ctl6W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl7(&mut self) -> Ctl7W<'_, CtlSpec> {
        Ctl7W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl8(&mut self) -> Ctl8W<'_, CtlSpec> {
        Ctl8W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl9(&mut self) -> Ctl9W<'_, CtlSpec> {
        Ctl9W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl10(&mut self) -> Ctl10W<'_, CtlSpec> {
        Ctl10W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl11(&mut self) -> Ctl11W<'_, CtlSpec> {
        Ctl11W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl12(&mut self) -> Ctl12W<'_, CtlSpec> {
        Ctl12W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl13(&mut self) -> Ctl13W<'_, CtlSpec> {
        Ctl13W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl14(&mut self) -> Ctl14W<'_, CtlSpec> {
        Ctl14W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Port x configuration bits (y = 0..15)"]
    #[inline(always)]
    pub fn ctl15(&mut self) -> Ctl15W<'_, CtlSpec> {
        Ctl15W::new(self, 30)
    }
}
