...
impl W {
    ...
    #[doc = "Bit 16 - Timer 14 hold register"]
    #[inline(always)]
    pub fn timer14_hold(&mut self) -> Timer14HoldW<'_, Ctl1Spec> {
        Timer14HoldW::new(self, 16)
    }
    #[doc = "Bit 17 - Timer 15 hold register"]
    #[inline(always)]
    pub fn timer15_hold(&mut self) -> Timer15HoldW<'_, Ctl1Spec> {
        Timer15HoldW::new(self, 17)
    }
    #[doc = "Bit 18 - Timer 16 hold register"]
    #[inline(always)]
    pub fn timer16_hold(&mut self) -> Timer16HoldW<'_, Ctl1Spec> {
