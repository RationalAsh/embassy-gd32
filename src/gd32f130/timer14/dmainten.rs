...
pub use crate::gd32f130::timer0::dmainten::Ch0ie;
#[doc = "Field `CH0IE` reader - Channel 0 Capture/Compare interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::Ch0ieR;
#[doc = "Field `CH1IE` reader - Channel 1 Capture/Compare interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::Ch0ieR as Ch1ieR;
#[doc = "Field `CH0IE` writer - Channel 0 Capture/Compare interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::Ch0ieW;
#[doc = "Field `CH1IE` writer - Channel 1 Capture/Compare interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::Ch0ieW as Ch1ieW;
#[doc = "CMT interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::Cmtie;
#[doc = "Field `CMTIE` reader - CMT interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::CmtieR;
#[doc = "Field `CMTIE` writer - CMT interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::CmtieW;
#[doc = "Update interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::Upie;
#[doc = "Field `UPIE` reader - Update interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::UpieR;
#[doc = "Field `UPIE` writer - Update interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::UpieW;
...
pub use crate::gd32f130::timer0::dmainten::Brkie;
#[doc = "Field `BRKIE` reader - Break interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::BrkieR;
#[doc = "Field `BRKIE` writer - Break interrupt enable"]
pub use crate::gd32f130::timer0::dmainten::BrkieW;
...
#[doc = "Field `TRGDEN` reader - DMA and interrupt enable register"]
...
#[doc = "Field `TRGDEN` writer - DMA and interrupt enable register"]
...
impl R {
    ...
    #[doc = "Bit 14 - DMA and interrupt enable register"]
    #[inline(always)]
...
impl W {
    ...
    #[doc = "Bit 5 - CMT interrupt enable"]
    #[inline(always)]
    pub fn cmtie(&mut self) -> CmtieW<'_, DmaintenSpec> {
        CmtieW::new(self, 5)
    }
    #[doc = "Bit 6 - Trigger interrupt enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 7 - Break interrupt enable"]
    #[inline(always)]
    pub fn brkie(&mut self) -> BrkieW<'_, DmaintenSpec> {
        BrkieW::new(self, 7)
    }
    #[doc = "Bit 8 - Update DMA request enable"]
    #[inline(always)]
