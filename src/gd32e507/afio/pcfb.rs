...
impl W {
    #[doc = "Bit 0 - PB0 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb0_afcfg(&mut self) -> Pb0AfcfgW<'_, PcfbSpec> {
        Pb0AfcfgW::new(self, 0)
    }
    #[doc = "Bits 2:3 - PB1 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb1_afcfg(&mut self) -> Pb1AfcfgW<'_, PcfbSpec> {
        Pb1AfcfgW::new(self, 2)
    }
    #[doc = "Bits 4:5 - PB2 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb2_afcfg(&mut self) -> Pb2AfcfgW<'_, PcfbSpec> {
        Pb2AfcfgW::new(self, 4)
    }
    #[doc = "Bit 6 - PB3 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb3_afcfg(&mut self) -> Pb3AfcfgW<'_, PcfbSpec> {
        Pb3AfcfgW::new(self, 6)
    }
    #[doc = "Bits 8:9 - PB4 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb4_afcfg(&mut self) -> Pb4AfcfgW<'_, PcfbSpec> {
        Pb4AfcfgW::new(self, 8)
    }
    #[doc = "Bits 10:11 - PB5 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb5_afcfg(&mut self) -> Pb5AfcfgW<'_, PcfbSpec> {
        Pb5AfcfgW::new(self, 10)
    }
    #[doc = "Bit 12 - PB6 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb6_afcfg(&mut self) -> Pb6AfcfgW<'_, PcfbSpec> {
        Pb6AfcfgW::new(self, 12)
    }
    #[doc = "Bit 14 - PB7 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb7_afcfg(&mut self) -> Pb7AfcfgW<'_, PcfbSpec> {
        Pb7AfcfgW::new(self, 14)
    }
    #[doc = "Bits 16:17 - PB8 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb8_afcfg(&mut self) -> Pb8AfcfgW<'_, PcfbSpec> {
        Pb8AfcfgW::new(self, 16)
    }
    #[doc = "Bits 18:19 - PB9 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb9_afcfg(&mut self) -> Pb9AfcfgW<'_, PcfbSpec> {
        Pb9AfcfgW::new(self, 18)
    }
    #[doc = "Bits 20:21 - PB10 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb10_afcfg(&mut self) -> Pb10AfcfgW<'_, PcfbSpec> {
        Pb10AfcfgW::new(self, 20)
    }
    #[doc = "Bits 22:23 - PB11 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb11_afcfg(&mut self) -> Pb11AfcfgW<'_, PcfbSpec> {
        Pb11AfcfgW::new(self, 22)
    }
    #[doc = "Bits 24:25 - PB12 AF function configuration bitse"]
    #[inline(always)]
    pub fn pb12_afcfg(&mut self) -> Pb12AfcfgW<'_, PcfbSpec> {
        Pb12AfcfgW::new(self, 24)
    }
    #[doc = "Bits 26:27 - PB13 AF function configuration bit"]
    #[inline(always)]
    pub fn pb13_afcfg(&mut self) -> Pb13AfcfgW<'_, PcfbSpec> {
        Pb13AfcfgW::new(self, 26)
    }
    #[doc = "Bits 28:29 - PB14 AF function configuration bit"]
    #[inline(always)]
    pub fn pb14_afcfg(&mut self) -> Pb14AfcfgW<'_, PcfbSpec> {
        Pb14AfcfgW::new(self, 28)
    }
    #[doc = "Bit 30 - PB15 AF function configuration bit"]
    #[inline(always)]
    pub fn pb15_afcfg(&mut self) -> Pb15AfcfgW<'_, PcfbSpec> {
        Pb15AfcfgW::new(self, 30)
    }
}
#[doc = "AFIO port configuration register B\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfb::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfb::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcfbSpec;
