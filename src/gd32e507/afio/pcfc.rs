...
impl W {
    #[doc = "Bit 0 - PC0 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc0_afcfg(&mut self) -> Pc0AfcfgW<'_, PcfcSpec> {
        Pc0AfcfgW::new(self, 0)
    }
    #[doc = "Bits 4:5 - PC2 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc2_afcfg(&mut self) -> Pc2AfcfgW<'_, PcfcSpec> {
        Pc2AfcfgW::new(self, 4)
    }
    #[doc = "Bit 6 - PC3 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc3_afcfg(&mut self) -> Pc3AfcfgW<'_, PcfcSpec> {
        Pc3AfcfgW::new(self, 6)
    }
    #[doc = "Bits 12:13 - PC6 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc6_afcfg(&mut self) -> Pc6AfcfgW<'_, PcfcSpec> {
        Pc6AfcfgW::new(self, 12)
    }
    #[doc = "Bits 14:15 - PC7 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc7_afcfg(&mut self) -> Pc7AfcfgW<'_, PcfcSpec> {
        Pc7AfcfgW::new(self, 14)
    }
    #[doc = "Bits 16:17 - PC8 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc8_afcfg(&mut self) -> Pc8AfcfgW<'_, PcfcSpec> {
        Pc8AfcfgW::new(self, 16)
    }
    #[doc = "Bits 18:19 - PC9 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc9_afcfg(&mut self) -> Pc9AfcfgW<'_, PcfcSpec> {
        Pc9AfcfgW::new(self, 18)
    }
    #[doc = "Bit 20 - PC10 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc10_afcfg(&mut self) -> Pc10AfcfgW<'_, PcfcSpec> {
        Pc10AfcfgW::new(self, 20)
    }
    #[doc = "Bits 22:23 - PC11 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc11_afcfg(&mut self) -> Pc11AfcfgW<'_, PcfcSpec> {
        Pc11AfcfgW::new(self, 22)
    }
    #[doc = "Bit 24 - PC12 AF function configuration bitse"]
    #[inline(always)]
    pub fn pc12_afcfg(&mut self) -> Pc12AfcfgW<'_, PcfcSpec> {
        Pc12AfcfgW::new(self, 24)
    }
}
#[doc = "AFIO port configuration register C\n\nYou can [`read`](crate::Reg::read) this register and get [`pcfc::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pcfc::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct PcfcSpec;
