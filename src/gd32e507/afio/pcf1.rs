...
impl W {
    #[doc = "Bit 5 - TIMER8 remapping"]
    #[inline(always)]
    pub fn timer8_remap(&mut self) -> Timer8RemapW<'_, Pcf1Spec> {
        Timer8RemapW::new(self, 5)
    }
    #[doc = "Bit 6 - TIMER9 remapping"]
    #[inline(always)]
    pub fn timer9_remap(&mut self) -> Timer9RemapW<'_, Pcf1Spec> {
        Timer9RemapW::new(self, 6)
    }
    #[doc = "Bit 7 - TIMER10 remapping"]
    #[inline(always)]
    pub fn timer10_remap(&mut self) -> Timer10RemapW<'_, Pcf1Spec> {
        Timer10RemapW::new(self, 7)
    }
    #[doc = "Bit 8 - TIMER12 remapping"]
    #[inline(always)]
    pub fn timer12_remap(&mut self) -> Timer12RemapW<'_, Pcf1Spec> {
        Timer12RemapW::new(self, 8)
    }
    #[doc = "Bit 9 - TIMER13 remapping"]
    #[inline(always)]
    pub fn timer13_remap(&mut self) -> Timer13RemapW<'_, Pcf1Spec> {
        Timer13RemapW::new(self, 9)
    }
    #[doc = "Bit 10 - EXMC_NADV connect/disconnect"]
    #[inline(always)]
    pub fn exmc_nadv(&mut self) -> ExmcNadvW<'_, Pcf1Spec> {
        ExmcNadvW::new(self, 10)
    }
    #[doc = "Bits 11:12 - CTC remapping"]
    #[inline(always)]
    pub fn ctc_remap(&mut self) -> CtcRemapW<'_, Pcf1Spec> {
