...
impl RegisterBlock {
    ...
    #[doc = "0xc4 - Additional clock configuration register"]
    #[inline(always)]
    pub const fn addcfg(&self) -> &Addcfg {
        &self.addcfg
    }
...
pub mod addctl;
#[doc = "ADDCFG (rw) register accessor: Additional clock configuration register\n\nYou can [`read`](crate::Reg::read) this register and get [`addcfg::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addcfg::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@addcfg`] module"]
#[doc(alias = "ADDCFG")]
pub type Addcfg = crate::Reg<addcfg::AddcfgSpec>;
