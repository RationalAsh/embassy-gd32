#[doc = "Register `ST2EXEVFCFG0` reader"]
pub type R = crate::R<St2exevfcfg0Spec>;
#[doc = "Register `ST2EXEVFCFG0` writer"]
pub type W = crate::W<St2exevfcfg0Spec>;
...
impl W {
    #[doc = "Bit 0 - External event 0 memorized enable"]
    #[inline(always)]
    pub fn exev0meen(&mut self) -> Exev0meenW<'_, St2exevfcfg0Spec> {
        Exev0meenW::new(self, 0)
    }
    #[doc = "Bits 1:4 - External event 0 filter mode"]
    #[inline(always)]
    pub fn exev0fm(&mut self) -> Exev0fmW<'_, St2exevfcfg0Spec> {
        Exev0fmW::new(self, 1)
    }
    #[doc = "Bit 6 - External event 1 memorized enable"]
    #[inline(always)]
    pub fn exev1meen(&mut self) -> Exev1meenW<'_, St2exevfcfg0Spec> {
        Exev1meenW::new(self, 6)
    }
    #[doc = "Bits 7:10 - External event 1 filter mode"]
    #[inline(always)]
    pub fn exev1fm(&mut self) -> Exev1fmW<'_, St2exevfcfg0Spec> {
        Exev1fmW::new(self, 7)
    }
    #[doc = "Bit 12 - External event 2 memorized enable"]
    #[inline(always)]
    pub fn exev2meen(&mut self) -> Exev2meenW<'_, St2exevfcfg0Spec> {
        Exev2meenW::new(self, 12)
    }
    #[doc = "Bits 13:16 - External event 2 filter mode"]
    #[inline(always)]
    pub fn exev2fm(&mut self) -> Exev2fmW<'_, St2exevfcfg0Spec> {
        Exev2fmW::new(self, 13)
    }
    #[doc = "Bit 18 - External event 3 memorized enable"]
    #[inline(always)]
    pub fn exev3meen(&mut self) -> Exev3meenW<'_, St2exevfcfg0Spec> {
        Exev3meenW::new(self, 18)
    }
    #[doc = "Bits 19:22 - External event 3 filter mode"]
    #[inline(always)]
    pub fn exev3fm(&mut self) -> Exev3fmW<'_, St2exevfcfg0Spec> {
        Exev3fmW::new(self, 19)
    }
    #[doc = "Bit 24 - External event 4 memorized enable"]
    #[inline(always)]
    pub fn exev4meen(&mut self) -> Exev4meenW<'_, St2exevfcfg0Spec> {
        Exev4meenW::new(self, 24)
    }
    #[doc = "Bits 25:28 - External event 4 filter mode"]
    #[inline(always)]
    pub fn exev4fm(&mut self) -> Exev4fmW<'_, St2exevfcfg0Spec> {
        Exev4fmW::new(self, 25)
    }
}
#[doc = "SHRTIMER Slave_TIMERx external event filter configuration register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`st2exevfcfg0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`st2exevfcfg0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St2exevfcfg0Spec;
impl crate::RegisterSpec for St2exevfcfg0Spec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st2exevfcfg0::R`](R) reader structure"]
impl crate::Readable for St2exevfcfg0Spec {}
#[doc = "`write(|w| ..)` method takes [`st2exevfcfg0::W`](W) writer structure"]
impl crate::Writable for St2exevfcfg0Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets ST2EXEVFCFG0 to value 0"]
impl crate::Resettable for St2exevfcfg0Spec {}
