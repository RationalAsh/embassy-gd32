...
pub type R = crate::R<St0intfSpec>;
...
#[doc = "SHRTIMER Slave_TIMER0 interrupt flag register\n\nYou can [`read`](crate::Reg::read) this register and get [`st0intf::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St0intfSpec;
impl crate::RegisterSpec for St0intfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st0intf::R`](R) reader structure"]
impl crate::Readable for St0intfSpec {}
#[doc = "`reset()` method sets ST0INTF to value 0"]
impl crate::Resettable for St0intfSpec {}
