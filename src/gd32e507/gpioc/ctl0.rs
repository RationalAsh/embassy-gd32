...
impl W {
    #[doc = "Bits 0:1 - Port x mode bits (x = 0)"]
    #[inline(always)]
    pub fn md0(&mut self) -> Md0W<'_, Ctl0Spec> {
        Md0W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Port x configuration bits (x = 0)"]
    #[inline(always)]
    pub fn ctl0(&mut self) -> Ctl0W<'_, Ctl0Spec> {
        Ctl0W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Port x mode bits (x = 1)"]
    #[inline(always)]
    pub fn md1(&mut self) -> Md1W<'_, Ctl0Spec> {
        Md1W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Port x configuration bits (x = 1)"]
    #[inline(always)]
    pub fn ctl1(&mut self) -> Ctl1W<'_, Ctl0Spec> {
        Ctl1W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Port x mode bits (x = 2 )"]
    #[inline(always)]
    pub fn md2(&mut self) -> Md2W<'_, Ctl0Spec> {
        Md2W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Port x configuration bits (x = 2)"]
    #[inline(always)]
    pub fn ctl2(&mut self) -> Ctl2W<'_, Ctl0Spec> {
        Ctl2W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Port x mode bits (x = 3 )"]
    #[inline(always)]
    pub fn md3(&mut self) -> Md3W<'_, Ctl0Spec> {
        Md3W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Port x configuration bits (x = 3)"]
    #[inline(always)]
    pub fn ctl3(&mut self) -> Ctl3W<'_, Ctl0Spec> {
        Ctl3W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Port x mode bits (x = 4)"]
    #[inline(always)]
    pub fn md4(&mut self) -> Md4W<'_, Ctl0Spec> {
        Md4W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Port x configuration bits (x = 4)"]
    #[inline(always)]
    pub fn ctl4(&mut self) -> Ctl4W<'_, Ctl0Spec> {
        Ctl4W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Port x mode bits (x = 5)"]
    #[inline(always)]
    pub fn md5(&mut self) -> Md5W<'_, Ctl0Spec> {
        Md5W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Port x configuration bits (x = 5)"]
    #[inline(always)]
    pub fn ctl5(&mut self) -> Ctl5W<'_, Ctl0Spec> {
        Ctl5W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Port x mode bits (x = 6)"]
    #[inline(always)]
    pub fn md6(&mut self) -> Md6W<'_, Ctl0Spec> {
        Md6W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Port x configuration bits (x = 6)"]
    #[inline(always)]
    pub fn ctl6(&mut self) -> Ctl6W<'_, Ctl0Spec> {
        Ctl6W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Port x mode bits (x = 7)"]
    #[inline(always)]
    pub fn md7(&mut self) -> Md7W<'_, Ctl0Spec> {
        Md7W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Port x configuration bits (x = 7)"]
    #[inline(always)]
    pub fn ctl7(&mut self) -> Ctl7W<'_, Ctl0Spec> {
        Ctl7W::new(self, 30)
    }
}
