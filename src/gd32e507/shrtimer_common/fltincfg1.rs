...
impl W {
    #[doc = "Bit 0 - Fault 4 input enable"]
    #[inline(always)]
    pub fn flt4inen(&mut self) -> Flt4inenW<'_, Fltincfg1Spec> {
        Flt4inenW::new(self, 0)
    }
    #[doc = "Bit 1 - Fault 4 input polarity"]
    #[inline(always)]
    pub fn flt4inp(&mut self) -> Flt4inpW<'_, Fltincfg1Spec> {
        Flt4inpW::new(self, 1)
    }
    #[doc = "Bit 2 - Fault 4 input source"]
    #[inline(always)]
    pub fn flt4insrc(&mut self) -> Flt4insrcW<'_, Fltincfg1Spec> {
        Flt4insrcW::new(self, 2)
    }
    #[doc = "Bits 3:6 - Fault 4 input filter control"]
    #[inline(always)]
    pub fn flt4infc(&mut self) -> Flt4infcW<'_, Fltincfg1Spec> {
        Flt4infcW::new(self, 3)
    }
    #[doc = "Bit 7 - Protect fault 4 input configuration"]
    #[inline(always)]
    pub fn flt4inprot(&mut self) -> Flt4inprotW<'_, Fltincfg1Spec> {
        Flt4inprotW::new(self, 7)
    }
    #[doc = "Bits 24:25 - Fault input digital filter clock division"]
    #[inline(always)]
    pub fn fltfdiv(&mut self) -> FltfdivW<'_, Fltincfg1Spec> {
        FltfdivW::new(self, 24)
    }
}
#[doc = "SHRTIMER fault input configuration register 1\n\nYou can [`read`](crate::Reg::read) this register and get [`fltincfg1::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`fltincfg1::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
