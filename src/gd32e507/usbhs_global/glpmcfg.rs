...
impl W {
    #[doc = "Bit 0 - LPM enable"]
    #[inline(always)]
    pub fn lpmen(&mut self) -> LpmenW<'_, GlpmcfgSpec> {
        LpmenW::new(self, 0)
    }
    #[doc = "Bit 1 - ACK in LPM transaction enable"]
    #[inline(always)]
    pub fn acklpm(&mut self) -> AcklpmW<'_, GlpmcfgSpec> {
        AcklpmW::new(self, 1)
    }
    #[doc = "Bits 2:5 - Best effort service latency"]
    #[inline(always)]
    pub fn besl(&mut self) -> BeslW<'_, GlpmcfgSpec> {
        BeslW::new(self, 2)
    }
    #[doc = "Bit 6 - RemoteWake value"]
    #[inline(always)]
    pub fn rew(&mut self) -> RewW<'_, GlpmcfgSpec> {
        RewW::new(self, 6)
    }
    #[doc = "Bit 7 - Shallow sleep enable"]
    #[inline(always)]
    pub fn ssen(&mut self) -> SsenW<'_, GlpmcfgSpec> {
        SsenW::new(self, 7)
    }
    #[doc = "Bits 8:11 - BESL threshold"]
    #[inline(always)]
    pub fn beslth(&mut self) -> BeslthW<'_, GlpmcfgSpec> {
        BeslthW::new(self, 8)
    }
    #[doc = "Bit 12 - Deep sleep enable"]
    #[inline(always)]
    pub fn dsen(&mut self) -> DsenW<'_, GlpmcfgSpec> {
        DsenW::new(self, 12)
    }
    #[doc = "Bits 13:14 - Response of LPM"]
    #[inline(always)]
    pub fn lpmrsp(&mut self) -> LpmrspW<'_, GlpmcfgSpec> {
        LpmrspW::new(self, 13)
    }
    #[doc = "Bit 15 - Sleep status"]
    #[inline(always)]
    pub fn lpmslps(&mut self) -> LpmslpsW<'_, GlpmcfgSpec> {
        LpmslpsW::new(self, 15)
    }
    #[doc = "Bit 16 - Resume can be sent after sleep state"]
    #[inline(always)]
    pub fn rsok(&mut self) -> RsokW<'_, GlpmcfgSpec> {
        RsokW::new(self, 16)
    }
    #[doc = "Bits 17:20 - Channel number index when send LPM transaction"]
    #[inline(always)]
    pub fn lpmchi(&mut self) -> LpmchiW<'_, GlpmcfgSpec> {
        LpmchiW::new(self, 17)
    }
    #[doc = "Bits 21:23 - LPM retry count"]
    #[inline(always)]
    pub fn lpmrc(&mut self) -> LpmrcW<'_, GlpmcfgSpec> {
        LpmrcW::new(self, 21)
    }
    #[doc = "Bit 24 - Send LPM transaction"]
    #[inline(always)]
    pub fn lpmsnd(&mut self) -> LpmsndW<'_, GlpmcfgSpec> {
        LpmsndW::new(self, 24)
    }
    #[doc = "Bits 25:27 - LPM retry count status"]
    #[inline(always)]
    pub fn lpmrcs(&mut self) -> LpmrcsW<'_, GlpmcfgSpec> {
        LpmrcsW::new(self, 25)
    }
    #[doc = "Bit 28 - LPM Errata selection enable"]
    #[inline(always)]
    pub fn beslen(&mut self) -> BeslenW<'_, GlpmcfgSpec> {
        BeslenW::new(self, 28)
    }
}
