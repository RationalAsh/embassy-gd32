...
impl W {
    #[doc = "Bit 1 - Mode fault interrupt enable"]
    #[inline(always)]
    pub fn mfie(&mut self) -> MfieW<'_, GintenSpec> {
        MfieW::new(self, 1)
    }
    #[doc = "Bit 2 - OTG interrupt enable"]
    #[inline(always)]
    pub fn otgie(&mut self) -> OtgieW<'_, GintenSpec> {
        OtgieW::new(self, 2)
    }
    #[doc = "Bit 3 - Start of frame interrupt enable"]
    #[inline(always)]
    pub fn sofie(&mut self) -> SofieW<'_, GintenSpec> {
        SofieW::new(self, 3)
    }
    #[doc = "Bit 4 - Receive FIFO non-empty interrupt enable"]
    #[inline(always)]
    pub fn rxfneie(&mut self) -> RxfneieW<'_, GintenSpec> {
        RxfneieW::new(self, 4)
    }
    #[doc = "Bit 5 - Non-periodic TxFIFO empty interrupt enable"]
    #[inline(always)]
    pub fn nptxfeie(&mut self) -> NptxfeieW<'_, GintenSpec> {
        NptxfeieW::new(self, 5)
    }
    #[doc = "Bit 6 - Global non-periodic IN NAK effective interrupt enable"]
    #[inline(always)]
    pub fn gnpinakie(&mut self) -> GnpinakieW<'_, GintenSpec> {
        GnpinakieW::new(self, 6)
    }
    #[doc = "Bit 7 - Global OUT NAK effective interrupt enable"]
    #[inline(always)]
    pub fn gonakie(&mut self) -> GonakieW<'_, GintenSpec> {
        GonakieW::new(self, 7)
    }
    #[doc = "Bit 10 - Early suspend interrupt enable"]
    #[inline(always)]
    pub fn espie(&mut self) -> EspieW<'_, GintenSpec> {
        EspieW::new(self, 10)
    }
    #[doc = "Bit 11 - USB suspend interrupt enable"]
    #[inline(always)]
    pub fn spie(&mut self) -> SpieW<'_, GintenSpec> {
        SpieW::new(self, 11)
    }
    #[doc = "Bit 12 - USB reset interrupt enable"]
    #[inline(always)]
    pub fn rstie(&mut self) -> RstieW<'_, GintenSpec> {
        RstieW::new(self, 12)
    }
    #[doc = "Bit 13 - Enumeration finish interrupt enable"]
    #[inline(always)]
    pub fn enumfie(&mut self) -> EnumfieW<'_, GintenSpec> {
        EnumfieW::new(self, 13)
    }
    #[doc = "Bit 14 - Isochronous OUT packet dropped interrupt enable"]
    #[inline(always)]
    pub fn isoopdie(&mut self) -> IsoopdieW<'_, GintenSpec> {
        IsoopdieW::new(self, 14)
    }
    #[doc = "Bit 15 - End of periodic frame interrupt enable"]
    #[inline(always)]
    pub fn eopfie(&mut self) -> EopfieW<'_, GintenSpec> {
        EopfieW::new(self, 15)
    }
    #[doc = "Bit 18 - IN endpoints interrupt enable"]
    #[inline(always)]
    pub fn iepie(&mut self) -> IepieW<'_, GintenSpec> {
        IepieW::new(self, 18)
    }
    #[doc = "Bit 19 - OUT endpoints interrupt enable"]
    #[inline(always)]
    pub fn oepie(&mut self) -> OepieW<'_, GintenSpec> {
        OepieW::new(self, 19)
    }
    #[doc = "Bit 20 - isochronous IN transfer not complete interrupt enable"]
    #[inline(always)]
    pub fn isoincie(&mut self) -> IsoincieW<'_, GintenSpec> {
        IsoincieW::new(self, 20)
    }
    #[doc = "Bit 21 - periodic transfer not compelete Interrupt enable(Host mode)/isochronous OUT transfer not complete interrupt enable(Device mode)"]
    #[inline(always)]
    pub fn pxncie_isooncie(&mut self) -> PxncieIsooncieW<'_, GintenSpec> {
        PxncieIsooncieW::new(self, 21)
    }
    #[doc = "Bit 25 - Host channels interrupt enable"]
    #[inline(always)]
    pub fn hcie(&mut self) -> HcieW<'_, GintenSpec> {
        HcieW::new(self, 25)
    }
    #[doc = "Bit 26 - Periodic TxFIFO empty interrupt enable"]
    #[inline(always)]
    pub fn ptxfeie(&mut self) -> PtxfeieW<'_, GintenSpec> {
        PtxfeieW::new(self, 26)
    }
    #[doc = "Bit 27 - LPM interrupt enable"]
    #[inline(always)]
    pub fn lpmie(&mut self) -> LpmieW<'_, GintenSpec> {
        LpmieW::new(self, 27)
    }
    #[doc = "Bit 28 - ID pin status change interrupt enable"]
    #[inline(always)]
    pub fn idpscie(&mut self) -> IdpscieW<'_, GintenSpec> {
        IdpscieW::new(self, 28)
    }
    #[doc = "Bit 29 - Disconnect interrupt enable"]
    #[inline(always)]
    pub fn discie(&mut self) -> DiscieW<'_, GintenSpec> {
        DiscieW::new(self, 29)
    }
    #[doc = "Bit 30 - Session interrupt enable"]
    #[inline(always)]
    pub fn sesie(&mut self) -> SesieW<'_, GintenSpec> {
        SesieW::new(self, 30)
    }
    #[doc = "Bit 31 - Wakeup interrupt enable"]
    #[inline(always)]
    pub fn wkupie(&mut self) -> WkupieW<'_, GintenSpec> {
        WkupieW::new(self, 31)
    }
}
