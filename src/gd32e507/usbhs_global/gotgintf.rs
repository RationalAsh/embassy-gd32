...
impl W {
    #[doc = "Bit 2 - Session end"]
    #[inline(always)]
    pub fn sesend(&mut self) -> SesendW<'_, GotgintfSpec> {
        SesendW::new(self, 2)
    }
    #[doc = "Bit 8 - Session request success status change"]
    #[inline(always)]
    pub fn srpend(&mut self) -> SrpendW<'_, GotgintfSpec> {
        SrpendW::new(self, 8)
    }
    #[doc = "Bit 9 - HNP end"]
    #[inline(always)]
    pub fn hnpend(&mut self) -> HnpendW<'_, GotgintfSpec> {
        HnpendW::new(self, 9)
    }
    #[doc = "Bit 17 - Host negotiation request detected"]
    #[inline(always)]
    pub fn hnpdet(&mut self) -> HnpdetW<'_, GotgintfSpec> {
        HnpdetW::new(self, 17)
    }
    #[doc = "Bit 18 - A-device timeout"]
    #[inline(always)]
    pub fn adto(&mut self) -> AdtoW<'_, GotgintfSpec> {
        AdtoW::new(self, 18)
    }
    #[doc = "Bit 19 - Debounce finish"]
    #[inline(always)]
    pub fn df(&mut self) -> DfW<'_, GotgintfSpec> {
        DfW::new(self, 19)
    }
    #[doc = "Bit 20 - There is a change in the value of ID input"]
    #[inline(always)]
    pub fn idchg(&mut self) -> IdchgW<'_, GotgintfSpec> {
        IdchgW::new(self, 20)
    }
}
