...
impl W {
    #[doc = "Bits 0:15 - Ethernet MAC address 2 high register"]
    #[inline(always)]
    pub fn addr2h(&mut self) -> Addr2hW<'_, MacAddr2hSpec> {
        Addr2hW::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask byte"]
    #[inline(always)]
    pub fn mb(&mut self) -> MbW<'_, MacAddr2hSpec> {
        MbW::new(self, 24)
    }
    #[doc = "Bit 30 - Source address filter"]
    #[inline(always)]
    pub fn saf(&mut self) -> SafW<'_, MacAddr2hSpec> {
        SafW::new(self, 30)
    }
    #[doc = "Bit 31 - Address filter enable"]
    #[inline(always)]
    pub fn afe(&mut self) -> AfeW<'_, MacAddr2hSpec> {
        AfeW::new(self, 31)
    }
}
