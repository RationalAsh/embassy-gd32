...
impl W {
    #[doc = "Bits 0:15 - MAC address3 high"]
    #[inline(always)]
    pub fn addr3h(&mut self) -> Addr3hW<'_, MacAddr3hSpec> {
        Addr3hW::new(self, 0)
    }
    #[doc = "Bits 24:29 - Mask byte"]
    #[inline(always)]
    pub fn mb(&mut self) -> MbW<'_, MacAddr3hSpec> {
        MbW::new(self, 24)
    }
    #[doc = "Bit 30 - Source address filter"]
    #[inline(always)]
    pub fn saf(&mut self) -> SafW<'_, MacAddr3hSpec> {
        SafW::new(self, 30)
    }
    #[doc = "Bit 31 - Address filter enable"]
    #[inline(always)]
    pub fn afe(&mut self) -> AfeW<'_, MacAddr3hSpec> {
        AfeW::new(self, 31)
    }
}
