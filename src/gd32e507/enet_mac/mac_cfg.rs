...
impl W {
    #[doc = "Bit 2 - Receiver enable"]
    #[inline(always)]
    pub fn ren(&mut self) -> RenW<'_, MacCfgSpec> {
        RenW::new(self, 2)
    }
    #[doc = "Bit 3 - Transmitter enable"]
    #[inline(always)]
    pub fn ten(&mut self) -> TenW<'_, MacCfgSpec> {
        TenW::new(self, 3)
    }
    #[doc = "Bit 4 - Deferral check"]
    #[inline(always)]
    pub fn dfc(&mut self) -> DfcW<'_, MacCfgSpec> {
        DfcW::new(self, 4)
    }
    #[doc = "Bits 5:6 - Back-off limit"]
    #[inline(always)]
    pub fn bol(&mut self) -> BolW<'_, MacCfgSpec> {
        BolW::new(self, 5)
    }
    #[doc = "Bit 7 - Automatic pad/CRC drop"]
    #[inline(always)]
    pub fn apcd(&mut self) -> ApcdW<'_, MacCfgSpec> {
        ApcdW::new(self, 7)
    }
    #[doc = "Bit 9 - Retry disable"]
    #[inline(always)]
    pub fn rtd(&mut self) -> RtdW<'_, MacCfgSpec> {
        RtdW::new(self, 9)
    }
    #[doc = "Bit 10 - IP frame checksum offload"]
    #[inline(always)]
    pub fn ipfco(&mut self) -> IpfcoW<'_, MacCfgSpec> {
        IpfcoW::new(self, 10)
    }
    #[doc = "Bit 11 - Duplex mode"]
    #[inline(always)]
    pub fn dpm(&mut self) -> DpmW<'_, MacCfgSpec> {
        DpmW::new(self, 11)
    }
    #[doc = "Bit 12 - Loopback mode"]
    #[inline(always)]
    pub fn lbm(&mut self) -> LbmW<'_, MacCfgSpec> {
        LbmW::new(self, 12)
    }
    #[doc = "Bit 13 - Receive own disable"]
    #[inline(always)]
    pub fn rod(&mut self) -> RodW<'_, MacCfgSpec> {
        RodW::new(self, 13)
    }
    #[doc = "Bit 14 - Fast Ethernet speed"]
    #[inline(always)]
    pub fn spd(&mut self) -> SpdW<'_, MacCfgSpec> {
        SpdW::new(self, 14)
    }
    #[doc = "Bit 16 - Carrier sense disable"]
    #[inline(always)]
    pub fn csd(&mut self) -> CsdW<'_, MacCfgSpec> {
        CsdW::new(self, 16)
    }
    #[doc = "Bits 17:19 - Inter frame gap bit selection"]
    #[inline(always)]
    pub fn igbs(&mut self) -> IgbsW<'_, MacCfgSpec> {
        IgbsW::new(self, 17)
    }
    #[doc = "Bit 22 - Jabber disable"]
    #[inline(always)]
    pub fn jbd(&mut self) -> JbdW<'_, MacCfgSpec> {
        JbdW::new(self, 22)
    }
    #[doc = "Bit 23 - Watchdog disable"]
    #[inline(always)]
    pub fn wdd(&mut self) -> WddW<'_, MacCfgSpec> {
        WddW::new(self, 23)
    }
    #[doc = "Bit 25 - Type Frame CRC Dropping"]
    #[inline(always)]
    pub fn tfcd(&mut self) -> TfcdW<'_, MacCfgSpec> {
        TfcdW::new(self, 25)
    }
}
