...
pub mod init;
#[doc = "RCMD (rw) register accessor: SQPI Read Command Register\n\nYou can [`read`](crate::Reg::read) this register and get [`rcmd::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`rcmd::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@rcmd`] module"]
#[doc(alias = "RCMD")]
pub type Rcmd = crate::Reg<rcmd::RcmdSpec>;
#[doc = "SQPI Read Command Register"]
pub mod rcmd;
#[doc = "WCMD (rw) register accessor: Write Command Register\n\nYou can [`read`](crate::Reg::read) this register and get [`wcmd::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`wcmd::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@wcmd`] module"]
#[doc(alias = "WCMD")]
pub type Wcmd = crate::Reg<wcmd::WcmdSpec>;
#[doc = "Write Command Register"]
pub mod wcmd;
#[doc = "IDL (r) register accessor: ID Low Register\n\nYou can [`read`](crate::Reg::read) this register and get [`idl::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@idl`] module"]
#[doc(alias = "IDL")]
pub type Idl = crate::Reg<idl::IdlSpec>;
#[doc = "ID Low Register"]
pub mod idl;
#[doc = "IDH (r) register accessor: ID High Register\n\nYou can [`read`](crate::Reg::read) this register and get [`idh::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@idh`] module"]
#[doc(alias = "IDH")]
