...
#[doc = "Field `CAN2_HOLD` reader - CAN2 hold bit"]
pub type Can2HoldR = crate::BitReader;
#[doc = "Field `CAN2_HOLD` writer - CAN2 hold bit"]
pub type Can2HoldW<'a, REG> = crate::BitWriter<'a, REG>;
...
impl R {
    ...
    #[doc = "Bit 3 - CAN2 hold bit"]
    #[inline(always)]
    pub fn can2_hold(&self) -> Can2HoldR {
        Can2HoldR::new(((self.bits >> 3) & 1) != 0)
    }
...
impl W {
    #[doc = "Bit 0 - Sleep mode hold register"]
    #[inline(always)]
    pub fn slp_hold(&mut self) -> SlpHoldW<'_, Ctl0Spec> {
        SlpHoldW::new(self, 0)
    }
    #[doc = "Bit 1 - Deep-sleep mode hold register"]
    #[inline(always)]
    pub fn dslp_hold(&mut self) -> DslpHoldW<'_, Ctl0Spec> {
        DslpHoldW::new(self, 1)
    }
    #[doc = "Bit 2 - Standby mode hold register"]
    #[inline(always)]
    pub fn stb_hold(&mut self) -> StbHoldW<'_, Ctl0Spec> {
        StbHoldW::new(self, 2)
    }
    #[doc = "Bit 3 - CAN2 hold bit"]
    #[inline(always)]
    pub fn can2_hold(&mut self) -> Can2HoldW<'_, Ctl0Spec> {
        Can2HoldW::new(self, 3)
    }
    #[doc = "Bit 5 - Trace pin allocation enable"]
    #[inline(always)]
    pub fn trace_ioen(&mut self) -> TraceIoenW<'_, Ctl0Spec> {
        TraceIoenW::new(self, 5)
    }
    #[doc = "Bits 6:7 - Trace pin allocation mode"]
    #[inline(always)]
    pub fn trace_mode(&mut self) -> TraceModeW<'_, Ctl0Spec> {
        TraceModeW::new(self, 6)
    }
    #[doc = "Bit 8 - FWDGT hold bit"]
    #[inline(always)]
    pub fn fwdgt_hold(&mut self) -> FwdgtHoldW<'_, Ctl0Spec> {
        FwdgtHoldW::new(self, 8)
    }
    #[doc = "Bit 9 - WWDGT hold bit"]
    #[inline(always)]
    pub fn wwdgt_hold(&mut self) -> WwdgtHoldW<'_, Ctl0Spec> {
        WwdgtHoldW::new(self, 9)
    }
    #[doc = "Bit 10 - TIMER 0 hold bit"]
    #[inline(always)]
    pub fn timer0_hold(&mut self) -> Timer0HoldW<'_, Ctl0Spec> {
        Timer0HoldW::new(self, 10)
    }
    #[doc = "Bit 11 - TIMER 1 hold bit"]
    #[inline(always)]
    pub fn timer1_hold(&mut self) -> Timer1HoldW<'_, Ctl0Spec> {
        Timer1HoldW::new(self, 11)
    }
    #[doc = "Bit 12 - TIMER 2 hold bit"]
    #[inline(always)]
    pub fn timer2_hold(&mut self) -> Timer2HoldW<'_, Ctl0Spec> {
        Timer2HoldW::new(self, 12)
    }
    #[doc = "Bit 13 - TIMER 23 hold bit"]
    #[inline(always)]
    pub fn timer3_hold(&mut self) -> Timer3HoldW<'_, Ctl0Spec> {
        Timer3HoldW::new(self, 13)
    }
    #[doc = "Bit 14 - CAN0 hold bit"]
    #[inline(always)]
    pub fn can0_hold(&mut self) -> Can0HoldW<'_, Ctl0Spec> {
        Can0HoldW::new(self, 14)
    }
    #[doc = "Bit 15 - I2C0 hold bit"]
    #[inline(always)]
    pub fn i2c0_hold(&mut self) -> I2c0HoldW<'_, Ctl0Spec> {
        I2c0HoldW::new(self, 15)
    }
    #[doc = "Bit 16 - I2C1 hold bit"]
    #[inline(always)]
    pub fn i2c1_hold(&mut self) -> I2c1HoldW<'_, Ctl0Spec> {
        I2c1HoldW::new(self, 16)
    }
    #[doc = "Bit 17 - TIMER7_HOLD"]
    #[inline(always)]
    pub fn timer7_hold(&mut self) -> Timer7HoldW<'_, Ctl0Spec> {
        Timer7HoldW::new(self, 17)
    }
    #[doc = "Bit 18 - TIMER4_HOLD"]
    #[inline(always)]
    pub fn timer4_hold(&mut self) -> Timer4HoldW<'_, Ctl0Spec> {
        Timer4HoldW::new(self, 18)
    }
    #[doc = "Bit 19 - TIMER 5 hold bit"]
    #[inline(always)]
    pub fn timer5_hold(&mut self) -> Timer5HoldW<'_, Ctl0Spec> {
        Timer5HoldW::new(self, 19)
    }
    #[doc = "Bit 20 - TIMER 6 hold bit"]
    #[inline(always)]
    pub fn timer6_hold(&mut self) -> Timer6HoldW<'_, Ctl0Spec> {
        Timer6HoldW::new(self, 20)
    }
    #[doc = "Bit 21 - CAN1 hold bit"]
    #[inline(always)]
    pub fn can1_hold(&mut self) -> Can1HoldW<'_, Ctl0Spec> {
        Can1HoldW::new(self, 21)
    }
    #[doc = "Bit 22 - I2C2 hold bit"]
    #[inline(always)]
    pub fn i2c2_hold(&mut self) -> I2c2HoldW<'_, Ctl0Spec> {
        I2c2HoldW::new(self, 22)
    }
    #[doc = "Bit 25 - TIMER 11 hold bit"]
    #[inline(always)]
    pub fn timer11_hold(&mut self) -> Timer11HoldW<'_, Ctl0Spec> {
        Timer11HoldW::new(self, 25)
    }
    #[doc = "Bit 26 - TIMER 12 hold bit"]
    #[inline(always)]
    pub fn timer12_hold(&mut self) -> Timer12HoldW<'_, Ctl0Spec> {
        Timer12HoldW::new(self, 26)
    }
    #[doc = "Bit 27 - TIMER 13 hold bit"]
    #[inline(always)]
    pub fn timer13_hold(&mut self) -> Timer13HoldW<'_, Ctl0Spec> {
        Timer13HoldW::new(self, 27)
    }
    #[doc = "Bit 28 - TIMER 8 hold bit"]
    #[inline(always)]
    pub fn timer8_hold(&mut self) -> Timer8HoldW<'_, Ctl0Spec> {
        Timer8HoldW::new(self, 28)
    }
    #[doc = "Bit 29 - TIMER 9 hold bit"]
    #[inline(always)]
    pub fn timer9_hold(&mut self) -> Timer9HoldW<'_, Ctl0Spec> {
        Timer9HoldW::new(self, 29)
    }
    #[doc = "Bit 30 - TIMER 10 hold bit"]
    #[inline(always)]
    pub fn timer10_hold(&mut self) -> Timer10HoldW<'_, Ctl0Spec> {
        Timer10HoldW::new(self, 30)
    }
    #[doc = "Bit 31 - SHRTIMER hold bit"]
    #[inline(always)]
    pub fn shrtimer_hold(&mut self) -> ShrtimerHoldW<'_, Ctl0Spec> {
