#[doc = "Register `ST3INTF` reader"]
pub type R = crate::R<St3intfSpec>;
...
#[doc = "SHRTIMER Slave_TIMERx interrupt flag register\n\nYou can [`read`](crate::Reg::read) this register and get [`st3intf::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St3intfSpec;
impl crate::RegisterSpec for St3intfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st3intf::R`](R) reader structure"]
impl crate::Readable for St3intfSpec {}
#[doc = "`reset()` method sets ST3INTF to value 0"]
impl crate::Resettable for St3intfSpec {}
