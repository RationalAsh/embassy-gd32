...
impl W {
    #[doc = "Bits 0:1 - Counter clock division"]
    #[inline(always)]
    pub fn cntckdiv(&mut self) -> CntckdivW<'_, Mtctl0Spec> {
        CntckdivW::new(self, 0)
    }
    #[doc = "Bit 3 - Continuous mode"]
    #[inline(always)]
    pub fn ctnm(&mut self) -> CtnmW<'_, Mtctl0Spec> {
        CtnmW::new(self, 3)
    }
    #[doc = "Bit 4 - Counter reset mode"]
    #[inline(always)]
    pub fn cntrstm(&mut self) -> CntrstmW<'_, Mtctl0Spec> {
        CntrstmW::new(self, 4)
    }
    #[doc = "Bit 5 - Half mode"]
    #[inline(always)]
    pub fn halfm(&mut self) -> HalfmW<'_, Mtctl0Spec> {
        HalfmW::new(self, 5)
    }
    #[doc = "Bits 8:9 - Synchronization input source"]
    #[inline(always)]
    pub fn synisrc(&mut self) -> SynisrcW<'_, Mtctl0Spec> {
        SynisrcW::new(self, 8)
    }
    #[doc = "Bit 10 - Synchronization input reset counter"]
    #[inline(always)]
    pub fn synirst(&mut self) -> SynirstW<'_, Mtctl0Spec> {
        SynirstW::new(self, 10)
    }
    #[doc = "Bit 11 - Synchronization input start counter"]
    #[inline(always)]
    pub fn synistrt(&mut self) -> SynistrtW<'_, Mtctl0Spec> {
        SynistrtW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Synchronization output pulse"]
    #[inline(always)]
    pub fn synopls(&mut self) -> SynoplsW<'_, Mtctl0Spec> {
        SynoplsW::new(self, 12)
    }
    #[doc = "Bits 14:15 - Synchronization output source"]
    #[inline(always)]
    pub fn synosrc(&mut self) -> SynosrcW<'_, Mtctl0Spec> {
        SynosrcW::new(self, 14)
    }
    #[doc = "Bit 16 - The counter of Master_TIMER enable"]
    #[inline(always)]
    pub fn mtcen(&mut self) -> MtcenW<'_, Mtctl0Spec> {
        MtcenW::new(self, 16)
    }
    #[doc = "Bit 17 - The counter of Slave_TIMER0 enable"]
    #[inline(always)]
    pub fn st0cen(&mut self) -> St0cenW<'_, Mtctl0Spec> {
        St0cenW::new(self, 17)
    }
    #[doc = "Bit 18 - The counter of Slave_TIMER1 enable"]
    #[inline(always)]
    pub fn st1cen(&mut self) -> St1cenW<'_, Mtctl0Spec> {
        St1cenW::new(self, 18)
    }
    #[doc = "Bit 19 - The counter of Slave_TIMER2 enable"]
    #[inline(always)]
    pub fn st2cen(&mut self) -> St2cenW<'_, Mtctl0Spec> {
        St2cenW::new(self, 19)
    }
    #[doc = "Bit 20 - The counter of Slave_TIMER3 enable"]
    #[inline(always)]
    pub fn st3cen(&mut self) -> St3cenW<'_, Mtctl0Spec> {
        St3cenW::new(self, 20)
    }
    #[doc = "Bit 21 - The counter of Slave_TIMER4 enable"]
    #[inline(always)]
    pub fn st4cen(&mut self) -> St4cenW<'_, Mtctl0Spec> {
        St4cenW::new(self, 21)
    }
    #[doc = "Bits 25:26 - Trigger source to DAC"]
    #[inline(always)]
    pub fn dactrgs(&mut self) -> DactrgsW<'_, Mtctl0Spec> {
        DactrgsW::new(self, 25)
    }
    #[doc = "Bit 27 - Shadow registers enable"]
    #[inline(always)]
    pub fn shwen(&mut self) -> ShwenW<'_, Mtctl0Spec> {
        ShwenW::new(self, 27)
    }
    #[doc = "Bit 29 - Update event generated by repetition event"]
    #[inline(always)]
    pub fn uprep(&mut self) -> UprepW<'_, Mtctl0Spec> {
        UprepW::new(self, 29)
    }
    #[doc = "Bits 30:31 - Update event selection"]
    #[inline(always)]
    pub fn upsel(&mut self) -> UpselW<'_, Mtctl0Spec> {
        UpselW::new(self, 30)
    }
}
#[doc = "SHRTIMER Master_TIMER control register 0\n\nYou can [`read`](crate::Reg::read) this register and get [`mtctl0::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`mtctl0::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
