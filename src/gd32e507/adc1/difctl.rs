...
impl W {
    #[doc = "Bits 0:14 - Differential mode for channel 14 to 0"]
    #[inline(always)]
    pub fn difctl_14_0(&mut self) -> Difctl14_0W<'_, DifctlSpec> {
        Difctl14_0W::new(self, 0)
    }
}
#[doc = "Differential mode control register\n\nYou can [`read`](crate::Reg::read) this register and get [`difctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`difctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
