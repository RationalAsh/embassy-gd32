...
impl W {
    #[doc = "Bits 0:10 - maximum packet length"]
    #[inline(always)]
    pub fn mpl(&mut self) -> MplW<'_, Doep5ctlSpec> {
        MplW::new(self, 0)
    }
    #[doc = "Bit 15 - Endpoint active"]
    #[inline(always)]
    pub fn epact(&mut self) -> EpactW<'_, Doep5ctlSpec> {
        EpactW::new(self, 15)
    }
    #[doc = "Bits 18:19 - Endpoint type"]
    #[inline(always)]
    ...
    #[doc = "Bit 20 - Snoop mode"]
    #[inline(always)]
    pub fn snoop(&mut self) -> SnoopW<'_, Doep5ctlSpec> {
        SnoopW::new(self, 20)
    }
    #[doc = "Bit 21 - STALL handshake"]
    #[inline(always)]
    ...
    #[inline(always)]
    pub fn sd0pid_sevenfrm(&mut self) -> Sd0pidSevenfrmW<'_, Doep5ctlSpec> {
        Sd0pidSevenfrmW::new(self, 28)
    }
    #[doc = "Bit 29 - SD1PID/SODDFRM"]
    #[inline(always)]
    pub fn sd1pid_soddfrm(&mut self) -> Sd1pidSoddfrmW<'_, Doep5ctlSpec> {
        Sd1pidSoddfrmW::new(self, 29)
    }
    #[doc = "Bit 30 - Endpoint disable"]
    #[inline(always)]
    pub fn epd(&mut self) -> EpdW<'_, Doep5ctlSpec> {
        EpdW::new(self, 30)
    }
    #[doc = "Bit 31 - Endpoint enable"]
    #[inline(always)]
    pub fn epen(&mut self) -> EpenW<'_, Doep5ctlSpec> {
        EpenW::new(self, 31)
    }
}
