#[doc = "Register `ST1INTF` reader"]
pub type R = crate::R<St1intfSpec>;
...
#[doc = "SHRTIMER Slave_TIMER1 interrupt flag register\n\nYou can [`read`](crate::Reg::read) this register and get [`st1intf::R`](R). See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct St1intfSpec;
impl crate::RegisterSpec for St1intfSpec {
    type Ux = u32;
}
#[doc = "`read()` method returns [`st1intf::R`](R) reader structure"]
impl crate::Readable for St1intfSpec {}
#[doc = "`reset()` method sets ST1INTF to value 0"]
impl crate::Resettable for St1intfSpec {}
