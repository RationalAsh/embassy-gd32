...
impl W {
    #[doc = "Bit 0 - DAC0 enable"]
    #[inline(always)]
    pub fn den0(&mut self) -> Den0W<'_, Ctl0Spec> {
        Den0W::new(self, 0)
    }
    #[doc = "Bit 1 - DAC0 output buffer turn off"]
    #[inline(always)]
    pub fn dboff0(&mut self) -> Dboff0W<'_, Ctl0Spec> {
        Dboff0W::new(self, 1)
    }
    #[doc = "Bit 2 - DAC0 trigger enable"]
    #[inline(always)]
    pub fn dten0(&mut self) -> Dten0W<'_, Ctl0Spec> {
        Dten0W::new(self, 2)
    }
    #[doc = "Bits 3:5 - DAC0 trigger selection"]
    #[inline(always)]
    pub fn dtsel0(&mut self) -> Dtsel0W<'_, Ctl0Spec> {
        Dtsel0W::new(self, 3)
    }
    #[doc = "Bits 6:7 - DAC0 noise wave mode"]
    #[inline(always)]
    pub fn dwm0(&mut self) -> Dwm0W<'_, Ctl0Spec> {
        Dwm0W::new(self, 6)
    }
    #[doc = "Bits 8:11 - DAC0 noise wave bit width"]
    #[inline(always)]
    pub fn dwbw0(&mut self) -> Dwbw0W<'_, Ctl0Spec> {
        Dwbw0W::new(self, 8)
    }
    #[doc = "Bit 12 - DAC0 DMA enable"]
    #[inline(always)]
    pub fn ddmaen0(&mut self) -> Ddmaen0W<'_, Ctl0Spec> {
        Ddmaen0W::new(self, 12)
    }
    #[doc = "Bit 13 - DAC_OUT0 DMA underrun interrupt enable"]
    #[inline(always)]
    pub fn ddudrie0(&mut self) -> Ddudrie0W<'_, Ctl0Spec> {
        Ddudrie0W::new(self, 13)
    }
    #[doc = "Bit 14 - DAC_OUT0 trigger selection bit\\[3\\], refer to DTSEL0\\[2:0\\]"]
    #[inline(always)]
    pub fn dtsel0_3(&mut self) -> Dtsel0_3W<'_, Ctl0Spec> {
        Dtsel0_3W::new(self, 14)
    }
    #[doc = "Bit 16 - DAC1 enable"]
    #[inline(always)]
    pub fn den1(&mut self) -> Den1W<'_, Ctl0Spec> {
        Den1W::new(self, 16)
    }
    #[doc = "Bit 17 - DAC1 output buffer turn off"]
    #[inline(always)]
    pub fn dboff1(&mut self) -> Dboff1W<'_, Ctl0Spec> {
        Dboff1W::new(self, 17)
    }
    #[doc = "Bit 18 - DAC1 trigger enable"]
    #[inline(always)]
    pub fn dten1(&mut self) -> Dten1W<'_, Ctl0Spec> {
        Dten1W::new(self, 18)
    }
    #[doc = "Bits 19:21 - DAC1 trigger selection"]
    #[inline(always)]
    pub fn dtsel1(&mut self) -> Dtsel1W<'_, Ctl0Spec> {
        Dtsel1W::new(self, 19)
    }
    #[doc = "Bits 22:23 - DAC1 noise wave mode"]
    #[inline(always)]
    pub fn dwm1(&mut self) -> Dwm1W<'_, Ctl0Spec> {
        Dwm1W::new(self, 22)
    }
    #[doc = "Bits 24:27 - DAC1 noise wave bit width"]
    #[inline(always)]
    pub fn dwbw1(&mut self) -> Dwbw1W<'_, Ctl0Spec> {
        Dwbw1W::new(self, 24)
    }
    #[doc = "Bit 28 - DAC1 DMA enable"]
    #[inline(always)]
    pub fn ddmaen1(&mut self) -> Ddmaen1W<'_, Ctl0Spec> {
        Ddmaen1W::new(self, 28)
    }
    #[doc = "Bit 29 - DAC_OUT1 DMA underrun interrupt enable"]
    #[inline(always)]
    pub fn ddudrie1(&mut self) -> Ddudrie1W<'_, Ctl0Spec> {
        Ddudrie1W::new(self, 29)
    }
    #[doc = "Bit 30 - DAC_OUT1 trigger selection bit\\[3\\], refer to DTSEL1\\[2:0\\]"]
    #[inline(always)]
    pub fn dtsel1_3(&mut self) -> Dtsel1_3W<'_, Ctl0Spec> {
