...
impl W {
    #[doc = "Bit 2 - DAC_OUT0 FIFO overflow flag"]
    #[inline(always)]
    pub fn fifoovr0(&mut self) -> Fifoovr0W<'_, Stat1Spec> {
        Fifoovr0W::new(self, 2)
    }
    #[doc = "Bit 3 - DAC_OUT0 FIFO underflow flag"]
    #[inline(always)]
    pub fn fifoudr0(&mut self) -> Fifoudr0W<'_, Stat1Spec> {
        Fifoudr0W::new(self, 3)
    }
    #[doc = "Bit 18 - DAC_OUT1 FIFO overflow flag"]
    #[inline(always)]
    pub fn fifoovr1(&mut self) -> Fifoovr1W<'_, Stat1Spec> {
        Fifoovr1W::new(self, 18)
    }
    #[doc = "Bit 19 - DAC_OUT1 FIFO underflow flag"]
    #[inline(always)]
    pub fn fifoudr1(&mut self) -> Fifoudr1W<'_, Stat1Spec> {
