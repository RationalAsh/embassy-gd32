...
pub type Md8W<'a, REG> = crate::FieldWriter<'a, REG, 2, Md8, crate::Safe>;
...
pub type Ctl8W<'a, REG> = crate::FieldWriter<'a, REG, 2, Ctl8, crate::Safe>;
...
impl W {
    #[doc = "Bits 0:1 - Port x mode bits (x = 8)"]
    #[inline(always)]
    pub fn md8(&mut self) -> Md8W<'_, Ctl1Spec> {
        Md8W::new(self, 0)
    }
    #[doc = "Bits 2:3 - Port x configuration bits (x = 8)"]
    #[inline(always)]
    pub fn ctl8(&mut self) -> Ctl8W<'_, Ctl1Spec> {
        Ctl8W::new(self, 2)
    }
    #[doc = "Bits 4:5 - Port x mode bits (x = 9)"]
    #[inline(always)]
    pub fn md9(&mut self) -> Md9W<'_, Ctl1Spec> {
        Md9W::new(self, 4)
    }
    #[doc = "Bits 6:7 - Port x configuration bits (x = 9)"]
    #[inline(always)]
    pub fn ctl9(&mut self) -> Ctl9W<'_, Ctl1Spec> {
        Ctl9W::new(self, 6)
    }
    #[doc = "Bits 8:9 - Port x mode bits (x = 10 )"]
    #[inline(always)]
    pub fn md10(&mut self) -> Md10W<'_, Ctl1Spec> {
        Md10W::new(self, 8)
    }
    #[doc = "Bits 10:11 - Port x configuration bits (x = 10)"]
    #[inline(always)]
    pub fn ctl10(&mut self) -> Ctl10W<'_, Ctl1Spec> {
        Ctl10W::new(self, 10)
    }
    #[doc = "Bits 12:13 - Port x mode bits (x = 11 )"]
    #[inline(always)]
    pub fn md11(&mut self) -> Md11W<'_, Ctl1Spec> {
        Md11W::new(self, 12)
    }
    #[doc = "Bits 14:15 - Port x configuration bits (x = 11)"]
    #[inline(always)]
    pub fn ctl11(&mut self) -> Ctl11W<'_, Ctl1Spec> {
        Ctl11W::new(self, 14)
    }
    #[doc = "Bits 16:17 - Port x mode bits (x = 12)"]
    #[inline(always)]
    pub fn md12(&mut self) -> Md12W<'_, Ctl1Spec> {
        Md12W::new(self, 16)
    }
    #[doc = "Bits 18:19 - Port x configuration bits (x = 12)"]
    #[inline(always)]
    pub fn ctl12(&mut self) -> Ctl12W<'_, Ctl1Spec> {
        Ctl12W::new(self, 18)
    }
    #[doc = "Bits 20:21 - Port x mode bits (x = 13)"]
    #[inline(always)]
    pub fn md13(&mut self) -> Md13W<'_, Ctl1Spec> {
        Md13W::new(self, 20)
    }
    #[doc = "Bits 22:23 - Port x configuration bits (x = 13)"]
    #[inline(always)]
    pub fn ctl13(&mut self) -> Ctl13W<'_, Ctl1Spec> {
        Ctl13W::new(self, 22)
    }
    #[doc = "Bits 24:25 - Port x mode bits (x = 14)"]
    #[inline(always)]
    pub fn md14(&mut self) -> Md14W<'_, Ctl1Spec> {
        Md14W::new(self, 24)
    }
    #[doc = "Bits 26:27 - Port x configuration bits (x = 14)"]
    #[inline(always)]
    pub fn ctl14(&mut self) -> Ctl14W<'_, Ctl1Spec> {
        Ctl14W::new(self, 26)
    }
    #[doc = "Bits 28:29 - Port x mode bits (x = 15)"]
    #[inline(always)]
    pub fn md15(&mut self) -> Md15W<'_, Ctl1Spec> {
        Md15W::new(self, 28)
    }
    #[doc = "Bits 30:31 - Port x configuration bits (x = 15)"]
    #[inline(always)]
    pub fn ctl15(&mut self) -> Ctl15W<'_, Ctl1Spec> {
        Ctl15W::new(self, 30)
    }
}
