...
impl W {
    #[doc = "Bit 0 - Interrupt rising edge status"]
    #[inline(always)]
    pub fn intrs(&mut self) -> IntrsW<'_, Npinten3Spec> {
        IntrsW::new(self, 0)
    }
    #[doc = "Bit 1 - Interrupt high-level status"]
    #[inline(always)]
    pub fn inths(&mut self) -> InthsW<'_, Npinten3Spec> {
        InthsW::new(self, 1)
    }
    #[doc = "Bit 2 - Interrupt falling edge status"]
    #[inline(always)]
    pub fn intfs(&mut self) -> IntfsW<'_, Npinten3Spec> {
        IntfsW::new(self, 2)
    }
    #[doc = "Bit 3 - Interrupt rising edge detection enable bit"]
    #[inline(always)]
    pub fn intren(&mut self) -> IntrenW<'_, Npinten3Spec> {
        IntrenW::new(self, 3)
    }
    #[doc = "Bit 4 - Interrupt high-level detection enable"]
    #[inline(always)]
    pub fn inthen(&mut self) -> InthenW<'_, Npinten3Spec> {
        InthenW::new(self, 4)
    }
    #[doc = "Bit 5 - Interrupt falling edge detection enable"]
    #[inline(always)]
    pub fn intfen(&mut self) -> IntfenW<'_, Npinten3Spec> {
        IntfenW::new(self, 5)
    }
    #[doc = "Bit 6 - FIFO empty flag"]
    #[inline(always)]
    pub fn ffept(&mut self) -> FfeptW<'_, Npinten3Spec> {
        FfeptW::new(self, 6)
    }
}
...
#[doc = "`reset()` method sets NPINTEN3 to value 0x42"]
