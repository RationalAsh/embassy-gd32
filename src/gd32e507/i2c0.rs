...
impl RegisterBlock {
    ...
    #[doc = "0x90 - Control register 2"]
    #[inline(always)]
    pub const fn ctl2(&self) -> &Ctl2 {
        &self.ctl2
    }
    #[doc = "0x94 - Control and status register"]
    #[inline(always)]
    pub const fn cs(&self) -> &Cs {
        &self.cs
    }
    #[doc = "0x98 - Status clear register"]
    #[inline(always)]
...
pub mod cs;
#[doc = "STATC (rw) register accessor: Status clear register\n\nYou can [`read`](crate::Reg::read) this register and get [`statc::R`]. You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`statc::W`]. You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@statc`] module"]
#[doc(alias = "STATC")]
