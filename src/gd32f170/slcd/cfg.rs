...
impl W {
    #[doc = "Bit 0 - High drive enable"]
    #[inline(always)]
    pub fn hden(&mut self) -> HdenW<'_, CfgSpec> {
        HdenW::new(self, 0)
    }
    #[doc = "Bit 1 - Start of frame interrupt enable"]
    #[inline(always)]
    pub fn sofie(&mut self) -> SofieW<'_, CfgSpec> {
        SofieW::new(self, 1)
    }
    #[doc = "Bit 3 - SLCD update done interrupt enable"]
    #[inline(always)]
    pub fn updie(&mut self) -> UpdieW<'_, CfgSpec> {
        UpdieW::new(self, 3)
    }
    #[doc = "Bits 4:6 - Pulse on duration"]
    #[inline(always)]
    pub fn pulse(&mut self) -> PulseW<'_, CfgSpec> {
        PulseW::new(self, 4)
    }
    #[doc = "Bits 7:9 - Dead time duration"]
    #[inline(always)]
    pub fn dtd(&mut self) -> DtdW<'_, CfgSpec> {
        DtdW::new(self, 7)
    }
    #[doc = "Bits 10:12 - Contrast ratio"]
    #[inline(always)]
    pub fn conr(&mut self) -> ConrW<'_, CfgSpec> {
        ConrW::new(self, 10)
    }
    #[doc = "Bits 13:15 - Blink frequency divider"]
    #[inline(always)]
    pub fn blkdiv(&mut self) -> BlkdivW<'_, CfgSpec> {
        BlkdivW::new(self, 13)
    }
    #[doc = "Bits 16:17 - Blink mode"]
    #[inline(always)]
    pub fn blkmod(&mut self) -> BlkmodW<'_, CfgSpec> {
        BlkmodW::new(self, 16)
    }
    #[doc = "Bits 18:21 - SLCD clock divider"]
    #[inline(always)]
    ...
    #[doc = "Bits 22:25 - SLCD clock prescaler"]
    #[inline(always)]
    pub fn psc(&mut self) -> PscW<'_, CfgSpec> {
        PscW::new(self, 22)
    }
}
