...
pub use Timer1enR as OpaivrefenR;
...
pub use Timer1enW as OpaivrefenW;
impl R {
    ...
    #[inline(always)]
    pub fn slcden(&self) -> SlcdenR {
        SlcdenR::new(((self.bits >> 9) & 1) != 0)
    }
    ...
    #[inline(always)]
    pub fn opaivrefen(&self) -> OpaivrefenR {
        OpaivrefenR::new(((self.bits >> 31) & 1) != 0)
    }
}
impl W {
    #[doc = "Bit 0 - TIMER1 timer clock enable"]
    ...
    #[doc = "Bit 9 - SLCD clock enable"]
    #[inline(always)]
    pub fn slcden(&mut self) -> SlcdenW<'_, Apb1enSpec> {
        SlcdenW::new(self, 9)
    }
    #[doc = "Bit 11 - Window watchdog timer clock enable"]
    #[inline(always)]
    ...
    #[doc = "Bit 30 - HDMI CEC interface clock enable"]
    #[inline(always)]
    pub fn cecen(&mut self) -> CecenW<'_, Apb1enSpec> {
        CecenW::new(self, 30)
    }
    #[doc = "Bit 31 - OPA and IVREF clock enable"]
    #[inline(always)]
    pub fn opaivrefen(&mut self) -> OpaivrefenW<'_, Apb1enSpec> {
        OpaivrefenW::new(self, 31)
    }
}
