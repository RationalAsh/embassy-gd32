...
pub type Ckout1selW<'a, REG> = crate::FieldWriter<'a, REG, 3, Ckout1sel, crate::Safe>;
...
impl W {
    #[doc = "Bits 0:2 - CKOUT1 Clock Source Selection"]
    #[inline(always)]
    pub fn ckout1sel(&mut self) -> Ckout1selW<'_, Cfg3Spec> {
        Ckout1selW::new(self, 0)
    }
    #[doc = "Bits 8:13 - The CK_OUT1 divider which the CK_OUT1 frequency can be reduced see bits 2:0 of RCU_CFG3 for CK_OUT1"]
    #[inline(always)]
    pub fn ckout1div(&mut self) -> Ckout1divW<'_, Cfg3Spec> {
