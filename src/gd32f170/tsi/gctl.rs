...
impl W {
    #[doc = "Bit 0 - Analog I/O group 0 enable"]
    #[inline(always)]
    pub fn ge0(&mut self) -> Ge0W<'_, GctlSpec> {
        Ge0W::new(self, 0)
    }
    #[doc = "Bit 1 - Analog I/O group 1 enable"]
    #[inline(always)]
    pub fn ge1(&mut self) -> Ge1W<'_, GctlSpec> {
        Ge1W::new(self, 1)
    }
    #[doc = "Bit 2 - Analog I/O group 2 enable"]
    #[inline(always)]
    pub fn ge2(&mut self) -> Ge2W<'_, GctlSpec> {
        Ge2W::new(self, 2)
    }
    #[doc = "Bit 3 - Analog I/O group 3 enable"]
    #[inline(always)]
    pub fn ge3(&mut self) -> Ge3W<'_, GctlSpec> {
        Ge3W::new(self, 3)
    }
    #[doc = "Bit 4 - Analog I/O group 4 enable"]
    #[inline(always)]
    pub fn ge4(&mut self) -> Ge4W<'_, GctlSpec> {
        Ge4W::new(self, 4)
    }
    #[doc = "Bit 5 - Analog I/O group 5 enable"]
    #[inline(always)]
    pub fn ge5(&mut self) -> Ge5W<'_, GctlSpec> {
        Ge5W::new(self, 5)
    }
}
