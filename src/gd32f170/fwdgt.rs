...
#[doc = "Status register"]
pub mod stat;
#[doc = "WND (r) register accessor: Window register\n\nYou can [`read`](crate::Reg::read) this register and get [`wnd::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@wnd`] module"]
#[doc(alias = "WND")]
