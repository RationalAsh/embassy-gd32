...
pub type Isq4R = crate::FieldReader;
#[doc = "Field `ISQ4` writer - 4th conversion in injected sequence"]
pub type Isq4W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
impl W {
    #[doc = "Bits 0:4 - 1st conversion in injected sequence"]
    #[inline(always)]
    pub fn isq1(&mut self) -> Isq1W<'_, IsqSpec> {
        Isq1W::new(self, 0)
    }
    #[doc = "Bits 5:9 - 2nd conversion in injected sequence"]
    #[inline(always)]
    pub fn isq2(&mut self) -> Isq2W<'_, IsqSpec> {
        Isq2W::new(self, 5)
    }
    #[doc = "Bits 10:14 - 3rd conversion in injected sequence"]
    #[inline(always)]
    pub fn isq3(&mut self) -> Isq3W<'_, IsqSpec> {
        Isq3W::new(self, 10)
    }
    #[doc = "Bits 15:19 - 4th conversion in injected sequence"]
    #[inline(always)]
    pub fn isq4(&mut self) -> Isq4W<'_, IsqSpec> {
        Isq4W::new(self, 15)
    }
    #[doc = "Bits 20:21 - Inserted channel group length"]
    #[inline(always)]
    pub fn il(&mut self) -> IlW<'_, IsqSpec> {
        IlW::new(self, 20)
    }
}
