...
pub type Oa0TrimLowW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa0TrimHighW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa1TrimLowW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa1TrimHighW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa2TrimLowW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa2TrimHighW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
impl W {
    #[doc = "Bits 0:4 - OPA0, normal mode 5-bit offset trim value for PMOS pairs"]
    #[inline(always)]
    pub fn oa0_trim_low(&mut self) -> Oa0TrimLowW<'_, OpaBtSpec> {
        Oa0TrimLowW::new(self, 0)
    }
    #[doc = "Bits 5:9 - OPA0, normal mode 5-bit offset trim value for NMOS pairs"]
    #[inline(always)]
    pub fn oa0_trim_high(&mut self) -> Oa0TrimHighW<'_, OpaBtSpec> {
        Oa0TrimHighW::new(self, 5)
    }
    #[doc = "Bits 10:14 - OPA1, normal mode 5-bit offset trim value for PMOS pairs"]
    #[inline(always)]
    pub fn oa1_trim_low(&mut self) -> Oa1TrimLowW<'_, OpaBtSpec> {
        Oa1TrimLowW::new(self, 10)
    }
    #[doc = "Bits 15:19 - OPA1, normal mode 5-bit offset trim value for NMOS pairs"]
    #[inline(always)]
    pub fn oa1_trim_high(&mut self) -> Oa1TrimHighW<'_, OpaBtSpec> {
        Oa1TrimHighW::new(self, 15)
    }
    #[doc = "Bits 20:24 - OPA2, normal mode 5-bit offset trim value for PMOS pairs"]
    #[inline(always)]
    pub fn oa2_trim_low(&mut self) -> Oa2TrimLowW<'_, OpaBtSpec> {
        Oa2TrimLowW::new(self, 20)
    }
    #[doc = "Bits 25:29 - OPA2, normal mode 5-bit offset trim value for NMOS pairs"]
    #[inline(always)]
    pub fn oa2_trim_high(&mut self) -> Oa2TrimHighW<'_, OpaBtSpec> {
        Oa2TrimHighW::new(self, 25)
    }
    #[doc = "Bit 31 - user programmed trimming value"]
    #[inline(always)]
    pub fn ot_user(&mut self) -> OtUserW<'_, OpaBtSpec> {
        OtUserW::new(self, 31)
    }
}
#[doc = "OPA offset trimming for normal mode register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa_bt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opa_bt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
