...
pub mod f27data1;
#[doc = "PHYCTL (r) register accessor: PHY control register\n\nYou can [`read`](crate::Reg::read) this register and get [`phyctl::R`]. See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [`mod@phyctl`] module"]
#[doc(alias = "PHYCTL")]
