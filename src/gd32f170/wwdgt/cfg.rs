...
pub type WinW<'a, REG> = crate::FieldWriter<'a, REG, 7, u8, crate::Safe>;
#[doc = "Prescaler\n\nValue on reset: 0"]
...
pub type PscW<'a, REG> = crate::FieldWriter<'a, REG, 2, Psc, crate::Safe>;
...
impl W {
    ...
    #[doc = "Bit 9 - Early wakeup interrupt enable"]
    #[inline(always)]
    pub fn ewie(&mut self) -> EwieW<'_, CfgSpec> {
        EwieW::new(self, 9)
    }
}
