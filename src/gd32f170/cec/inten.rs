...
impl W {
    #[doc = "Bit 0 - RBR Interrupt Enable"]
    #[inline(always)]
    pub fn rbrie(&mut self) -> RbrieW<'_, IntenSpec> {
        RbrieW::new(self, 0)
    }
    #[doc = "Bit 1 - REND Interrupt Enable"]
    #[inline(always)]
    pub fn rendie(&mut self) -> RendieW<'_, IntenSpec> {
        RendieW::new(self, 1)
    }
    #[doc = "Bit 2 - RO Interrupt Enable"]
    #[inline(always)]
    pub fn roie(&mut self) -> RoieW<'_, IntenSpec> {
        RoieW::new(self, 2)
    }
    #[doc = "Bit 3 - RBRE Interrupt Enable"]
    #[inline(always)]
    pub fn rbreie(&mut self) -> RbreieW<'_, IntenSpec> {
        RbreieW::new(self, 3)
    }
    #[doc = "Bit 4 - RSBPE Interrupt Enable"]
    #[inline(always)]
    pub fn rsbpeie(&mut self) -> RsbpeieW<'_, IntenSpec> {
        RsbpeieW::new(self, 4)
    }
    #[doc = "Bit 5 - RLBPE Interrupt Enable"]
    #[inline(always)]
    pub fn rlbpeie(&mut self) -> RlbpeieW<'_, IntenSpec> {
        RlbpeieW::new(self, 5)
    }
    #[doc = "Bit 6 - RAE Interrupt Enable"]
    #[inline(always)]
    pub fn raeie(&mut self) -> RaeieW<'_, IntenSpec> {
        RaeieW::new(self, 6)
    }
    #[doc = "Bit 7 - ALRLST Interrupt Enable"]
    #[inline(always)]
    pub fn lstarbie(&mut self) -> LstarbieW<'_, IntenSpec> {
        LstarbieW::new(self, 7)
    }
    #[doc = "Bit 8 - TBR Interrupt Enable"]
    #[inline(always)]
    pub fn tbrie(&mut self) -> TbrieW<'_, IntenSpec> {
        TbrieW::new(self, 8)
    }
    #[doc = "Bit 9 - TEND Interrupt Enable"]
    #[inline(always)]
    pub fn txendie(&mut self) -> TxendieW<'_, IntenSpec> {
        TxendieW::new(self, 9)
    }
    #[doc = "Bit 10 - TU Interrupt Enable"]
    #[inline(always)]
    pub fn tuie(&mut self) -> TuieW<'_, IntenSpec> {
        TuieW::new(self, 10)
    }
    #[doc = "Bit 11 - TERR Interrupt Enable"]
    #[inline(always)]
    pub fn terrie(&mut self) -> TerrieW<'_, IntenSpec> {
        TerrieW::new(self, 11)
    }
    #[doc = "Bit 12 - TAERR Interrupt Enable"]
    #[inline(always)]
    pub fn taerrie(&mut self) -> TaerrieW<'_, IntenSpec> {
