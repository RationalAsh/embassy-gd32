...
#[doc = "Field `CH1VAL` reader - Capture or compare value of channel 1"]
pub type Ch1valR = crate::FieldReader<u32>;
#[doc = "Field `CH1VAL` writer - Capture or compare value of channel 1"]
pub type Ch1valW<'a, REG> = crate::FieldWriter<'a, REG, 32, u32, crate::Safe>;
impl R {
    #[doc = "Bits 0:31 - Capture or compare value of channel 1"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:31 - Capture or compare value of channel 1"]
    #[inline(always)]
    pub fn ch1val(&mut self) -> Ch1valW<'_, Ch1cvSpec> {
        Ch1valW::new(self, 0)
    }
}
