...
impl W {
    #[doc = "Bit 0 - Power down voltage select"]
    #[inline(always)]
    pub fn pdrvs(&mut self) -> PdrvsW<'_, PdvselSpec> {
        PdrvsW::new(self, 0)
    }
}
#[doc = "Power down voltage select register\n\nYou can [`read`](crate::Reg::read) this register and get [`pdvsel::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`pdvsel::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
