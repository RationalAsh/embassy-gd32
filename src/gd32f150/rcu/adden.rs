...
impl W {
    #[doc = "Bit 0 - I2C2 unit clock enable"]
    #[inline(always)]
    pub fn i2c2en(&mut self) -> I2c2enW<'_, AddenSpec> {
        I2c2enW::new(self, 0)
    }
}
#[doc = "Additional enable register\n\nYou can [`read`](crate::Reg::read) this register and get [`adden::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`adden::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
