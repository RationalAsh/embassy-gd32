...
pub use Timer1rstR as UsbdrstR;
...
pub use Timer1rstW as UsbdrstW;
...
impl W {
    ...
    #[doc = "Bit 23 - USBD reset"]
    #[inline(always)]
    pub fn usbdrst(&mut self) -> UsbdrstW<'_, Apb1rstSpec> {
    ...
    #[doc = "Bit 30 - HDMI CEC reset"]
    #[inline(always)]
    pub fn cecrst(&mut self) -> CecrstW<'_, Apb1rstSpec> {
        CecrstW::new(self, 30)
    }
}
