...
impl crate::IsEnum for Hxtalpredv {}
...
pub type HxtalpredvW<'a, REG> = crate::FieldWriter<'a, REG, 4, Hxtalpredv, crate::Safe>;
...
impl W {
    #[doc = "Bits 0:3 - CK_HXTAL divider previous PLL"]
    #[inline(always)]
    pub fn hxtalpredv(&mut self) -> HxtalpredvW<'_, Cfg1Spec> {
