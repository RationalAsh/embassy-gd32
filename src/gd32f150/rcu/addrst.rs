...
impl W {
    #[doc = "Bit 0 - I2C2 unit reset"]
    #[inline(always)]
    pub fn i2c2rst(&mut self) -> I2c2rstW<'_, AddrstSpec> {
        I2c2rstW::new(self, 0)
    }
}
#[doc = "Additional reset register\n\nYou can [`read`](crate::Reg::read) this register and get [`addrst::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`addrst::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
