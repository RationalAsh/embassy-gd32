...
pub type StbW<'a, REG> = crate::FieldWriter<'a, REG, 2, Stb, crate::Safe>;
...
pub type AddrW<'a, REG> = crate::FieldWriter<'a, REG, 8, u8, crate::Safe>;
impl R {
...
impl W {
    #[doc = "Bit 4 - Address detection mode"]
    #[inline(always)]
    pub fn addm(&mut self) -> AddmW<'_, Ctl1Spec> {
        AddmW::new(self, 4)
    }
    #[doc = "Bit 5 - LIN break frame length"]
    #[inline(always)]
    ...
    #[doc = "Bit 15 - Swap TX/RX pins"]
    #[inline(always)]
    pub fn strp(&mut self) -> StrpW<'_, Ctl1Spec> {
        StrpW::new(self, 15)
    }
    #[doc = "Bit 16 - RX pin level inversion"]
    #[inline(always)]
    pub fn rinv(&mut self) -> RinvW<'_, Ctl1Spec> {
        RinvW::new(self, 16)
    }
    #[doc = "Bit 17 - TX pin level inversion"]
    #[inline(always)]
    pub fn tinv(&mut self) -> TinvW<'_, Ctl1Spec> {
        TinvW::new(self, 17)
    }
    #[doc = "Bit 18 - Data bit level inversion"]
    #[inline(always)]
    pub fn dinv(&mut self) -> DinvW<'_, Ctl1Spec> {
        DinvW::new(self, 18)
    }
    #[doc = "Bit 19 - Most significant bit first"]
    #[inline(always)]
    pub fn msbf(&mut self) -> MsbfW<'_, Ctl1Spec> {
        MsbfW::new(self, 19)
    }
    #[doc = "Bit 20 - Auto baud rate enable"]
    #[inline(always)]
    pub fn abden(&mut self) -> AbdenW<'_, Ctl1Spec> {
        AbdenW::new(self, 20)
    }
    #[doc = "Bits 21:22 - Auto baud rate mode"]
    #[inline(always)]
    pub fn abdm(&mut self) -> AbdmW<'_, Ctl1Spec> {
        AbdmW::new(self, 21)
    }
    #[doc = "Bit 23 - Receiver timeout enable"]
    #[inline(always)]
    pub fn rten(&mut self) -> RtenW<'_, Ctl1Spec> {
        RtenW::new(self, 23)
    }
    #[doc = "Bits 24:31 - Address of the USART terminal"]
    #[inline(always)]
