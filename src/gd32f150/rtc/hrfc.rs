...
impl W {
    #[doc = "Bits 0:8 - Calibration mask number"]
    #[inline(always)]
    pub fn cmsk(&mut self) -> CmskW<'_, HrfcSpec> {
        CmskW::new(self, 0)
    }
    #[doc = "Bit 13 - Frequency compensation window 16 second selected"]
    #[inline(always)]
    pub fn cwnd16(&mut self) -> Cwnd16W<'_, HrfcSpec> {
        Cwnd16W::new(self, 13)
    }
    #[doc = "Bit 14 - Frequency compensation window 8 second selected"]
    #[inline(always)]
    pub fn cwnd8(&mut self) -> Cwnd8W<'_, HrfcSpec> {
        Cwnd8W::new(self, 14)
    }
    #[doc = "Bit 15 - Increase RTC frequency by 488.5ppm"]
    #[inline(always)]
    pub fn freqi(&mut self) -> FreqiW<'_, HrfcSpec> {
        FreqiW::new(self, 15)
    }
}
