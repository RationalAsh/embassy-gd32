...
impl W {
    #[doc = "Bits 0:10 - LPM Token bmAttribute Field."]
    #[inline(always)]
    pub fn subpid_attr(&mut self) -> SubpidAttrW<'_, Sep4Spec> {
        SubpidAttrW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Status bits, for the handshake of receiving subpid LPM"]
    #[inline(always)]
    pub fn sub_sta(&mut self) -> SubStaW<'_, Sep4Spec> {
        SubStaW::new(self, 12)
    }
    #[doc = "Bit 15 - Successful Receive for LPM Token"]
    #[inline(always)]
    pub fn sub_st(&mut self) -> SubStW<'_, Sep4Spec> {
        SubStW::new(self, 15)
    }
}
#[doc = "USB sub-endpoint 4 register\n\nYou can [`read`](crate::Reg::read) this register and get [`sep4::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sep4::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sep4Spec;
