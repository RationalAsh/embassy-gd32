#[doc = "Register `SEP7` reader"]
pub type R = crate::R<Sep7Spec>;
#[doc = "Register `SEP7` writer"]
pub type W = crate::W<Sep7Spec>;
...
impl W {
    #[doc = "Bits 0:10 - LPM Token bmAttribute Field."]
    #[inline(always)]
    pub fn subpid_attr(&mut self) -> SubpidAttrW<'_, Sep7Spec> {
        SubpidAttrW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Status bits, for the handshake of receiving subpid LPM"]
    #[inline(always)]
    pub fn sub_sta(&mut self) -> SubStaW<'_, Sep7Spec> {
        SubStaW::new(self, 12)
    }
    #[doc = "Bit 15 - Successful Receive for LPM Token"]
    #[inline(always)]
    pub fn sub_st(&mut self) -> SubStW<'_, Sep7Spec> {
        SubStW::new(self, 15)
    }
}
#[doc = "USB sub-endpoint 7 register\n\nYou can [`read`](crate::Reg::read) this register and get [`sep7::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sep7::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sep7Spec;
impl crate::RegisterSpec for Sep7Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sep7::R`](R) reader structure"]
impl crate::Readable for Sep7Spec {}
#[doc = "`write(|w| ..)` method takes [`sep7::W`](W) writer structure"]
impl crate::Writable for Sep7Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SEP7 to value 0"]
impl crate::Resettable for Sep7Spec {}
