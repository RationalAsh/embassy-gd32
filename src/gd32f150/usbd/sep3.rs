...
pub type R = crate::R<Sep3Spec>;
#[doc = "Register `SEP3` writer"]
pub type W = crate::W<Sep3Spec>;
...
impl W {
    #[doc = "Bits 0:10 - LPM Token bmAttribute Field."]
    #[inline(always)]
    pub fn subpid_attr(&mut self) -> SubpidAttrW<'_, Sep3Spec> {
        SubpidAttrW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Status bits, for the handshake of receiving subpid LPM"]
    #[inline(always)]
    pub fn sub_sta(&mut self) -> SubStaW<'_, Sep3Spec> {
        SubStaW::new(self, 12)
    }
    #[doc = "Bit 15 - Successful Receive for LPM Token"]
    #[inline(always)]
    pub fn sub_st(&mut self) -> SubStW<'_, Sep3Spec> {
        SubStW::new(self, 15)
    }
}
#[doc = "USB sub-endpoint 3 register\n\nYou can [`read`](crate::Reg::read) this register and get [`sep3::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sep3::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sep3Spec;
impl crate::RegisterSpec for Sep3Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sep3::R`](R) reader structure"]
impl crate::Readable for Sep3Spec {}
#[doc = "`write(|w| ..)` method takes [`sep3::W`](W) writer structure"]
impl crate::Writable for Sep3Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SEP3 to value 0"]
impl crate::Resettable for Sep3Spec {}
