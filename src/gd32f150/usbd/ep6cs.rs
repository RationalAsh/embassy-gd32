...
impl W {
    #[doc = "Bits 0:3 - Endpoint address"]
    #[inline(always)]
    pub fn ep_ar(&mut self) -> EpArW<'_, Ep6csSpec> {
        EpArW::new(self, 0)
    }
    #[doc = "Bits 4:5 - Status bits, for transmission transfers"]
    #[inline(always)]
    pub fn tx_sta(&mut self) -> TxStaW<'_, Ep6csSpec> {
        TxStaW::new(self, 4)
    }
    #[doc = "Bit 6 - Transmission Data PID Toggle"]
    #[inline(always)]
    pub fn tx_dtg(&mut self) -> TxDtgW<'_, Ep6csSpec> {
        TxDtgW::new(self, 6)
    }
    #[doc = "Bit 7 - Transmission Successful Transfer"]
    #[inline(always)]
    pub fn tx_st(&mut self) -> TxStW<'_, Ep6csSpec> {
        TxStW::new(self, 7)
    }
    #[doc = "Bit 8 - Endpoint kind control"]
    #[inline(always)]
    pub fn ep_kctl(&mut self) -> EpKctlW<'_, Ep6csSpec> {
        EpKctlW::new(self, 8)
    }
    #[doc = "Bits 9:10 - Endpoint type control"]
    #[inline(always)]
    pub fn ep_ctl(&mut self) -> EpCtlW<'_, Ep6csSpec> {
        EpCtlW::new(self, 9)
    }
    #[doc = "Bit 11 - Setup transaction completed"]
    #[inline(always)]
    pub fn setup(&mut self) -> SetupW<'_, Ep6csSpec> {
        SetupW::new(self, 11)
    }
    #[doc = "Bits 12:13 - Reception status bits"]
    #[inline(always)]
    pub fn rx_sta(&mut self) -> RxStaW<'_, Ep6csSpec> {
        RxStaW::new(self, 12)
    }
    #[doc = "Bit 14 - Reception Data PID Toggle"]
    #[inline(always)]
    pub fn rx_dtg(&mut self) -> RxDtgW<'_, Ep6csSpec> {
        RxDtgW::new(self, 14)
    }
    #[doc = "Bit 15 - Reception Successful Transferred"]
    #[inline(always)]
    pub fn rx_st(&mut self) -> RxStW<'_, Ep6csSpec> {
        RxStW::new(self, 15)
    }
}
