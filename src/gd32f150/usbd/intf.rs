...
#[doc = "Field `RSTIF` reader - USB reset interrupt flag"]
pub type RstifR = crate::BitReader;
#[doc = "Field `RSTIF` writer - USB reset interrupt flag"]
pub type RstifW<'a, REG> = crate::BitWriter<'a, REG>;
#[doc = "Field `SPSIF` reader - Suspend state interrupt flag"]
pub type SpsifR = crate::BitReader;
#[doc = "Field `SPSIF` writer - Suspend state interrupt flag"]
...
#[doc = "Field `PMOUIF` reader - Packet memory overrun / underrun interrupt flag"]
pub type PmouifR = crate::BitReader;
#[doc = "Field `PMOUIF` writer - Packet memory overrun / underrun interrupt flag"]
...
impl R {
    ...
    #[doc = "Bit 10 - USB reset interrupt flag"]
    #[inline(always)]
    pub fn rstif(&self) -> RstifR {
        RstifR::new(((self.bits >> 10) & 1) != 0)
    }
    #[doc = "Bit 11 - Suspend state interrupt flag"]
    #[inline(always)]
    ...
    #[doc = "Bit 14 - Packet memory overrun / underrun interrupt flag"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:3 - Endpoint Number"]
    #[inline(always)]
    pub fn epnum(&mut self) -> EpnumW<'_, IntfSpec> {
        EpnumW::new(self, 0)
    }
    #[doc = "Bit 4 - Direction of transaction"]
    #[inline(always)]
    pub fn dir(&mut self) -> DirW<'_, IntfSpec> {
        DirW::new(self, 4)
    }
    #[doc = "Bit 8 - Expected start of frame interrupt flag"]
    #[inline(always)]
    pub fn esofif(&mut self) -> EsofifW<'_, IntfSpec> {
        EsofifW::new(self, 8)
    }
    #[doc = "Bit 9 - Start of frame interrupt flag"]
    #[inline(always)]
    pub fn sofif(&mut self) -> SofifW<'_, IntfSpec> {
        SofifW::new(self, 9)
    }
    #[doc = "Bit 10 - USB reset interrupt flag"]
    #[inline(always)]
    pub fn rstif(&mut self) -> RstifW<'_, IntfSpec> {
        RstifW::new(self, 10)
    }
    #[doc = "Bit 11 - Suspend state interrupt flag"]
    #[inline(always)]
    pub fn spsif(&mut self) -> SpsifW<'_, IntfSpec> {
        SpsifW::new(self, 11)
    }
    #[doc = "Bit 12 - Wakeup interrupt flag"]
    #[inline(always)]
    pub fn wkupif(&mut self) -> WkupifW<'_, IntfSpec> {
        WkupifW::new(self, 12)
    }
    #[doc = "Bit 13 - Error interrupt flag"]
    #[inline(always)]
    pub fn errif(&mut self) -> ErrifW<'_, IntfSpec> {
        ErrifW::new(self, 13)
    }
    #[doc = "Bit 14 - Packet memory overrun / underrun interrupt flag"]
    #[inline(always)]
    pub fn pmouif(&mut self) -> PmouifW<'_, IntfSpec> {
        PmouifW::new(self, 14)
    }
    #[doc = "Bit 15 - Successful transfer interrupt flag"]
    #[inline(always)]
    pub fn stif(&mut self) -> StifW<'_, IntfSpec> {
        StifW::new(self, 15)
    }
}
