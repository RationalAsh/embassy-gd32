...
pub type R = crate::R<Sep2Spec>;
#[doc = "Register `SEP2` writer"]
pub type W = crate::W<Sep2Spec>;
...
impl W {
    #[doc = "Bits 0:10 - LPM Token bmAttribute Field."]
    #[inline(always)]
    pub fn subpid_attr(&mut self) -> SubpidAttrW<'_, Sep2Spec> {
        SubpidAttrW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Status bits, for the handshake of receiving subpid LPM"]
    #[inline(always)]
    pub fn sub_sta(&mut self) -> SubStaW<'_, Sep2Spec> {
        SubStaW::new(self, 12)
    }
    #[doc = "Bit 15 - Successful Receive for LPM Token"]
    #[inline(always)]
    pub fn sub_st(&mut self) -> SubStW<'_, Sep2Spec> {
        SubStW::new(self, 15)
    }
}
#[doc = "USB sub-endpoint 2 register\n\nYou can [`read`](crate::Reg::read) this register and get [`sep2::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sep2::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sep2Spec;
impl crate::RegisterSpec for Sep2Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sep2::R`](R) reader structure"]
impl crate::Readable for Sep2Spec {}
#[doc = "`write(|w| ..)` method takes [`sep2::W`](W) writer structure"]
impl crate::Writable for Sep2Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SEP2 to value 0"]
impl crate::Resettable for Sep2Spec {}
