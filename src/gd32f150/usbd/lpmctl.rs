...
impl W {
    #[doc = "Bit 15 - LPM token successful transfer interrupt enable"]
    #[inline(always)]
    pub fn lpmstie(&mut self) -> LpmstieW<'_, LpmctlSpec> {
        LpmstieW::new(self, 15)
    }
}
#[doc = "USB LPM control register\n\nYou can [`read`](crate::Reg::read) this register and get [`lpmctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`lpmctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
