#[doc = "Register `SEP6` reader"]
pub type R = crate::R<Sep6Spec>;
#[doc = "Register `SEP6` writer"]
pub type W = crate::W<Sep6Spec>;
...
impl W {
    #[doc = "Bits 0:10 - LPM Token bmAttribute Field."]
    #[inline(always)]
    pub fn subpid_attr(&mut self) -> SubpidAttrW<'_, Sep6Spec> {
        SubpidAttrW::new(self, 0)
    }
    #[doc = "Bits 12:13 - Status bits, for the handshake of receiving subpid LPM"]
    #[inline(always)]
    pub fn sub_sta(&mut self) -> SubStaW<'_, Sep6Spec> {
        SubStaW::new(self, 12)
    }
    #[doc = "Bit 15 - Successful Receive for LPM Token"]
    #[inline(always)]
    pub fn sub_st(&mut self) -> SubStW<'_, Sep6Spec> {
        SubStW::new(self, 15)
    }
}
#[doc = "USB sub-endpoint 6 register\n\nYou can [`read`](crate::Reg::read) this register and get [`sep6::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`sep6::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
pub struct Sep6Spec;
impl crate::RegisterSpec for Sep6Spec {
    type Ux = u16;
}
#[doc = "`read()` method returns [`sep6::R`](R) reader structure"]
impl crate::Readable for Sep6Spec {}
#[doc = "`write(|w| ..)` method takes [`sep6::W`](W) writer structure"]
impl crate::Writable for Sep6Spec {
    type Safety = crate::Unsafe;
}
#[doc = "`reset()` method sets SEP6 to value 0"]
impl crate::Resettable for Sep6Spec {}
