...
impl W {
    ...
    #[doc = "Bits 25:29 - 12th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq12(&mut self) -> Rsq12W<'_, Rsq1Spec> {
        Rsq12W::new(self, 25)
    }
}
