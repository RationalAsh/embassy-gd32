...
impl W {
    #[doc = "Bit 0 - Filter 0 associated FIFO"]
    #[inline(always)]
    pub fn faf0(&mut self) -> Faf0W<'_, FafifoSpec> {
        Faf0W::new(self, 0)
    }
    #[doc = "Bit 1 - Filter 1 associated FIFO"]
    #[inline(always)]
    pub fn faf1(&mut self) -> Faf1W<'_, FafifoSpec> {
        Faf1W::new(self, 1)
    }
    #[doc = "Bit 2 - Filter 2 associated FIFO"]
    #[inline(always)]
    pub fn faf2(&mut self) -> Faf2W<'_, FafifoSpec> {
        Faf2W::new(self, 2)
    }
    #[doc = "Bit 3 - Filter 3 associated FIFO"]
    #[inline(always)]
    pub fn faf3(&mut self) -> Faf3W<'_, FafifoSpec> {
        Faf3W::new(self, 3)
    }
    #[doc = "Bit 4 - Filter 4 associated FIFO"]
    #[inline(always)]
    pub fn faf4(&mut self) -> Faf4W<'_, FafifoSpec> {
        Faf4W::new(self, 4)
    }
    #[doc = "Bit 5 - Filter 5 associated FIFO"]
    #[inline(always)]
    pub fn faf5(&mut self) -> Faf5W<'_, FafifoSpec> {
        Faf5W::new(self, 5)
    }
    #[doc = "Bit 6 - Filter 6 associated FIFO"]
    #[inline(always)]
    pub fn faf6(&mut self) -> Faf6W<'_, FafifoSpec> {
        Faf6W::new(self, 6)
    }
    #[doc = "Bit 7 - Filter 7 associated FIFO"]
    #[inline(always)]
    pub fn faf7(&mut self) -> Faf7W<'_, FafifoSpec> {
        Faf7W::new(self, 7)
    }
    #[doc = "Bit 8 - Filter 8 associated FIFO"]
    #[inline(always)]
    pub fn faf8(&mut self) -> Faf8W<'_, FafifoSpec> {
        Faf8W::new(self, 8)
    }
    #[doc = "Bit 9 - Filter 9 associated FIFO"]
    #[inline(always)]
    pub fn faf9(&mut self) -> Faf9W<'_, FafifoSpec> {
        Faf9W::new(self, 9)
    }
    #[doc = "Bit 10 - Filter 10 associated FIFO"]
    #[inline(always)]
    pub fn faf10(&mut self) -> Faf10W<'_, FafifoSpec> {
        Faf10W::new(self, 10)
    }
    #[doc = "Bit 11 - Filter 11 associated FIFO"]
    #[inline(always)]
    pub fn faf11(&mut self) -> Faf11W<'_, FafifoSpec> {
        Faf11W::new(self, 11)
    }
    #[doc = "Bit 12 - Filter 12 associated FIFO"]
    #[inline(always)]
    pub fn faf12(&mut self) -> Faf12W<'_, FafifoSpec> {
        Faf12W::new(self, 12)
    }
    #[doc = "Bit 13 - Filter 13 associated FIFO"]
    #[inline(always)]
    pub fn faf13(&mut self) -> Faf13W<'_, FafifoSpec> {
        Faf13W::new(self, 13)
    }
    #[doc = "Bit 14 - Filter 14 associated FIFO"]
    #[inline(always)]
    pub fn faf14(&mut self) -> Faf14W<'_, FafifoSpec> {
        Faf14W::new(self, 14)
    }
    #[doc = "Bit 15 - Filter 15 associated FIFO"]
    #[inline(always)]
    pub fn faf15(&mut self) -> Faf15W<'_, FafifoSpec> {
        Faf15W::new(self, 15)
    }
    #[doc = "Bit 16 - Filter 16 associated FIFO"]
    #[inline(always)]
    pub fn faf16(&mut self) -> Faf16W<'_, FafifoSpec> {
        Faf16W::new(self, 16)
    }
    #[doc = "Bit 17 - Filter 17 associated FIFO"]
    #[inline(always)]
    pub fn faf17(&mut self) -> Faf17W<'_, FafifoSpec> {
        Faf17W::new(self, 17)
    }
    #[doc = "Bit 18 - Filter 18 associated FIFO"]
    #[inline(always)]
    pub fn faf18(&mut self) -> Faf18W<'_, FafifoSpec> {
        Faf18W::new(self, 18)
    }
    #[doc = "Bit 19 - Filter 19 associated FIFO"]
    #[inline(always)]
    pub fn faf19(&mut self) -> Faf19W<'_, FafifoSpec> {
        Faf19W::new(self, 19)
    }
    #[doc = "Bit 20 - Filter 20 associated FIFO"]
    #[inline(always)]
    pub fn faf20(&mut self) -> Faf20W<'_, FafifoSpec> {
        Faf20W::new(self, 20)
    }
    #[doc = "Bit 21 - Filter 21 associated FIFO"]
    #[inline(always)]
    pub fn faf21(&mut self) -> Faf21W<'_, FafifoSpec> {
        Faf21W::new(self, 21)
    }
    #[doc = "Bit 22 - Filter 22 associated FIFO"]
    #[inline(always)]
    pub fn faf22(&mut self) -> Faf22W<'_, FafifoSpec> {
        Faf22W::new(self, 22)
    }
    #[doc = "Bit 23 - Filter 23 associated FIFO"]
    #[inline(always)]
    pub fn faf23(&mut self) -> Faf23W<'_, FafifoSpec> {
        Faf23W::new(self, 23)
    }
    #[doc = "Bit 24 - Filter 24 associated FIFO"]
    #[inline(always)]
    pub fn faf24(&mut self) -> Faf24W<'_, FafifoSpec> {
        Faf24W::new(self, 24)
    }
    #[doc = "Bit 25 - Filter 25 associated FIFO"]
    #[inline(always)]
    pub fn faf25(&mut self) -> Faf25W<'_, FafifoSpec> {
        Faf25W::new(self, 25)
    }
    #[doc = "Bit 26 - Filter 26 associated FIFO"]
    #[inline(always)]
    pub fn faf26(&mut self) -> Faf26W<'_, FafifoSpec> {
        Faf26W::new(self, 26)
    }
    #[doc = "Bit 27 - Filter 27 associated FIFO"]
    #[inline(always)]
    pub fn faf27(&mut self) -> Faf27W<'_, FafifoSpec> {
        Faf27W::new(self, 27)
    }
}
