...
pub type CptW<'a, REG> = crate::FieldWriter<'a, REG, 5, Cpt, crate::Safe>;
...
pub type VptW<'a, REG> = crate::FieldWriter<'a, REG, 5, Vpt, crate::Safe>;
...
#[doc = "IVREF control register\n\nYou can [`read`](crate::Reg::read) this register and get [`ivref_ctl::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`ivref_ctl::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
