...
pub type Oa0TrimLpLowW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa0TrimLpHighW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa1TrimLpLowW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa1TrimLpHighW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa2TrimLpLowW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
pub type Oa2TrimLpHighW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
impl R {
...
impl W {
    #[doc = "Bits 0:4 - OPA0, low power mode 5-bit offset trim value for PMOS pairs"]
    #[inline(always)]
    pub fn oa0_trim_lp_low(&mut self) -> Oa0TrimLpLowW<'_, OpaLpbtSpec> {
        Oa0TrimLpLowW::new(self, 0)
    }
    #[doc = "Bits 5:9 - OPA0, low power mode 5-bit offset trim value for NMOS pairs"]
    #[inline(always)]
    pub fn oa0_trim_lp_high(&mut self) -> Oa0TrimLpHighW<'_, OpaLpbtSpec> {
        Oa0TrimLpHighW::new(self, 5)
    }
    #[doc = "Bits 10:14 - OPA1, low power mode 5-bit offset trim value for PMOS pairs"]
    #[inline(always)]
    pub fn oa1_trim_lp_low(&mut self) -> Oa1TrimLpLowW<'_, OpaLpbtSpec> {
        Oa1TrimLpLowW::new(self, 10)
    }
    #[doc = "Bits 15:19 - OPA1, low power mode 5-bit offset trim value for NMOS pairs"]
    #[inline(always)]
    pub fn oa1_trim_lp_high(&mut self) -> Oa1TrimLpHighW<'_, OpaLpbtSpec> {
        Oa1TrimLpHighW::new(self, 15)
    }
    #[doc = "Bits 20:24 - OPA2, low power mode 5-bit offset trim value for PMOS pairs"]
    #[inline(always)]
    pub fn oa2_trim_lp_low(&mut self) -> Oa2TrimLpLowW<'_, OpaLpbtSpec> {
        Oa2TrimLpLowW::new(self, 20)
    }
    #[doc = "Bits 25:29 - OPA2, low power mode 5-bit offset trim value for NMOS pairs"]
    #[inline(always)]
    pub fn oa2_trim_lp_high(&mut self) -> Oa2TrimLpHighW<'_, OpaLpbtSpec> {
        Oa2TrimLpHighW::new(self, 25)
    }
}
#[doc = "OPA offset trimming for low power mode register\n\nYou can [`read`](crate::Reg::read) this register and get [`opa_lpbt::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`opa_lpbt::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
