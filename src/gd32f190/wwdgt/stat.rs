...
#[doc = "EEarly wakeup interrupt flag\n\nValue on reset: 0"]
...
#[doc = "Field `EWIF` reader - EEarly wakeup interrupt flag"]
...
#[doc = "Field `EWIF` writer - EEarly wakeup interrupt flag"]
...
impl R {
    #[doc = "Bit 0 - EEarly wakeup interrupt flag"]
    #[inline(always)]
