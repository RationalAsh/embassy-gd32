...
#[doc = "Field `OB_DATA` reader - Store OB_DATA\\[15:0\\] of option byte block after system reset"]
...
impl R {
    ...
    #[doc = "Bits 16:31 - Store OB_DATA\\[15:0\\] of option byte block after system reset"]
    #[inline(always)]
