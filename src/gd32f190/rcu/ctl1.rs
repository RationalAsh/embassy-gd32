...
pub type Irc14madjW<'a, REG> = crate::FieldWriter<'a, REG, 5, u8, crate::Safe>;
...
impl W {
    #[doc = "Bit 0 - IRC14M Internal 14M RC oscillator Enable"]
    #[inline(always)]
    pub fn irc14men(&mut self) -> Irc14menW<'_, Ctl1Spec> {
        Irc14menW::new(self, 0)
    }
    #[doc = "Bits 3:7 - Internal 14M RC Oscillator clock trim adjust value"]
    #[inline(always)]
    pub fn irc14madj(&mut self) -> Irc14madjW<'_, Ctl1Spec> {
