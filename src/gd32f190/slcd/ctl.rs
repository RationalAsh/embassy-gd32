...
impl W {
    #[doc = "Bit 0 - SLCD controller start"]
    #[inline(always)]
    pub fn slcdon(&mut self) -> SlcdonW<'_, CtlSpec> {
        SlcdonW::new(self, 0)
    }
    #[doc = "Bit 1 - SLCD voltage source"]
    #[inline(always)]
    pub fn vsrc(&mut self) -> VsrcW<'_, CtlSpec> {
        VsrcW::new(self, 1)
    }
    #[doc = "Bits 2:4 - Duty select"]
    #[inline(always)]
    pub fn duty(&mut self) -> DutyW<'_, CtlSpec> {
        DutyW::new(self, 2)
    }
    #[doc = "Bits 5:6 - Bias select"]
    #[inline(always)]
    pub fn bias(&mut self) -> BiasW<'_, CtlSpec> {
        BiasW::new(self, 5)
    }
    #[doc = "Bit 7 - Common/segment padselect"]
    #[inline(always)]
    pub fn coms(&mut self) -> ComsW<'_, CtlSpec> {
        ComsW::new(self, 7)
    }
}
