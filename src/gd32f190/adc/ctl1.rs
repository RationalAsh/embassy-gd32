...
pub type EtsicW<'a, REG> = crate::FieldWriter<'a, REG, 3, Etsic, crate::Safe>;
...
pub type EtsrcW<'a, REG> = crate::FieldWriter<'a, REG, 3, Etsrc, crate::Safe>;
...
impl From<Swrcstr> for bool {
    #[inline(always)]
    fn from(variant: Swrcstr) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SWRCST` reader - Start on regular channel"]
pub type SwrcstR = crate::BitReader<Swrcstr>;
impl SwrcstR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    pub const fn variant(&self) -> Swrcstr {
        match self.bits {
            false => Swrcstr::Started,
            true => Swrcstr::NotStarted,
        }
    }
    #[doc = "Reset state"]
    #[inline(always)]
    pub fn is_started(&self) -> bool {
        *self == Swrcstr::Started
    }
    #[doc = "Starting conversion of regular channels"]
    #[inline(always)]
    pub fn is_not_started(&self) -> bool {
        *self == Swrcstr::NotStarted
    }
}
#[doc = "Start on regular channel\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
...
impl From<SwrcstwWO> for bool {
    #[inline(always)]
    fn from(variant: SwrcstwWO) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `SWRCST` writer - Start on regular channel"]
pub type SwrcstW<'a, REG> = crate::BitWriter<'a, REG, SwrcstwWO>;
...
#[doc = "Field `VBATEN` reader - enable/disable the VBAT channel"]
...
#[doc = "Field `VBATEN` writer - enable/disable the VBAT channel"]
...
impl W {
    ...
    #[doc = "Bit 24 - enable/disable the VBAT channel"]
    #[inline(always)]
    pub fn vbaten(&mut self) -> VbatenW<'_, Ctl1Spec> {
        VbatenW::new(self, 24)
    }
}
