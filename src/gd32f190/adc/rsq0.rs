...
pub type Rsq16R = crate::FieldReader;
#[doc = "Field `RSQ16` writer - 16th conversion in regular sequence"]
pub type Rsq16W<'a, REG> = crate::FieldWriter<'a, REG, 5>;
...
impl W {
    #[doc = "Bits 0:4 - 13th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq13(&mut self) -> Rsq13W<'_, Rsq0Spec> {
        Rsq13W::new(self, 0)
    }
    #[doc = "Bits 5:9 - 14th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq14(&mut self) -> Rsq14W<'_, Rsq0Spec> {
        Rsq14W::new(self, 5)
    }
    #[doc = "Bits 10:14 - 15th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq15(&mut self) -> Rsq15W<'_, Rsq0Spec> {
        Rsq15W::new(self, 10)
    }
    #[doc = "Bits 15:19 - 16th conversion in regular sequence"]
    #[inline(always)]
    pub fn rsq16(&mut self) -> Rsq16W<'_, Rsq0Spec> {
        Rsq16W::new(self, 15)
    }
    #[doc = "Bits 20:23 - Regular channel group length"]
    #[inline(always)]
    pub fn rl(&mut self) -> RlW<'_, Rsq0Spec> {
        RlW::new(self, 20)
    }
}
