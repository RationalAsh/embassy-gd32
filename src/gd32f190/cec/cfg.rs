...
impl W {
    #[doc = "Bits 0:2 - Signal Free Time"]
    #[inline(always)]
    pub fn sft(&mut self) -> SftW<'_, CfgSpec> {
        SftW::new(self, 0)
    }
    #[doc = "Bit 3 - Reception bit timing tolerance"]
    #[inline(always)]
    pub fn rtol(&mut self) -> RtolW<'_, CfgSpec> {
        RtolW::new(self, 3)
    }
    #[doc = "Bit 4 - Whether stop receive message when detected RBRE"]
    #[inline(always)]
    pub fn rbrestp(&mut self) -> RbrestpW<'_, CfgSpec> {
        RbrestpW::new(self, 4)
    }
    #[doc = "Bit 5 - Generate Error-bit when detected RBRE in singlecast"]
    #[inline(always)]
    pub fn rbregen(&mut self) -> RbregenW<'_, CfgSpec> {
        RbregenW::new(self, 5)
    }
    #[doc = "Bit 6 - Generate Error-bit when detected RLBPE in singlecast"]
    #[inline(always)]
    pub fn rlbpegen(&mut self) -> RlbpegenW<'_, CfgSpec> {
        RlbpegenW::new(self, 6)
    }
    #[doc = "Bit 7 - Do not generate Error-bit in broadcast message"]
    #[inline(always)]
    pub fn bcng(&mut self) -> BcngW<'_, CfgSpec> {
        BcngW::new(self, 7)
    }
    #[doc = "Bit 8 - The SFT start option"]
    #[inline(always)]
    pub fn sftopt(&mut self) -> SftoptW<'_, CfgSpec> {
        SftoptW::new(self, 8)
    }
    #[doc = "Bits 16:30 - Own Address"]
    #[inline(always)]
    pub fn oadr(&mut self) -> OadrW<'_, CfgSpec> {
        OadrW::new(self, 16)
    }
    #[doc = "Bit 31 - Listen mode enable"]
    #[inline(always)]
    pub fn lmen(&mut self) -> LmenW<'_, CfgSpec> {
        LmenW::new(self, 31)
    }
}
