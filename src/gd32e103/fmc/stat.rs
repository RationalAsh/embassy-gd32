...
#[doc = "Program alignment error flag bit\n\nValue on reset: 0"]
#[derive(Clone, Copy, Debug, PartialEq, Eq)]
pub enum Pgaerrr {
    #[doc = "0: There was no error"]
    NoError = 0,
    #[doc = "1: There was an error in program alignment"]
    Error = 1,
}
...
pub type PgaerrR = crate::BitReader<Pgaerrr>;
impl PgaerrR {
    #[doc = "Get enumerated values variant"]
    #[inline(always)]
    ...
    #[doc = "There was an error in program alignment"]
    #[inline(always)]
    pub fn is_error(&self) -> bool {
        *self == Pgaerrr::Error
    }
...
impl From<PgaerrwWO> for bool {
    #[inline(always)]
    fn from(variant: PgaerrwWO) -> Self {
        variant as u8 != 0
    }
}
#[doc = "Field `PGAERR` writer - Program alignment error flag bit"]
pub type PgaerrW<'a, REG> = crate::BitWriter<'a, REG, PgaerrwWO>;
impl<'a, REG> PgaerrW<'a, REG>
where
    REG: crate::Writable + crate::RegisterSpec,
{
    #[doc = "Clears flag"]
...
impl W {
    #[doc = "Bit 2 - Program error flag bit"]
    #[inline(always)]
    pub fn pgerr(&mut self) -> PgerrW<'_, StatSpec> {
        PgerrW::new(self, 2)
    }
    #[doc = "Bit 3 - Program alignment error flag bit"]
    #[inline(always)]
    pub fn pgaerr(&mut self) -> PgaerrW<'_, StatSpec> {
        PgaerrW::new(self, 3)
    }
    #[doc = "Bit 4 - Erase/Program protection error flag bit"]
    #[inline(always)]
    pub fn wperr(&mut self) -> WperrW<'_, StatSpec> {
        WperrW::new(self, 4)
    }
    #[doc = "Bit 5 - End of operation flag bit"]
    #[inline(always)]
    pub fn endf(&mut self) -> EndfW<'_, StatSpec> {
        EndfW::new(self, 5)
    }
}
