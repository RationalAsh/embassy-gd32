...
#[doc = "Field `ADDRESS` reader - Bit 0 of a 10-bit address"]
pub type AddressR = crate::FieldReader<u16>;
#[doc = "Field `ADDRESS` writer - Bit 0 of a 10-bit address"]
pub type AddressW<'a, REG> = crate::FieldWriter<'a, REG, 10, u16, crate::Safe>;
...
impl R {
    #[doc = "Bits 0:9 - Bit 0 of a 10-bit address"]
    #[inline(always)]
...
impl W {
    #[doc = "Bits 0:9 - Bit 0 of a 10-bit address"]
    #[inline(always)]
    pub fn address(&mut self) -> AddressW<'_, Saddr0Spec> {
        AddressW::new(self, 0)
    }
    #[doc = "Bit 15 - Address mode for the I2C slave"]
    #[inline(always)]
    pub fn addformat(&mut self) -> AddformatW<'_, Saddr0Spec> {
