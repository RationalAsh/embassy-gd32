...
impl W {
    #[doc = "Bit 0 - Filter data"]
    #[inline(always)]
    pub fn fd0(&mut self) -> Fd0W<'_, F0data1Spec> {
        Fd0W::new(self, 0)
    }
    #[doc = "Bit 1 - Filter data"]
    #[inline(always)]
    pub fn fd1(&mut self) -> Fd1W<'_, F0data1Spec> {
        Fd1W::new(self, 1)
    }
    #[doc = "Bit 2 - Filter data"]
    #[inline(always)]
    pub fn fd2(&mut self) -> Fd2W<'_, F0data1Spec> {
        Fd2W::new(self, 2)
    }
    #[doc = "Bit 3 - Filter data"]
    #[inline(always)]
    pub fn fd3(&mut self) -> Fd3W<'_, F0data1Spec> {
        Fd3W::new(self, 3)
    }
    #[doc = "Bit 4 - Filter data"]
    #[inline(always)]
    pub fn fd4(&mut self) -> Fd4W<'_, F0data1Spec> {
        Fd4W::new(self, 4)
    }
    #[doc = "Bit 5 - Filter data"]
    #[inline(always)]
    pub fn fd5(&mut self) -> Fd5W<'_, F0data1Spec> {
        Fd5W::new(self, 5)
    }
    #[doc = "Bit 6 - Filter data"]
    #[inline(always)]
    pub fn fd6(&mut self) -> Fd6W<'_, F0data1Spec> {
        Fd6W::new(self, 6)
    }
    #[doc = "Bit 7 - Filter data"]
    #[inline(always)]
    pub fn fd7(&mut self) -> Fd7W<'_, F0data1Spec> {
        Fd7W::new(self, 7)
    }
    #[doc = "Bit 8 - Filter data"]
    #[inline(always)]
    pub fn fd8(&mut self) -> Fd8W<'_, F0data1Spec> {
        Fd8W::new(self, 8)
    }
    #[doc = "Bit 9 - Filter data"]
    #[inline(always)]
    pub fn fd9(&mut self) -> Fd9W<'_, F0data1Spec> {
        Fd9W::new(self, 9)
    }
    #[doc = "Bit 10 - Filter data"]
    #[inline(always)]
    pub fn fd10(&mut self) -> Fd10W<'_, F0data1Spec> {
        Fd10W::new(self, 10)
    }
    #[doc = "Bit 11 - Filter data"]
    #[inline(always)]
    pub fn fd11(&mut self) -> Fd11W<'_, F0data1Spec> {
        Fd11W::new(self, 11)
    }
    #[doc = "Bit 12 - Filter data"]
    #[inline(always)]
    pub fn fd12(&mut self) -> Fd12W<'_, F0data1Spec> {
        Fd12W::new(self, 12)
    }
    #[doc = "Bit 13 - Filter data"]
    #[inline(always)]
    pub fn fd13(&mut self) -> Fd13W<'_, F0data1Spec> {
        Fd13W::new(self, 13)
    }
    #[doc = "Bit 14 - Filter data"]
    #[inline(always)]
    pub fn fd14(&mut self) -> Fd14W<'_, F0data1Spec> {
        Fd14W::new(self, 14)
    }
    #[doc = "Bit 15 - Filter data"]
    #[inline(always)]
    pub fn fd15(&mut self) -> Fd15W<'_, F0data1Spec> {
        Fd15W::new(self, 15)
    }
    #[doc = "Bit 16 - Filter data"]
    #[inline(always)]
    pub fn fd16(&mut self) -> Fd16W<'_, F0data1Spec> {
        Fd16W::new(self, 16)
    }
    #[doc = "Bit 17 - Filter data"]
    #[inline(always)]
    pub fn fd17(&mut self) -> Fd17W<'_, F0data1Spec> {
        Fd17W::new(self, 17)
    }
    #[doc = "Bit 18 - Filter data"]
    #[inline(always)]
    pub fn fd18(&mut self) -> Fd18W<'_, F0data1Spec> {
        Fd18W::new(self, 18)
    }
    #[doc = "Bit 19 - Filter data"]
    #[inline(always)]
    pub fn fd19(&mut self) -> Fd19W<'_, F0data1Spec> {
        Fd19W::new(self, 19)
    }
    #[doc = "Bit 20 - Filter data"]
    #[inline(always)]
    pub fn fd20(&mut self) -> Fd20W<'_, F0data1Spec> {
        Fd20W::new(self, 20)
    }
    #[doc = "Bit 21 - Filter data"]
    #[inline(always)]
    pub fn fd21(&mut self) -> Fd21W<'_, F0data1Spec> {
        Fd21W::new(self, 21)
    }
    #[doc = "Bit 22 - Filter data"]
    #[inline(always)]
    pub fn fd22(&mut self) -> Fd22W<'_, F0data1Spec> {
        Fd22W::new(self, 22)
    }
    #[doc = "Bit 23 - Filter data"]
    #[inline(always)]
    pub fn fd23(&mut self) -> Fd23W<'_, F0data1Spec> {
        Fd23W::new(self, 23)
    }
    #[doc = "Bit 24 - Filter data"]
    #[inline(always)]
    pub fn fd24(&mut self) -> Fd24W<'_, F0data1Spec> {
        Fd24W::new(self, 24)
    }
    #[doc = "Bit 25 - Filter data"]
    #[inline(always)]
    pub fn fd25(&mut self) -> Fd25W<'_, F0data1Spec> {
        Fd25W::new(self, 25)
    }
    #[doc = "Bit 26 - Filter data"]
    #[inline(always)]
    pub fn fd26(&mut self) -> Fd26W<'_, F0data1Spec> {
        Fd26W::new(self, 26)
    }
    #[doc = "Bit 27 - Filter data"]
    #[inline(always)]
    pub fn fd27(&mut self) -> Fd27W<'_, F0data1Spec> {
        Fd27W::new(self, 27)
    }
    #[doc = "Bit 28 - Filter data"]
    #[inline(always)]
    pub fn fd28(&mut self) -> Fd28W<'_, F0data1Spec> {
        Fd28W::new(self, 28)
    }
    #[doc = "Bit 29 - Filter data"]
    #[inline(always)]
    pub fn fd29(&mut self) -> Fd29W<'_, F0data1Spec> {
        Fd29W::new(self, 29)
    }
    #[doc = "Bit 30 - Filter data"]
    #[inline(always)]
    pub fn fd30(&mut self) -> Fd30W<'_, F0data1Spec> {
        Fd30W::new(self, 30)
    }
    #[doc = "Bit 31 - Filter data"]
    #[inline(always)]
    pub fn fd31(&mut self) -> Fd31W<'_, F0data1Spec> {
        Fd31W::new(self, 31)
    }
}
