...
impl W {
    #[doc = "Bits 0:3 - address setup time"]
    #[inline(always)]
    pub fn waset(&mut self) -> WasetW<'_, SnwtcfgSpec> {
        WasetW::new(self, 0)
    }
    #[doc = "Bits 4:7 - address hold time"]
    #[inline(always)]
    pub fn wahld(&mut self) -> WahldW<'_, SnwtcfgSpec> {
        WahldW::new(self, 4)
    }
    #[doc = "Bits 8:15 - data setup time"]
    #[inline(always)]
    pub fn wdset(&mut self) -> WdsetW<'_, SnwtcfgSpec> {
        WdsetW::new(self, 8)
    }
    #[doc = "Bits 16:19 - bus latency"]
    #[inline(always)]
    pub fn wbuslat(&mut self) -> WbuslatW<'_, SnwtcfgSpec> {
        WbuslatW::new(self, 16)
    }
    #[doc = "Bits 28:29 - asynchronous access mode"]
    #[inline(always)]
    pub fn wasyncmod(&mut self) -> WasyncmodW<'_, SnwtcfgSpec> {
        WasyncmodW::new(self, 28)
    }
}
#[doc = "SRAM/NOR write timing configuration registers\n\nYou can [`read`](crate::Reg::read) this register and get [`snwtcfg::R`](R). You can [`reset`](crate::Reg::reset), [`write`](crate::Reg::write), [`write_with_zero`](crate::Reg::write_with_zero) this register using [`snwtcfg::W`](W). You can also [`modify`](crate::Reg::modify) this register. See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
